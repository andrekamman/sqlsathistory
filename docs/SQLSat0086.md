...
---|---|---|---
00:00:00|Adam Jorgensen|Analysis|[BI with SharePoint 2010 and  Performance Point](#sessionid:-28526)
00:00:00|Adam Jorgensen|Analysis|[Analysis - 0 to SSAS](#sessionid:-28528)
00:00:00|Andy Warren|xMisc - Prof Dev, DBA, Powershell|[Building a Professional Development Plan](#sessionid:-28702)
00:00:00|Angel Abundez|Presentation|[Unleash the Tablix](#sessionid:-28733)
00:00:00|Bradley Ball|xMisc - Prof Dev, DBA, Powershell|[Page and Row Compression How, When, and Why](#sessionid:-29136)
00:00:00|Brian Mitchell|ETL|[Applying FastTrack  PDW Best Practices to your DW](#sessionid:-29262)
00:00:00|Chris Albrektson|Presentation|[Introduction to SSRS Dashboards](#sessionid:-29374)
00:00:00|Dustin Ryan|Presentation|[Reporting on a Cube with SSRS 2008](#sessionid:-30022)
00:00:00|Daniel Taylor|xMisc - Prof Dev, DBA, Powershell|[Useful tools SSMS TipsTricks for DBA  Developer](#sessionid:-30024)
00:00:00|Joe Celko|ETL|[Nested Sets model for Trees  Hierarchies](#sessionid:-30574)
00:00:00|Joe Celko|ETL|[Modeling Time in SQL](#sessionid:-30575)
00:00:00|Jose Chinchilla|xMisc - Prof Dev, DBA, Powershell|[SQLServer 2012 PowerView "Crescent" Dashboards](#sessionid:-30611)
00:00:00|Jen Underwood|Analysis|[What's New for Business Intelligence in "Denali"](#sessionid:-30722)
00:00:00|James McAuliffe|ETL|[SSIShare The Code, Man](#sessionid:-30864)
00:00:00|James McAuliffe|ETL|[Lookup Between The Lines is Data Late Than Never](#sessionid:-30866)
00:00:00|John Welch|ETL|[Do You Know the Data Flow?](#sessionid:-30985)
00:00:00|John Welch|ETL|[Do More (ETL) with Less (Effort) - Automating SSIS](#sessionid:-30986)
00:00:00|John Welch|Analysis|[Tuning Analysis Services Processing Performance](#sessionid:-30987)
00:00:00|John Welch|ETL|[Handling Advanced Data Warehouse Scenarios in SSIS](#sessionid:-30989)
00:00:00|Richie Rump|xMisc - Prof Dev, DBA, Powershell|[Intro to Project Management for BI Professionals](#sessionid:-31045)
00:00:00|Juan Soto|Analysis|[Using MS Access as a BI Tool with SQL Server](#sessionid:-31089)
00:00:00|Marc Miller|Analysis|[BI in the Cloud](#sessionid:-31544)
00:00:00|Maximo Trinidad|xMisc - Prof Dev, DBA, Powershell|[SSIS - Analyzing your data integrating PowerShell](#sessionid:-31632)
00:00:00|Michael Hinckley|Presentation|[BI to SharePoint and vice versa](#sessionid:-31727)
00:00:00|Michael Antonovich|Presentation|[SQL - External Data Source for SharePoint  Office](#sessionid:-31807)
00:00:00|Melissa Coates|Presentation|[Dashboards...How to Choose Which MSBI Tool?](#sessionid:-31933)
00:00:00|Rob Collie|Analysis|[PowerPivot: BI  Massive Data Analysis for Humans](#sessionid:-32550)
00:00:00|Phillip E Rosen|Presentation|[Biz Intel Dashboards W/Excel OLAP formulas](#sessionid:-32649)
00:00:00|Sanjay Soni|Presentation|[Delivering BI to the masses at Microsoft](#sessionid:-32779)
00:00:00|Mark Tabladillo|Analysis|[Data Mining with Excel 2010 and PowerPivot](#sessionid:-33108)
00:00:00|Mark Tabladillo|xMisc - Prof Dev, DBA, Powershell|[Social Marketing 2011 for Microsoft Professionals](#sessionid:-33109)
00:00:00|Todd Davis|xMisc - Prof Dev, DBA, Powershell|[SELECT job FROM firm WHERE hired = 'Yes'](#sessionid:-33320)
#  
#### SessionID: 28526
