...
---|---|---|---
09:00:00|William Durkin|   DBA/DEV|[SQL Server 2016 - is it worth the upgrade?](#sessionid-50961)
09:00:00|Stephane Haby| DBA|[Demistifying the errorlog](#sessionid-52427)
09:00:00|Alex Whittles|      BI|[Introduction to U-SQL and Data Lake](#sessionid-52919)
10:15:00|Karol Papaj| DBA|[SQL Server 2016 Availability Group Enhancements](#sessionid-50944)
10:15:00|Regis Baccaro|     BI/DEV|[Advanced BIML - for the advanced ETL developer](#sessionid-50957)
10:15:00|Uwe Ricken|   DBA/DEV|[Are Temporal Tables The Better CDC?](#sessionid-50975)
10:15:00|Sergio Govoni|    DEV|[Execution Plans End-to-End in SQL Server](#sessionid-54162)
10:15:00|Prathy Kamasani|      BI|[Compelling visuals in Power BI](#sessionid-54675)
11:30:00|Miroslav Dimitrov|   DBA/DEV|[SQL Server Myths and Misconceptions](#sessionid-51178)
11:30:00|Janos Berke|    DEV|[The Good, the Bad and the Ugly - Always Encrypted in action](#sessionid-51184)
11:30:00|Dejan Dular|    DEV|[In the name of the resources: Aggregating data](#sessionid-52476)
11:30:00|Johan Ludvig Brattås|      BI|[Step into the Internet of Things with Azure IoT, Stream Analytics and PowerBI](#sessionid-54547)
13:30:00|Rob Sewell| DBA|[How I use PowerShell to automate the installation  upgrade of DBA scripts](#sessionid-50943)
13:30:00|n/a n/a|     BI/DEV|[Session Details not available](#sessionid-51009)
13:30:00|Andrea Martorana Tusa|      BI|[Mobile BI with Microsoft tools](#sessionid-52236)
13:30:00|Erland Sommarskog|    DEV|[Giving Permissions through Stored Procedures](#sessionid-54285)
13:30:00|Gianluca Sartori|   DBA/DEV|[Benchmarking like a Pro](#sessionid-54694)
14:45:00|Denis Reznik|    DEV|[Deadlocks. Everything you ever wanted to ask but were too shy.](#sessionid-50971)
14:45:00|Enrico van de Laar|   DBA/DEV|[Introducing the SQL Server 2016 Query Store](#sessionid-51121)
14:45:00|Bent Pedersen|      BI|[Scripting tabular models](#sessionid-52341)
14:45:00|André Kamman| DBA|[Powershell community scripts for DBAs](#sessionid-53849)
14:45:00|Stijn Wynants|     BI/DEV|[Real-Time Analytics: OLAP  OLTP in the mix!](#sessionid-54066)
16:00:00|Markus Ehrenmueller-Jensen|     BI/DEV|[Boosting DWH-Performance with SQL Server 2016](#sessionid-50985)
16:00:00|Vedran Kesegic| DBA|[How to recover deleted data with no backups?](#sessionid-54373)
16:00:00|Tobias Koprowski|   DBA/DEV|[SQL Security in the Cloud](#sessionid-54522)
16:00:00|Gabi Münster|      BI|[From MDS to SSRS - a short walkthrough](#sessionid-54705)
16:00:00|Emanuele Zanchettin|    DEV|[Performance tips for faster SQL queries](#sessionid-54746)
#  
#### SessionID: 50961
