...
---|---|---|---
09:00:00|Ruslan Zolotukhin|BI Platform Architecture, Development  Administration|[Demystification of Calculation Groups in Analysis Services Tabular](#sessionid-105887)
09:00:00|André Melancia|Application  Database Development|[Hacking SQL Server Is Not Enough](#sessionid-107482)
09:00:00|Itshak David|Application  Database Development|[SQL Server 2019 on containers and Kubernetes(k8s) from zero to an hero !](#sessionid-107647)
09:00:00|Ana Maria Bisbé York|Analytics and Visualization|[Escenarios de modelado en DAX, el súper lenguaje de Power BI.](#sessionid-107781)
10:15:00|David Patrick|Application  Database Development|[3 Ways for Getting Data from SharePoint : SSIS, Excel and Access](#sessionid-105526)
10:15:00|Jose Manuel Jurado Diaz|Cloud Application Development  Deployment|[How to get the most from Azure SQL Database](#sessionid-106019)
10:15:00|Orlando Mezquita|Analytics and Visualization|[Query folding in Power BI: maximizing the performance of database connections](#sessionid-107458)
10:15:00|Sam Nasr|Application  Database Development|[14 T-SQL Functions You May Not Know](#sessionid-107863)
11:30:00|Alex Rostan|Cloud Application Development  Deployment|[Get data easily and fast with Cognitives Services](#sessionid-105986)
11:30:00|Tracy Boggiano|Enterprise Database Administration  Deployment|[SQL Server Configuration with dbatools and dbachecks](#sessionid-107456)
11:30:00|Mohammad Darab|Enterprise Database Administration  Deployment|[Big Data Clusters for the Absolute Beginner](#sessionid-107607)
11:30:00|Kenneth Urena|Application  Database Development|[SQL Server 2019: Estrategias de Indexación para alto desempeño](#sessionid-108522)
13:30:00|Javier Villegas|Enterprise Database Administration  Deployment|[Monitoring SQL Server using Community solutions (Free)](#sessionid-105750)
13:30:00|Eduardo Castro|Analytics and Visualization|[Forecasting con SQL Server R Services y PowerBI](#sessionid-107247)
13:30:00|Deepthi Goguri|Enterprise Database Administration  Deployment|[SQL Engine: Its Working Style](#sessionid-107620)
13:30:00|Martha Chávez|BI Platform Architecture, Development  Administration|[Databricks for data engineers](#sessionid-107846)
14:45:00|Ahias Portillo|BI Platform Architecture, Development  Administration|[Delivering a Data Warehouse in the Cloud](#sessionid-107293)
14:45:00|Andrea Mascher|Professional Development|[SELECT Questions FROM Diversity.Inclusion WHERE AfraidToAsk = 1](#sessionid-107356)
14:45:00|MAYRA BADILLO VILLAMIZAR|BI Platform Architecture, Development  Administration|[Power BI and Common Data Service](#sessionid-107376)
14:45:00|Vladimir Guzman|Application  Database Development|[SQL DevOps](#sessionid-107669)
16:00:00|Ondrej Aubrecht|Enterprise Database Administration  Deployment|[Can really Naming Convention and standards save your environment ?](#sessionid-105759)
16:00:00|Ricardo Estrada|BI Platform Architecture, Development  Administration|[¡Cross Selling con SQL Grafos!](#sessionid-107416)
16:00:00|Edwin Martinez|BI Platform Architecture, Development  Administration|[PowerBI Embedded First Steps](#sessionid-107595)
16:00:00|Jose L. Rivera|BI Information Delivery|[Power BI Composite Models](#sessionid-108521)
#  
#### SessionID: 105887
