...
---|---|---|---
00:00:00|Gene Webb|DBA|[Introduction to Master Data Management (MDM) with SQL Server Master Data Services (MDS) for Beginner](#sessionid:-14447)
00:00:00|Michael Fal|DBA|[Getting Started with Database Automation](#sessionid:-34780)
00:00:00|Michael Fal|DBA|[Powershell and the Art of SQL Server Deployment](#sessionid:-34781)
08:15:00|Dave Mattingly|Reporting  Visualization|[Database: The Motion Picture](#sessionid:-12253)
08:15:00|Dave Fackler|DBA|[Clustered Columnstore Indexes in SQL Server 2014](#sessionid:-12349)
08:15:00|Dan Holmes|DBA|[Emulating a SELECT Trigger if Such a Thing Existed](#sessionid:-13351)
08:15:00|Louis Davidson|DEV|[Database Design Fundamentals](#sessionid:-13494)
08:15:00|Jeff Reinhard|DBA|[Sliding Window Table Partition Intro](#sessionid:-16288)
08:15:00|Jim Christopher|PowerShell|[Closing the SSIS Package Management Story with BIPS](#sessionid:-16840)
08:15:00|Rick Lowe|DEV|[Why should I care about the plan cache?](#sessionid:-22985)
08:15:00|Scott Currie|BIML|[SSIS Unit and Integration Testing with the Open Source BEST project](#sessionid:-24056)
08:15:00|Kevin Boles|DBA|[SQL Server Defaults SUCK!!](#sessionid:-26430)
08:15:00|Teo Lachev|BI|[Increase Your BI Developer Productivity with Community Samples](#sessionid:-26941)
09:30:00|Jason Brimhall|DBA|[Using Extended Events in SQL Server](#sessionid:-10859)
09:30:00|Daniel Glenn|DBA|[Tuning SQL Server for SharePoint](#sessionid:-12179)
09:30:00|Javier Guillen|BI|[Are users working against you? Manage human factors to achieve BI success](#sessionid:-16028)
09:30:00|Jeffrey Garbus|DEV|[Indexing for Join Optimization](#sessionid:-16336)
09:30:00|Paco Gonzalez|Big Data  Data Science|[Sentiment Analysis with Big Data](#sessionid:-21622)
09:30:00|Reeves Smith|BIML|[Increase your SSIS productivity with Biml](#sessionid:-22807)
09:30:00|Lindsay Clark|DBA|[Beginners SQL Server Security the Low Hanging Fruit](#sessionid:-24447)
09:30:00|Sven Aelterman|DEV|[Gentle Introduction to T-SQL Window Functions](#sessionid:-25922)
09:30:00|Justin Dearing|DBA|[Version control with GIT for the DBA](#sessionid:-28345)
09:30:00|Amir Charania|ETL/SSIS|[SSIS 2014: Project Deployment  Configuration using SSIS Catalog](#sessionid:-9397)
10:45:00|Mike Robbins|PowerShell|[PS C:\gt; Get-Started -With 'PowerShell Desired State Configuration'](#sessionid:-20709)
10:45:00|William Wolf|DEV|[Common Coding Mistakes and how to Mitigate them](#sessionid:-22095)
10:45:00|Phil Pledger|DEV|[Choosing the right clustering key](#sessionid:-22259)
10:45:00|Robert Biddle|ETL/SSIS|[Loading a Data Warehouse with SSIS](#sessionid:-23154)
10:45:00|Robert Verell|Availability  Replication|[Getting Started With SQL Server Replication](#sessionid:-23255)
10:45:00|Bill Anton|BI|[20-Minute Tabular Model](#sessionid:-28181)
10:45:00|Kevin Hazzard|BIML|[The Absolute Beginner's Guide to BIML](#sessionid:-28254)
10:45:00|Mark Tabladillo|Big Data  Data Science|[Microsoft Technologies for Data Science](#sessionid:-34748)
10:45:00|Michael Fal|DBA|[Powershell Tips and Tricks for SQL Server Administration](#sessionid:-34779)
10:45:00|Rob Volk|Ask Doc  Einstein!|[Ask Doc Brown and Einstein!](#sessionid:-37062)
10:45:00|Amy Herold|DBA|[Deadlock, Block  Two Smoking Barrels: Breaking Down Blocking and Deadlocks](#sessionid:-9410)
10:45:00|Robert Cain|DEV|[Database Development Using SQL Server Data Tools](#sessionid:-9740)
11:45:00|Carl Berglund|Availability  Replication|[Standalone to High-Availability Clusters over Lunch—with Time to Spare](#sessionid:-11171)
11:45:00|Gene Webb|BI|[Learn How To Build A Golden Record for Any Subject Over Lunch!](#sessionid:-14448)
11:45:00|Rie Irish|Professional Development|[Girl, Interrupted: Supporting Women's Voices - Sponsored by Intellinet](#sessionid:-36841)
11:45:00|Gary Serda|Sponsor/Lunch|[Cisco: Optimize Your SQL Server 2014 Workloads with Cisco UCS](#sessionid:-37004)
11:45:00|SIOS Technology|Availability  Replication|[Clusters Your Way: #SANLess clusters for physical, virtual  cloud environments](#sessionid:-37006)
11:45:00|Brett Johnson|Sponsor/Lunch|[SQL Server and Microsoft Business Solutions - Tegile](#sessionid:-37011)
11:45:00|Rob Volk|Ask Doc  Einstein!|[1.21 Gigawatt Talks!](#sessionid:-37063)
11:45:00|Denny Cherry|Sponsor/Lunch|[SQL Server Clinic](#sessionid:-37164)
11:45:00|Mark Scott|Sponsor/Lunch|[Learn about Governed Data Discovery with Pyramid Analytics](#sessionid:-37235)
13:15:00|Carla Sessions|BIML|[How I Became a BIML Believer](#sessionid:-11174)
13:15:00|Carlos Rodrigues|ETL/SSIS|[Making your SSIS Fly Beyond the Sky](#sessionid:-11222)
13:15:00|Denis McDowell|Sponsor/Lunch|[DevOps for the DBA - Bridging the Gap Between Infrastructure, Administration, and Development](#sessionid:-13080)
13:15:00|Jason Thomas|BI|[Memoirs of Building a 150 GB (and growing) SSAS Tabular Model](#sessionid:-15911)
13:15:00|Jon Boulineau|DEV|[Continuous Integration with SQL Server Data Tools](#sessionid:-17324)
13:15:00|miguel Cebollero|DEV|[SQL Server 2014 In-Memory Programming](#sessionid:-20426)
13:15:00|Denny Cherry|DEV|[Index Internals](#sessionid:-21072)
13:15:00|Pam Shaw|Reporting  Visualization|[Tips  Tricks for dynamic SSRS Reports](#sessionid:-22370)
13:15:00|Lance Tidwell|DEV|[Parameter Sniffing the Good and the Bad](#sessionid:-24436)
13:15:00|Damu Venkatesan|ETL/SSIS|[Self-Service ETL with Microsoft Power Query](#sessionid:-27354)
13:15:00|Aaron Nelson|PowerShell|[Awesome PowerShell for SQL 2014](#sessionid:-36842)
13:15:00|Michael French|Professional Development|[Independent Contracting 101](#sessionid:-37174)
13:15:00|Allan Hirt|Availability  Replication|[Business Continuity: The Real Reason for HA and DR](#sessionid:-9276)
14:30:00|Ben Miller|DBA|[SQL Server Encryption](#sessionid:-10303)
14:30:00|Brian Moran|Professional Development|[9 secrets to independent consulting success](#sessionid:-10768)
14:30:00|Ed Watson|DBA|[Performance Tuning for Mere Mortals Part I](#sessionid:-13702)
14:30:00|Jason Horner|BI|[Dimensional Modeling Design Patterns: Beyond Basics](#sessionid:-15877)
14:30:00|Joseph D'Antoni|DBA|[Becoming a Top DBA--Learning Automation in SQL Server](#sessionid:-16223)
14:30:00|Mark Fugel|DEV|[Unit Testing with tSQLt an Open Source Testing Framework for SQL](#sessionid:-20077)
14:30:00|Rafael Salas|ETL/SSIS|[Design principles for robust ETL processes](#sessionid:-22967)
14:30:00|Wes Springob|Reporting  Visualization|[Querying Active Directory From SSRS To Secure Reports And Enhance The User Experience](#sessionid:-24824)
14:30:00|Chad Churchwell|Availability  Replication|[Introduction to SQL Server Clustering](#sessionid:-24927)
14:30:00|Steve Wake|ETL/SSIS|[Near Real-Time Data Warehouse Updates with CDC  SSIS](#sessionid:-25722)
14:30:00|Stuart Ainsworth|Big Data  Data Science|[Eating The Elephant; A DBA's Guide to Hadoop  Big Data](#sessionid:-25858)
14:30:00|Tim Radney|Professional Development|[Getting involved and Getting ahead](#sessionid:-26726)
14:30:00|Wayne Sheffield|DEV|[Table Vars  Temp Tables - What you NEED to Know!](#sessionid:-27771)
14:30:00|Andy Leonard|BIML|[Using BIML as an SSIS Design Patterns Engine ](#sessionid:-9554)
15:45:00|Julie Smith|BI|[Master Data Management with MDS, DQS and SSIS](#sessionid:-11132)
15:45:00|David Dye|ETL/SSIS|[Advanced SSIS Techniques](#sessionid:-13190)
15:45:00|Jim Wooley|DEV|[Entity Framework performance monitoring and tuning](#sessionid:-16864)
15:45:00|James McAuliffe|DEV|[Changing Data Is Easy, Managing Data Change is Hard!](#sessionid:-16998)
15:45:00|John Welch|BI|[Continuous Delivery for Data Warehouses and Marts](#sessionid:-17210)
15:45:00|John Deardurff|DEV|[What's your Character Type?](#sessionid:-17214)
15:45:00|John Morehouse|DBA|[Only You Can Prevent Database Fires!](#sessionid:-17268)
15:45:00|Kevin Kline|DBA|[SQL Server Internals and Architecture](#sessionid:-18246)
15:45:00|Luis Figueroa|Reporting  Visualization|[R intro for the SQL Server Pro](#sessionid:-19005)
15:45:00|Mike Lawell|DBA|[Performance Tuning for Mere Mortals Part II](#sessionid:-20606)
15:45:00|Melissa Coates|BI|[Power BI as a Self-Service BI Platform: Architecture, Strengths, and Shortcomings](#sessionid:-24941)
15:45:00|Tim Radney|DBA|[Understanding SQL Backups and Restores](#sessionid:-26727)
#  
#### SessionID: 14447
