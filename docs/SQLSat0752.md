...
---|---|---|---
08:45:00|Jared Zagelbaum|Analytics and Visualization|[Intro to Machine Learning](#sessionid-74074)
08:45:00|Sean Forgatch|BI Platform Architecture, Development  Administration|[Processing Big Data with Azure Data Lake Analytics](#sessionid-74667)
08:45:00|Arthur Daniels III|Enterprise Database Administration  Deployment|[Plan Cache performance tuning](#sessionid-77842)
08:45:00|Dave Bland|Enterprise Database Administration  Deployment|[Extended Events: What are they and How do I use them](#sessionid-80723)
08:45:00|Rick Lowe|Application  Database Development|[Why Should I Care About ... Partitioned Views?](#sessionid-82424)
10:10:00|Rick Bielawski|Application  Database Development|[Mastering queries into XML data.](#sessionid-74079)
10:10:00|Eric Fait|Analytics and Visualization|[Power BI Bookmarks: Four Business Use Cases](#sessionid-74240)
10:10:00|David Klee|Enterprise Database Administration  Deployment|[Zen and the Art of Perfmon 2018](#sessionid-77381)
10:10:00|Andy Galbraith|Enterprise Database Administration  Deployment|[Intro to Powershell for the SQL Server DBA](#sessionid-78332)
10:10:00|Brian Hansen|Application  Database Development|[The Amazing Utility of ROW_NUMBER()](#sessionid-82039)
12:50:00|Rick Bielawski|Strategy and Architecture|[Implementing security inside SQL Server](#sessionid-74078)
12:50:00|Turner Kunkel|Cloud Application Development  Deployment|[Azure Analysis Services: Purpose, Migration, Benefits, and Tools](#sessionid-74137)
12:50:00|David Klee|Enterprise Database Administration  Deployment|[Ping! (no reply)](#sessionid-77382)
12:50:00|Dan Mallott|Application  Database Development|[The Fruit Goes Enterprise: Full Stack .NET Development Using Only Mac-Native Tools](#sessionid-77946)
12:50:00|Joe Obbish|Application  Database Development|[Decoding the Cardinality Estimator to Speed Up Queries](#sessionid-78899)
14:15:00|Dave Bland|Enterprise Database Administration  Deployment|[Statistics - Why are they there and what do I do with them](#sessionid-74258)
14:15:00|Sourav Mukherjee|Application  Database Development|[Upgrade to SQL Server 2017: Unleashing the Power of SQL Server 2017](#sessionid-77041)
14:15:00|Frank Henninger|Enterprise Database Administration  Deployment|[Introducing dbachecks : Unit testing for your database infrastructure](#sessionid-78583)
14:15:00|Joshuha Owen|Cloud Application Development  Deployment|[Let's build a data app with Azure Functions!](#sessionid-82025)
14:15:00|Ed Leighton-Dick|Enterprise Database Administration  Deployment|[Availability Group Troubleshooting Beyond the Basics](#sessionid-82211)
15:40:00|Jared Zagelbaum|Cloud Application Development  Deployment|[Custom Activities in Azure Data Factory](#sessionid-74073)
15:40:00|Kevin Trojanowski|Application  Database Development|[SQL Unit Testing with T-SQLt](#sessionid-74705)
15:40:00|Joe Obbish|Application  Database Development|[Four Rules For Columnstore Query Performance](#sessionid-78900)
15:40:00|Pat Phelan|Strategy and Architecture|[In memory database... Let's rethink that request!](#sessionid-82185)
15:40:00|Jake Manske|Application  Database Development|[Locking and its effects on queries and maintenance tasks](#sessionid-82193)
#  
#### SessionID: 74074
