...
---|---|---|---
09:00:00|Adam Belebczuk|Application  Database Development|[XML Without Xanax: How to Handle XML in SQL Server](#sessionid:-42470)
09:00:00|Jared Karney|Enterprise Database Administration  Deployment|[I Installed SQL Server... Now What?](#sessionid:-42527)
09:00:00|Jes Schultz|Enterprise Database Administration  Deployment|[Everyday Extended Events](#sessionid:-44690)
09:00:00|Pat Phelan|Application  Database Development|[Data Architecture 101](#sessionid:-44800)
09:00:00|Gill Rowley|BI Platform Architecture, Development  Administration|[Introduction to Data Warehousing](#sessionid:-45358)
09:00:00|Phillip Labry|BI Platform Architecture, Development  Administration|[Why do I need Analysis Services?](#sessionid:-45540)
09:00:00|Grant Fritchey|Application  Database Development|[The Query Store and Query Tuning in SQL Server vNext](#sessionid:-45650)
09:00:00|Jason Brimhall|Enterprise Database Administration  Deployment|[Working with Object Compression in SQL Server](#sessionid:-46461)
09:00:00|Rob Long|BI Information Delivery|[Getting More from Analysis Services – Writing Data Back](#sessionid:-46465)
10:30:00|Gary Schultz|Professional Development|[SSMS Tips and Tricks](#sessionid:-43061)
10:30:00|Paul Popovich Jr|Enterprise Database Administration  Deployment|[Clusters! From the ground up, let's build one together](#sessionid:-44130)
10:30:00|Paul Timmerman|Enterprise Database Administration  Deployment|[SQL Server Hybrid Cloud Strategy: Best Of Both Worlds With On-Prem + Cloud](#sessionid:-44932)
10:30:00|Ben Miller|Application  Database Development|[Be Friendly to SQL Server with TSQL Best Practices](#sessionid:-45029)
10:30:00|Michael Fal|Enterprise Database Administration  Deployment|[Exploring SQLPS, the SQL Server Powershell Module](#sessionid:-45443)
10:30:00|Andy Yun|Application  Database Development|[Every Byte Counts: Why Your Data Type Choices Matter](#sessionid:-45790)
10:30:00|Jason Strate|BI Platform Architecture, Development  Administration|[Azure SQL Data Warehouse Overview](#sessionid:-46494)
10:30:00|Michael Steineke|Enterprise Database Administration  Deployment|[All things you need to know before you start setting up SQL AlwaysOn](#sessionid:-46498)
10:30:00|Omni Resources Speaker Panel|Application  Database Development|[How Developers Can Use SQL 2016](#sessionid:-49187)
13:00:00|Ross LoForte|Enterprise Database Administration  Deployment|[What's new in SQL Server 2016](#sessionid:-42391)
13:00:00|Thomas Lane|Enterprise Database Administration  Deployment|["I Love Replication"...Something Rarely if Ever Said By DBAs But Should Be](#sessionid:-42993)
13:00:00|Bob Pusateri|Enterprise Database Administration  Deployment|[Introduction to SQL Server Encryption](#sessionid:-44863)
13:00:00|George Bryant|Analytics and Visualization|[Power Query: Making developers redundant since 2015](#sessionid:-45130)
13:00:00|David Klee|Enterprise Database Administration  Deployment|[Infrastructure Tuning for SQL Server Performance](#sessionid:-45201)
13:00:00|Andy Yun|Enterprise Database Administration  Deployment|[Uncovering Duplicate, Redundant,  Missing Indexes](#sessionid:-45789)
13:00:00|Reed Powell|Professional Development|[Surviving a Technical SQL Interview](#sessionid:-45916)
13:00:00|Brian Larson|BI Information Delivery|[Effective Reporting through SSRS Advanced Authoring Features ](#sessionid:-46063)
13:00:00|Seth Bauer|BI Information Delivery|[Power BI - A new way to Explore SQL Server Database and Performance Metrics](#sessionid:-46124)
14:30:00|David Maxwell|Enterprise Database Administration  Deployment|[The Usual SUSPECTs: When Good Databases Go Bad](#sessionid:-42942)
14:30:00|Kevin Feasel|BI Platform Architecture, Development  Administration|[Data Migration Using BIML](#sessionid:-44185)
14:30:00|Ross Parks|BI Information Delivery|[PowerBI  Other Self Service BI tools: Where They Fit in the Enterprise.](#sessionid:-44388)
14:30:00|Luke Jian|Enterprise Database Administration  Deployment|[Anatomy of an Optimizer](#sessionid:-44923)
14:30:00|Michael Fal|Enterprise Database Administration  Deployment|[Managing Availability Groups (What happens after the build!)](#sessionid:-45444)
14:30:00|Grant Fritchey|Application  Database Development|[Automating Your Database Deployments](#sessionid:-45648)
14:30:00|Jared Zagelbaum|Application  Database Development|[SQL Server 2016 - New Security Features](#sessionid:-45654)
14:30:00|Elizabeth Block|Enterprise Database Administration  Deployment|[DBA Cheat Sheet](#sessionid:-46463)
14:30:00|Julie Koesmarno|BI Platform Architecture, Development  Administration|[Azure SQL Database Monitoring and Performance Tuning 101](#sessionid:-46680)
16:00:00|Dave DuVarney|BI Platform Architecture, Development  Administration|[Architecting Cloud Based BI Solutions using Microsoft Azure](#sessionid:-44331)
16:00:00|Jes Schultz|Enterprise Database Administration  Deployment|[Minimize Data Loss with Advanced Restore Methods ](#sessionid:-44691)
16:00:00|John Pertell|Analytics and Visualization|["R" You Ready For SQL 2016?](#sessionid:-44795)
16:00:00|Colleen Morrow|Enterprise Database Administration  Deployment|[Enterprise Auditing with SQL Server Audit](#sessionid:-45196)
16:00:00|David Klee|Enterprise Database Administration  Deployment|[Objective SQL Server Performance](#sessionid:-45203)
16:00:00|Ed Leighton-Dick|Application  Database Development|[Understanding SQL Server 2016 Always Encrypted](#sessionid:-45481)
16:00:00|Bill Preachuk|Information Delivery|[Hadoop for the SQL Server Developer/DBA](#sessionid:-46388)
16:00:00|Jim Dorame|Application  Database Development|[JSON for the DBA](#sessionid:-46407)
16:00:00|Doug Lane|Application  Database Development|[Living and Dying by Dynamic SQL](#sessionid:-46505)
#  
#### SessionID: 42470
