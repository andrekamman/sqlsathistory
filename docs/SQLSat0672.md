...
---|---|---|---
09:15:00|Eladio Rincon|DBA|[Operación de SQL Server 24x7 - 365d: Trucos y consejos para llevarlo bien](#sessionid-67692)
09:15:00|Alberto López Grande|DBA|[DBA Moderno: Perversiones para desordenar el caos](#sessionid-68646)
09:15:00|Kenneth Nielsen|Big Data  Analytics|[Data Lake Analytics - R, Python and Cognitive Services](#sessionid-68731)
09:15:00|Jose Luis Cano|Business Intelligence|[Together is better: Azure SQL Datawarehouse  Azure Analysis Services](#sessionid-68744)
10:15:00|Regis Baccaro|Business Intelligence|[Azure Data Factory vs SSIS, the Ins and Outs.](#sessionid-65520)
10:15:00|Pablo Doval|Big Data  Analytics|[Introduction to Deep Learning](#sessionid-67166)
10:15:00|Pieter Vanhove|DBA|[Run Your DBA Morning Checklist with Policy-Based Management](#sessionid-68651)
10:15:00|Carlos Sacristán|Big Data  Analytics|[Hay un nuevo forastero en la ciudad y se hace llamar SQL Graph](#sessionid-68676)
12:00:00|Niko Neugebauer|Business Intelligence|[Worst Practices  Less known limitations for Columnstore Indexes](#sessionid-65429)
12:00:00|Robert Bermejo Blasco|Big Data  Analytics|[Porque no todo tiene que ser SQL: CosmosDB](#sessionid-66436)
12:00:00|Enrique Bañuls|Big Data  Analytics|[Aplicando R al análisis de rendimiento de un servidor](#sessionid-66707)
12:00:00|Adrian Diaz Cervera|DBA|[Dockeriza tu SQL Server](#sessionid-68745)
13:00:00|LEONEL ABREU|DBA|[A time travel with temporal tables](#sessionid-66589)
13:00:00|Miguel Egea|Business Intelligence|[Agile BI: Como tener linaje de datos y no morir en el intento](#sessionid-67287)
13:00:00|Mark Broadbent|DBA|[Lockless in Seattle: Using In-Memory OLTP Transaction Processing](#sessionid-67551)
13:00:00|Ana Maria Bisbé York|Business Intelligence|[Escenarios de modelado en DAX, el súper lenguaje de Power BI.](#sessionid-68531)
15:00:00|Francisco Racionero|DBA|[SQL Security](#sessionid-66244)
15:00:00|Cédric Charlier|Business Intelligence|[Let’s have some fun(ctional) with M (Power Query/Power BI) language!](#sessionid-66870)
15:00:00|Jose Manuel Jurado Diaz|DBA|[Back to the future - Migrando nuestro SQL Server OnPremise a Azure](#sessionid-66972)
15:00:00|Ruben Pertusa Lopez|Business Intelligence|[Haciendo BI en 2017: los 3 puntos clave](#sessionid-68747)
16:30:00|Rodrigo Cabello|Big Data  Analytics|[Machine Learning for developers](#sessionid-67167)
16:30:00|Andre Batista|DBA|[Challenges in HA\DR scenarios in SQL Server 2017 vNext on Linux](#sessionid-68371)
16:30:00|Salvador Ramos|Business Intelligence|[¿Aún puedes vivir sin Power BI?](#sessionid-68701)
16:30:00|Pau Sempere|Big Data  Analytics|[El tiempo es oro - Series temporales con R Server](#sessionid-68728)
#  
#### SessionID: 67692
