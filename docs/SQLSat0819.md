...
---|---|---|---
10:00:00|Fernando Garcia|BI Information Delivery|[Power BI + Azure + Forms + Flow + Sharepoint - Dados em tempo real analisando sentimentos da platéia](#sessionid-87946)
10:00:00|Luiz Henrique Garetti|Enterprise Database Administration  Deployment|[SQL Server 2019 Big Data Clusters](#sessionid-87990)
10:00:00|Fabiano Amorim|Application  Database Development|[Tuning no SQL Server 2019 - Quais as novidades?](#sessionid-89003)
10:00:00|Nilton Kazuyuki Ueda|Analytics and Visualization|[Visualização de Dados na Era do Big Data](#sessionid-91548)
10:00:00|Reginaldo Silva|Application  Database Development|[Otimizando seu ambiente com SQL Server 2017/2019](#sessionid-92074)
11:00:00|Sulamita Dantas|Cloud Application Development  Deployment|[Porque migrar seu SQL Server On Premisse  para o SQL Azure!](#sessionid-88690)
11:00:00|RUY LACERDA|Analytics and Visualization|[O nome dela é CALCULATE. A função mais importante do Power BI!](#sessionid-89504)
11:00:00|Marcelo Adade|Enterprise Database Administration  Deployment|[SQL SERVER on Docker and Linux (Why and How)](#sessionid-90033)
11:00:00|Luan Moreno Medeiros Maciel|BI Platform Architecture, Development  Administration|[Era do Streaming: Implementando Soluções e Reagindo a Eventos](#sessionid-91536)
11:00:00|Jucinei Santos|Professional Development|[Canadá tem vagas para Brasileiros?](#sessionid-92075)
13:00:00|Rafael Mendonça|BI Information Delivery|[Streaming de dados no Power BI utilizando PowerShell](#sessionid-86839)
13:00:00|Suellen Moraes|Enterprise Database Administration  Deployment|[Internals Always On](#sessionid-87592)
13:00:00|Renan Queiroz|Strategy and Architecture|[DevOps for Azure Databases](#sessionid-89512)
14:00:00|Arthur Luz|BI Platform Architecture, Development  Administration|[Big Data e Arquitetura Lambda](#sessionid-88197)
14:00:00|Tiago Neves|Enterprise Database Administration  Deployment|[Iniciando um trabalho de tuning.](#sessionid-88715)
14:00:00|Rayssa Dias|Analytics and Visualization|[Nem tudo que reluz é ouro! O design e a visualização de dados!](#sessionid-90047)
15:30:00|Wiluey Sousa|Cloud Application Development  Deployment|[Criando e gerenciando réplicas geo-localizadas no SQL Azure](#sessionid-87532)
15:30:00|Aislan Honorato|BI Platform Architecture, Development  Administration|[SSIS, SSAS e PowerBI: Indicadores Elicitados com MindMap e Canvas](#sessionid-90035)
15:30:00|Caio Amante|Enterprise Database Administration  Deployment|[Aumentando o Nível de Segurança com o SQL Server](#sessionid-90050)
16:30:00|Leandro Domingues|Strategy and Architecture|[Modelando em Document Model - Além do NoJoin!](#sessionid-87493)
16:30:00|Kevin Boles|Application  Database Development|[Common TSQL Mistakes](#sessionid-87969)
16:30:00|Vitor Fava|Analytics and Visualization|[Implementando soluções de IA utilizando os serviços cognitvos no](#sessionid-90034)
#  
#### SessionID: 87946
