...
---|---|---|---
09:00:00|Ed Watson|BI Platform Architecture, Development  Administration     RM 101|[A Beginner's Guide to Power BI](#sessionid-80349)
09:00:00|Elizabeth Noble|Application  Database Development|[Source control, now. Peace through database lifecycle management.](#sessionid-80873)
09:00:00|Senthil Raghavan|Enterprise Database Administration  Deployment  RM 201|[Supporting a very large environment](#sessionid-84059)
09:00:00|Chris Hyde|BI Platform Architecture, Development  Administration     RM 101|[SQL Server R Services in SQL 2016 and 2017](#sessionid-85108)
10:15:00|Thomas Norman|Enterprise Database Administration  Deployment  RM 201|[Database Project Makes Deployment Consistent](#sessionid-82238)
10:15:00|Jon Boulineau|BI Platform Architecture, Development  Administration     RM 101|[Introducing Hadoop to SQL Server Pros](#sessionid-82401)
10:15:00|Aaron Nelson|BI Platform Architecture, Development  Administration     RM 101|[PowerShell for BI Pros: Automating SSIS, SSRS, SSAS, and Power BI](#sessionid-82961)
10:15:00|Amy Herold|Enterprise Database Administration  Deployment  RM 201|[PowerShell for the DBA](#sessionid-85635)
11:30:00|Samir Behara|Application  Database Development|[DevOps, Continuous Integration  Automated Testing: Rule them all](#sessionid-80362)
11:30:00|Kathi Kellenberger|Application  Database Development|[Introduction to T-SQL Windowing Functions](#sessionid-80767)
11:30:00|Paul LaGrone|BI Platform Architecture, Development  Administration     RM 101|[2017 SSIS Scale Out:  How and Why](#sessionid-82459)
11:30:00|Steven Cush|Enterprise Database Administration  Deployment  RM 201|[A Beginner’s Guide to the Query Store](#sessionid-83670)
12:30:00|Tim Radney|Other RM 202|[LUNCH](#sessionid-85637)
13:30:00|Eric Flamm|Enterprise Database Administration  Deployment  RM 201|[Intro to SQL Operations Studio](#sessionid-80353)
13:30:00|Jeff Reinhard|Application  Database Development|[Agile Database Development and Zero Downtime Deployments](#sessionid-80758)
13:30:00|Kathi Kellenberger|BI Platform Architecture, Development  Administration     RM 101|[Azure Machine Learning 101](#sessionid-80766)
14:45:00|Steven Cush|Enterprise Database Administration  Deployment  RM 201|[Lessons learned for optimum performance and up-time](#sessionid-83731)
14:45:00|Chris Hyde|BI Platform Architecture, Development  Administration     RM 101|[Detecting and Capturing Change for Data Warehousing](#sessionid-85104)
14:45:00|Mike Lawell|Cloud Application Development  Deployment    RM 102|[Cosmos DB: Planet Earth Scale](#sessionid-85654)
#  
#### SessionID: 80349
