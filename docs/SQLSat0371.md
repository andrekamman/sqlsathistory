...
---|---|---|---
00:00:00|Allen White|Azure / Prof Dev|[Manage Both On-Prem and Azure Databases with PowerShell](#sessionid-10051)
00:00:00|Allen White|BI 2|[Maintain SQL Server Performance Baseline w/PowerShell](#sessionid-10052)
00:00:00|Julie Smith|SSIS|[Friendlier Data Profiling with the SSIS Data Profiler Task](#sessionid-11125)
00:00:00|Christopher Price|BI 1|[Introduction to Azure Machine Learning Experiments](#sessionid-11897)
00:00:00|Christopher Price|Misc|[Master Data Service in Practice: An Integrated Approach](#sessionid-11898)
00:00:00|Denis McDowell|Misc|[DevOps for the DBA - Bridging the Gap Between Infrastructure, Administration, and Development](#sessionid-13074)
00:00:00|Dan King|SSIS|[SSIS performance Tuning](#sessionid-13258)
00:00:00|Dmitri Korotkevitch|DBA 1|[Size does matter: 10 ways to reduce the database size and improve performance](#sessionid-13292)
00:00:00|Jorge Novo|SSIS|[Advance SSIS development using .NET framework --Real work Situations--](#sessionid-13989)
00:00:00|Jorge Novo|SSIS|[Reusable ssis development using Parent - Child methodology ](#sessionid-13990)
00:00:00|Eric Wisdahl|DBA 2|[SQL 2014 In Memory OLTP and Natively Compiled Stored Procedures](#sessionid-14032)
00:00:00|Kevin Feasel|DBA 1|[APPLY Yourself](#sessionid-14200)
00:00:00|Frank Quintana|BI 1|[“A New Data Architecture: Business Intelligence (BI) and Big Data Management Systems (BDMS)”](#sessionid-14317)
00:00:00|Gene Webb|BI 2|[Business Rules, Data Governance, and Workflow with MDS and Maestro ](#sessionid-14434)
00:00:00|Janis Griffin|DBA 1|[Introduction to Wait Types and Response Time Analysis](#sessionid-15739)
00:00:00|Janis Griffin|DBA 1|[Query Tuning - Get it Right the First Time ](#sessionid-15740)
00:00:00|Jeff Reinhard|DBA 2|[Sliding Window Table Partition Intro](#sessionid-16285)
00:00:00|Jeffrey Garbus|Misc|[How to be a GREAT DBA](#sessionid-16345)
00:00:00|Jeffrey Garbus|DBA 1|[Indexing for performance](#sessionid-16348)
00:00:00|Jen Underwood|BI 1|[Introducing the Reimagined Power BI Platform](#sessionid-16577)
00:00:00|Jessica Moss|Misc|[Analysis Services: Multidimensional vs Tabular](#sessionid-16670)
00:00:00|Joe Healy|Azure / Prof Dev|[Exploring Azure for Storage Options](#sessionid-16789)
00:00:00|Kendal Van Dyke|DBA 2|[Transactional Replication: Architecture, Setup, and Monitoring](#sessionid-18085)
00:00:00|Kendal Van Dyke|BI 2|[Transactional Replication: Tuning and Troubleshooting](#sessionid-18086)
00:00:00|Konstantin Melamud|DBA 1|[Performance Tuning - Index Optimization](#sessionid-18571)
00:00:00|Maximo Trinidad|Azure / Prof Dev|[Powershell Working with Windows Azure SQL Database Server](#sessionid-19924)
00:00:00|Gareth Swanepoel|Azure / Prof Dev|[A practical guide to Windows Azure SQL Database for the DBA](#sessionid-20036)
00:00:00|Gareth Swanepoel|SSIS|[SQL Server 2014 for the DBA ](#sessionid-20037)
00:00:00|miguel Cebollero|SSIS|[SQL Server 2014 In-Memory Programming](#sessionid-20420)
00:00:00|Michael Antonovich|BI 2|[Introducing Cube World To Users From Flat Table Land](#sessionid-20494)
00:00:00|Paco Gonzalez|BI 1|[Sentiment Analysis with Big Data](#sessionid-21617)
00:00:00|Peter Evans|BI 1|[Extend the Reach of Power BI with Easy Data Integration](#sessionid-22069)
00:00:00|Phillip Labry|BI 2|[Getting Started with Analysis Services Tabular mode](#sessionid-22119)
00:00:00|Robert Biddle|Misc|[.NET for Data Professionals](#sessionid-23152)
00:00:00|Ronald Dameron|DBA 2|[Real World SQL Server Administration with just a bit of sysadmin](#sessionid-23442)
00:00:00|Shawn Meyers|DBA 2|[Virtualize Clusters and AlwaysOn Availability Groups ](#sessionid-24633)
00:00:00|Wes Springob|BI 2|[Querying Active Directory From SSRS To Secure Reports And Enhance The User Experience](#sessionid-24810)
00:00:00|Damu Venkatesan|BI 1|[DAX 101](#sessionid-27350)
00:00:00|Andy Warren|Azure / Prof Dev|[Turbocharge Your Career With a Learning Plan](#sessionid-9585)
00:00:00|Andy Warren|DBA 2|[Common SQL Server Security Mistakes (And The Fixes)](#sessionid-9587)
00:00:00|Arvin Meyer|Misc|[Access as a fron-end ro SQL-Server](#sessionid-9881)
#  
#### SessionID: 10051
# Manage Both On-Prem and Azure Databases with PowerShell
#### [Back to calendar](#nr-371)
