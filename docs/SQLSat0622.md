...
---|---|---|---
08:30:00|Derik Hammer|Database Administration|[Architecting Availability Groups](#sessionid-59502)
08:30:00|Sunil Kadimdiwan|Enterprise BI|[Learn On-premises BI: SSRS 2016 and Power BI](#sessionid-59770)
08:30:00|John Miner|Database Administration|[Public Preview of SQL Server on Linux](#sessionid-60944)
08:30:00|Fabiano Amorim|Optimization/Tuning|[Advanced SQL Server execution plans](#sessionid-62971)
08:30:00|Chris Sommer|Database Administration|[Painting with PowerShell: SQL Server Administration](#sessionid-64755)
08:30:00|Mike Hillwig|Database Administration|[Leaving the Past Behind: Rewriting Your Checklist for SQL 2016](#sessionid-65250)
10:00:00|George Walters|Database Administration|[Organizational Security  Compliance with SQL 2012 through 2016](#sessionid-59553)
10:00:00|Taiob Ali|Database Administration|[Think like the Cardinality Estimator](#sessionid-61662)
10:00:00|Bryan Cafferky|Cloud Application Development  Deployment|[Managing Azure Resources with PowerShell](#sessionid-64300)
10:00:00|Andy Mallon|Database Administration|[PS > .\Install-SqlServer.ps1  "Automating your SQL Server Install"](#sessionid-64385)
10:00:00|Greg Moore|Database Administration|[Whoa! Backup, what happened?](#sessionid-66231)
10:00:00|Lisa Margerum|Professional/Personal Development|[Network your Way to Success!](#sessionid-66352)
12:00:00|David Bermingham|Database Administration|[SANLess clustering for physical, virtual and cloud environments](#sessionid-66779)
12:30:00|Kevin Feasel|Big Data|[Much Ado About Hadoop](#sessionid-59755)
12:30:00|Azhagappan Arunachalam|Enterprise BI|[SQL Server - R Services](#sessionid-63019)
12:30:00|Matt Batalon|Database Development|[Dissecting the Data Flow: Exploring SSIS Transformations, Memory and the Pipeline](#sessionid-65694)
12:30:00|Rachel Blum|Enterprise BI|[Top 10 Features of a Great Business Intelligence Solution](#sessionid-66360)
12:30:00|Deborah Melkin|Database Development|[Back to the Basics: T-SQL 101](#sessionid-66372)
12:30:00|Fabiano Amorim|Database Administration|[Man vs Machine: Adaptive query processing and auto tune on SQL2017](#sessionid-66420)
14:00:00|Paresh Motiwala|Professional/Personal Development|[SQL Server 2016 Migration:A Technical/Project Management Approach](#sessionid-59537)
14:00:00|Justin Dearing|Application Development|[Utilizing Docker to create developer instances for SQL Server.](#sessionid-62500)
14:00:00|Thomas Grohser|Database Administration|[# vs @ - it's not about Social Media it's about temporary tables and data](#sessionid-62809)
14:00:00|Bryan Cafferky|Big Data|[Learn How to do Predictive Modeling with R](#sessionid-62818)
14:00:00|Beth Wolfset|Database Development|[Master Your Data using DQS and MDS](#sessionid-64719)
14:00:00|George Walters|Self-Service BI|[Power BI: Architecture and demo](#sessionid-66228)
15:30:00|Ray Kim|Professional/Personal Development|[Tech Writing for Techies: A Primer](#sessionid-59504)
15:30:00|Steve Simon|Application Development|[Surviving parsing XML with T-SQL](#sessionid-59521)
15:30:00|Stephen Mokszycki|Database Administration|[Outsourcing database administration to your users.](#sessionid-61042)
15:30:00|Sebastian Meine|Database Development|[Introduction to Unit-Testing in SQL Server](#sessionid-66376)
15:30:00|David Bermingham|Cloud Application Development  Deployment|[SQL Server High Availability in Azure IaaS](#sessionid-66425)
15:30:00|Edward Pollack|Lightning Talks|[Lightning Talks](#sessionid-66501)
#  
#### SessionID: 59502
