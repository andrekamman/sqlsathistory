...
---|---|---|---
08:00:00|Paul Popovich Jr|Admin|[Registration](#sessionid-101242)
08:25:00|Paul Popovich Jr|Admin|[Opening](#sessionid-101236)
08:30:00|Matt Slocum|Database Performance|[Hardware Hints For The SQL DBA - Don't Let Your IT Department Hand You A Big Bag Of Hurt](#sessionid-100412)
08:30:00|Leslie Andrews|SQL Development|[The Power of Data: The Complete Beginners Data Warehouse Kit](#sessionid-100435)
08:30:00|Taiob Ali|Cloud|[If you use Azure, you must learn Kusto Query Language?](#sessionid-100485)
08:30:00|John Deardurff|Database Performance|[Inside the Database Engine](#sessionid-99370)
08:30:00|Kevin Feasel|Analytics and Visualization|[Eyes on the Prize:  Simple and Effective Dashboard Visualization Techniques](#sessionid-99468)
08:30:00|Dave Bland|Database Monitoring, Maintenance, and Tools|[How to do a Complete SQL Server Assessment](#sessionid-99498)
08:30:00|Hilary Cotter|Database Architecture and Design|[Replication Technologies](#sessionid-99991)
09:30:00|Paul Popovich Jr|Admin|[Break](#sessionid-101234)
09:45:00|Frank Gill|Database Performance|[Performance Improvements in SQL Server 2019](#sessionid-100426)
09:45:00|Jes Schultz|SQL Development|[Source Control for Databases: Why You Need It and How To Get Started](#sessionid-100536)
09:45:00|Matt Gordon|Analytics and Visualization|[Make Your Company Conversational using Azure Cognitive Services](#sessionid-99362)
09:45:00|Peter Shore|Database Monitoring, Maintenance, and Tools|[Wait Wait Do Tell Me](#sessionid-99518)
09:45:00|Joseph Fleming|Database Performance|[Going Beyond the Basics with Query Store](#sessionid-99601)
09:45:00|Dan de Sousa|Cloud|[Azure Data Factory as easy as 1..2...3](#sessionid-99900)
11:00:00|Allen White|Database Monitoring, Maintenance, and Tools|[Find (So You can Fix) those Troublesome Queries](#sessionid-100199)
11:00:00|Sarah Dutkiewicz|SQL Development|[Using Azure DevOps to Automate Database Deployments](#sessionid-100480)
11:00:00|Angela Henry|Database Architecture and Design|[Data Types Do Matter](#sessionid-99348)
11:00:00|Matthew Groves|Analytics and Visualization|[Introduction to SQL++ for Big Data: Same Language, More Power](#sessionid-99367)
11:00:00|Jim Donahoe|Cloud|[Mario..Take My Data To The Cloud!](#sessionid-99662)
11:00:00|Jeff Iannucci|Database Performance|[It's Not Your Fault, It's the SQL Server Default](#sessionid-99968)
12:00:00|Paul Popovich Jr|Admin|[Lunch](#sessionid-101235)
13:30:00|Anthony Nocentino|Cloud|[Practical Container Scenarios in Azure](#sessionid-100196)
13:30:00|Andy Mallon|SQL Development|[Shortcuts from an Impatient DBA](#sessionid-100423)
13:30:00|Ed Wagner|Database Monitoring, Maintenance, and Tools|[DBA - What's Most Important](#sessionid-100493)
13:30:00|Rayis Imayev|Database Architecture and Design|[Loading your Data Vault with Azure Data Factory Mapping Data Flows](#sessionid-99383)
13:30:00|Joshua Higginbotham|Analytics and Visualization|[Tapping into the Power of Data Flows in Power BI](#sessionid-99713)
13:30:00|David Maxwell|Database Performance|[SQL Server Indexing - Practical Solutions](#sessionid-99735)
15:00:00|Jeff Moden|SQL Development|[Automating "Excel Hell" with T-SQL](#sessionid-100404)
15:00:00|Marsha Pierce|Database Architecture and Design|[How To Talk To Your Storage Admin](#sessionid-100840)
15:00:00|Andy Levy|SQL Development|[Keys to a Healthy Relationship with SQL Server](#sessionid-99331)
15:00:00|Michael J Swart|Database Performance|[What Developers Need to Know About The Transaction Log](#sessionid-99439)
15:00:00|Eugene Meidinger|Analytics and Visualization|[Introduction to M (a.k.a Power Query)](#sessionid-99572)
15:00:00|Sean Forgatch|Cloud|[Data Hub Automation with Databricks Delta](#sessionid-99921)
16:15:00|Slava Murygin|Analytics and Visualization|[Power BI: From Zero to 101](#sessionid-100259)
