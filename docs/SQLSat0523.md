...
---|---|---|---
08:15:00|Jim Dorame|Automation and Monitoring|[How to collect a baseline on all your servers and still get a good night's sleep.](#sessionid-46182)
08:15:00|Mike Hays|Enterprise Database Administration  Deployment|[Taming the Transaction Log](#sessionid-48156)
08:15:00|James Borland|BI Platform Architecture, Development  Administration|[DataZen and MS SQL 2016 Mobile BI now](#sessionid-49545)
08:15:00|Andy Yun|Application  Database Development|[Performance Pitfalls from Code Reuse](#sessionid-49572)
08:15:00|Pat Phelan|Application  Database Development|[Data Architecture 101](#sessionid-52277)
09:40:00|George Bryant|BI Information Delivery|[SQL Server 2016 for BI](#sessionid-48564)
09:40:00|Andy Galbraith|Automation and Monitoring|[Does it Hurt When I Do This? Performing a SQL Server Health Check](#sessionid-49225)
09:40:00|Ed Leighton-Dick|Automation and Monitoring|[Dammit Jim! Dr McCoy’s Field Guide to system_health (and the default trace)](#sessionid-49489)
09:40:00|John Pertell|Analytics and Visualization|["R" You Ready For SQL 2016?](#sessionid-49565)
09:40:00|Andy Yun|Application  Database Development|[Uncovering Duplicate, Redundant, and Missing Indexes](#sessionid-49571)
11:05:00|Ameena Lalani|Enterprise Database Administration  Deployment|[SQL Server 2016: What's new?](#sessionid-49292)
11:05:00|Samantha Fahrmann|Application  Database Development|[SQL Server may let you do it, but it doesn't mean you should.](#sessionid-49665)
11:05:00|Andrea Mascher|Professional Development|[Women in Technology Lunch: Energizing the Next Generation](#sessionid-49679)
11:05:00|Brandon Grieve|Strategy and Architecture|[The Flash-Enhanced Database [Sponsored]](#sessionid-51138)
11:45:00|Klas Wiberg|Strategy and Architecture|[SQL Server Data Protection with EMC Technology [Sponsored]](#sessionid-52242)
12:25:00|George Bryant|BI Platform Architecture, Development  Administration|[So this is Power BI. What now?](#sessionid-47703)
12:25:00|David Klee|Enterprise Database Administration  Deployment|[Virtual SQL Servers. Actual Performance.](#sessionid-48278)
12:25:00|Brian Hansen|Enterprise Database Administration  Deployment|[Get Your Optimizer to Give up All Its Secrets](#sessionid-49602)
12:25:00|Frank Gill|PowerShell|[Using Powershell to Automate Your Restore Strategy](#sessionid-49656)
12:25:00|Wylie Blanchard|Application  Database Development|[Capture Changes with SQL Server's Change Data Capture](#sessionid-51081)
13:50:00|Jared Karney|Enterprise Database Administration  Deployment|[I Installed SQL Server... Now What?](#sessionid-48212)
13:50:00|Paul Timmerman|Cloud Application Development  Deployment|[SQL Server Hybrid Cloud Strategy: Best Of Both Worlds With On-Prem + Cloud](#sessionid-48781)
13:50:00|Ed Leighton-Dick|Application  Database Development|[Understanding SQL Server 2016 Always Encrypted](#sessionid-49490)
13:50:00|Pat Phelan|Automation and Monitoring|[Building a Data Warehouse for the DBA](#sessionid-49680)
13:50:00|Ben Miller|PowerShell|[PoShDBA: Practical PowerShell for the DBA](#sessionid-49991)
15:15:00|Dave Bland|Automation and Monitoring|[Extended Events: What are they and How do I use them](#sessionid-45564)
15:15:00|Mike Hays|Professional Development|[Tackling Technical Blogging](#sessionid-48155)
15:15:00|David Klee|Enterprise Database Administration  Deployment|[Infrastructure Tuning for SQL Server Performance](#sessionid-48280)
15:15:00|Kathi Kellenberger|Enterprise Database Administration  Deployment|[Kerberos Delegation Made Simple](#sessionid-49097)
15:15:00|James Borland|Application  Database Development|[Wibbly-Wobbly, Timey-Wimey Tables](#sessionid-49544)
#  
#### SessionID: 46182
# How to collect a baseline on all your servers and still get a good night's sleep.
#### [Back to calendar](#nr-523)
