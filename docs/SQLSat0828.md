...
---|---|---|---
09:00:00|Keneth Murillo|Analytics and Visualization|[Machine Learning and Microsoft Cognitive Services](#sessionid-86994)
09:00:00|Yanitza Campos|Enterprise Database Administration  Deployment|[SQL Power Shell](#sessionid-87925)
09:00:00|Julio Enrique Urriola Barra|BI Platform Architecture, Development  Administration|[La nueva era Azure Data Factory v2](#sessionid-88310)
09:00:00|Raul Sao|Analytics and Visualization|[Integracion de Power BI con R](#sessionid-88391)
09:00:00|Mynor Bolanos|Strategy and Architecture|[Piérdele el miedo a los Indices](#sessionid-88747)
09:00:00|Luis Angel Dionicio Kuri|Analytics and Visualization|[Azure Data Analytics: El poder de la información](#sessionid-88842)
10:00:00|Jonathan Stewart|BI Platform Architecture, Development  Administration|[Performance Tuning for the BI Professional](#sessionid-86927)
10:00:00|Carlos Lopez|Strategy and Architecture|[Aspectos para Crear un Plan de Recuperacion de Desastres](#sessionid-88781)
10:00:00|Luis Angel Dionicio Kuri|BI Information Delivery|[Azure SQL Datawarehouse: Mis primeros pasos](#sessionid-88843)
10:00:00|Joseph Arriola|Other|[Extracción de datos de RDBMS hacia ambientes de Big Data como Azure Data Lake, Cassandra y Kafka](#sessionid-88846)
10:00:00|Ricardo Estrada|Strategy and Architecture|[BI para una Farmacia de Pueblo](#sessionid-88851)
10:00:00|Carlos A. Ulate Hernandez|Professional Development|[Accidental DBA 101, El inicio!!!](#sessionid-89433)
10:00:00|Carlos Lone|Cloud Application Development  Deployment|[Manteniendo vivo al muerto - Taller de Migración de BD a SQL Database Managed Instances](#sessionid-89592)
11:00:00|Christian Araujo|Enterprise Database Administration  Deployment|[Introduction to Query Store](#sessionid-87087)
11:00:00|Alejandro Cordero|Enterprise Database Administration  Deployment|[SQL Server 2019 new features!](#sessionid-87202)
11:00:00|Carlos A. Ulate Hernandez|Other|[SQL Server Graph Databases](#sessionid-87863)
11:00:00|byron maldonado|Enterprise Database Administration  Deployment|[Gestionando los datos como su activo más valioso](#sessionid-88824)
11:00:00|PABLO JAVIER FERNANDEZ|Enterprise Database Administration  Deployment|[ENCONTRANDO EL ORIGEN DEL PROBLEMA](#sessionid-89424)
11:00:00|Ahias Portillo|Advanced Analysis Techniques|[Ciencia de datos, implementado modelos de clasificación con Python](#sessionid-89451)
12:00:00|Yanitza Campos|Analytics and Visualization|[El ABC de los Reportes](#sessionid-87927)
12:00:00|PABLO JAVIER FERNANDEZ|Enterprise Database Administration  Deployment|[EL ARTE DE DOMINAR SQL SERVER DESDE LA PERSPECTIVA DEL DESARROLLO Y LA ADMINISTRACION](#sessionid-88269)
12:00:00|Vladimir Guzman|Strategy and Architecture|[SQL en la nube o en tierra??...pensemos en SQL infraestructura hibrida](#sessionid-88309)
12:00:00|Carlos Robles|Cloud Application Development  Deployment|[Azure Fundaments for the SQL Server DBA](#sessionid-88335)
12:00:00|Raul Sao|Advanced Analysis Techniques|[Introduccion a Machine Learning](#sessionid-88400)
12:00:00|Marco Tulio Gómez Reyes|Strategy and Architecture|[Necesito implementar Power BI en mi empresa ¿por donde empiezo?](#sessionid-88780)
12:00:00|Jesus Gil|Enterprise Database Administration  Deployment|[Dr Rudo SQL presenta: Mejores practicas de un DBA para aprovechar SQL Server 2019](#sessionid-88848)
14:15:00|Jonathan Stewart|Analytics and Visualization|[Data Visualization: How to truly tell a great story!](#sessionid-86925)
14:15:00|Christian Araujo|Enterprise Database Administration  Deployment|[Introduction to azure cosmos DB](#sessionid-87089)
14:15:00|Carlos Robles|Enterprise Database Administration  Deployment|[SQL Server containers on Docker, Kubernetes and more](#sessionid-88121)
14:15:00|Vladimir Guzman|Analytics and Visualization|[Analisis en tiempo real con Power BI](#sessionid-88308)
14:15:00|Joseph Arriola|BI Platform Architecture, Development  Administration|[Big Data en la Nube - Ecosistema Hadoop con HDInsight](#sessionid-88844)
14:15:00|Jesus Gil|Enterprise Database Administration  Deployment|[Dr Rudo SQL presenta: Fin del soporte de SQL 2008-2008R2 ¿cómo migrar mi base de datos a Azure?](#sessionid-88847)
14:15:00|Ricardo Estrada|Advanced Analysis Techniques|[Introducción a R y Visual Studio](#sessionid-88849)
15:15:00|Fabricio Quintanilla|Advanced Analysis Techniques|[Usando la ciencia de datos para impulsar un cambio más allá de lo digital](#sessionid-86950)
15:15:00|Keneth Murillo|Application  Database Development|[Design an Evolutionary Database](#sessionid-86993)
15:15:00|Christian Araujo|Cloud Application Development  Deployment|[Designing Hybrid environments with Microsoft Azure](#sessionid-87092)
15:15:00|Eduardo Pivaral|Application  Database Development|[T-SQL Basics: Coding for performance](#sessionid-87912)
15:15:00|Mynor Bolanos|Strategy and Architecture|[The Art and Science of SQL Server Indexes (Learn when to create or drop an index)](#sessionid-88777)
15:15:00|Marco Tulio Gómez Reyes|BI Platform Architecture, Development  Administration|[Self-service data preparation con Power BI Dataflows](#sessionid-88779)
15:15:00|Juan Alvarado|Analytics and Visualization|[De cero a 100 con Excel como fuente de datos principal y Power BI](#sessionid-89053)
15:15:00|Ahias Portillo|Advanced Analysis Techniques|[Estadísticas para ciencia de datos, amasando los datos con R](#sessionid-89452)
#  
#### SessionID: 86994
