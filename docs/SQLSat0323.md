...
---|---|---|---
00:00:00|Boris Hristov|2. English speaking track|[The nightmare of locking, blocking and isolation levels!](#sessionid-10957)
00:00:00|Christophe Laporte|1. Parcours SQL Server|[Et hop, ma base migre dans Azure :)](#sessionid-11647)
00:00:00|GUSS France|5. Chalk-Talk|[Métiers autour de SQL Server](#sessionid-11818)
00:00:00|GUSS France|5. Chalk-Talk|[L'avenir de la BI](#sessionid-11819)
00:00:00|GUSS France|5. Chalk-Talk|[Femmes dans L'IT](#sessionid-11820)
00:00:00|GUSS France|5. Chalk-Talk|[Cloud vs on Premise](#sessionid-11821)
00:00:00|Francis Incours|4. Parcours écosytème|[XLCubed, le lien manquant entre votre plateforme Microsoft BI et vos utilisateurs sur Excel/Web/Mobi](#sessionid-14265)
00:00:00|Frederic Gisbert|4. Parcours écosytème|[Azure mobile service and BI Dashboard](#sessionid-14352)
00:00:00|Gilles Pommier|4. Parcours écosytème|[Construire et déployer une application métier Office 365/ SQL Azure en 60 minutes chrono](#sessionid-14650)
00:00:00|Isabelle Van Campenhoudt|1. Parcours SQL Server|[Migrer SQL server: casse-tête ou opportunité.](#sessionid-15456)
00:00:00|Jean-Pierre Riehl|3. Parcours Business Intelligence|[Attachez vos ceintures et écoutez le Data-Steward](#sessionid-16256)
00:00:00|Jen Stirrup|2. English speaking track|[Counting is easy, Measuring is hard: insights using Data Visualisation](#sessionid-16429)
00:00:00|Jordan Mootoosamy|3. Parcours Business Intelligence|[Menez l'enquête avec Power BI!](#sessionid-17074)
00:00:00|David Barbarin|1. Parcours SQL Server|[SQL Server AlwaysOn et les groupes de disponibilités en détail](#sessionid-20685)
00:00:00|Gokan Ozcifci|4. Parcours écosytème|[SharePoint - de la méfiance jusqu'à l'acceptation](#sessionid-21603)
00:00:00|Philippe Geiger|4. Parcours écosytème|[Bien choisir sa plate-forme de données](#sessionid-22074)
00:00:00|Patrice Harel|3. Parcours Business Intelligence|[Monitoring et configuration SSAS](#sessionid-22106)
00:00:00|Romain Casteres|3. Parcours Business Intelligence|[HDInsight : Cas d'usages, Hive, Sqoop, Pig, ...](#sessionid-22429)
00:00:00|Rudi Bruchez|1. Parcours SQL Server|[Le diagnostic avec les événements étendus](#sessionid-23570)
00:00:00|serge Luca|1. Parcours SQL Server|[Ce que tout DBA doit savoir sur la configuration et l’optimisation de SQL Serveur pour SharePoint](#sessionid-24321)
00:00:00|Tillmann Eitelberg|2. English speaking track|[Data Quality rulez! Integration and Performance best practices](#sessionid-25988)
00:00:00|Kevin Boles|2. English speaking track|[Indexing Deep Dive](#sessionid-26502)
00:00:00|Andy Leonard|2. English speaking track|[Using BIML as an SSIS Design Patterns Engine ](#sessionid-9540)
#  
#### SessionID: 10957
