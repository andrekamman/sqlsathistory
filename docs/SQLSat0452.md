...
---|---|---|---
09:00:00|Vladimir Oselsky|Application  Database Development|[Crash course on becoming better SQL Developer.](#sessionid-37624)
09:00:00|Andy Leonard|BI Platform Architecture, Development  Administration|[SSIS 2014 Data Flow Tuning Tips and Tricks](#sessionid-37632)
09:00:00|Michael Wharton|Enterprise Database Administration  Deployment|[PowerShell Basics for SQLServer](#sessionid-37862)
09:00:00|Harsh Deep Singh|Enterprise Database Administration  Deployment|[SQL Clinic ](#sessionid-38134)
09:00:00|Rick Heiges|Enterprise Database Administration  Deployment|[First Look at SQL Server 2016](#sessionid-38220)
09:00:00|John Welch|BI Platform Architecture, Development  Administration|[Getting Started with SSIS Script Tasks and Components](#sessionid-39109)
09:00:00|Kiran Math|Analytics and Visualization|[Introduction To R For Sql Developers](#sessionid-39840)
09:00:00|Paco Gonzalez|BI Information Delivery|[Tone Analysis with HDInsight and Azure Machine Learning](#sessionid-40152)
10:15:00|Andrew Kelly|Enterprise Database Administration  Deployment|[Getting the Skinny on Minimally Logged Operations](#sessionid-37630)
10:15:00|George Walkey|Enterprise Database Administration  Deployment|[Scripting out SQL Server for Documentation and Disaster Recovery](#sessionid-37638)
10:15:00|Lindsay Clark|Enterprise Database Administration  Deployment|[Beginners SQL Server Security the Low Hanging Fruit](#sessionid-37828)
10:15:00|Bill Anton|BI Platform Architecture, Development  Administration|[Analysis Services: Show Me Where It Hurts](#sessionid-38511)
10:15:00|Melissa Coates|BI Platform Architecture, Development  Administration|[Power BI: Architecture, Integration Points, Implementation Options](#sessionid-39370)
10:15:00|Allen White|Application  Database Development|[Scalable Application Design with Service Broker](#sessionid-39794)
10:15:00|Justin Ward|BI Information Delivery|[Trust Your Data with Data Quality Services](#sessionid-40077)
10:15:00|Brian Carrig|Other|[Planning for Virtualization](#sessionid-40193)
11:30:00|Jeff Reinhard|Enterprise Database Administration  Deployment|[Table Partitioning Intro and make that a sliding window too!](#sessionid-37636)
11:30:00|Kevin Feasel|Other|[Much Ado About Hadoop](#sessionid-37707)
11:30:00|Denis McDowell|Enterprise Database Administration  Deployment|[Managing Complex Workloads Using the SQL Server 2014 Resource Governor](#sessionid-37829)
11:30:00|Slava Murygin|Enterprise Database Administration  Deployment|[Statistics are hidden treasure.](#sessionid-37875)
11:30:00|Jake Switzer|Analytics and Visualization|[Introduction to R Programming](#sessionid-38093)
11:30:00|Kevin Hazzard|BI Information Delivery|[From T4 to BimlScript](#sessionid-39007)
11:30:00|Jason Hall|Cloud Application Development  Deployment|[Managing a Production Azure SQL Database - True Story!](#sessionid-39459)
11:30:00|Jana Sattainathan|Other|[Small Scale Data Collection Using PowerShell -  Going NSA Style!](#sessionid-40194)
11:30:00|Mark Scott|Analytics and Visualization|[Looking for the Power BI on-prem alternative?](#sessionid-40879)
13:00:00|Gene Webb|Sponsored Session|[Profisee: Learn How To Build A Golden Record for Any Subject](#sessionid-41338)
13:00:00|Mark Scott|Sponsored Session|[Pyramid Analytics:  Looking for the Power BI on-prem alternative](#sessionid-41339)
13:00:00|Scott Fallen|Sponsored Session|[Better Managed Services Through Monitoring with UpSearch and SQL Sentry](#sessionid-41342)
13:00:00|Vera Takakura|Sponsored Session|[DELL SQL Server Solutions](#sessionid-41343)
13:45:00|Justin Randall|Professional Development|[Building Your Yellow Brick Road: Directing Your Path to a Successful Career](#sessionid-37672)
13:45:00|Lori Clark|Cloud Application Development  Deployment|[Azure SQL Database - Is it right for my organization?](#sessionid-38487)
13:45:00|Meagan Longoria|Professional Development|[There May Be No Free Lunch But You Can Have Free Training](#sessionid-38813)
13:45:00|Nate West|Application  Database Development|[What's in a Date? Avoiding confusion with Dates, Times, and Durations](#sessionid-39719)
13:45:00|Melvin Black|BI Platform Architecture, Development  Administration|[Creating a Performance Monitoring Solution for SQL Server BI Suite](#sessionid-39824)
13:45:00|Mark Hudson|Other|[Making Predictions with Microsoft Data Mining Tools](#sessionid-40008)
13:45:00|Montrial Harrell|BI Information Delivery|[Configuring and using PolyBase to interact with Hadoop](#sessionid-40009)
13:45:00|Tracy Boggiano|Other|[Disaster Recovery Where to Begin](#sessionid-40024)
13:45:00|Thomas Chan|Enterprise Database Administration  Deployment|[Secure/Encrypt SQL Server Database With TDE](#sessionid-40190)
13:45:00|Rich Cargile|Cloud Application Development  Deployment|[SQL Server and Azure](#sessionid-41074)
15:00:00|Ryan Brickey|Enterprise Database Administration  Deployment|[Policy Based Management: Introduction and Implementation](#sessionid-37681)
15:00:00|Rob Volk|Application  Database Development|[Tame Your Unruly Data...With Constraints!](#sessionid-37691)
15:00:00|William E Pearson III|Analytics and Visualization|[Introducing Forensic Analytics with PowerPivot for Excel](#sessionid-37727)
15:00:00|Leveat Ruse|Professional Development|[Status of the Charlotte IT Marketplace](#sessionid-39141)
15:00:00|Stephen Muliokela|Other|[Database Corruption](#sessionid-39157)
15:00:00|Patrick Keisler|Enterprise Database Administration  Deployment|[No Money for Performance Monitoring Tools? No Problem!](#sessionid-39401)
15:00:00|Scott Fallen|Enterprise Database Administration  Deployment|[Getting Started With Execution Plans](#sessionid-39608)
15:00:00|Thomas Norman|Cloud Application Development  Deployment|[Beginning Azure](#sessionid-39959)
15:00:00|Cornell Emile|Analytics and Visualization|[Enhancing Data and Predictive Analytics with NoSQL](#sessionid-40687)
#  
#### SessionID: 37624
