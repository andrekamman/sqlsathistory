...
---|---|---|---
08:30:00|Thomas Grohser|DBDev: Development, Tools, Scalability, Query Tuning and Indexing|[Using Clustered Column Store Indexes at Scale](#sessionid-96168)
08:30:00|Steve Wake|BI Arch/Admin: Design, ETL, SSIS, EDW|[Power BI Premium: Just the Facts](#sessionid-96183)
08:30:00|James McGillivray|DBDev: Development, Tools, Scalability, Query Tuning and Indexing|[Windowing Functions: Shedding some light](#sessionid-96273)
08:30:00|Aaron Cutshall|Essentials: SQL Basics: Object/Data types, Best Practices, Query Plans, Indexing, Maintenance, SSMS/SQLOps/SSDT tips|[Defining What's Normal -- The Basics of Database Normalization](#sessionid-96323)
08:30:00|Ganesh Lohani|Data Science: Analytics; Machine Learning, Python,  R, R Server, R Services, etc.|[Data Science 101: An Introduction to Data Science Using Python](#sessionid-96706)
08:30:00|Erland Sommarskog|DBAdmin: Administration, Deploy, Manage, Repair, Server and Database Configuration, HA/DR|[Certificates and EXECUTE AS - Putting Permissions Inside Stored Procedures](#sessionid-96863)
08:30:00|Martin Catherall|Professional Development: Career, Skills, Interviewing, Managing, WIT|[Data Privacy and Data Security in a Data-Driven world](#sessionid-98181)
08:30:00|Oliver Engels|BI Arch/Admin: Design, ETL, SSIS, EDW|[Common Data Model - Our new buddy for Data Governance](#sessionid-98189)
08:30:00|Michael Wall|Essentials: SQL Basics: Object/Data types, Best Practices, Query Plans, Indexing, Maintenance, SSMS/SQLOps/SSDT tips|[Lightning Talks Session 1](#sessionid-99584)
10:15:00|Kellyn Pot'Vin-Gorman|Cloud Data: Architecture, Platform, Managed vs. VM, CosmosDb, Azure, AWS, etc.|[Be Part of the Solution with Automation](#sessionid-96216)
10:15:00|Neil Hambly|BI Design: Delivery: Power BI, SSRS, Visualization|[PowerBI Model Designs  Techniques](#sessionid-96330)
10:15:00|Ben Miller|DBAdmin: Administration, Deploy, Manage, Repair, Server and Database Configuration, HA/DR|[Tips and Tricks for the PowerShell DBA [VIDEO]](#sessionid-96502)
10:15:00|Brian Ziff-Levine|Essentials: SQL Basics: Object/Data types, Best Practices, Query Plans, Indexing, Maintenance, SSMS/SQLOps/SSDT tips|[SQL for Product Mangers and Business Line Managers](#sessionid-96521)
10:15:00|Padmashree Koneti|Professional Development: Career, Skills, Interviewing, Managing, WIT|[Grabbing the brass ring: tools for better self-advocacy in the tech workplace](#sessionid-97958)
10:15:00|Erik Darling|DBDev: Development, Tools, Scalability, Query Tuning and Indexing|[The SQL Server Performance Tasting Menu](#sessionid-98176)
10:15:00|Robby Boney|Data Science: Analytics; Machine Learning, Python,  R, R Server, R Services, etc.|[The Jupyterian Snake Invasion: Intro to Jupyter Notebooks, Python, Azure and Beyond [VIDEO]](#sessionid-98183)
10:15:00|Ken Puls|BI Arch/Admin: Design, ETL, SSIS, EDW|[BI in Modern Excel: The value is in the Refresh](#sessionid-98199)
10:15:00|Michael Wall|Essentials: SQL Basics: Object/Data types, Best Practices, Query Plans, Indexing, Maintenance, SSMS/SQLOps/SSDT tips|[Lightning Talks Session 2](#sessionid-99585)
11:45:00|Daniel Cai|BI Arch/Admin: Design, ETL, SSIS, EDW|[KingswaySoft - Supercharge your ETL Dev with Advanced SSIS Components](#sessionid-96181)
11:45:00|Diane Schuster|BI Arch/Admin: Design, ETL, SSIS, EDW|[CozyRoc: Dynamic Data Flows in SSIS Without Programming](#sessionid-99179)
11:45:00|Tillmann Eitelberg|BI Arch/Admin: Design, ETL, SSIS, EDW|[OH22 - Data Quality in Action](#sessionid-99208)
11:45:00|Brandon Leach|DBAdmin: Administration, Deploy, Manage, Repair, Server and Database Configuration, HA/DR|[VMWare - Virtualizing SQL Server on vSphere](#sessionid-99224)
11:45:00|Jackie Wilushewski|BI Design: Delivery: Power BI, SSRS, Visualization|[Marquam - How to Make Beautiful Dashboards in Power BI](#sessionid-99265)
11:45:00|Brian Whittington|BI Arch/Admin: Design, ETL, SSIS, EDW|[Becoming Data-Driven with Snowflake](#sessionid-99278)
11:45:00|Chris Finlan|BI Design: Delivery: Power BI, SSRS, Visualization|[Power BI - Ask Microsoft Anything](#sessionid-99496)
11:45:00|Elliott Whitling|Data Science: Analytics; Machine Learning, Python,  R, R Server, R Services, etc.|[Interject - Are you prepping for the Data Apocalypse?](#sessionid-99549)
11:45:00|Karan Kumar|BI Arch/Admin: Design, ETL, SSIS, EDW|[Talend - Delivering Trusted Data at Speed](#sessionid-99550)
13:00:00|Randolph West|DBDev: Development, Tools, Scalability, Query Tuning and Indexing|[Back to the Future with Temporal Tables](#sessionid-96155)
13:00:00|Melody Zacharias|Data Science: Analytics; Machine Learning, Python,  R, R Server, R Services, etc.|[Introduction to AI](#sessionid-96187)
13:00:00|Joshua Higginbotham|DBDev: Development, Tools, Scalability, Query Tuning and Indexing|[Introduction to GitHub](#sessionid-96219)
13:00:00|Angela Henry|BI Design: Delivery: Power BI, SSRS, Visualization|[What is Power BI?](#sessionid-96320)
13:00:00|Adrian Mee|Essentials: SQL Basics: Object/Data types, Best Practices, Query Plans, Indexing, Maintenance, SSMS/SQLOps/SSDT tips|[SQL Server Management Studio - Beyond the basics](#sessionid-96336)
13:00:00|Vern Rabe|DBAdmin: Administration, Deploy, Manage, Repair, Server and Database Configuration, HA/DR|[Get Faster Queries with Better Statistics Management](#sessionid-96830)
13:00:00|Gabi Münster|DevOps: Agile Processes between Dev and Ops|[Continuous Intelligence... Is it all about automation?](#sessionid-98192)
13:00:00|Frank Geisler|BI Arch/Admin: Design, ETL, SSIS, EDW|[Code Your Report Environment](#sessionid-99551)
13:00:00|Michael Wall|Cloud Data: Architecture, Platform, Managed vs. VM, CosmosDb, Azure, AWS, etc.|[Lightning Talks Session 3](#sessionid-99586)
14:45:00|Rob Volk|DBDev: Development, Tools, Scalability, Query Tuning and Indexing|[That's So Metadata: Discover Your Database From The Inside](#sessionid-96158)
14:45:00|Ted Stathakis|BI Arch/Admin: Design, ETL, SSIS, EDW|[Reporting Services Tips, Tricks, Templates and Considerations](#sessionid-96174)
14:45:00|Frank Geisler|DBAdmin: Administration, Deploy, Manage, Repair, Server and Database Configuration, HA/DR|[SQL on Docker 101](#sessionid-96309)
14:45:00|Christopher Unwin|DevOps: Agile Processes between Dev and Ops|[Protect your Data by Design: Creating a Data Masking Strategy](#sessionid-96315)
14:45:00|Asgeir Gunnarsson|BI Design: Delivery: Power BI, SSRS, Visualization|[Enterprise Power BI - Development Lifecycle [VIDEO]](#sessionid-96385)
14:45:00|Randy Knight|Essentials: SQL Basics: Object/Data types, Best Practices, Query Plans, Indexing, Maintenance, SSMS/SQLOps/SSDT tips|[Locks?  We don't need no stinkin' locks!](#sessionid-96556)
14:45:00|Heidi Hasting|Essentials: SQL Basics: Object/Data types, Best Practices, Query Plans, Indexing, Maintenance, SSMS/SQLOps/SSDT tips|[Intro to Azure Data Studio](#sessionid-98169)
14:45:00|Michael Curry|Data Science: Analytics; Machine Learning, Python,  R, R Server, R Services, etc.|[Theory Driven Data Science: Cyber-security Improvement using SQL, R and machine learning [Video]](#sessionid-98228)
14:45:00|Michael Wall|Professional Development: Career, Skills, Interviewing, Managing, WIT|[Lightning Talks - Session 4](#sessionid-99587)
16:15:00|Thomas Norman|DBDev: Development, Tools, Scalability, Query Tuning and Indexing|[Encrypting Data Within SQL Server](#sessionid-96159)
16:15:00|Slava Murygin|BI Design: Delivery: Power BI, SSRS, Visualization|[Power BI: From Zero to 101](#sessionid-96259)
16:15:00|Christine Assaf|Professional Development: Career, Skills, Interviewing, Managing, WIT|[Mastering your Resume  Interview: Tips to Get Hired](#sessionid-96284)
16:15:00|Julie Koesmarno|Cloud Data: Architecture, Platform, Managed vs. VM, CosmosDb, Azure, AWS, etc.|[Azure SQL Database Edge - Tiny but mighty](#sessionid-96339)
16:15:00|Kathi Kellenberger|DevOps: Agile Processes between Dev and Ops|[What is DevOps and Why Should DBAs Care? [VIDEO]](#sessionid-96344)
16:15:00|Janis Griffin|DBDev: Development, Tools, Scalability, Query Tuning and Indexing|[Inside the Query Store. What Knowledge can You Gain?](#sessionid-96347)
16:15:00|Jamey Johnston|BI Design: Delivery: Power BI, SSRS, Visualization|[Enterprise Row Level Security in SQL Server and Power BI  [VIDEO]](#sessionid-96683)
16:15:00|Hamish Watson|DBAdmin: Administration, Deploy, Manage, Repair, Server and Database Configuration, HA/DR|[Essential Linux skills for SQL Server DBAs](#sessionid-96873)
16:15:00|Michael Wall|BI Arch/Admin: Design, ETL, SSIS, EDW|[Lightning Talks - Session 5](#sessionid-99588)
#  
#### SessionID: 96168
# Using Clustered Column Store Indexes at Scale
#### [Back to calendar](#SQLSaturday-#920---Oregon-2019)
