...
---|---|---|---
09:00:00|Melissa Coates|BI Platform Architecture, Development  Administration|[Architecting a Data Lake (Paid Pre-con)](#sessionid:-68636)
09:00:00|Ed Leighton-Dick|Strategy and Architecture|[Securing the Data Platform: Crafting a Strategy That Works (Paid Pre-con)](#sessionid:-68942)
08:20:00|Tracy Boggiano|Enterprise Database Administration  Deployment|[Monitoring Availability Groups](#sessionid:-68190)
08:20:00|Stephen Muliokela|Enterprise Database Administration  Deployment|[Database Corruption](#sessionid:-68269)
08:20:00|Kevin Feasel|Analytics and Visualization|[Data Cleansing With SQL And R](#sessionid:-68553)
08:20:00|Rie Irish|Professional Development|[Let Her Finish: Supporting Women's Voices in Technology](#sessionid:-68558)
08:20:00|Mindy Curnutt|Application  Database Development|[Reading Between the Lines - Using XEvents to Diagnose Application Issues](#sessionid:-69396)
08:20:00|Justin Dearing|Application  Database Development|[Version control with GIT for the DBA](#sessionid:-69423)
08:20:00|Jim Donahoe|Enterprise Database Administration  Deployment|[Getting started with SQL Azure Database: What you need to know](#sessionid:-69761)
08:20:00|Ivan Carter|Professional Development|[The 7 Secrets to Creating a Brand that Clients Love](#sessionid:-70140)
09:45:00|Chris Hyde|Analytics and Visualization|[SQL Server R Services in SQL 2016](#sessionid:-68002)
09:45:00|Greg Moore|Professional Development|[Who's flying the plane? What IT can learn from plane crashes](#sessionid:-68011)
09:45:00|Brian Carrig|Enterprise Database Administration  Deployment|[Controlling Competing Workloads with SQL Server Resource Governor](#sessionid:-68749)
09:45:00|Azhagappan Arunachalam|Application  Database Development|[SQL Graph](#sessionid:-68760)
09:45:00|Melissa Coates|BI Platform Architecture, Development  Administration|[Azure Data Lake: What, Why, and How](#sessionid:-68868)
09:45:00|Andrew Kelly|Enterprise Database Administration  Deployment|[Getting the Most Out of Plan Reuse](#sessionid:-69280)
09:45:00|Rick Lowe|Application  Database Development|[Why is my DBA So Grumpy ... When I Use NOLOCK and Other Query Hints.](#sessionid:-69535)
09:45:00|Jason Brimhall|Enterprise Database Administration  Deployment|[A Masters Passport to Extended Events](#sessionid:-69883)
11:10:00|Slava Murygin|Enterprise Database Administration  Deployment|[SQL Server on Linux for SQL DBA.](#sessionid:-68117)
11:10:00|Sebastian Meine|Application  Database Development|[Introduction to Unit-Testing in SQL Server](#sessionid:-69556)
11:10:00|Rick Heiges|Enterprise Database Administration  Deployment|[Winning with Columnstore - A Customer Story](#sessionid:-69757)
11:10:00|Amy Herold|Enterprise Database Administration  Deployment|[Deadlock, Block  Two Smoking Barrels: Breaking Down Blocking and Deadlocks](#sessionid:-69796)
11:10:00|Wayne Sheffield|Enterprise Database Administration  Deployment|[SSMS Tips and Tricks](#sessionid:-69891)
11:10:00|Ravi Kumar|BI Information Delivery|[SSAS Cube Security: who can see what?](#sessionid:-69937)
11:10:00|Lisa Margerum|Professional Development|[Network your Way to Success!](#sessionid:-70139)
11:10:00|Edward Corcoran|Application  Database Development|[Intro to Service Broker](#sessionid:-71712)
13:40:00|Greg Moore|Professional Development|[Presently Presenting.... Presenting](#sessionid:-68009)
13:40:00|Jamie Wick|Enterprise Database Administration  Deployment|[Automated SQL Server installation and configuration using PowerShell](#sessionid:-68333)
13:40:00|Jonathan Stewart|Analytics and Visualization|[From problem to Power BI:  A journey in data visualization](#sessionid:-69225)
13:40:00|Mindy Curnutt|Enterprise Database Administration  Deployment|[Help! I Need Somebody. Help!: Resources for the New or Accidental DBA](#sessionid:-69400)
13:40:00|Rick Lowe|Application  Database Development|[Weird Stuff I Saw While ... Working With Heaps](#sessionid:-69534)
13:40:00|Jason Brimhall|Enterprise Database Administration  Deployment|[Extended Events - Better than Profiler](#sessionid:-69886)
13:40:00|Mike Walsh|Cloud Application Development  Deployment|[Azure SQL Databases: A Guided Tour](#sessionid:-70082)
13:40:00|John Morehouse|Application  Database Development|[Database Continuous Delivery  Your Salvation!](#sessionid:-71679)
15:05:00|Azhagappan Arunachalam|Analytics and Visualization|[SQL Server - R Services](#sessionid:-68761)
15:05:00|Ed Leighton-Dick|Enterprise Database Administration  Deployment|[Dammit Jim! Dr McCoy’s Field Guide to system_health (and the default trace)](#sessionid:-68941)
15:05:00|Andy Mallon|Professional Development|[Interview with Rie Irish: Inside the Management Studio](#sessionid:-69598)
15:05:00|Carlos L Chacon|Enterprise Database Administration  Deployment|[How can containers for my database help me?](#sessionid:-69759)
15:05:00|Jim Donahoe|Enterprise Database Administration  Deployment|[New Instance, Now what?](#sessionid:-69762)
15:05:00|Amy Herold|Enterprise Database Administration  Deployment|[Beginning Automation with Powershell](#sessionid:-69799)
15:05:00|Ravi Kumar|Analytics and Visualization|[Power BI Security](#sessionid:-69936)
#  
#### SessionID: 68636
# Architecting a Data Lake (Paid Pre-con)
#### [Back to calendar](#SQLSaturday-#693---Washington-DC-2017)
