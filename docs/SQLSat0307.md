...
---|---|---|---
00:00:00|Chaitanya Khaladkar|Track 4|[Data Visualization with SQL Server 2012](#sessionid-11140)
00:00:00|David Klee|Track 1|[How to Argue with Your Infrastructure Admins – and Win](#sessionid-12508)
00:00:00|David Klee|Track 4|[SQL Server Virtualization 101](#sessionid-12509)
00:00:00|Dennis  Graham|Track 4|[Reporting for SQL Health](#sessionid-13244)
00:00:00|Dave Tigges|Track 5|[That's Not in My Job Description: The Accidental Developer](#sessionid-13590)
00:00:00|Ed Leighton-Dick|Track 1|[SQL Server Features That Will Blow Your Mind!](#sessionid-13675)
00:00:00|Jim Dorame|Track 4|[PowerShell and SQLPSX the Dynamic Duo for the DBA](#sessionid-15556)
00:00:00|Jason Strate|Track 1|[Managing SQL Server Performance with Extended Events](#sessionid-15978)
00:00:00|James Borland|Track 2|[Add SSIS to the developer tool belt without adding to the DBA’s work load Part 1 (for the DBA)](#sessionid-16830)
00:00:00|James Borland|Track 3|[Add SSIS to the developer tool belt without adding to the DBA’s work load Part 2 (for the developer)](#sessionid-16831)
00:00:00|John Morehouse|Track 3|[10 Things Every DBA Should Know!](#sessionid-17252)
00:00:00|Kirby Richter|Track 4|[Implement a Dynamic Table Partitioning Solution](#sessionid-18388)
00:00:00|Keith Tate|Track 3|[The Curious Case of Isolation Levels](#sessionid-18855)
00:00:00|Larry Toothman|Track 2|[Yesterday I Couldn’t Even Spell ‘DBA’.](#sessionid-18964)
00:00:00|Mike Hays|Track 2|[Recovery that May or May Not have a Wizard](#sessionid-20653)
00:00:00|Mark Skiles|Track 5|[Mission Critical Confidence – (SQL 2012/2014 AlwaysOn) and Availability Groups](#sessionid-21137)
00:00:00|Paul Timmerman|Track 5|[Scary Things A Database Owner Can Do](#sessionid-22396)
00:00:00|Frank Gill|Track 3|[Designing a Restore Strategy](#sessionid-24592)
00:00:00|MIKE DONNELLY|Track 5|[Microsoft Azure SQL Database for the DBA](#sessionid-24962)
00:00:00|Kevin Boles|Track 2|[Indexing Deep Dive](#sessionid-26383)
00:00:00|Kevin Boles|Track 1|[SQL Server 2014 New Features](#sessionid-26384)
00:00:00|William E Pearson III|Track 2|[Getting Started with MDX](#sessionid-28120)
00:00:00|Andy Galbraith|Track 5|[Are You Maintaining Your SQL Servers?](#sessionid-9607)
#  
#### SessionID: 11140
# Data Visualization with SQL Server 2012
#### [Back to calendar](#nr-307)
