...
---|---|---|---
09:45:00|Tim Mitchell|Track 4|[Are There Time Bombs in your SSIS Packages?](#sessionid-82839)
09:45:00|Jennifer McCown|Track 4|[Beginning T-SQL](#sessionid-83302)
09:45:00|Caitlin Stewart|Track 4|[SSMS Magic: Tips  Tricks for Management Studio](#sessionid-83561)
09:45:00|Ben Miller|Track 2|[SQL Server Encryption](#sessionid-83762)
11:15:00|Mike Byrd|Track 4|[A Rocket Scientist Perspective on Indexes](#sessionid-82648)
11:15:00|Shawn Weisfeld|Track 4|[Get insights from data with Cognitive Services](#sessionid-82718)
11:15:00|Tim Mitchell|Track 4|[Deep Dive into the SSIS Catalog](#sessionid-82836)
11:15:00|Jennifer McCown|Track 4|[T-SQL's Hidden Support Feature](#sessionid-83304)
12:30:00|William Barnes|Track 4|[LUNCH: Simplifying SQL Data Protection by - Mike Fal](#sessionid-85482)
12:30:00|William Barnes|Track 1|[LUNCH: Auditing your Enterprise with MinionWare By The Midnight DBAs](#sessionid-85483)
12:30:00|William Barnes|Track 1|[LUNCH: Introduction to Visual Analytics and Tableau-By Kent Sloan](#sessionid-85484)
13:45:00|Ryan Casey|Track 4|["Real World" Examples on How to Load Data Warehouse Structures using SSIS](#sessionid-82627)
13:45:00|Trayce Jordan|Track 2|[Finding root cause for unexplained Availability Group failover](#sessionid-82791)
13:45:00|Ben Miller|Track 2|[SQL Server PowerShell for the Beginner](#sessionid-83759)
13:45:00|Kenneth Fisher|Track 2|[SQL Server Security from the ground up](#sessionid-83772)
13:45:00|Kristin Ferrier|Track 4|[Demystifying JSON in SQL Server](#sessionid-84078)
13:45:00|Matthew Brimer|Track 1|[Intro Data Warehousing for the DBA\Dev: From “Stupid Data" to Star Schema](#sessionid-85324)
15:15:00|John Wells|Track 4|[Fundamentals That Will Improve Your Query Performance!](#sessionid-82578)
15:15:00|Mike Byrd|Track 4|[Climbing the SQL Server Index B-Tree (from a user perspective)](#sessionid-82649)
15:15:00|Sean McCown|Track 4|[The Master Stored Procedure Workshop](#sessionid-82970)
15:15:00|Russel Loski|Track 4|[Querying Semistructured Data in Azure Data Lake with USQL](#sessionid-83298)
15:15:00|David Stein|Track 4|[Agile Data Warehouse and ETL Design with Biml](#sessionid-84081)
#  
#### SessionID: 82839
