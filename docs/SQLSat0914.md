...
---|---|---|---
09:30:00|Łukasz Bielak|BI Platform Architecture, Development  Administration|[Processing Large Tabular models with Analysis Services Partition Manager](#sessionid-96246)
09:30:00|Marek Maśko|Application  Database Development|[Wprowadzenie do SQL Server Data Tools](#sessionid-96690)
09:30:00|Emil Wasilewski|Cloud Application Development  Deployment|[Life on the Edge](#sessionid-98113)
09:30:00|Tomasz Cieplak|Advanced Analysis  Machine Learning|[Metody wykrywania anomalii z zastosowaniem sieci LSTM](#sessionid-98666)
10:30:00|Pawel Potasinski|Analytics and Visualization|[AI and (Power) BI - Better Together](#sessionid-94727)
10:30:00|Adrian Chodkowski|Application  Database Development|[Hidden aspects of SQL Server](#sessionid-95663)
10:30:00|Adam Marczak|Cloud Application Development  Deployment|[Creating data transformation in minutes with no code using Azure Data Factory with Data Flows](#sessionid-96332)
10:30:00|Patryk Miziuła|Advanced Analysis  Machine Learning|[Uczenie maszynowe – jak zacząć](#sessionid-96481)
11:30:00|Marcin Szeliga|Advanced Analysis  Machine Learning|[AutoML at scale](#sessionid-95102)
11:30:00|Tomasz Waloszek|BI Platform Architecture, Development  Administration|[Best Practices in SSIS](#sessionid-95667)
11:30:00|Sławomir Drzymała|Application  Database Development|[Docker for data amateur](#sessionid-96071)
11:30:00|Hubert Kobierzewski|Analytics and Visualization|[Mój własny wykres w Power BI](#sessionid-96543)
13:15:00|Rafał Suchorski|Enterprise Database Administration  Deployment|[Statystyki danych - czy to jest istotne?](#sessionid-95586)
13:15:00|Bartosz Ratajczyk|Application  Database Development|[How does the recursive CTE work?](#sessionid-95622)
13:15:00|Michał Ćwiok|Analytics and Visualization|[Zaawansowane obchodzenie ograniczneń w Power BI. Komentarze do danych w real-time w bankingu.](#sessionid-96727)
13:15:00|Jakub Wawrzyniak|BI Platform Architecture, Development  Administration|[PowerBI Embedded: powerful analytics in your application](#sessionid-96760)
14:15:00|Jose Manuel Jurado Diaz|Cloud Application Development  Deployment|[How to get the most from Azure SQL Database](#sessionid-95132)
14:15:00|Kevin Chant|Enterprise Database Administration  Deployment|[Database Adventure](#sessionid-95853)
14:15:00|Tomasz Gołaszewski|Advanced Analysis  Machine Learning|[DAX Filter Context](#sessionid-96565)
14:15:00|Damian Widera|BI Platform Architecture, Development  Administration|[Query optimization on steroids with SQL Server 2017/2019](#sessionid-96722)
15:15:00|Natalia Świtalska|Application  Database Development|[Non-relational faces of SQL](#sessionid-95866)
15:15:00|Grzegorz Stolecki|Analytics and Visualization|[How to quickly cook a brand new visual for Power BI](#sessionid-96319)
15:15:00|Andrzej Pyskir|Advanced Analysis  Machine Learning|[Czy można nauczyć komputer znajdować budynki na zdjęciach satelitarnych?](#sessionid-96548)
15:15:00|Lukasz Kaluzny|Enterprise Database Administration  Deployment|[Availability Groups on Kubernetes in SQL Server 2019](#sessionid-98522)
#  
#### SessionID: 96246
