...
---|---|---|---
10:10:00|Marcelo Adade|DBA - Iniciante (Sala 215 - 2º Andar)|[Entendendo Backup/Restore no SQL Server](#sessionid:-64517)
10:10:00|Gaston Cruz|BI/Analytics (Sala 102 - 1º Andar)|[Power BI in Action - Sentiment Analysis - Cognitive Services - Flow](#sessionid:-64879)
10:10:00|Thiago Cruz|Miscellania (Sala 216 - 2º Andar)|[De DBA a empreendedor! Como ter sua própria consultoria SQL Server.](#sessionid:-69020)
10:10:00|Marcus Vinícius Bittencourt|DBA - Avançado (Auditório - 2º Andar)|[SQL Bad Practices](#sessionid:-69522)
10:10:00|Alexandre Araujo|BI/Analytics (Sala 102 - 1º Andar)|[Azure CosmosDB - As armas da Microsoft no mundo NoSQL](#sessionid:-69566)
11:30:00|Eduardo Morelli|Miscellania (Sala 216 - 2º Andar)|[Acessando dados no Hadoop HDFS usando SQL via Apache Hive](#sessionid:-68988)
11:30:00|Thiago Carlos de Alencar|DBA - Avançado (Auditório - 2º Andar)|[Tuning do inicio ao fim!](#sessionid:-69067)
11:30:00|Arthur Luz|BI/Analytics (Sala 102 - 1º Andar)|[Por Detrás do Relatórios](#sessionid:-69125)
11:30:00|Mohamed Mawla|DBA - Iniciante (Sala 215 - 2º Andar)|[Linux essential Skills for SQL Server Professionals](#sessionid:-69145)
13:30:00|Fabiano Amorim|DBA - Avançado (Auditório - 2º Andar)|[SQL Server 2017 - Homem VS Máquina, estamos perdendo a guerra!](#sessionid:-64515)
13:30:00|Armando Lacerda|Miscellania (Sala 216 - 2º Andar)|[Unleashing Stretched Databases](#sessionid:-64521)
13:30:00|Tiago Neves|DBA - Iniciante (Sala 215 - 2º Andar)|[Quero ser um DBA. O que devo aprender ?](#sessionid:-67212)
13:30:00|Vitor Ferreira|BI/Analytics (Sala 102 - 1º Andar)|[SSIS Scale Out](#sessionid:-68455)
14:40:00|Luiz Mercante|DBA - Iniciante (Sala 215 - 2º Andar)|[Introdução à Storage](#sessionid:-64527)
14:40:00|Vitor Fava|BI/Analytics (Sala 102 - 1º Andar)|[Introdução ao SQL DataWarehouse](#sessionid:-64539)
14:40:00|André Melancia|DBA - Avançado (Auditório - 2º Andar)|[Hackeando o SQL Server](#sessionid:-64804)
14:40:00|Reginaldo Silva|Miscellania (Sala 216 - 2º Andar)|[Aumentando a segurança com SQL Server 2016/2017](#sessionid:-67476)
14:40:00|Thiago Carlos de Alencar|Miscellania (Sala 216 - 2º Andar)|[What's the New in SQL Server 2017?](#sessionid:-69069)
14:40:00|Arthur Luz|DBA - Iniciante (Sala 215 - 2º Andar)|[Introdução a T-SQL](#sessionid:-69123)
16:00:00|Sulamita Dantas|DBA - Iniciante (Sala 215 - 2º Andar)|[Versões do SQL Server - 2000 a  2017](#sessionid:-66380)
16:00:00|Nilton Pinheiro|DBA - Avançado (Auditório - 2º Andar)|[Diagnosticando os problemas de latência com as réplicas secundárias do AlwaysOn AG](#sessionid:-69137)
16:00:00|Diego Nogare|BI/Analytics (Sala 102 - 1º Andar)|[Análise em tempo real com Stream Analytics, AZUREML, e PowerBI](#sessionid:-69343)
16:00:00|Igor Santos de Paula|BI/Analytics (Sala 102 - 1º Andar)|[Case: Detecção de anomalias onde um desvio pode custar milhões](#sessionid:-69853)
16:00:00|Caio Amante|Miscellania (Sala 216 - 2º Andar)|[5 dicas de performance tuning para desenvolvedores](#sessionid:-69854)
17:10:00|Rodrigo Ribeiro Gomes|DBA - Avançado (Auditório - 2º Andar)|[Introdução à Windows Debugging para SQL Server (Windbg)](#sessionid:-64534)
17:10:00|Vitor Fava|DBA - Avançado (Auditório - 2º Andar)|[Azure SQL Database - Scaling In e Scaling Out através do elastic pool](#sessionid:-64536)
17:10:00|André Melancia|BI/Analytics (Sala 102 - 1º Andar)|[If a machine can learn, why can't YOU learn Azure Machine Learning?](#sessionid:-64805)
17:10:00|Gustavo Carneiro|DBA - Iniciante (Sala 215 - 2º Andar)|[Obtenha maior produtividade: desenvolvimento e administracao do seu SQL Server](#sessionid:-67779)
17:10:00|Mohamed Mawla|Miscellania (Sala 216 - 2º Andar)|[Azure DataFactory for heterogeneous Data Sources](#sessionid:-69144)
#  
#### SessionID: 64517
# Entendendo Backup/Restore no SQL Server
#### [Back to calendar](#SQLSaturday-#663---Rio-de-Janeiro-2017)
...
#  
#### SessionID: 64534
# Introdução à Windows Debugging para SQL Server (Windbg)
#### [Back to calendar](#SQLSaturday-#663---Rio-de-Janeiro-2017)
Event Date: 21-10-2017 - Session time: 17:10:00 - Track: DBA - Avançado (Auditório - 2º Andar)
...
#  
#### SessionID: 69144
# Azure DataFactory for heterogeneous Data Sources
#### [Back to calendar](#SQLSaturday-#663---Rio-de-Janeiro-2017)
Event Date: 21-10-2017 - Session time: 17:10:00 - Track: Miscellania (Sala 216 - 2º Andar)
## Speaker: Mohamed Mawla
