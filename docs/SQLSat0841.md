...
---|---|---|---
08:30:00|Hasan Savran|Analytics and Visualization|[How to use GeoSpatial Data in SQL Server](#sessionid-88315)
08:30:00|Adam Saxton|BI Information Delivery|[Introduction to Power BI Desktop](#sessionid-88580)
08:30:00|John Sterrett|Cloud Application Development  Deployment|[Successfully Migrating Existing Databases to Azure SQL Database](#sessionid-88614)
08:30:00|Thomas Norman|Application  Database Development|[Encrypting Data within Sql Server](#sessionid-88637)
08:30:00|Brent Ozar|Application  Database Development|[Dynamic SQL: When, Why, and How to Use It](#sessionid-89087)
08:30:00|Mohammad Darab|Professional Development|[3 Keys to Successful Consulting](#sessionid-89459)
08:30:00|Jennifer McCown|Enterprise Database Administration  Deployment|[Beginning Admin: The Care and Feeding of SQL Server](#sessionid-90391)
08:30:00|Thomas LeBlanc|Application  Database Development|[Execution Plans for Performance Tuning SQL Server 2017](#sessionid-91961)
08:30:00|Angela Tidwell|Strategy and Architecture|[Data Collection and Usage: Illegal or Unethical?](#sessionid-92208)
09:45:00|Anders Pedersen|Application  Database Development|[I/O Tuning 101](#sessionid-87864)
09:45:00|Abdullah Mamun|Enterprise Database Administration  Deployment|[SQL Server on Azure VM (IaaS)](#sessionid-87880)
09:45:00|Bob Ward|Enterprise Database Administration  Deployment|[Inside SQL Server 2019](#sessionid-88572)
09:45:00|Ben Miller|Enterprise Database Administration  Deployment|[Tips and Tricks for the PowerShell DBA](#sessionid-89100)
09:45:00|Taiyebali Zakir|Enterprise Database Administration  Deployment|[SQL Replication on Linux](#sessionid-89345)
09:45:00|Andy Yun|Application  Database Development|[Why Your Data Type Choices Matter](#sessionid-89829)
09:45:00|Paul LaGrone|BI Platform Architecture, Development  Administration|[SSIS 2017 Scale Out for HA/DR ETL](#sessionid-89848)
09:45:00|Leslie Andrews|BI Platform Architecture, Development  Administration|[A Perfect Ten: The Data Model](#sessionid-89916)
09:45:00|Julie Smith|Advanced Analysis Techniques|[Leveraging Python in SQL Server](#sessionid-91577)
09:45:00|Peter Doyle|Analytics and Visualization|[Become a T-SQL Pivoting Ninja in 60 Minutes Or Less](#sessionid-92511)
11:00:00|Jay Falck|Enterprise Database Administration  Deployment|[Introduction to Linux for SQL Server](#sessionid-88608)
11:00:00|Anna Hoffman|Analytics and Visualization|[Microsoft SQL Server Machine Learning Services - a Complete Platform for E2E ML](#sessionid-88816)
11:00:00|Eddy Djaja|Enterprise Database Administration  Deployment|[What Is Clogging Your Database Performance?](#sessionid-89070)
11:00:00|Ryan Adams|Enterprise Database Administration  Deployment|[TempDB Inside Out](#sessionid-90795)
11:00:00|Alicia Moniz|Analytics and Visualization|[AI Cognitive Services: Vision 101](#sessionid-91175)
11:00:00|Dave Bland|Enterprise Database Administration  Deployment|[Extended Events: What are they and How do I use them](#sessionid-91741)
11:00:00|Ganesh Lohani|BI Platform Architecture, Development  Administration|[Implementing ETL solution for incremental data load](#sessionid-92169)
11:00:00|Chris Hyde|BI Platform Architecture, Development  Administration|[Python in SQL Server 2017 and 2019](#sessionid-93141)
11:00:00|Allan Hirt|Enterprise Database Administration  Deployment|[Modern Infrastructure Fundamentals for SQL Server](#sessionid-93254)
13:15:00|Martin Perez|Application  Database Development|[T-SQL Tools: Simplicity for Synchronizing Changes](#sessionid-87867)
13:15:00|Matt Gordon|Analytics and Visualization|[Feelings Quantified: Scoring and Storing Social Media Sentiment](#sessionid-87998)
13:15:00|Kevin Feasel|Application  Database Development|[A Map To Success:  Functional Programming For Database Developers](#sessionid-88112)
13:15:00|Roberto Cavalcanti|Cloud Application Development  Deployment|[Azure SQL Managed Instance - Lessons learned from the trenches](#sessionid-88265)
13:15:00|Brent Ozar|Enterprise Database Administration  Deployment|[What's New in SQL Server 2019: 100% Demos](#sessionid-89086)
13:15:00|Trevor Barkhouse|Enterprise Database Administration  Deployment|[Backing up to Azure BLOB Storage](#sessionid-90878)
13:15:00|Lance Tidwell|Application  Database Development|[Introduction to Execution Plans](#sessionid-91780)
13:15:00|Melissa Stein|BI Platform Architecture, Development  Administration|[The True Story of Learning Biml](#sessionid-92537)
13:15:00|William Assaf|Enterprise Database Administration  Deployment|[SQL Security Principals and Permissions 101](#sessionid-93063)
13:15:00|Andy Leonard|Cloud Application Development  Deployment|[Moving Data with Azure Data Factory](#sessionid-93147)
14:30:00|Buck Woody|Advanced Analysis Techniques|[Introduction to SQL Server Big Data Clusters](#sessionid-89036)
14:30:00|Eugene Meidinger|BI Information Delivery|[An (Advanced) Introduction to DAX](#sessionid-89358)
14:30:00|Kevin Boles|Application  Database Development|[Query Plan Deep Dive](#sessionid-91602)
14:30:00|Kathi Kellenberger|Application  Database Development|[T-SQL Window Function Performance in 2019](#sessionid-92032)
14:30:00|Anthony Nocentino|Cloud Application Development  Deployment|[Practical Container Scenarios in Azure](#sessionid-92433)
14:30:00|Mike Burek|Application  Database Development|[Raspberry Pi and SQL Server](#sessionid-92555)
14:30:00|Christine Assaf|Professional Development|[Mastering your Resume  Interview: Tips to Get Hired](#sessionid-93068)
15:45:00|Reinaldo Kibel|Strategy and Architecture|[Hackers move away, we are Always Encrypted](#sessionid-88089)
15:45:00|Kellyn Pot'Vin-Gorman|Cloud Application Development  Deployment|[Be Part of the Solution with Automation](#sessionid-88156)
15:45:00|Kenneth Fisher|Application  Database Development|[SQL Server Security from the ground up](#sessionid-88267)
15:45:00|Mark Moore|Enterprise Database Administration  Deployment|[SQL in Azure 101](#sessionid-88664)
15:45:00|Mike Byrd|Application  Database Development|[Indexing Like a Rocket Scientist](#sessionid-89765)
15:45:00|Sean McCown|Enterprise Database Administration  Deployment|[Beginning Powershell for DBAs 1.0](#sessionid-90386)
15:45:00|Mike Diehl|BI Platform Architecture, Development  Administration|[Building measures in Power BI (and SQL Server Analysis Services tabular models)](#sessionid-90728)
15:45:00|Paul Bell|Strategy and Architecture|[Where should I store my database?](#sessionid-91634)
15:45:00|Joshua Higginbotham|Application  Database Development|[Introduction to GitHub](#sessionid-92013)
15:45:00|Kalen Delaney|Enterprise Database Administration  Deployment|[Are You Optimistic About Concurrency?](#sessionid-93139)
#  
#### SessionID: 88315
# How to use GeoSpatial Data in SQL Server
#### [Back to calendar](#SQLSaturday-#841-Dallas-2019)
Event Date: 01-06-2019 - Session time: 15:45:00 - Track: Analytics and Visualization
...
#### [Back to calendar](#SQLSaturday-#841-Dallas-2019)
Event Date: 01-06-2019 - Session time: 15:45:00 - Track: BI Information Delivery
## Speaker: Adam Saxton
...
#### [Back to calendar](#SQLSaturday-#841-Dallas-2019)
Event Date: 01-06-2019 - Session time: 15:45:00 - Track: Professional Development
...
#### [Back to calendar](#SQLSaturday-#841-Dallas-2019)
Event Date: 01-06-2019 - Session time: 15:45:00 - Track: Advanced Analysis Techniques
## Speaker: Julie Smith
