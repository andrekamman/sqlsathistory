...
---|---|---|---
09:00:00|Vladimir Medina|BI 02|[Explore SharePoint 2016 and beyond](#sessionid-61404)
09:00:00|Robert Davis|Administración 02|[How to Lose Your Job in 3 Easy Steps](#sessionid-61433)
09:00:00|Dave Walden|Administración 01|[New Security Features of SQL Server 2016](#sessionid-61455)
09:00:00|Adan Ortiz-Cordova|BI 01|[Machine Learning (Aprendizaje Automático) en la nube de Azure](#sessionid-64414)
09:00:00|Adrian Miranda|Administración 03|[Internet of Things (IoT) - Mis primeros pasos.](#sessionid-64644)
10:00:00|Jonathan Stewart|BI 02|[An introduction to the magical world of BIML!](#sessionid-61451)
10:00:00|Daniel Valero|Administración 03|[Alta Disponibilidad con Always On Availability Groups en SQL 2016](#sessionid-61799)
10:00:00|Eduardo Castro|BI 01|[Introducci#243;n al an#225;lisis predictivo con SQL Server y Le](#sessionid-63955)
10:00:00|Kenneth Urena|Administración 02|[SQL Server 2016 - Mejorando el desempeño de consultas de análisis sobre sistemas de misión crítica](#sessionid-64820)
10:00:00|Dave Rendon|Administración 01|[Protect your applications from SQL injections, cross site scripting](#sessionid-64849)
10:00:00|Rolando Lopez|Administración 03|[Software Asessment Manager.. El Famoso SAM](#sessionid-66046)
11:00:00|Vladimir Medina|BI 02|[PowerApps, Flow, Office 365 y su integración con SQL](#sessionid-61403)
11:00:00|Robert Davis|Administración 02|[SQLCmd Mode - The T-SQL Easy Button](#sessionid-61434)
11:00:00|Vishal Pawar|BI 01|[Power BI-Create a Dashboard from Zero to Hero](#sessionid-61552)
11:00:00|Daniel Valero|Administración 01|[Asegurar tu base de datos es ahora más fácil con SQL Server 2016](#sessionid-61801)
11:00:00|Carlos A. Ulate Hernandez|Administración 03|[Novedades en SQL Server 2016 Integration Services](#sessionid-62832)
11:00:00|Dave Walden|Administración 02|[LIVE SQL Server 2017 LINUX Availability Group buildout!](#sessionid-65137)
12:00:00|Eduardo Castro|BI 01|[Power BI creando Dashboard de forma rápida](#sessionid-63956)
12:00:00|Miguel Angel Granados|Administración 01|[Security 360 on Data Platform](#sessionid-64688)
12:00:00|Juan Alvarado|BI 02|[Como resolver el mito de "Quiero mi cubo y reporte en tiempo real"](#sessionid-64710)
12:00:00|Jesus Rodriguez Rodriguez|Administración 02|[Monitoreo y diagnostico de bases de datos SQL Server](#sessionid-64813)
12:00:00|Juan Alvarado|BI 01|[Introduccion a Data Lakes y su uso dentro de una estrategia analitica](#sessionid-65200)
12:00:00|Carmen Aguila|Administración 03|[Equipos Agiles con TaaaaLento ?](#sessionid-66273)
14:00:00|Enrique Argüelles|Administración 02|[Uso de herramientas gratuitas para el diagnostico de desempeño](#sessionid-61402)
14:00:00|Dave Walden|Administración 01|[What's so special about SQL Server 2016?](#sessionid-61457)
14:00:00|Yanitza Campos|BI 01|[Power BI, Algo mas Informacion](#sessionid-63161)
14:00:00|Marco Tulio Gómez Reyes|BI 02|[Construyendo mi primer modelo Tabular con Analysis Services](#sessionid-63479)
14:00:00|Adrian Miranda|Administración 03|[SQL Data Warehouse. Casos de uso, escalabilidad, cargas de datos](#sessionid-64643)
15:00:00|Robert Davis|Administración 02|[Performance Tuning 101: Parallelism](#sessionid-61435)
15:00:00|Jonathan Stewart|BI 02|[Performance Tuning for the BI Professional](#sessionid-61454)
15:00:00|Dave Walden|Administración 03|[Your Data, in the Cloud](#sessionid-61458)
15:00:00|Carlos A. Ulate Hernandez|Administración 01|[SQL Server on Linux](#sessionid-62834)
15:00:00|Juan Alvarado|BI 01|[Lo nuevo de power BI !!](#sessionid-64712)
16:00:00|Jonathan Stewart|BI 01|[From problem to Power BI:  A journey in data visualization](#sessionid-61453)
16:00:00|Marco Tulio Gómez Reyes|BI 02|[Introducción a Mobile Reports](#sessionid-63480)
16:00:00|Kenneth Urena|Administración 02|[Mejoras en desempeño de SQL Server con SQL Sentinel](#sessionid-64819)
16:00:00|Jesus Gil|Administración 01|[De Linux a tu BI - No Slides Full Demos](#sessionid-64965)
16:00:00|Jesus Dominguez|Administración 03|[Soluciones de Analítica Avanzada con Microsoft](#sessionid-66426)
#  
#### SessionID: 61404
# Explore SharePoint 2016 and beyond
#### [Back to calendar](#SQLSaturday-#633-Mexico-2017)
...
#  
#### SessionID: 66426
# Soluciones de Analítica Avanzada con Microsoft
#### [Back to calendar](#SQLSaturday-#633-Mexico-2017)
Event Date: 03-06-2017 - Session time: 16:00:00 - Track: Administración 03
