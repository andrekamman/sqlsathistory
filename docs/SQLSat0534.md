...
---|---|---|---
08:30:00|Pawel Potasinski|BI Platform Architecture, Development  Administration|[(PL) Think Mobile! Mobile Reporting with Microsoft Data Platform](#sessionid:-53900)
10:30:00|Uwe Ricken|Enterprise Database Administration  Deployment|[(EN) Demystifying clustered indexes](#sessionid:-47718)
10:30:00|Agnieszka Cieplak|Enterprise Database Administration  Deployment|[(PL) Rozwiązywanie problemów i optym. SQL Server przy użyciu Data Collect](#sessionid:-52912)
10:30:00|André Melancia|Enterprise Database Administration  Deployment|[(EN) NSA Secrets - Hacking SQL Server](#sessionid:-53109)
11:45:00|Cédric Charlier|BI Platform Architecture, Development  Administration|[(EN) Automating the testing of your BI solutions with NBi](#sessionid:-47604)
11:45:00|Lord Richard Douglas|Enterprise Database Administration  Deployment|[(EN) Natural Born Killers, Performance Issues to Avoid](#sessionid:-50377)
11:45:00|Michał Janiec|Enterprise Database Administration  Deployment|[(PL) Optymalizacja zapytań opartych o linked servery](#sessionid:-53569)
13:45:00|Satya Jayanty|Enterprise Database Administration  Deployment|[(EN)Upgrade, upgrade  more upgrade -know about SQL Server platform upgrade](#sessionid:-48864)
13:45:00|Marcin Szeliga|Advanced Analysis Techniques|[(EN) Microsoft R Server](#sessionid:-53324)
13:45:00|Neil Hambly|Enterprise Database Administration  Deployment|[(EN) Effective Index Partitioning, Compression Strategy](#sessionid:-53327)
13:45:00|Bartosz Ratajczyk|Application  Database Development|[(PL) How minimal logging can help me?](#sessionid:-53467)
15:00:00|Regis Baccaro|Enterprise Database Administration  Deployment|[(EN) Continuous Integration with SSDT and Team Foundation Server](#sessionid:-51153)
15:00:00|Sergiy Lunyakin|BI Platform Architecture, Development  Administration|[(EN) Azure SQL Data Warehouse: Deep Dive](#sessionid:-52268)
15:00:00|Denis Reznik|Application  Database Development|[(EN) Hidden gems of SQL Server 2014](#sessionid:-53291)
16:15:00|Andrzej Pilacik|Enterprise Database Administration  Deployment|[(PL) Refresh a 1TB+ database in under 10 seconds](#sessionid:-48103)
16:15:00|Grzegorz Stolecki|BI Platform Architecture, Development  Administration|[(PL) Diving into hyperspace - how to make better OLAP calculation](#sessionid:-52390)
17:30:00|Damian Widera|Application  Database Development|[(PL) Travelling in time with SQL Server 2016](#sessionid:-53200)
17:30:00|Mikael Wedham|Enterprise Database Administration  Deployment|[(EN) When good pages go bad / The rise and fall of db corruption.](#sessionid:-53525)
17:30:00|Hubert Kobierzewski|BI Information Delivery|[(PL) SQL Server talks Hadoop](#sessionid:-53625)
#  
#### SessionID: 53900
