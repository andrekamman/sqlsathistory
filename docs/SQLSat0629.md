...
---|---|---|---
08:00:00|Vladimir Oselsky|Application  Database Development|[Crash Course on Better SQL Development](#sessionid-61091)
08:00:00|Sean Werick|Application  Database Development|[SQL Server 2016: Data Masking and Encryption](#sessionid-61095)
08:00:00|Kevin Feasel|Enterprise Database Administration  Deployment|[Securing SQL Server](#sessionid-61244)
08:00:00|Drew Furgiuele|Application  Database Development|[SQL Server and PowerShell: Let's Get Serious](#sessionid-61272)
08:00:00|Dave Mattingly|Cloud Application Development  Deployment|[Alexa, Talk to Me](#sessionid-63151)
08:00:00|Dave Bland|Enterprise Database Administration  Deployment|[Extended Events: What are they and How do I use them](#sessionid-63332)
08:00:00|Britton Gray|BI Platform Architecture, Development  Administration|[MPP – Master Parallel Productivity in Azure SQL DW](#sessionid-63688)
08:00:00|Martin Madsen|Analytics and Visualization|[An Adventure Works IoT Demo: moving beyond sales data](#sessionid-65806)
08:00:00|Stan Siranovich|Analytics and Visualization|[SQL into R: an Absolute Beginners' Guide to R for the SQL User](#sessionid-66527)
08:00:00|Warren Sifre|SQL Starter Track|[Introduction to Big Data](#sessionid-66987)
09:15:00|Ross LoForte|Enterprise Database Administration  Deployment|[Find out why SQL Server 2016 Service Pack 1 is an Industry Game changer](#sessionid-61116)
09:15:00|Frank Gill|Strategy and Architecture|[Anatomy of a Transaction](#sessionid-61616)
09:15:00|Warren Sifre|Cloud Application Development  Deployment|[Introduction to Azure Streaming Analytics](#sessionid-62934)
09:15:00|Ben Miller|Enterprise Database Administration  Deployment|[Managing Availability Groups with PowerShell](#sessionid-64099)
09:15:00|David Mellinger|BI Platform Architecture, Development  Administration|[SQL Server 2017 New BI Features](#sessionid-65313)
09:15:00|Brandon Lukes|Enterprise Database Administration  Deployment|[SSMS Tips and Tricks](#sessionid-66713)
09:15:00|Alan Dykes|Analytics and Visualization|[Getting Started with R and R Services](#sessionid-66758)
09:15:00|Pat Phelan|Professional Development|[Ethics, Morals, and Laws for the DBA 101](#sessionid-66762)
09:15:00|David Maxwell|SQL Starter Track|[Introduction to Database Administration](#sessionid-66989)
10:30:00|Ed Watson|BI Platform Architecture, Development  Administration|[Introduction to SQL Server Integration Services](#sessionid-61145)
10:30:00|Wylie Blanchard|BI Information Delivery|[MS SSAS  Business Value: Should I choose Tabular or Multidimensional?](#sessionid-61163)
10:30:00|Aaron Cutshall|Strategy and Architecture|[Introduction to Relational Database Design Patterns](#sessionid-61520)
10:30:00|Samir Behara|Application  Database Development|[Increase Your Coding Speed in SQL Server Management Studio](#sessionid-61543)
10:30:00|Peter Shore|Cloud Application Development  Deployment|[SELECT Provider FROM Cloud](#sessionid-62850)
10:30:00|Ben Miller|Enterprise Database Administration  Deployment|[SQL Server Encryption](#sessionid-64100)
10:30:00|David Maxwell|Application  Database Development|[Handling Temporal Data in SQL Server 2016](#sessionid-64290)
10:30:00|Tamera Clark|Enterprise Database Administration  Deployment|[Reduce your DBA ( DEV) task list by using Microsoft BI tools](#sessionid-66146)
10:30:00|Robert Verell|Strategy and Architecture|[Right-Size Your Data Files](#sessionid-66771)
10:30:00|Stan Siranovich|SQL Starter Track|[Introduction to Data Science](#sessionid-66988)
10:30:00|Sean Werick|SQL Starter Track|[Introduction to Data Science](#sessionid-68730)
11:45:00|Matt Henderson|Other|[Architecting for Performance](#sessionid-68617)
13:00:00|Jonathan Stewart|Analytics and Visualization|[Data Visualization:  How to truly tell a great story!](#sessionid-61125)
13:00:00|Armando Lacerda|Enterprise Database Administration  Deployment|[Unleashing Stretched Databases](#sessionid-63873)
13:00:00|Amber Goins|Professional Development|[Using SQL as the Key to Robust Automation](#sessionid-63917)
13:00:00|Wendy Pastrick|Application  Database Development|[Read Dirty to Me - Isolation Levels/User Impact](#sessionid-64081)
13:00:00|Stacy Hein|Strategy and Architecture|[Installing SQL Server on Linux in AWS](#sessionid-64094)
13:00:00|Robert Verell|Application  Database Development|[SQL Election: Which Tech is Faster?](#sessionid-66770)
13:00:00|Kerry Tyler|BI Platform Architecture, Development  Administration|[45 Minutes to Your First SSAS Tabular Model](#sessionid-66782)
13:00:00|Ed Leighton-Dick|Enterprise Database Administration  Deployment|[How to Keep Your Databases Secure in Just Minutes a Day](#sessionid-66784)
13:00:00|Aaron King|SQL Starter Track|[Introduction to Database Development](#sessionid-66990)
13:00:00|Peter Shore|Enterprise Database Administration  Deployment|[The Data-Professional’s Junk Drawer](#sessionid-68850)
13:00:00|Alan Dykes|Other|[Game of Thrones Discussion](#sessionid-68857)
14:15:00|Denis McDowell|Application  Database Development|[Stop Ignoring the SQL Server Resource Governor](#sessionid-61199)
14:15:00|Greg Deckler|Advanced Analysis Techniques|[It's a Machine World - Predictive Analytics with Azure Machine Learning](#sessionid-62928)
14:15:00|Shannon Lowder|BI Platform Architecture, Development  Administration|[Advanced Biml Concepts](#sessionid-63492)
14:15:00|Tracy Boggiano|Enterprise Database Administration  Deployment|[Query Store Primer](#sessionid-63944)
14:15:00|Stacia Varga|Analytics and Visualization|[Getting Your Story Straight with Data Visualizations](#sessionid-64281)
14:15:00|Andrew Loree|Enterprise Database Administration  Deployment|[SQL Server 2017 (Linux and Beyond)](#sessionid-64421)
14:15:00|Dan (Annie) Xu|BI Information Delivery|[From SQL to DAX – another way of extract data](#sessionid-66015)
14:15:00|Jay Robinson|Application  Database Development|[Partitioned Tables and Query Performance](#sessionid-66773)
14:15:00|Kerry Tyler|SQL Starter Track|[Introduction to Business Intelligence](#sessionid-66991)
14:15:00|Eddie Wuerch|Enterprise Database Administration  Deployment|[Never Lose Data! Digging Out From Corruption](#sessionid-68794)
15:30:00|Brian Beswick|BI Platform Architecture, Development  Administration|[SSAS 2016 Tabular - Diving into the new features](#sessionid-62871)
15:30:00|Ryan Wade|Advanced Analysis Techniques|[Leveraging SQL Server R Services to Perform Advanced Analytics](#sessionid-63669)
15:30:00|Stacia Varga|Analytics and Visualization|[Where Does R Fit Into Your SQL Server Stack?](#sessionid-64280)
15:30:00|Rob Volk|Application  Database Development|[Tame Your Unruly Data With Constraints](#sessionid-64405)
15:30:00|Chris Koester|BI Platform Architecture, Development  Administration|[Working with JSON in SQL Server 2016](#sessionid-66651)
15:30:00|Joe McTaggart|Strategy and Architecture|[Availablity Groups in SQL 2016 and beyond: Faster, Higher, Stronger](#sessionid-66777)
15:30:00|Gareth Swanepoel|BI Platform Architecture, Development  Administration|[SQL Server ColumnStore Indexes](#sessionid-67070)
15:30:00|Armando Lacerda|Enterprise Database Administration  Deployment|[SQL Server Tricks for Storage and I/O Performance in the cloud](#sessionid-67691)
15:30:00|John Deardurff|SQL Starter Track|[How to get Microsoft Certified](#sessionid-67694)
#  
#### SessionID: 61091
