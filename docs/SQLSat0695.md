...
---|---|---|---
09:00:00|Marco Tulio Gómez Reyes|Information Delivery|[Power BI Report Server](#sessionid:-70440)
09:00:00|Yanitza Campos|Analytics and Visualization|[Introducción a Reporting Services 2017](#sessionid:-70508)
09:00:00|Carlos A. Ulate Hernandez|Application  Database Development|[SQL Server on Linux](#sessionid:-70509)
09:00:00|Keneth Murillo|Application  Database Development|[Working with Mobile Databases](#sessionid:-71409)
09:00:00|Jesus Gil|Enterprise Database Administration  Deployment|[Dr Rudo SQL presenta: Administra SQL Server 2017](#sessionid:-72401)
09:00:00|Victor Hugo Cardenas|Advanced Analysis Techniques|[Machine Learning para principiantes](#sessionid:-72951)
10:00:00|Christian Melendez|Cloud Application Development  Deployment|[Integracion y Entrega Continua con Docker para SQL Server](#sessionid:-69571)
10:00:00|Eduardo Castro|Analytics and Visualization|[Data Analytics con Python en SQL Server 2017](#sessionid:-69573)
10:00:00|Carlos Robles|Enterprise Database Administration  Deployment|[SQL Server Health check](#sessionid:-69834)
10:00:00|Ricardo Estrada|Analytics and Visualization|[Introducción a SQL Graph Databases](#sessionid:-71309)
10:00:00|Javier Loria|Application  Database Development|[Una luz dentro del mundo oculto de las estadísticas de SQL Server](#sessionid:-72571)
10:00:00|Ahias Portillo|Application  Database Development|[Mas rápido y Mas Furioso: Windowing Functions  Columnstore Indexes](#sessionid:-73739)
11:00:00|Adrian Miranda|Enterprise Database Administration  Deployment|[Como resolver problemas de rendimiento con SQL Server 2016](#sessionid:-68954)
11:00:00|Christian Araujo|Enterprise Database Administration  Deployment|[Implementing Row Level security](#sessionid:-69640)
11:00:00|José Villalta|Strategy and Architecture|[Mejores practicas para instalación de motores SQL Server](#sessionid:-69967)
11:00:00|Juan Alvarado|BI Information Delivery|[Tips and tricks de Power BI](#sessionid:-72378)
11:00:00|Javier Loria|BI Platform Architecture, Development  Administration|[Trucos de T-SQL que deberias estar usando en tu Datawarehouse](#sessionid:-72574)
11:00:00|Alexander Ortiz|Enterprise Database Administration  Deployment|[Advanced Performance Diagnostics in SQL Server](#sessionid:-72987)
12:00:00|Kenneth Urena|BI Platform Architecture, Development  Administration|[SQL Server 2016 - Mejorando el desempeño de consultas de análisis sobre sistemas de misión crítica](#sessionid:-69177)
12:00:00|Alejandro Cordero|Enterprise Database Administration  Deployment|[SQL Server 2017 Automatic Tuning](#sessionid:-69483)
12:00:00|Marco Tulio Gómez Reyes|BI Information Delivery|[Introducción a Data Analysis Expressions (DAX)](#sessionid:-69577)
12:00:00|Esdras Salazar|Professional Development|[New times, new business, new generations.  Training new (and old) members of your team.](#sessionid:-69920)
12:00:00|Luis Angel Dionicio Kuri|BI Information Delivery|[Necesitamos BI, ¡utilicemos la nube! (Azure SQL Database - Azure Analysis Services - Power BI)](#sessionid:-70452)
12:00:00|Vladimir Guzman|Application  Database Development|[La historia debe contarse como es......SQL Temporal Tables](#sessionid:-70596)
12:00:00|Jesus Gil|Analytics and Visualization|[Como hacer un  PowerBI DBA Dashboard](#sessionid:-72402)
14:15:00|Adrian Miranda|Enterprise Database Administration  Deployment|[Troubleshooting SQL Server](#sessionid:-68953)
14:15:00|Kenneth Urena|BI Platform Architecture, Development  Administration|[SQL 2016 - Diseñando mi datawarehouse "Disaster recovery ready"](#sessionid:-69175)
14:15:00|Carlos Robles|Advanced Analysis Techniques|[Advance SQL Server troubleshooting with DMVs](#sessionid:-69835)
14:15:00|José Villalta|Strategy and Architecture|[Monitoreando el performance del motor SQL con el Performance Dashboard Reports de Microsoft.](#sessionid:-69971)
14:15:00|Yanitza Campos|Analytics and Visualization|[La era de los Reportes Móviles](#sessionid:-70542)
14:15:00|Julio Enrique Urriola Barra|Other|[Big Bang SQL Server 2017](#sessionid:-70594)
15:15:00|Eduardo Castro|Analytics and Visualization|[Introduccion al Machine Learning Server](#sessionid:-69855)
15:15:00|Ahias Portillo|BI Platform Architecture, Development  Administration|[Delivering a Data Warehouse in the Cloud](#sessionid:-70358)
15:15:00|Keneth Murillo|Analytics and Visualization|[Working with Text Analytics](#sessionid:-70405)
15:15:00|Carlos A. Ulate Hernandez|BI Platform Architecture, Development  Administration|[Reporting Services Administration Tips](#sessionid:-70511)
15:15:00|Alejandro Cordero|BI Platform Architecture, Development  Administration|[AWS RedShift vs MS Azure Data Warehouse](#sessionid:-72526)
#  
#### SessionID: 70440
# Power BI Report Server
#### [Back to calendar](#SQLSaturday-#695---Guatemala-2018)
...
#  
#### SessionID: 69855
# Introduccion al Machine Learning Server
#### [Back to calendar](#SQLSaturday-#695---Guatemala-2018)
Event Date: 03-02-2018 - Session time: 15:15:00 - Track: Analytics and Visualization
## Speaker: Eduardo Castro
...
#  
#### SessionID: 72526
# AWS RedShift vs MS Azure Data Warehouse
#### [Back to calendar](#SQLSaturday-#695---Guatemala-2018)
Event Date: 03-02-2018 - Session time: 15:15:00 - Track: BI Platform Architecture, Development  Administration
## Speaker: Alejandro Cordero
