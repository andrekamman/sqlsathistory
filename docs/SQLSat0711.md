...
---|---|---|---
10:00:00|Sergiy Lunyakin|BI Information Delivery|[Get data insights faster with Data Wrangling](#sessionid-73695)
10:00:00|Mihail Mateev|Strategy and Architecture|[Choosing the Right Database for Microservices Solutions](#sessionid-73859)
10:00:00|Pavel Malek|Application  Database Development|[Score a (row) goal and beat a query optimizer](#sessionid-77687)
10:00:00|André Melancia|Analytics and Visualization|[If a machine can learn, why can't YOU learn Azure Machine Learning?](#sessionid-80233)
11:10:00|Boriana Petrova|BI Platform Architecture, Development  Administration|[Real solution using PowerBI](#sessionid-70381)
11:10:00|Andrey Nikolov|Application  Database Development|[The hidden power of Power BI or what we can do using Power BI REST API](#sessionid-73896)
11:10:00|Janusz Rokicki|Cloud Application Development  Deployment|[The Road to Autonomous Databases](#sessionid-77592)
11:10:00|Catalin Gheorghiu|Cloud Application Development  Deployment|[“SQL-like” or query languages in Azure IoT](#sessionid-80229)
12:50:00|Ust Oldfield|BI Platform Architecture, Development  Administration|[Tabular Automation With TMSL and PowerShell](#sessionid-73937)
12:50:00|Margarita Naumova|Application  Database Development|[Query tuning when indexes cannot help](#sessionid-80040)
12:50:00|Sergey Prokofiev|Cloud Application Development  Deployment|[Moving eLearning system to the cloud](#sessionid-82108)
14:00:00|Matt Willis|Analytics and Visualization|[The Maths behind Machine Learning](#sessionid-75833)
14:00:00|Arnie Rowland|Application  Database Development|[RC, SI, and RCSI -It's So Confusing. Which Should You Use?](#sessionid-78883)
14:00:00|Cédric Charlier|Analytics and Visualization|[Building a data connector for Power BI](#sessionid-80238)
15:10:00|Jose Mendes|Cloud Application Development  Deployment|[Chatbots for Dummies](#sessionid-71569)
15:10:00|Ivan Donev|Application  Database Development|[SQL Server statistics - quick and dirty deep dive](#sessionid-74279)
15:10:00|Todor Matev|Application  Database Development|[How do SQL DB projects support DB scheme and help you make weekly or daily releases?](#sessionid-82080)
16:20:00|Jose Manuel Jurado Diaz|Cloud Application Development  Deployment|[Back to the future - Migrating our SQL Server OnPremise Database to Azure](#sessionid-71688)
16:20:00|Radoslav Gatev|Cloud Application Development  Deployment|[Bringing DevOps to your database](#sessionid-74243)
16:20:00|Rozalina Zaharieva|Enterprise Database Administration  Deployment|[SQL Server on Linux –  from 0 to 100 in 1 hour!](#sessionid-80199)
17:30:00|David Postlethwaite|Application  Database Development|[Taming the Beast – How a SQL DBA can keep Kerberos under control](#sessionid-73120)
17:30:00|Ventsy Popov|Application  Database Development|[Service Fabric Reliable Collection - Lessons Learned](#sessionid-82239)
17:30:00|Ivan Pavlov|Other|[Deep Learning with Keras, Microsoft R Open, and VS – A Practical Introduction](#sessionid-82513)
#  
#### SessionID: 73695
# Get data insights faster with Data Wrangling
#### [Back to calendar](#SQLSaturday-#711-Plovdiv-2018)
