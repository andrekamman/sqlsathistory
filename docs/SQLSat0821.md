...
---|---|---|---
08:30:00|Allen White|Architecture  Tools|[Find and Fix those Troublesome Queries](#sessionid-86605)
08:30:00|Andy Yun|Development|[T-SQL Tips  Tricks to Make Your Life Easier!](#sessionid-87287)
08:30:00|Julie Smith|Cloud|[Introduction to Azure Search](#sessionid-87593)
08:30:00|James Livingston|Database Monitoring  Maintenance|[Pester your SQL Servers!](#sessionid-87621)
08:30:00|Leslie Andrews|Database Design|[A Perfect Ten: The Data Model](#sessionid-87692)
08:30:00|Jess Pomfret|Database Performance - 2|[Data Compression: Squeeze Out Some Free Gains](#sessionid-87694)
08:30:00|Chris Hyde|Analytics  Visualization|[Python in SQL Server 2017](#sessionid-87704)
08:30:00|Monica Rathbun|Database Performance - 1|[Performance Tuning, Getting the Biggest Bang for Your Buck](#sessionid-87707)
09:45:00|Thomas Norman|Development|[Encrypting Data within Sql Server](#sessionid-86310)
09:45:00|Phillip Labry|Analytics  Visualization|[Why do I need Analysis Services?](#sessionid-86354)
09:45:00|Jeff Moden|Database Performance - 2|[“Black Arts” Index Maintenance #1: How the “Best Practice” Methods are Silently Killing Performance](#sessionid-86385)
09:45:00|Mike Petrak|Database Monitoring  Maintenance|[Ola Hallengren’s Free  Awesome SQL Server Maintenance Solution](#sessionid-86895)
09:45:00|Spencer Swindell|Database Design|[Applying Data Warehousing Principles](#sessionid-86962)
09:45:00|Andrew Loree|Architecture  Tools|[Azure Data Studio - The Open-Source, Cross-Platform, Cloud Database Tool for SQL](#sessionid-87022)
09:45:00|David Pless|Database Performance - 1|[Real World Report Server Performance  Scalability Strategies](#sessionid-88064)
09:45:00|John Morehouse|Cloud|[Azure Basics for the DBA](#sessionid-89663)
11:00:00|Jeff Moden|Database Performance - 2|[“Black Arts” Index Maintenance #2: Better Methods that Can Actually Prevent Fragmentation for Weeks.](#sessionid-86386)
11:00:00|Drew Furgiuele|Database Design|[SQL Server Transactional Replication: A Deeper Dive](#sessionid-86402)
11:00:00|Aaron King|Development|[Grudge Match: XML vs JSON](#sessionid-86826)
11:00:00|Eric Blinn|Database Performance - 1|[I have Indexes, but do I have the Right Indexes?](#sessionid-87150)
11:00:00|Peter Shore|Architecture  Tools|[Infrastructure for the DBA: An Introduction](#sessionid-87218)
11:00:00|Rayis Imayev|Analytics  Visualization|[Power BI with Maps: Choose Your Destination](#sessionid-87382)
11:00:00|Erin Stellato|Database Monitoring  Maintenance|[Introduction to Query Store](#sessionid-87651)
11:00:00|Tim Radney|Cloud|[An Introduction to Azure SQL Managed Instances](#sessionid-87703)
13:30:00|David Maxwell|Database Performance - 2|[Using Extended Events for Wait Stats Analysis](#sessionid-86337)
13:30:00|Dave Bland|Architecture  Tools|[Wow....there are a ton of Settings in SSMS](#sessionid-86459)
13:30:00|Eugene Meidinger|Development|[Introduction to M (a.k.a Power Query)](#sessionid-86712)
13:30:00|Jonathan Stewart|Analytics  Visualization|[Now you see it, but did you really?  Correcting visual fallacies...](#sessionid-86922)
13:30:00|Hasan Savran|Cloud|[Building Scalable, Globally Distributed Systems with Cosmos DB](#sessionid-87433)
13:30:00|Bert Wagner|Database Performance - 1|[I Want To Go Faster! An Introduction To Indexing](#sessionid-87556)
13:30:00|John Deardurff|Database Design|[A Beginners Guide to Transactions](#sessionid-87659)
13:30:00|Amy Herold|Database Monitoring  Maintenance|[PowerShell for the DBA](#sessionid-87731)
14:45:00|Kellyn Pot'Vin-Gorman|Analytics  Visualization|[Taming of the Shrew - Optimizing Power BI](#sessionid-86347)
14:45:00|Kimberly StJacques|Architecture  Tools|[Data Virtualization -  SQL Server 2019 Enhanced PolyBase](#sessionid-86513)
14:45:00|Lisa Bohm|Database Performance - 2|[The Curious Case of the Foreign Key](#sessionid-86560)
14:45:00|Lucas Feiock|Cloud|[Lambda architecture design using Azure Databricks for advanced analytics](#sessionid-87134)
14:45:00|Eric Blinn|Database Performance - 1|["Full Text indexing!" or..."What is that service I never turn on?"](#sessionid-87148)
14:45:00|Elizabeth Noble|Database Design|[Using distributed AGs for your migrations](#sessionid-87400)
14:45:00|Sourav Mukherjee|Development|[Are you following SQL Server Development Best Practices?](#sessionid-87729)
14:45:00|Ed Wagner|Database Monitoring  Maintenance|[DBA - What's Most Important](#sessionid-88063)
16:00:00|Dave Bland|Database Performance - 2|[Statistics - Why are they there and what do I do with them](#sessionid-86457)
16:00:00|Kevin Feasel|Cloud|[Getting Started with Apache Spark](#sessionid-86536)
16:00:00|Matt Gordon|Database Monitoring  Maintenance|[How to Keep Your Database Servers Out of the News](#sessionid-86644)
16:00:00|Joe Bruno|Analytics  Visualization|[Build a Simple OLAP Cube from Scratch](#sessionid-86830)
16:00:00|Peter Shore|Architecture  Tools|[The Data-Professional’s Junk Drawer](#sessionid-87217)
16:00:00|Bert Wagner|Database Performance - 1|[The Analyst’s Guide To Finding and Fixing Performance Anti-Patterns](#sessionid-87645)
16:00:00|Sam Nasr|Development|[14 T-SQL Functions You May Not Know](#sessionid-87674)
16:00:00|Ameena Lalani|Database Design|[Learn History from Temporal Tables](#sessionid-88291)
#  
#### SessionID: 86605
# Find and Fix those Troublesome Queries
#### [Back to calendar](#nr-821)
