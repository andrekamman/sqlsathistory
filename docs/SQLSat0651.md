...
---|---|---|---
08:30:00|William Assaf|Application  Database Development|[SQL Server Permissions and Security Principals](#sessionid-63544)
08:30:00|Brent Ozar|Enterprise Database Administration  Deployment|[What to Do When SQL Server is Slow](#sessionid-63546)
08:30:00|Thomas LeBlanc|BI Platform Architecture, Development  Administration|[Business Analytics in SQL Server 2016](#sessionid-63571)
08:30:00|Ryan Adams|Enterprise Database Administration  Deployment|[Install an AlwaysOn Failover Cluster and Availability Group](#sessionid-63850)
08:30:00|Phillip Labry|Cloud Application Development  Deployment|[Analysis Services is in Azure? Seriously!? Let's build a model!](#sessionid-64120)
08:30:00|Rick Lowe|Application  Database Development|[Why should I care about ... the plan cache?](#sessionid-64410)
09:45:00|Roberto Cavalcanti|Cloud Application Development  Deployment|[Azure SQL Database - Lessons learned from the trenches](#sessionid-63511)
09:45:00|Mike Byrd|Application  Database Development|[A Rocket Scientist View on Indexes](#sessionid-63549)
09:45:00|Robert Bishop|Application  Database Development|[You want me to Isolate what? An introduction into data integrity and Isolation Levels of SQL Server](#sessionid-63584)
09:45:00|Trayce Jordan|Enterprise Database Administration  Deployment|[Finding root cause for unexplained Availability Group failover](#sessionid-63589)
09:45:00|Tim Mitchell|BI Platform Architecture, Development  Administration|[Exploring the All-New SSRS 2016](#sessionid-63616)
09:45:00|Bob Ward|Enterprise Database Administration  Deployment|[Inside SQL Server Machine Learning Services: Database Intelligence at Scale](#sessionid-63726)
11:00:00|Kevin Hill|Other|[Backups for non-DBAs...the Why, not the How](#sessionid-63590)
11:00:00|Christopher Sims|Application  Database Development|[I like big data for $400  - Exploring quiz show questions using Angular, DocumentDB and Azure Search](#sessionid-63691)
11:00:00|Russel Loski|Cloud Application Development  Deployment|[Querying Semistructured Data in Azure Data Lake with USQL](#sessionid-64358)
11:00:00|David Stein|BI Platform Architecture, Development  Administration|[Agile Data Warehouse and ETL Design with Biml](#sessionid-64403)
11:00:00|Lance Tidwell|Enterprise Database Administration  Deployment|[Introduction to Execution Plans](#sessionid-64442)
11:00:00|Kris Hokanson|Application  Database Development|[Random Acts of Senseless Databasing](#sessionid-65390)
12:30:00|Brent Ozar|Enterprise Database Administration  Deployment|[Free Scripts to Troubleshoot SQL Server: sp_Blitz, sp_BlitzCache, and More](#sessionid-63550)
12:30:00|Robyn Fuentes|Application  Database Development|[DevOps for Migratory Deployments](#sessionid-65237)
13:30:00|Steven Tidwell|Application  Database Development|[Dynamic SQL: Tables, Pivots](#sessionid-63587)
13:30:00|Shawn Weisfeld|Cloud Application Development  Deployment|[Intro to Azure SQL Data Warehouse](#sessionid-63588)
13:30:00|Jennifer McCown|Application  Database Development|[Beginning T-SQL](#sessionid-63778)
13:30:00|Vicky Harp|Enterprise Database Administration  Deployment|[Introduction to SQL 2016 Temporal Tables](#sessionid-64022)
13:30:00|Robert Stewart|BI Platform Architecture, Development  Administration|[Data Warehousing 101](#sessionid-64178)
13:30:00|Amy Herold|Enterprise Database Administration  Deployment|[Deadlock, Block  Two Smoking Barrels: Breaking Down Blocking and Deadlocks](#sessionid-64337)
14:45:00|Bob Ward|Enterprise Database Administration  Deployment|[Inside SQL Server In-Memory OLTP](#sessionid-63725)
14:45:00|John Cook|Application  Database Development|[SQL Server Graph Database](#sessionid-63797)
14:45:00|Dane Schilling|Application  Database Development|[MS SQL - Review, Renew, and Reveal](#sessionid-63816)
14:45:00|Lori Edwards|Professional Development|[Do More Than Just Talk](#sessionid-64328)
14:45:00|John Harp|Enterprise Database Administration  Deployment|[Crappy Queries: A Beginner's Guide to Hunting in the Field](#sessionid-64346)
14:45:00|Chris Hyde|BI Platform Architecture, Development  Administration|[Python in SQL Server 2017](#sessionid-65108)
16:00:00|Naomi Williams|Enterprise Database Administration  Deployment|[SQL Server Internals](#sessionid-63514)
16:00:00|Thomas Norman|Application  Database Development|[Database Project Makes Deployment Consistent](#sessionid-63529)
16:00:00|Jamey Johnston|BI Platform Architecture, Development  Administration|[Code Like a Pirate ... Intro to R and Data Science Tools in MS](#sessionid-63723)
16:00:00|Sean McCown|Enterprise Database Administration  Deployment|[Loading SQL Server Data with Powershell](#sessionid-63782)
16:00:00|John Sterrett|Enterprise Database Administration  Deployment|[Table Partitioning: the Secret Weapon for Your Big Data Problems](#sessionid-64259)
16:00:00|Anthony {Tex} Moreign|Cloud Application Development  Deployment|[Big|Small|Tiny Data  +  The Hybrid Cloud](#sessionid-64365)
#  
#### SessionID: 63544
