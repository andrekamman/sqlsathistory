...
---|---|---|---
09:00:00|Anthony Nocentino|Application  Database Development|[Kubernetes Zero to Hero - Installation, Configuration, and Applic](#sessionid-97978)
09:00:00|Kendra Little|Enterprise Database Administration  Deployment|[How to Architect Successful Database Changes: Source Control and](#sessionid-97979)
09:00:00|Ginger Grant|Analytics and Visualization|[Getting Started with Data Science and Databricks](#sessionid-98238)
09:00:00|Ganesh Lohani|Analytics and Visualization|[Data Science 101: An Introduction to Data Science Using Python](#sessionid-95360)
09:00:00|Kellyn Pot'Vin-Gorman|Enterprise Database Administration  Deployment|[Empowering the SQL Server Professional with Linux Scripting- 60 min.](#sessionid-95490)
09:00:00|Steve Wake|BI Information Delivery|[Power BI Premium: Is it for Your Company (and Worth It)?](#sessionid-95967)
09:00:00|Paul Paiva|Professional Development|[Consulting/contracting - is it right for me?](#sessionid-96350)
09:00:00|Eric Peterson|Strategy and Architecture|[SQL and MongoDB: When Two Worlds Collide](#sessionid-96805)
09:00:00|Gabriel Villa|Analytics and Visualization|[Analytics on AWS](#sessionid-96821)
09:00:00|Jason Brimhall|Advanced Analysis Techniques|[Anatomy of Select](#sessionid-99061)
09:00:00|Marc Beacom|BI Platform Architecture, Development  Administration|[ETL Best Practices and Techniques](#sessionid-99151)
10:15:00|Carlos Robles|Cloud Application Development  Deployment|[Working with SQL Server containers to build database solutions](#sessionid-95498)
10:15:00|Glenn Berry|Enterprise Database Administration  Deployment|[Dr. DMV's Troubleshooting Toolkit](#sessionid-96059)
10:15:00|Ted Stathakis|BI Platform Architecture, Development  Administration|[Reporting Services: A Smart Migration Strategy](#sessionid-96101)
10:15:00|Yuliya Quintela|Cloud Application Development  Deployment|[Building Big Data Analytics solutions with Azure Databricks](#sessionid-96878)
10:15:00|Kendra Little|Enterprise Database Administration  Deployment|[An Introduction to Versioning and Branching Database Code in Git](#sessionid-97973)
10:15:00|Phillip Labry|Application  Database Development|[Assimilating Microsoft Access -- Upsizing to SQL Server](#sessionid-97988)
10:15:00|Richard Waymire|Cloud Application Development  Deployment|[Running SQL Server on AWS](#sessionid-98983)
10:15:00|Ginger Grant|Advanced Analysis Techniques|[Revealing the Differences in Azure Machine Learning Products](#sessionid-99119)
12:45:00|Mark Moore|Information Delivery|[Demystifying SQL in Azure](#sessionid-95594)
12:45:00|Kara Annanie|Analytics and Visualization|[Machine Learning in Azure Databricks](#sessionid-95646)
12:45:00|Steve Jones|Application  Database Development|[The Future of Database Development with Containers](#sessionid-95989)
12:45:00|Meagan Longoria|BI Platform Architecture, Development  Administration|[Moving and Transforming Your Data with Azure Data Factory V2](#sessionid-96406)
12:45:00|Manguirish Sardessai|Cloud Application Development  Deployment|[SQL Server Migration to the AWS: Approach and Methodology](#sessionid-96410)
12:45:00|Scot Reagin|BI Platform Architecture, Development  Administration|[Azure Analysis Services – Multidimensional solutions in the cloud](#sessionid-96526)
12:45:00|TJay Belt|Enterprise Database Administration  Deployment|[Power BI, from a DBA's Perspective](#sessionid-96625)
12:45:00|Todd Kleinhans|Enterprise Database Administration  Deployment|[Storing Images in a Database - Tips and Techniques](#sessionid-98042)
14:00:00|Aaron Cutshall|Application  Database Development|[Tally Ho! -- Explore the Varied Uses of Tally Tables](#sessionid-95643)
14:00:00|Steve Wake|BI Information Delivery|[Data Modeling and Prototyping in Power BI Desktop](#sessionid-95966)
14:00:00|Glenn Berry|Enterprise Database Administration  Deployment|[High Availability/Disaster Recovery 101](#sessionid-96061)
14:00:00|Susantha Bathige|Cloud Application Development  Deployment|[SQL Server on Kubernetes](#sessionid-96305)
14:00:00|Marc Beacom|Analytics and Visualization|[Translating your Excel Skills to Power BI](#sessionid-96677)
14:00:00|Leslie Weed|BI Platform Architecture, Development  Administration|[Innovative Data Modeling: Make Data Warehousing Cool Again Part 1](#sessionid-96774)
14:00:00|Carlos Bossy|Information Delivery|[Operationalize Data Science for Advanced Decision Support](#sessionid-96907)
14:00:00|Angela Tidwell|Enterprise Database Administration  Deployment|[Data Collection and Usage: Illegal or Unethical?](#sessionid-98046)
14:00:00|Rick Lowe|Application  Database Development|[Weird Stuff I Saw While … Supporting a Java Team](#sessionid-98959)
15:15:00|John Byrnes|Analytics and Visualization|[Predicting the NFL with SQL Server 2017 ML Services](#sessionid-95744)
15:15:00|Christopher Wolff|Enterprise Database Administration  Deployment|[SQL Servers on Containers](#sessionid-95950)
15:15:00|Amie Mason|Strategy and Architecture|[Preparing your Business for Data Science](#sessionid-96138)
15:15:00|Jeff Renz|BI Platform Architecture, Development  Administration|[Innovative Data Modeling: Make Data Warehousing Cool Again Part 2](#sessionid-96785)
15:15:00|Daniel Janik|Enterprise Database Administration  Deployment|[Migrating your SQL Server to the cloud: Tips and Best Practices](#sessionid-96929)
15:15:00|Anthony Nocentino|Application  Database Development|[Practical Container Scenarios in Azure](#sessionid-98157)
15:15:00|Jason Horner|Cloud Application Development  Deployment|[Azure Analytics Platform Quickstart](#sessionid-98960)
15:15:00|Kellyn Pot'Vin-Gorman|Advanced Analysis Techniques|[DevOps or Decoys](#sessionid-99174)
#  
#### SessionID: 97978
# Kubernetes Zero to Hero - Installation, Configuration, and Applic
#### [Back to calendar](#SQLSaturday-#908-Denver-2019)
