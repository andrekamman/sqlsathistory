...
---|---|---|---
00:00:00|Ben Miller|DBA 2|[SQL Server TDE](#sessionid-10230)
00:00:00|David Klee|DBA 2|[Squeezing Top Performance from Your Virtualized SQL Server](#sessionid-12527)
00:00:00|Erika Bakse|DBA 1|[Stats Across The Stack](#sessionid-13606)
00:00:00|Ed Watson|DBA 1|["So you have a performance issue.  What now?"](#sessionid-13686)
00:00:00|Jason Horner|BI|[Dimensional Modeling Design Patterns: Beyond Basics](#sessionid-15813)
00:00:00|Joseph D'Antoni|BI|[The Modern Analytics Architecture](#sessionid-16160)
00:00:00|Karen Lopez|BI|[$#*! Your Database Says About Me](#sessionid-17868)
00:00:00|Randy Knight|DBA 2|[But it worked great in Dev!  Perfomance for Devs](#sessionid-22532)
00:00:00|Reeves Smith|BI|[Increase your SSIS productivity with Biml](#sessionid-22760)
00:00:00|Russ Thomas|DBA 1|[XPath - XQuery; I guess if I HAVE to](#sessionid-23589)
00:00:00|Steve Jones|DBA 2|[The Encryption Primer](#sessionid-24529)
00:00:00|Pat Wright|BI|[Integrating SQL Server with Hadoop](#sessionid-24877)
00:00:00|Thomas LaRock|DBA 1|[Database Design: Size DOES Matter](#sessionid-25148)
00:00:00|Tamera Clark|BI|[45 min to build your first SSRS report](#sessionid-26011)
00:00:00|TJay Belt|DBA 2|[Database Monitoring : Trying To Keep Sane](#sessionid-26893)
00:00:00|Michael Fal|DBA 1|[Managing Log File Obesity](#sessionid-34792)
00:00:00|Allen White|DBA 2|[Manage SQLServer Efficiently w/PowerShell Remoting](#sessionid-9980)
#  
#### SessionID: 10230
# SQL Server TDE
