...
---|---|---|---
09:30:00|Chris Taylor|Data Platform|[Database CI/CD with Containers and Azure DevOps](#sessionid-100909)
09:30:00|Hylke Peek|Azure BI|[Common Data Service, why is it not common yet?](#sessionid-101013)
09:30:00|Nicky van Vroenhoven|Power BI|[A Form, a Flow and a Power BI Streaming Dataset Walk Into a Bar](#sessionid-101154)
09:30:00|Rune Ovlien Rakeie|Cloud Development|[Easing the pain of database migrations to the cloud - Planning, process and great tools!](#sessionid-101752)
09:30:00|Hasan Savran|Azure DB|[How does Azure Cosmos DB work under the hood?](#sessionid-107520)
10:45:00|Johan Ludvig Brattås|Azure BI|[Creating an modern data platform in the cloud](#sessionid-100922)
10:45:00|Kevin Chant|Cloud Development|[Azure DevOps duet (90 minutes version)](#sessionid-100954)
10:45:00|Uwe Ricken|Data Platform|[Analyze and solve common wait stats scenarios](#sessionid-100964)
10:45:00|Jose Manuel Jurado Diaz|Azure DB|[How to get the most from Azure SQL Database](#sessionid-102502)
10:45:00|Lorenzo Vercellati|Power BI|[Datastorytelling  Visualization Best Practices with PowerBi](#sessionid-103284)
12:00:00|John Martin|Azure DB|[Getting Started with Azure SQL Database](#sessionid-100917)
12:00:00|Daniel Otykier|Azure BI|[What's New in Tabular Editor](#sessionid-101562)
12:00:00|Asgeir Gunnarsson|Power BI|[What's Going On in My Power BI Environment?](#sessionid-101943)
12:00:00|Dave Ruijter|Data Platform|[The Battle of Modern Data Architectures: Databricks vs Synapse vs ADF](#sessionid-107537)
13:15:00|John Martin|Cloud Development|[Infrastructure as Code: An Introduction to Terraform](#sessionid-100916)
13:15:00|Erik Svensen|Power BI|[Power BI Paginated Reports - How to and why should I care](#sessionid-102871)
13:15:00|Wolfgang Strasser|Azure BI|[Continuous Integration for the BI Developer](#sessionid-107465)
13:15:00|Tariq Younas|Azure DB|[Azure SQL || SQL Server || Which one is right for me?](#sessionid-107466)
13:15:00|Markus Ehrenmueller-Jensen|Data Platform|[From SQL to R – Leverage Your T-SQL Knowledge to Learn R](#sessionid-107510)
14:30:00|Will Velida|Cloud Development|[Introduction to building Machine Learning pipelines and models using ML.NET](#sessionid-101091)
14:30:00|Dennes Torres|Azure BI|[Why Synapse Analytics is beyond Azure SQL Datawarehouse](#sessionid-101322)
14:30:00|Rob Sewell|Azure DB|[SQL Notebooks in Azure Data Studio for the DBA](#sessionid-103577)
14:30:00|Erwin De Kreuk|Data Platform|[Azure Key Vault, Azure Dev Ops and Data Factory how do these Azur](#sessionid-107523)
14:30:00|Marco Russo|Power BI|[Using calculation groups in DAX](#sessionid-107536)
15:45:00|Gethyn Ellis|Azure DB|[Top 5 Skills that a DBA will need in 2020](#sessionid-101033)
15:45:00|Simon Whiteley|Azure BI|[Advancing Databricks - Next Level ETL](#sessionid-102806)
15:45:00|Koen Verbeeck|Data Platform|[The modern Cloud Data Warehouse - Snowflake on Azure](#sessionid-107462)
15:45:00|Marc Lelijveld|Power BI|[External Tools for Power BI, how to create them!](#sessionid-107529)
15:45:00|Andreas Bergstedt|Cloud Development|[Synapse Beyond the Data Warehouse](#sessionid-107901)
#  
#### SessionID: 100909
