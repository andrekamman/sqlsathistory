...
---|---|---|---
08:30:00|John Martin|Enterprise Database Administration  Deployment|[Being a DBA - A day in the life.](#sessionid-40648)
08:30:00|Dave Ballantyne|Application  Database Development|[Query Processing  Internals](#sessionid-40925)
08:30:00|Mladen Prajdić|Application  Database Development|[SQL Server for Developers: Database is no dumping ground!](#sessionid-40926)
08:30:00|Stacia Varga|BI Platform Architecture, Development  Administration|[Building Blocks of BIML](#sessionid-40940)
08:30:00|Tobias Koprowski|Cloud Application Development  Deployment|[Windows Azure SQL Database - A Journey from Zero to be Hero](#sessionid-40941)
08:30:00|Neil Hambly|Enterprise Database Administration  Deployment|[Load Testing With SQL Server Tools](#sessionid-39217)
08:30:00|David Williams|SQL Server 2016 New Features|[SQL Server 2016 New Feaures (Not Query Store!)](#sessionid-39411)
08:30:00|Dr. Subramani Paramasivam|Cloud Application Development  Deployment|[Tired of connecting on-prem  cloud data? Take a DB stretch](#sessionid-39703)
08:30:00|Eric Lawson|BI Platform Architecture, Development  Administration|[Click  Clone - a simple model for managing data quality and scaling out ](#sessionid-39990)
08:30:00|Emanuele Zanchettin|Cloud Application Development  Deployment|[Implementing and Maintaining an Azure SQL Database project](#sessionid-40545)
08:30:00|André Melancia|Data Platform Security  Compliance|[MI6 Secrets - Data Security For Developers](#sessionid-40695)
09:45:00|Alex Whittles|BI Platform Architecture, Development  Administration|[Data Warehouse modeling, for data analysis and cubes](#sessionid-38980)
09:45:00|Lord Richard Douglas|Enterprise Database Administration  Deployment|[Understanding the Transaction Log, Your Key to Unlocking Greater Throughput](#sessionid-39250)
09:45:00|David Conlan|BI Platform Architecture, Development  Administration|[SSRS - The Dark Side: Custom Rendering](#sessionid-40489)
09:45:00|Prathy Kamasani|BI Platform Architecture, Development  Administration|[Dive into SSISDB Catalog using PowerBI](#sessionid-40524)
09:45:00|Dave Ballantyne|Application  Database Development|[Query Optimizer internals](#sessionid-40665)
11:00:00|Tobias Koprowski|Enterprise Database Administration  Deployment|[SQL Server Backup in the Era of the Cloud](#sessionid-39726)
11:00:00|Christopher Adkin|Application  Database Development|[Super Scaling Clustered Index Inserts](#sessionid-39796)
11:00:00|Mike Hillwig|Enterprise Database Administration  Deployment|[Do More With Less: Inside SQL Agent Multi-Server Administration](#sessionid-39887)
11:00:00|Annette Allen|Application  Database Development|[The What, Why and How of Unit Testing SQL Server](#sessionid-40494)
11:00:00|Simon Whiteley|BI Platform Architecture, Development  Administration|[ETL in the Clouds](#sessionid-40551)
11:00:00|André Kamman|Enterprise Database Administration  Deployment|[No stress with OSTRESS, Lessons Learned from a high traffic Replay attempt](#sessionid-40598)
13:15:00|Allan Mitchell|BI Platform Architecture, Development  Administration|[Azure DocumentDB](#sessionid-38922)
13:15:00|David Postlethwaite|Professional Development|[Beware of the Dark Side - A Guided Tour of Oracle for the SQL DBA](#sessionid-38935)
13:15:00|Mladen Prajdić|Application  Database Development|[SQL Server and Application Security for Developers](#sessionid-39021)
13:15:00|Al Eardley|Enterprise Database Administration  Deployment|[SharePoint Databases - What you need to know](#sessionid-39176)
13:15:00|Rob Sewell|Enterprise Database Administration  Deployment|[Using Power BI with my DBA Database](#sessionid-40160)
13:15:00|Niall MacLeod|Application  Database Development|[Microsoft SQL Server Data Warehouse Fast Track – Understanding th](#sessionid-41705)
14:30:00|John Tunnicliffe|BI Platform Architecture, Development  Administration|[Continuous Integration and the Data Warehouse](#sessionid-38925)
14:30:00|Andreas Bergstedt|BI Platform Architecture, Development  Administration|[10 Things that you already knew about SSIS](#sessionid-38937)
14:30:00|n/a n/a|Cloud Application Development  Deployment|[Session Details not available](#sessionid-38939)
14:30:00|Bob Duffy|Application  Database Development|[When good SQL design goes bad](#sessionid-39341)
14:30:00|Kenneth Nielsen|Application  Database Development|[SQL Server 2016 - Always Encrypted - secure your data from the prying eye](#sessionid-39366)
14:30:00|Justin Langford|Enterprise Database Administration  Deployment|[Performance troubleshooting SQL Server](#sessionid-42046)
14:30:00|John Martin|Enterprise Database Administration  Deployment|[Building  Configuring SQL Server : Recommended Practices](#sessionid-42047)
15:45:00|Stephanie Locke|Application  Database Development|[Anchor Modelling: Sixth normal form databases!](#sessionid-38929)
15:45:00|Jen Stirrup|Advanced Analysis Techniques|[What a boozy day at the Guinness factory teaches us about Analytics](#sessionid-39313)
15:45:00|Mike Hillwig|Enterprise Database Administration  Deployment|[Maintenance Plans: Planning to Fail](#sessionid-39886)
15:45:00|Alex Yates|Application  Database Development|[State-based or migrations-based database development? The pros and cons...](#sessionid-39968)
15:45:00|Stacia Varga|Cloud Application Development  Deployment|[Building a BI Solution in the Cloud ](#sessionid-40473)
15:45:00|Mike Boswell|BI Platform Architecture, Development  Administration|[Changing the face of your desktop with PowerBI](#sessionid-42045)
#  
#### SessionID: 40648
# Being a DBA - A day in the life.
#### [Back to calendar](#nr-467)
