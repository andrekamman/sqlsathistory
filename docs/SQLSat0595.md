...
---|---|---|---
08:30:00|Vladimir Oselsky|Application  Database Development|[Crash Course on Better SQL Development](#sessionid-56328)
08:30:00|Kevin Feasel|Strategy and Architecture|[Big Data, Small Data, and Everything In Between](#sessionid-56342)
08:30:00|Slava Murygin|Enterprise Database Administration  Deployment|[SQL Server on Linux for SQL DBA.](#sessionid-56937)
08:30:00|Ginger Grant|BI Information Delivery|[Power BI Administration and Best Practices Implementation Techniques](#sessionid-57151)
08:30:00|Jeremy Frye|BI Platform Architecture, Development  Administration|[SSIS Incremental Loading:  The Tortoise and The Hare](#sessionid-57311)
08:30:00|Anders Pedersen|Enterprise Database Administration  Deployment|[I/O Tuning 101](#sessionid-57499)
09:45:00|Vishal Pawar|Analytics and Visualization|[Create lightning fast Dashboard with Power BI and its Components](#sessionid-56343)
09:45:00|Matt Gordon|Enterprise Database Administration  Deployment|[Top 5 Tips to Keep Always On Always Humming and Users Happy](#sessionid-56349)
09:45:00|Delora Bradish|Strategy and Architecture|[Beyond the Basics of Multidimensional vs Tabular in SQL 2016](#sessionid-56970)
09:45:00|Dave Bland|Enterprise Database Administration  Deployment|[Extended Events: What are they and How do I use them](#sessionid-57368)
09:45:00|Eric Blinn|Application  Database Development|[SSMS Tips and Tricks](#sessionid-57450)
09:45:00|Frank Gill|Enterprise Database Administration  Deployment|[Anatomy of a Transaction](#sessionid-57770)
11:00:00|Jonathan Stewart|BI Platform Architecture, Development  Administration|[Data Visualization:  How to truly tell a great story!](#sessionid-56364)
11:00:00|Janis Griffin|Enterprise Database Administration  Deployment|[Does your performance tuning need a 12-step program?](#sessionid-56554)
11:00:00|Adam Machanic|Application  Database Development|[Don't Let History Be a Mystery! Temporal Data in SQL Server 2016](#sessionid-57337)
11:00:00|Kathi Kellenberger|Application  Database Development|[Introduction to Window Functions](#sessionid-57381)
11:00:00|Konstantin Melamud|Application  Database Development|[In-Memory OLTP for Developers: What You Need to Know](#sessionid-57391)
11:00:00|Pat Phelan|Application  Database Development|[Relational Data Architecture 101](#sessionid-57437)
13:30:00|Wylie Blanchard|BI Information Delivery|[Analyzing SQL Server Data using PowerPivot in MS Excel](#sessionid-56345)
13:30:00|Drew Furgiuele|Enterprise Database Administration  Deployment|[SQL Server Transactional Replication: A Deep Dive](#sessionid-56616)
13:30:00|David Maxwell|Enterprise Database Administration  Deployment|[Wait Statistics - The Top 5 Waits You Should Know](#sessionid-56675)
13:30:00|Aaron Cutshall|Professional Development|[How To Give a Technical Presentation](#sessionid-56677)
13:30:00|Andy Yun|Application  Database Development|[Performance Pitfalls from Code Reuse](#sessionid-57301)
13:30:00|Dustin Prescott|Enterprise Database Administration  Deployment|[Hacking SQL Server - A Peek into the Dark Side](#sessionid-57510)
14:45:00|William E Pearson III|BI Platform Architecture, Development  Administration|[Seeking the Perfect Hybrid:  On-Prem Data with Reports and Dashboards in Power BI](#sessionid-56378)
14:45:00|Eugene Meidinger|Application  Database Development|[Execution Plans 101](#sessionid-56487)
14:45:00|Greg Deckler|Advanced Analysis Techniques|[It's a Machine World - Predictive Analytics with Azure Machine Learning](#sessionid-56629)
14:45:00|Thomas Chan|Enterprise Database Administration  Deployment|[Secure/Encrypt SQL Server Database With TDE](#sessionid-57487)
14:45:00|Erin Stellato|Enterprise Database Administration  Deployment|[Ensuring Plan Stability with Query Store](#sessionid-57497)
14:45:00|Frank Gill|Cloud Application Development  Deployment|[Creating an Azure SQL Database Using PowerShell](#sessionid-57771)
16:15:00|Michael Schulte|Analytics and Visualization|[Extending SQL Server with Advanced Analytics and R](#sessionid-56354)
16:15:00|Jared Karney|Application  Database Development|[Introduction to Indexes and SARGability](#sessionid-56460)
16:15:00|Wendy Pastrick|Application  Database Development|[Why NULL is not a value (and other SQL gotchas)](#sessionid-56523)
16:15:00|Rick Lowe|Enterprise Database Administration  Deployment|[Why should I care about ... the plan cache?](#sessionid-57469)
16:15:00|Andy Mallon|Application  Database Development|[Demystifying Data Compression](#sessionid-57511)
16:15:00|Peter Shore|Enterprise Database Administration  Deployment|[Got stress?  Sometimes the SQL Server needs some too](#sessionid-57533)
#  
#### SessionID: 56328
