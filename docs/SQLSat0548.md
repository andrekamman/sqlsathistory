...
---|---|---|---
08:30:00|Janis Griffin|Enterprise Database Administration  Deployment|[Top 10 Wait Types Everyone Should Know](#sessionid-49102)
08:30:00|Andy Galbraith|Enterprise Database Administration  Deployment|[Does it Hurt When I Do This? Performing a SQL Server Health Check](#sessionid-49229)
08:30:00|Chris Hyde|Advanced Analysis Techniques|[SQL Server R Services in SQL 2016](#sessionid-49655)
08:30:00|Steve Wake|BI Information Delivery|[Mobile, Paginated, KPIs and Power BI, Oh My! SSRS 2016 Reporting](#sessionid-50076)
08:30:00|Ben Weissman|Biml|[Biml: Your 3D Printer for SSIS](#sessionid-53116)
08:30:00|George Bryant|BI Platform Architecture, Development  Administration|[So this is Power BI. What now?](#sessionid-53123)
08:30:00|Carlos L Chacon|Enterprise Database Administration  Deployment|[Disaster Recovery  From On Premises to Azure](#sessionid-53232)
08:30:00|Frank Kearney|BI Information Delivery|[Near real time analytics with Azure Stream Analytics](#sessionid-53308)
10:00:00|Erica Woods|Professional Development|[Shaping Your Process to Hire Top Talent](#sessionid-49029)
10:00:00|Ameena Lalani|Enterprise Database Administration  Deployment|[What is new in SQL Server 2016 for DBAs?](#sessionid-52499)
10:00:00|William E Pearson III|BI Platform Architecture, Development  Administration|[Pragmatic Power BI:  Transforming Data](#sessionid-52676)
10:00:00|Cher Fox|Other|[Test Automation: Agile Enablement for DW and BI Teams](#sessionid-52727)
10:00:00|Melody Zacharias|BI Information Delivery|[Introduction to Microsoft Analytics – Turning Data into Intelligent Action](#sessionid-52936)
10:00:00|Ben Weissman|Biml|[Biml: I got the basics - what's next?](#sessionid-53117)
10:00:00|John Morehouse|Enterprise Database Administration  Deployment|[SQL Server Databaseology: A Deep Dive Into Database Internals](#sessionid-53165)
10:00:00|Wylie Blanchard|Analytics and Visualization|[Analyze  Visualize SQL Server Data w/ PowerPivot, PowerView  Excel](#sessionid-54387)
12:45:00|Kevin Feasel|Biml|[Data Migration Using BIML](#sessionid-49038)
12:45:00|Chase Aucoin|Application  Database Development|[Microdata For Microservices](#sessionid-50279)
12:45:00|Rie Irish|Professional Development|[WIT: Identifying, Understanding and Combating Gender Bias](#sessionid-51212)
12:45:00|Bill Graziano|Strategy and Architecture|[Building a Modern Transaction System on SQL Server](#sessionid-52597)
12:45:00|Adam Koehler|Enterprise Database Administration  Deployment|[Isolation Levels – Understanding Transaction Temper Tantrums](#sessionid-52883)
12:45:00|Jeremy Marx|BI Platform Architecture, Development  Administration|[Introduction to BIML and BimlScript](#sessionid-53000)
12:45:00|Bill Fellows|Biml|[An Architect's Strategy for Consistent SSIS with SQL Server 2016](#sessionid-53167)
12:45:00|Chuck Hieber|Other|[SQL Server Tips and Tricks from a lazy DBA](#sessionid-53314)
14:15:00|Monica Rathbun|Professional Development|[I’m It – Survival Techniques for the Lone DBA](#sessionid-49099)
14:15:00|Kathi Kellenberger|Enterprise Database Administration  Deployment|[Kerberos Delegation Made Simple](#sessionid-49145)
14:15:00|David Maxwell|Enterprise Database Administration  Deployment|[Turbo Charged Transaction Logs - Internals and Performance](#sessionid-49408)
14:15:00|Brian Beswick|BI Platform Architecture, Development  Administration|[SSAS 2016 Tabular - Diving into the new features](#sessionid-50001)
14:15:00|Daniel Maenle|Application  Database Development|[Lock, Block, and Two Smoking CPUs](#sessionid-52670)
14:15:00|Brian Hansen|Enterprise Database Administration  Deployment|[Get Your Optimizer to Give up All Its Secrets](#sessionid-53269)
14:15:00|Pierre LaFromboise|BI Platform Architecture, Development  Administration|[Understanding Azure SQL Data Warehouse](#sessionid-53303)
14:15:00|Scott Currie|Biml|[Incrementally Moving to the Cloud Using Biml](#sessionid-53339)
15:45:00|Wendy Pastrick|Enterprise Database Administration  Deployment|[Using SQL Nexus for system health](#sessionid-49026)
15:45:00|Ben DeBow|Professional Development|[Troubleshooting Skills for the DBA](#sessionid-50697)
15:45:00|Michael Fal|Enterprise Database Administration  Deployment|[Powershell Jumpstart for SQL Server DBAs](#sessionid-52513)
15:45:00|Rob Volk|Enterprise Database Administration  Deployment|[Revenge: The SQL!](#sessionid-52995)
15:45:00|Ed Leighton-Dick|Application  Database Development|[Understanding SQL Server 2016 Always Encrypted](#sessionid-53017)
15:45:00|Dave Walden|Enterprise Database Administration  Deployment|[Your Data, in the Cloud](#sessionid-53268)
15:45:00|Reeves Smith|BI Platform Architecture, Development  Administration|[A New Approach to Unit and Integration Testing in SSIS](#sessionid-53316)
15:45:00|Andre DuBois|Enterprise Database Administration  Deployment|[Essential steps to ensure survivability of your SQL Server database](#sessionid-53360)
15:45:00|Jason Horner|BI Platform Architecture, Development  Administration|[Dimensional Modeling Design Patterns: Beyond the Basics](#sessionid-54546)
#  
#### SessionID: 49102
