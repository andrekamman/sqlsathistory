...
---|---|---|---
08:15:00|Daniel Glenn|Other|[Keys to Successful SharePoint Administration for the DBA](#sessionid-45637)
08:15:00|Monica Rathbun|Professional Development|[I'm It - Survival Techniques for the Lone DBA](#sessionid-45762)
08:15:00|William Wolf|Application  Database Development|[Locks, Blocks, and Deadlocks; Tame the Sibling Rivalry](#sessionid-46180)
08:15:00|Vishal Pawar|Application  Database Development|[SSIS - Lightning fast processing using Parallel processing  Optimization](#sessionid-46262)
08:15:00|Jeffrey Garbus|Professional Development|[How to be a GREAT DBA](#sessionid-46303)
08:15:00|Alex Grinberg|Other|[Efficient table design](#sessionid-46378)
08:15:00|Teo Lachev|BI Platform Architecture, Development  Administration|[What's New for BI in SQL Server 2016](#sessionid-46658)
08:15:00|Paresh Motiwala|Enterprise Database Administration  Deployment|[TempDB- More permanent impact than you think](#sessionid-46714)
08:15:00|Janis Griffin|Enterprise Database Administration  Deployment|[Top 10 Wait Types Everyone Should Know](#sessionid-46744)
08:15:00|Bill Anton|BI Platform Architecture, Development  Administration|[20 Minute Tabular Model](#sessionid-46902)
08:15:00|Andy Leonard|BI Platform Architecture, Development  Administration|[SSIS Frameworks and Biml](#sessionid-47120)
08:15:00|Rafael Salas|BI Information Delivery|[Getting Data with Power BI: Tips,  Tricks and Scripts](#sessionid-48358)
08:15:00|Mike Oberlin|Enterprise Database Administration  Deployment|[How answers.microsoft.com Overcame the Challenges of Upgrading to SQLServer](#sessionid-48855)
08:15:00|Michael French|Professional Development|[Independent Contracting 101](#sessionid-49537)
09:30:00|Mike Byrd|Application  Database Development|[SS2014/16 In-Memory Tables:  Formula 1 Performance Unleashed?](#sessionid-46268)
09:30:00|miguel Cebollero|Strategy and Architecture|[Datawarehouse Development in an Agile World](#sessionid-46270)
09:30:00|Tamera Clark|BI Information Delivery|[Microsoft Business Intelligence 2016 – More Love for Your Data](#sessionid-46784)
09:30:00|Mike Robbins|Other|[PowerShell Toolmaking with Advanced Functions and Script Modules](#sessionid-47143)
09:30:00|Thomas Grohser|Enterprise Database Administration  Deployment|[Optimizing the SQL Server and Databases for large Fact Tables](#sessionid-47160)
09:30:00|Jon Boulineau|BI Platform Architecture, Development  Administration|[Introducing Hadoop to SQL Server Pros](#sessionid-47493)
09:30:00|Robert Cain|BI Platform Architecture, Development  Administration|[Introducing the SSAS BI Semantic Model, aka Tabular](#sessionid-48463)
09:30:00|Jamey Johnston|Analytics and Visualization|[Code Like a Pirate ... Intro to R and Data Science Tools in MS](#sessionid-48510)
09:30:00|Jason Brimhall|Enterprise Database Administration  Deployment|[Murder They Wrote](#sessionid-48591)
09:30:00|Carlos L Chacon|Cloud Application Development  Deployment|[Disaster Recovery Options with Azure](#sessionid-48824)
09:30:00|Peter Avenant|BI Platform Architecture, Development  Administration|[Azure Data Warehousing made easy with Biml ](#sessionid-48868)
09:30:00|Paco Gonzalez|Advanced Analysis Techniques|[Enterprise Machine Learning with R and SQL Server](#sessionid-48876)
09:30:00|Damu Venkatesan|BI Platform Architecture, Development  Administration|[DAX 101](#sessionid-48894)
09:30:00|Melissa Coates|Cloud Application Development  Deployment|[Building Blocks of Cortana Intelligence Suite in Azure](#sessionid-48897)
09:30:00|Shabnam Watson|BI Platform Architecture, Development  Administration|[A SQL Developer’s Guide to MDX Basics](#sessionid-49448)
10:45:00|Kevin Feasel|Application  Database Development|[Peanut Butter  Chocolate:  Integrating Hadoop with SQL Server](#sessionid-46082)
10:45:00|Aaron Cutshall|Application  Database Development|[The Lost Science of Set Theory](#sessionid-46361)
10:45:00|Mindy Curnutt|Application  Database Development|[TSQL Coding Techniques - Are You Playing with Fire?](#sessionid-46419)
10:45:00|Stuart Ainsworth|Strategy and Architecture|[Microsoft Data Platform: The Open Space Session](#sessionid-46958)
10:45:00|Mike Hillwig|Enterprise Database Administration  Deployment|[SQL Phone Home: Teaching Your SQL Servers to Call for Help](#sessionid-48196)
10:45:00|Andy Mallon|Professional Development|[Shortcuts from an Impatient DBA](#sessionid-48201)
10:45:00|Daniel McLeod|BI Platform Architecture, Development  Administration|[What is Biml?](#sessionid-48259)
10:45:00|Louis Davidson|Application  Database Development|[Let Me Finish... Isolating Write Operations](#sessionid-48380)
10:45:00|Niran Even-Chen|Enterprise Database Administration  Deployment|[Architecting virtual SQL server for performance ](#sessionid-48549)
10:45:00|Michael Fal|Enterprise Database Administration  Deployment|[Managing Availability Groups (What happens after the build!)](#sessionid-48614)
10:45:00|Nathan Boster|Application  Database Development|[Write Queries Faster with AutoHotKey](#sessionid-48792)
10:45:00|Joseph Daigle|Application  Database Development|[Data Access for Performance Junkies](#sessionid-48794)
10:45:00|Ginger Grant|BI Information Delivery|[R School for the SQL Practitioner](#sessionid-48932)
10:45:00|Jeremy Frye|BI Platform Architecture, Development  Administration|[Speed Up Your SSAS Cube's Data Refresh With Dynamic Partition Processing](#sessionid-48942)
12:00:00|Jeffrey Garbus|Information Delivery|[Indexing for Join Optimization](#sessionid-46304)
12:00:00|Rie Irish|Professional Development|[Making the Most of Virtual Chapters and Other Free Training](#sessionid-48813)
12:00:00|Rob Volk|Enterprise Database Administration  Deployment|[A Modern SQL Server DBA...In 10 Minutes](#sessionid-48848)
12:00:00|Konstantin Melamud|BI Platform Architecture, Development  Administration|[Optimizing your data warehouse for OLAP Processing](#sessionid-48890)
12:00:00|Rie Irish|Professional Development|[Women in Technology: Identifying, Understanding and Combating Gender Bias](#sessionid-48898)
12:00:00|Mark Van de Wiel|BI Information Delivery|[Real-time data delivery may be easier than you think](#sessionid-50096)
12:00:00|Jason Picker|BI Platform Architecture, Development  Administration|[Making Microsoft BI On-premise A Reality](#sessionid-50367)
12:00:00|SQLSat Lunch|Enterprise Database Administration  Deployment|[The HA Blueprint for SQL Server](#sessionid-50596)
12:00:00|SQLSat Lunch|Enterprise Database Administration  Deployment|[Tintri  SQL Sentry - Optimizing Your Virtualized Workload](#sessionid-50597)
12:00:00|Tim Radney|Enterprise Database Administration  Deployment|[Cisco UCS for the Data Professional](#sessionid-50607)
12:00:00|David Bermingham|Cloud Application Development  Deployment|[Protecting Business Critical Applications in the New Data Center](#sessionid-50613)
12:00:00|SQLSat Lunch|Enterprise Database Administration  Deployment|[Transform SQL Server Agility](#sessionid-50615)
13:15:00|Eric Peterson|Enterprise Database Administration  Deployment|[SQL Server 2016  - New DBMS Features and examples](#sessionid-46338)
13:15:00|Luis Figueroa|Information Delivery|[A closer look at Azure Data Factory](#sessionid-46489)
13:15:00|Dan Holmes|Application  Database Development|[The Last Mile:  Dynamically Created Objects](#sessionid-47061)
13:15:00|Chrissy LeMaire|Enterprise Database Administration  Deployment|[Simplifying SQL Server Migrations using PowerShell](#sessionid-47215)
13:15:00|Kevin Kline|Enterprise Database Administration  Deployment|[Top 10 Admininistrator Mistakes on SQL Server](#sessionid-47323)
13:15:00|Taiob Ali|Enterprise Database Administration  Deployment|[SQL Server Agent : All the Knobs You Need to Know](#sessionid-47879)
13:15:00|David Bermingham|Enterprise Database Administration  Deployment|[SQL Server High Availability in Azure IaaS](#sessionid-48113)
13:15:00|Jay Harris|BI Platform Architecture, Development  Administration|[Biml Recipies: Automatically Create T-SQL Scripts for Common Tasks](#sessionid-48261)
13:15:00|Ravi Lobo|Professional Development|[A sense of automation](#sessionid-48532)
13:15:00|Thomas LeBlanc|Professional Development|[Skills Needed to Transition From DBA to BI Architect](#sessionid-48735)
13:15:00|Brian Kelley|BI Platform Architecture, Development  Administration|[Securing the Extract, Transform, and Load (ETL) Pipeline](#sessionid-48740)
13:15:00|Brandon Leach|Application  Database Development|[Partitioning Basics: Treating Your Tables Like Legos](#sessionid-48821)
13:15:00|Kerry Tyler|BI Information Delivery|[Connecting Power BI to On-Prem Data with SSAS](#sessionid-48918)
13:15:00|Patrick LeBlanc|BI Information Delivery|[Introduction to the Power BI Desktop](#sessionid-49450)
14:30:00|Tim Radney|Enterprise Database Administration  Deployment|[Azure SQL Database for the Production DBA](#sessionid-45521)
14:30:00|Naomi Williams|Enterprise Database Administration  Deployment|[SQL Server Internals](#sessionid-45530)
14:30:00|Jennifer McCown|Application  Database Development|[Unraveling Tangled Code:A Spellbinding Tale of Victory Over Chaos](#sessionid-46135)
14:30:00|Paul Popovich Jr|Enterprise Database Administration  Deployment|[Clusters! From the ground up, let's build one together](#sessionid-46265)
14:30:00|Deji Akomolafe|Strategy and Architecture|[Successfully Virtualizing SQL Server on vSphere - Straight from the Source](#sessionid-46380)
14:30:00|Cornell Emile|Advanced Analysis Techniques|[Enhancing Data and Predictive Analytics with Azure HDInsight](#sessionid-46491)
14:30:00|Matt Martin|Information Delivery|[Advanced Error Tracking for Quick Diagnosis](#sessionid-46592)
14:30:00|David Maxwell|Enterprise Database Administration  Deployment|[DBA 911 - Database Corruption](#sessionid-46811)
14:30:00|Mike Lawell|Application  Database Development|[Execution Plans for Mere Mortals](#sessionid-47044)
14:30:00|Mark Tabladillo|Application  Database Development|[T-SQL Window Functions for Analytics](#sessionid-48215)
14:30:00|Amy Herold|Enterprise Database Administration  Deployment|[Deadlock, Block  Two Smoking Barrels: Breaking Down Blocking and Deadlocks](#sessionid-48348)
14:30:00|Sven Aelterman|Cloud Application Development  Deployment|[Azure SQL Database: Deployment and Development of Your First DB](#sessionid-48529)
14:30:00|Jason Horner|BI Platform Architecture, Development  Administration|[Dimensional Modeling Design Patterns: Beyond the Basics](#sessionid-48630)
14:30:00|Brad McKuhen|Enterprise Database Administration  Deployment|[SQL Auditing - Getting A View Of Yesterday's Activity Today](#sessionid-48856)
14:30:00|Julie Smith|Cloud Application Development  Deployment|[Cloud Cloud. Cloud cloud cloud cloud cloud.....also Azure.](#sessionid-48946)
14:30:00|Lindsay Clark|Professional Development|[TechGirlz  How You Can Help Usher In The Next Generation](#sessionid-50494)
15:45:00|Ben Miller|Enterprise Database Administration  Deployment|[Administering SQL Server on Server Core with PowerShell](#sessionid-45874)
15:45:00|Ed Watson|BI Information Delivery|[Introduction to SQL Server Integration Services](#sessionid-46055)
15:45:00|Vladimir Oselsky|Analytics and Visualization|[Insight through Spatial Data](#sessionid-46258)
15:45:00|Christopher Wolff|Application  Database Development|[Continuous Deployments using SSDT](#sessionid-46259)
15:45:00|Lance Tidwell|Application  Database Development|[Parameter Sniffing the Good, the Bad and the Ugly](#sessionid-46840)
15:45:00|Robert Verell|Other|[Vote or Die 2016: Which is Faster?](#sessionid-47058)
15:45:00|Justin Randall|Enterprise Database Administration  Deployment|[The Sorcerer's Apprentice Guide to Configuration Options and Trace Flags](#sessionid-47116)
15:45:00|Jana Sattainathan|Strategy and Architecture|[Small Scale Data Collection Using PowerShell -  Going NSA Style!](#sessionid-47148)
15:45:00|Scott Currie|BI Platform Architecture, Development  Administration|[SSIS Unit and Integration Testing with the Open Source BEST project](#sessionid-47616)
15:45:00|Scott Currie|BI Platform Architecture, Development  Administration|[Incrementally Moving to the Cloud Using Biml](#sessionid-48257)
15:45:00|Karlyn LeBlanc|Professional Development|[Whip Away Stress at Home  Work to Create a Better You](#sessionid-48466)
15:45:00|Wayne Sheffield|Enterprise Database Administration  Deployment|[SSMS Tips and Tricks](#sessionid-48633)
15:45:00|Daniel Taylor|Enterprise Database Administration  Deployment|[More than Just a basic Database Backup and Recovery](#sessionid-48900)
15:45:00|John Morehouse|Enterprise Database Administration  Deployment|[Backups  Restores: You're Not In Kansas Anymore!](#sessionid-48939)
#  
#### SessionID: 45637
# Keys to Successful SharePoint Administration for the DBA
#### [Back to calendar](#SQLSaturday-#521---Atlanta-2016)
...
#### [Back to calendar](#SQLSaturday-#521---Atlanta-2016)
Event Date: 21-05-2016 - Session time: 15:45:00 - Track: Cloud Application Development  Deployment
...
#### [Back to calendar](#SQLSaturday-#521---Atlanta-2016)
Event Date: 21-05-2016 - Session time: 15:45:00 - Track: Advanced Analysis Techniques
...
#### [Back to calendar](#SQLSaturday-#521---Atlanta-2016)
Event Date: 21-05-2016 - Session time: 15:45:00 - Track: Information Delivery
## Speaker: Jeffrey Garbus
