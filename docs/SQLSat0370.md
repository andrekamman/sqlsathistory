...
---|---|---|---
00:00:00|Bradley Ball|SSIS/DBA/Misc|[BI DBA Performance Tuning](#sessionid-10164)
00:00:00|Ben Miller|DBA/Prof Dev|[SMO Internals for High Performance Automation](#sessionid-10281)
00:00:00|Benjamin Nevarez|DBA|[Understanding Parameter Sniffing](#sessionid-10378)
00:00:00|Jason Brimhall|DBA|[Using Extended Events in SQL Server](#sessionid-10892)
00:00:00|Carl Berglund|DBA|[Standalone to High-Availability Clusters over Lunch—with Time to Spare](#sessionid-11170)
00:00:00|Carlos Bossy|BIA|[Getting started with Big Data and BI](#sessionid-11364)
00:00:00|Carlos Bossy|BIA|[Tune a star schema for High Performance Data Warehouse Reporting ](#sessionid-11366)
00:00:00|Chris Hyde|App Dev|[Ten T-SQL Techniques with Tally Tables](#sessionid-11529)
00:00:00|Clay Jackson|DBA/Prof Dev|[Database Replication Strategies for Improved Productivity](#sessionid-11725)
00:00:00|David Klee|DBA|[Achieving Peak Performance from your Virtual SQL Servers](#sessionid-12601)
00:00:00|Ed Leighton-Dick|DBA|[Extending Your Availability Group for Disaster Recovery](#sessionid-13678)
00:00:00|Ed Leighton-Dick|SSIS/DBA/Misc|[Protecting Your Data with Encryption](#sessionid-13679)
00:00:00|Eric Oszakiewski|App Dev|[Make Your DBA Happy: 5 Habits Developers Can Implement Today](#sessionid-13898)
00:00:00|Ginger Grant|DBA|[Predicting the future with Machine Learning  ](#sessionid-14670)
00:00:00|Ira Warren|SSIS|[Guerilla MDM via MDS/SSIS Implementation](#sessionid-15508)
00:00:00|Janis Griffin|DBA|[Introduction to Wait Types and Response Time Analysis](#sessionid-15737)
00:00:00|Jason Horner|BIA|[Dimensional Modeling Design Patterns: Beyond Basics](#sessionid-15868)
00:00:00|John McAllister|DBA|[Enterprise-grade MDM On SQL Server - the Keys to Success ](#sessionid-17159)
00:00:00|Joshua Buttles|BIA|[Creating Dashboards in SSRS](#sessionid-17496)
00:00:00|Josh Sivey|BIA|[Introduction to Microsoft Power Query](#sessionid-17508)
00:00:00|Josh Luedeman|BIA|[Data Factory: Data Integration in the Cloud](#sessionid-17532)
00:00:00|Joseph Barth|SSIS|[Diary of a Wimpy SSIS Developer](#sessionid-17812)
00:00:00|Gary Serda|SSIS|[Optimize Your SQL Server 2014 Workloads with Cisco UCS](#sessionid-17817)
00:00:00|Kevin Cox|DBA|[Microsoft Keynote - Advancing the Cloud  Data Platform](#sessionid-18253)
00:00:00|Kathi Kellenberger|DBA|[WIT Panel](#sessionid-18453)
00:00:00|Kathi Kellenberger|App Dev|[Writing Better T-SQL Queries with Window Functions](#sessionid-18454)
00:00:00|Keith Tate|DBA|[SQL Server Backups and Restores A to Z](#sessionid-18858)
00:00:00|Leonard Lobel|App Dev|[Geospatial Data Types in SQL Server 2012](#sessionid-19092)
00:00:00|Lori Edwards|DBA|[SQL Server Statistics – What Are The Chances?](#sessionid-19236)
00:00:00|Matt Smith|BIA|[Data wizardry with the next generation of Power BI!](#sessionid-19341)
00:00:00|Martin Schoombee|App Dev|[How "quirky" is your update?](#sessionid-19757)
00:00:00|Michael DeFehr|App Dev|[TSQL Bullet-Dodging and Spoon-bending](#sessionid-20004)
00:00:00|Michael Perillo|BIA|[Introduction to Tableau](#sessionid-20250)
00:00:00|Mindy Curnutt|App Dev|[The Ins and Outs of SQL Indexes](#sessionid-20775)
00:00:00|Marie Roqueni|BIA|[Setting up an Azure Test Lab](#sessionid-21115)
00:00:00|Mike Tutor|DBA|[Tools in Your Toolbox You’re Not using!  Why Not?](#sessionid-21167)
00:00:00|Orion Gebremedhin|BIA|[Application of Hadoop on-demand for BI Integration and ETL Automation Using Azure HDInsight](#sessionid-21594)
00:00:00|Paul Graham|SSIS|[Fun with the File System Task](#sessionid-21822)
00:00:00|Paul Turley|BIA|[Power BI Hands-On Micro-Workshop](#sessionid-21862)
00:00:00|Paul Combellick|App Dev|[In Memory OLTP: One programmer's experience ](#sessionid-21879)
00:00:00|Randy Knight|DBA|[Understanding the SQL Server Transaction Log](#sessionid-22605)
00:00:00|Reeves Smith|SSIS|[Dynamically Increase your Data Awareness](#sessionid-22793)
00:00:00|Jeff Renz|BIA|[Introduction to Microsoft Azure DocumentDB](#sessionid-22930)
00:00:00|Richard Kemp|BIA|[Powershell - Automating build and deployment in a datawarehouse environment   ](#sessionid-22981)
00:00:00|Robert Miller|DBA|[Event Notification in SQL Server 2012](#sessionid-23093)
00:00:00|Rob Mandeville|DBA|[Virtualizing our Environment](#sessionid-23367)
00:00:00|Roger Wolter|SSIS/DBA/Misc|[SQL Server Filesystem](#sessionid-23703)
00:00:00|Ryan McCauley|SSIS|[Introduction to Excel pivot tables](#sessionid-23706)
00:00:00|Steve Wake|SSIS/DBA/Misc|[Change Data Capture (CDC) with SSIS](#sessionid-25710)
00:00:00|Kevin Boles|DBA|[SQL Server 2014 Column Store Index vNEXT](#sessionid-26468)
00:00:00|Tim Hidalgo|App Dev|[Setting the stage...](#sessionid-26572)
00:00:00|Todd Kleinhans|DBA/Prof Dev|[The Life Cycle of a Query in 3D](#sessionid-26967)
00:00:00|Vern Rabe|App Dev|[The Significance of Choosing the Right Data Types](#sessionid-27386)
00:00:00|Michael Fal|DBA/Prof Dev|[Powershell Tips and Tricks for SQL Server Administration](#sessionid-34778)
00:00:00|Mike Teel|BIA|[Pyramid Ananytics Govern Data Discovery](#sessionid-34815)
00:00:00|Alan Faulkner|BIA|[SSAS Multidimensional vs. SSAS Tabular – Which one do I use?](#sessionid-9068)
00:00:00|Adam Jorgensen|BIA|[On-Demand Compute and Analytics with Powershell, Hadoop and Azure](#sessionid-9141)
00:00:00|Amy Herold|DBA|[Deadlock, Block  Two Smoking Barrels: Breaking Down Blocking and Deadlocks](#sessionid-9417)
00:00:00|Amy Herold|DBA/Prof Dev|[Making the Leap from Developer to DBA](#sessionid-9420)
00:00:00|Jared Lutgen|DBA/Prof Dev|[The Leader in Server-Side Storage Intelligence ](#sessionid-9450)
00:00:00|Arnie Rowland|SSIS/DBA/Misc|[RC, SI, and RCSI, Oh My! –We're off to see the Wizard -to understand how it all works](#sessionid-9867)
#  
#### SessionID: 10164
