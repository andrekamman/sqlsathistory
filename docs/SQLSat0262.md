...
---|---|---|---
00:00:00|Ayad Shammout|Constitution|[Building BI Semantic Model Tabular in 60 minutes](#sessionid-10070)
00:00:00|Bradley Ball|Bunker Hill|[Trimming Indexes Getting Your Database In Shape](#sessionid-10149)
00:00:00|Brian McCaig|Lexington|[SQL Server cell level and transparent data encryption a case study](#sessionid-10526)
00:00:00|Bob Pusateri|Longfellow|[Whatcha Doin'? Passive Security for Hostile Environments](#sessionid-10591)
00:00:00|Brandon Leach|Lexington|[Treating Tables Like Legos, Partitioning Basics](#sessionid-10670)
00:00:00|Brandon Leach|Constitution|[Implementing a HIPAA Compliance Strategy with SQL Server](#sessionid-10672)
00:00:00|Bryan Cafferky|Constitution|[So you think you know SSIS? What about Scripting? ](#sessionid-11024)
00:00:00|Bryan Cafferky|Concord|[Dimensional Modeling:  The Heart of the Data Warehouse](#sessionid-11025)
00:00:00|Chris Bell|Thoreau|[Optimizing Protected Indexes](#sessionid-11258)
00:00:00|Jack Corbett|Concord|[Inroduction to Triggers](#sessionid-11851)
00:00:00|David Bermingham|Concord|[High Availability with Windows Server 2012 R2 and SQL Server 2014](#sessionid-12378)
00:00:00|Edward Pollack|Concord|[Dynamic SQL: Writing Efficient Queries on the Fly](#sessionid-13831)
00:00:00|Edward Pollack|Thoreau|[Diving Into Query Execution Plans](#sessionid-13832)
00:00:00|George Walters|Longfellow|[SQL Server 2012 AlwaysOn Availability Groups](#sessionid-14520)
00:00:00|Grant Fritchey|Hawthorne|[Statistics and Query Optimization](#sessionid-14731)
00:00:00|Joseph D'Antoni|Concord|[In-Memory Columnstore Indexes--Make Your Data Warehouse Fly ](#sessionid-16205)
00:00:00|John Flannery|Lexington|[What the Hekaton](#sessionid-16731)
00:00:00|John Miner|Lexington|[Effective use of temporary tables](#sessionid-17044)
00:00:00|Kevin Kline|Hawthorne|[SQL Server Internals and Architecture](#sessionid-18197)
00:00:00|Michael Corey|Thoreau|[Virtualizing SQL Server: Doing It Right – The SeQueL](#sessionid-20242)
00:00:00|Mike Hillwig|Lexington|[Recovery and Backup for Beginners](#sessionid-20540)
00:00:00|Mike Walsh|Thoreau|[What I Wish I Knew Before Becoming a DBA](#sessionid-20621)
00:00:00|Paresh Motiwala|Hawthorne|[Database Forensics - Part 1](#sessionid-21643)
00:00:00|Mohammad Yusuf|Longfellow|[An Introduction to Database Design And Management](#sessionid-23794)
00:00:00|Stacia Varga|Hawthorne|[(Way Too Much) Fun with Reporting Services ](#sessionid-24658)
00:00:00|Steve Simon|Bunker Hill|[Mind your language!!   Cursors are a dirty word](#sessionid-25370)
00:00:00|Sunil Kadimdiwan|Bunker Hill|[Develop Impressive Dashboards using SSRS 2012](#sessionid-25874)
00:00:00|Tim Radney|Bunker Hill|[Know Backups and Know Recovery](#sessionid-26709)
00:00:00|Tim Radney|Bunker Hill|[You Inherited a Database, Now What?](#sessionid-26710)
00:00:00|Timothy McAliley|Constitution|[Floating on a Hybrid Cloud: SQL Server 2014  Windows Azure ](#sessionid-26822)
00:00:00|Varsham Papikian|Constitution|[Yes, you can do it in SSMS: tips and tricks.](#sessionid-27546)
00:00:00|Aaron Bertrand|Hawthorne|[T-SQL : Bad Habits  Best Practices](#sessionid-8909)
00:00:00|Allan Hirt|Thoreau|[Patch Management Strategies for SQL Server](#sessionid-9242)
00:00:00|Adam Machanic|Longfellow|[Query Tuning Mastery: Clash of the Row Goals](#sessionid-9364)
00:00:00|Andy Leonard|Longfellow|[Designing an SSIS Framework ](#sessionid-9511)
#  
#### SessionID: 10070
