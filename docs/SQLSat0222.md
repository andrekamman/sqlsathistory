...
---|---|---|---
00:00:00|Ben Miller|Nimble Storage Room|[SMO Internals for High Performance PowerShell](#sessionid-10250)
00:00:00|Ben Miller|Nimble Storage Room|[SQL LogShipping with PowerShell](#sessionid-10253)
00:00:00|Carlos Bossy|SIOS Room|[Real-time Data Warehouse and Reporting Solutions](#sessionid-11338)
00:00:00|Chris Skorlinski|Red Gate Room|[RU Ready for the Cloud?](#sessionid-11553)
00:00:00|Chris Skorlinski|SIOS Room|[Read Hunter](#sessionid-11556)
00:00:00|DIlip nayak|Quest/Dell Room|[AlwaysOn Availability Groups in Action](#sessionid-12126)
00:00:00|David Klee|Nimble Storage Room|[It's All About the Performance, Right?](#sessionid-12547)
00:00:00|David Klee|Track 4|[Squeezing Performance from VMware-Based SQL Server](#sessionid-12548)
00:00:00|Grant Fritchey|Red Gate Room|[What to Look for in Execution Plans](#sessionid-14743)
00:00:00|Janis Griffin|Nimble Storage Room|[Looney Tuner?  No, there IS a method to my madness](#sessionid-15713)
00:00:00|Jason Hall|Quest/Dell Room|[Lunch Session  Dell Software Solutions for SQL Server - Free Tools!!!](#sessionid-15882)
00:00:00|Joseph D'Antoni|Quest/Dell Room|[Using Compression to Improve Database Performance](#sessionid-16212)
00:00:00|Jim Murphy|Quest/Dell Room|[AlwaysOn - Finally, A usable 'mirror'!](#sessionid-16802)
00:00:00|Joseph Verftido|Red Gate Room|[Data Quality Services Approach to Cleansing](#sessionid-17486)
00:00:00|Tom Riggins|Nimble Storage Room|[Lunch Session  Accelerating SQL in the Datacenter with Hybrid Storage](#sessionid-17544)
00:00:00|Kalen Delaney|Quest/Dell Room|[What Happened? Exploring the Plan Cache](#sessionid-17844)
00:00:00|Mark Gschwind|Nimble Storage Room|[Master Data and Data Quality in SQL Server 2012](#sessionid-20136)
00:00:00|Mickey Stuewe|SIOS Room|[Table Partitioning in the Wild](#sessionid-20385)
00:00:00|Mitchell Bottel|Nimble Storage Room|[Want a promotion? It’s up to you!](#sessionid-20832)
00:00:00|Paul Turley|Red Gate Room|[Tabular Models: Easier  Faster Than Cubes; Really?](#sessionid-21832)
00:00:00|Peter Myers|Red Gate Room|[Big Data Analytics with PowerPivot and Power View](#sessionid-21959)
00:00:00|Prakash Heda|Quest/Dell Room|[Detect Worst Performing SQL Queries During Peak Hour](#sessionid-22276)
00:00:00|Steve Jones|Red Gate Room|[Searching Binary Data in SQL Server 2012](#sessionid-24494)
00:00:00|Phil Robinson|SIOS Room|[Report Delivery - From Report Manager to the Cloud](#sessionid-24947)
00:00:00|Dan Hess|Track 4|[SQL Server encryption 3 ways - in transit, at rest and in the database](#sessionid-24949)
00:00:00|Steve Stedman|SIOS Room|[T-SQL Productivity](#sessionid-25742)
00:00:00|Steve Stedman|Red Gate Room|[Lunch Session  A Day in the Life of a DBA](#sessionid-25743)
00:00:00|Steve Stedman|SIOS Room|[Lunch Session  High Performance SANLess Clustering](#sessionid-25744)
00:00:00|Vicky Harp|Track 4|[Care and Feeding of Your System Databases](#sessionid-27397)
00:00:00|Michael Fal|Track 4|[Managing Log File Obesity](#sessionid-34803)
00:00:00|John Morehouse|Track 4|[SQL Server Databaseology 201](#sessionid-34837)
00:00:00|Angel Abundez|Quest/Dell Room|[5 Ways SSIS 2012 can Save You Time and Money](#sessionid-9659)
00:00:00|Argenis Fernandez|SIOS Room|[Code-Less Securing of SQL Server](#sessionid-9765)
#  
#### SessionID: 10250
# SMO Internals for High Performance PowerShell
#### [Back to calendar](#nr-222)
