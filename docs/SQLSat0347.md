...
---|---|---|---
00:00:00|Allen White|BI2 - Intermediate / Advanced|[Get Near Realtime ETL with Service Broker](#sessionid-10068)
00:00:00|Ayman El-Ghazali|DBA 2 - Intermediate / Advanced|[Performance Tuning Pit Stop for DBAs](#sessionid-10089)
00:00:00|Jason Brimhall|DBA 1 - Intro / Intermediate|[Murder They Wrote](#sessionid-10867)
00:00:00|Carlos L Chacon|DBA 1 - Intro / Intermediate|["I Know What You Did Last Query" --SQL Server](#sessionid-11205)
00:00:00|David Dye|BI 1 - Intro / Intermediate|[Dealing With Errors in SSIS 2012 ](#sessionid-13197)
00:00:00|Doug Purnell|Prof. Dev.|[Congrats on your promotion to DBA, now what?](#sessionid-13416)
00:00:00|Gigi Bell|Prof. Dev.|[Dealing With Difficult People](#sessionid-14412)
00:00:00|Grant Fritchey|DBA 2 - Intermediate / Advanced|[Getting Started Reading Execution Plans](#sessionid-14793)
00:00:00|Joseph D'Antoni|BI 1 - Intro / Intermediate|[Power BI in the Fast Lane--Visualizing Formula 1](#sessionid-16240)
00:00:00|Jessica Moss|BI2 - Intermediate / Advanced|[Analysis Services: Multidimensional vs Tabular](#sessionid-16673)
00:00:00|Jimmy May|BI2 - Intermediate / Advanced|[Columnstore Indexes in SQL Server 2014: Flipping the DW /Faster Bit](#sessionid-16850)
00:00:00|Konstantin Melamud|DBA 2 - Intermediate / Advanced|[Performance Tuning - Analyzing Execution Plans](#sessionid-18566)
00:00:00|Konstantin Melamud|DEV|[Turbo Boost Performance: In Memory Tables index optimizations](#sessionid-18568)
00:00:00|Ravi Kumar|BI 1 - Intro / Intermediate|[Think like SSIS and Build a package](#sessionid-18871)
00:00:00|Michael Bourgon|DBA 1 - Intro / Intermediate|[SQL Watchdog -  find out instantly when SQL changes occur in production](#sessionid-19934)
00:00:00|Paresh Motiwala|Prof. Dev.|[DBA to Project Manager in 75 minutes flat](#sessionid-21674)
00:00:00|Sebastian Meine|DEV|[Securing a Multi-Database Application](#sessionid-21731)
00:00:00|William Wolf|DEV|[Common Coding Mistakes and how to Mitigate them](#sessionid-22077)
00:00:00|Randy Knight|DBA 2 - Intermediate / Advanced|[Locks, Blocks, and Deadlocks Oh My!](#sessionid-22571)
00:00:00|Reeves Smith|BI 1 - Intro / Intermediate|[Data Discovery with Power Query for Excel](#sessionid-22779)
00:00:00|Reeves Smith|BI2 - Intermediate / Advanced|[Get Into Evaluation Context with DAX, the Language of PowerPivot](#sessionid-22780)
00:00:00|Samuel Vanga|BI2 - Intermediate / Advanced|[SSIS Data Flow Engine: Under the Hood](#sessionid-23904)
00:00:00|Steve Jones|Prof. Dev.|[Branding Yourself for a Dream Job](#sessionid-24558)
00:00:00|Timothy McAliley|DBA 1 - Intro / Intermediate|[Backup to the Cloud: Integrating On-Premises SQL Server Backup and Recovery with Window Azure](#sessionid-26834)
00:00:00|Theresa Iserman|DBA 1 - Intro / Intermediate|[Not So Basic Backup and Restore](#sessionid-26888)
00:00:00|Slava Murygin|DBA 2 - Intermediate / Advanced|[Charlie and the SQL Server Re-Fill Factory](#sessionid-27532)
00:00:00|Wayne Sheffield|DEV|[SSMS Tips  Tricks](#sessionid-27758)
00:00:00|Alan Faulkner|BI 1 - Intro / Intermediate|[SSAS Best Practices](#sessionid-9069)
00:00:00|Amy Herold|DEV|[Beginning Automation with Powershell](#sessionid-9414)
#  
#### SessionID: 10068
# Get Near Realtime ETL with Service Broker
#### [Back to calendar](#nr-347)
