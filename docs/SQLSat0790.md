...
---|---|---|---
09:00:00|Kasper de Jonge|BI Platform Architecture, Development  Administration|[Understanding the Power BI data model](#sessionid-82681)
09:00:00|Alexander Klein|Cloud Application Development  Deployment|[Azure Cognitive Services - AI for everyone](#sessionid-82685)
09:00:00|Rob Sewell|Enterprise Database Administration  Deployment|[dbachecks - The PowerShell Module to validate your SQL Estate](#sessionid-82698)
09:00:00|Christopher Adkin|Application  Database Development|[Scaling Out Workload Processing Using SQL Server Running Inside Containers](#sessionid-82998)
09:00:00|Koen Verbeeck|BI Platform Architecture, Development  Administration|[Introduction to Biml - Generating your SSIS packages from scratch](#sessionid-83727)
09:00:00|Eelco Drost|Enterprise Database Administration  Deployment|[Deploy database changes using SSDT, VSTS and DACPAC](#sessionid-84050)
10:15:00|David Postlethwaite|Enterprise Database Administration  Deployment|[New Security Features in SQL Server 2016](#sessionid-83074)
10:15:00|Gabi Münster|BI Platform Architecture, Development  Administration|[Azure Analysis Services - An important step for BI in the cloud?](#sessionid-84272)
10:15:00|Niels Naglé|Advanced Analysis Techniques|[Combining Azure Cognitive Services and ML.net for AI empowerment!](#sessionid-84407)
10:15:00|Paul Mooij|Application  Database Development|[U-SQL custom extractor for multi-gigabyte XML](#sessionid-84424)
10:15:00|Manon van den Burg|Advanced Analysis Techniques|[Techniques to implement privacy for Data analytics](#sessionid-84454)
11:30:00|Torsten Strauss|Enterprise Database Administration  Deployment|[Database tuning advisor vs. dynamic management views](#sessionid-82761)
11:30:00|Tracy Boggiano|Enterprise Database Administration  Deployment|[Monitoring Availability Groups](#sessionid-83018)
11:30:00|Callum Green|BI Platform Architecture, Development  Administration|[Embedding PowerApps into a Power BI Dashboard](#sessionid-83592)
11:30:00|Nico Jacobs|Advanced Analysis Techniques|[Using Azure Machine Learning in Stream Analytics](#sessionid-83733)
11:30:00|Daniel Hutmacher|Application  Database Development|[Not just polish – How good code also runs faster](#sessionid-83978)
13:30:00|John Martin|Strategy and Architecture|[GDPR, A European Horror Story](#sessionid-82646)
13:30:00|Erwin De Kreuk|BI Platform Architecture, Development  Administration|[Migrating to an Azure SQL Datawarehouse with Azure Data Factory V2](#sessionid-84326)
13:30:00|Arne Bartels|Application  Database Development|[Step-by-step towards building a SSIS Custom Pipeline Component](#sessionid-84404)
13:30:00|Hans Geurtsen|Advanced Analysis Techniques|[Building solutions with Azure Databricks](#sessionid-84410)
13:30:00|Jose Manuel Jurado Diaz|Enterprise Database Administration  Deployment|[Azure SQL Database - Lessons learned from the trenches](#sessionid-84537)
14:45:00|Stijn Wynants|BI Platform Architecture, Development  Administration|[Datawarehouse Lightning Performance with Columnstore!](#sessionid-82937)
14:45:00|Joseph D'Antoni|Enterprise Database Administration  Deployment|[Containers, Pods, and Databases-The the Future of Infrastructure](#sessionid-83184)
14:45:00|Jan Mulkens|BI Platform Architecture, Development  Administration|[Automating Power BI](#sessionid-83747)
14:45:00|Hylke Peek|Analytics and Visualization|[Automatisch werkproces met Microsoft Flow en Power BI](#sessionid-84089)
14:45:00|Hugo Kornelis|Application  Database Development|[Deep dive into Adaptive Query Processing](#sessionid-84339)
16:00:00|Enrico van de Laar|Advanced Analysis Techniques|[Moving advanced analytics to your SQL Server databases](#sessionid-82692)
16:00:00|Chrissy LeMaire|Enterprise Database Administration  Deployment|[Simplifying XEvents Management with dbatools](#sessionid-82694)
16:00:00|Tobias Koprowski|Enterprise Database Administration  Deployment|[SQL Security in the Cloud](#sessionid-83114)
16:00:00|Bartosz Ratajczyk|BI Platform Architecture, Development  Administration|[Start testing your SSIS packages with ssisUnit](#sessionid-83327)
16:00:00|Kevin Boles|Application  Database Development|[Know What Your Code is Doing to SQL Server!](#sessionid-84250)
#  
#### SessionID: 82681
# Understanding the Power BI data model
#### [Back to calendar](#SQLSaturday-#790---Holland-2018)
