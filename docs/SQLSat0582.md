...
---|---|---|---
09:00:00|Craig Bryden|Analytics and Visualization|[An Introduction to R and R Services](#sessionid-54457)
09:00:00|Kevin Boles|Application  Database Development|[Common TSQL Mistakes](#sessionid-56651)
09:00:00|Bernard Spence|BI Platform Architecture, Development  Administration|[Excel tips and tricks for the data professional](#sessionid-57059)
09:00:00|Greg Low|Azure Services and Platform|[What on earth are all the Azure* and Power* services and why would I want them?](#sessionid-57175)
09:00:00|Johnley John|BI Platform Architecture, Development  Administration|[SQL Server Integration Services](#sessionid-57254)
09:00:00|Ajay Jagannathan|Enterprise Database Administration  Deployment|[Become A Troubleshooting Ninja with PowerBI and SQL Server Extended Events](#sessionid-57282)
10:10:00|Edwin M Sarmiento|Enterprise Database Administration  Deployment|[Proactively Identifying and Dealing with SQL Server Database Corruption](#sessionid-56689)
10:10:00|Susantha Bathige|Enterprise Database Administration  Deployment|[Statistics and New Cardinality Estimator Model](#sessionid-56874)
10:10:00|Ankit Patira|Azure Services and Platform|[Real time reporting with Power BI](#sessionid-57060)
10:10:00|Jim McLeod|BI Platform Architecture, Development  Administration|[Azure SQL Data Warehouse - Massive, Parallel, and in the Cloud](#sessionid-57253)
10:10:00|Matt Masson|Analytics and Visualization|[The Power of Power Query!](#sessionid-59926)
10:10:00|Victor Isakov|Application  Database Development|[New Security Features in SQL Server 2016](#sessionid-61623)
11:25:00|Tobias Koprowski|Enterprise Database Administration  Deployment|[SQL Security in the Cloud](#sessionid-54533)
11:25:00|Matt Allington|Analytics and Visualization|[How you can use disconnected tables in PowerPivot/Tabular models to solve real world problems](#sessionid-54934)
11:25:00|Victor Isakov|Application  Database Development|[Query Store: A (R)evolution in Query Tuning](#sessionid-56174)
11:25:00|Reza Rad|BI Platform Architecture, Development  Administration|[10 Amazing Things About Power BI You Don't Know](#sessionid-56885)
11:25:00|Michael Carder|Enterprise Database Administration  Deployment|[Simplify management of multi-server, multi-region SQL Server deployments with Conductor4SQL](#sessionid-57007)
11:25:00|Julie Koesmarno|Analytics and Visualization|[Intro to Azure Data Lake and U-SQL](#sessionid-59644)
14:05:00|Martin Catherall|Application  Database Development|[Oh, When did THAT change happen?](#sessionid-56508)
14:05:00|Adam Gilmore|BI Platform Architecture, Development  Administration|[Automate Data Warehouse build and deployment (db,SSIS  SSAS) with Visual Studio 2015 and TFS](#sessionid-56684)
14:05:00|Warwick Rudd|Enterprise Database Administration  Deployment|[2016 – The Rise and Fall of DBM](#sessionid-56723)
14:05:00|Hamish Watson|Strategy and Architecture|[Making DevOps work in the wild...](#sessionid-57170)
14:05:00|Rob Douglas|Enterprise Database Administration  Deployment|[Adding Powershell to Your Skillset](#sessionid-57172)
14:05:00|Lindsey Allen|Azure Services and Platform|[What's new in  Azure SQL DB and SQL engine](#sessionid-57283)
15:15:00|Manohar Punna|Enterprise Database Administration  Deployment|[Plan, Design and Implement a HADR Solution - a Journey](#sessionid-54458)
15:15:00|Martin Cairney|Azure Services and Platform|[Database Administration for Azure SQL DB](#sessionid-56876)
15:15:00|Patrick Flynn|Enterprise Database Administration  Deployment|[SQL Server on Linux - The How, the What and the Why?](#sessionid-56963)
15:15:00|Allen White|Application  Database Development|[Scalable Application Design with Service Broker](#sessionid-56973)
15:15:00|James Beresford|BI Platform Architecture, Development  Administration|[Creating High Performance Tabular Models](#sessionid-57167)
15:15:00|Darren Gosbell|Analytics and Visualization|[Why your charts suck and how to fix them](#sessionid-57240)
16:30:00|Manjot Kaur|BI Platform Architecture, Development  Administration|[DW SuperHero-Columnstore Index](#sessionid-54832)
16:30:00|Nagaraj Venkatesan|Enterprise Database Administration  Deployment|[R for Database Administrators](#sessionid-56411)
16:30:00|Rolf Tesmer|Azure Services and Platform|[Azure Cognitive Services - The Rise of the Machines!](#sessionid-56483)
16:30:00|Leila Etaati|Analytics and Visualization|[R; One Ring to Rule Them All](#sessionid-56865)
16:30:00|Sunil Agarwal|Enterprise Database Administration  Deployment|[SQL Server 2016 SP1: Enhancements that will make your SQL Server roar!](#sessionid-56904)
16:30:00|Guy Glantser|Application  Database Development|[How to Use Parameters Like a Pro and Boost Performance](#sessionid-59688)
#  
#### SessionID: 54457
