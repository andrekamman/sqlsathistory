...
---|---|---|---
00:00:00|Bjorn D. Jensen|Magnus|[Why proper data quality and modelling matters](#sessionid-10486)
00:00:00|Bob Duffy|Harald|[MIgrating to the Azure and the cloud](#sessionid-10551)
00:00:00|Brian Boenk|Svend|[Dynamic Partitioning Cubes](#sessionid-10774)
00:00:00|Boris Hristov|Magnus|[Replay your workload as it's your actual one!](#sessionid-10901)
00:00:00|Christina Leo|Harald|[Building Your T-SQL Tool Kit: Window Function Fundamentals](#sessionid-11583)
00:00:00|Carmel Gunn|Harald|[The Irish Economic Crisis, Visualized with Power BI](#sessionid-11707)
00:00:00|Erik Svensen|Harald|[Prepare your Excel Power Pivot models for QA](#sessionid-13958)
00:00:00|Glenn Berry|Gorm|[Analyzing I/O Subsystem Performance](#sessionid-14688)
00:00:00|Hans Hansen|Svend|[Encryption in SQL Server - things to consider before flipping the switch](#sessionid-14939)
00:00:00|Hugo Kornelis|Knud|[Advanced Indexing](#sessionid-15035)
00:00:00|Jen Stirrup|Gorm|[Let's PowerBI Denmark with Big Data!](#sessionid-16533)
00:00:00|Just Blindbaek|Knud|[Unit testing Analysis Services](#sessionid-17780)
00:00:00|Jens Vestergaard|Knud|[Analysis Services Security](#sessionid-17792)
00:00:00|Kennie Pontoppidan|Svend|[Autogenerating a process data warehouse](#sessionid-18103)
00:00:00|Kenneth Nielsen|Magnus|[Microsoft Master Data Services - Used for more than just data management](#sessionid-18591)
00:00:00|Marcin Szeliga|Svend|[Indexing for denormalization](#sessionid-19452)
00:00:00|Marco Russo|Gorm|[Optimizing DAX Analyzing Query Plans](#sessionid-19465)
00:00:00|Mark S. Rasmussen|Gorm|[Recovering Data from Fatally Corrupt Databases](#sessionid-19602)
00:00:00|Mark Stacey|Harald|[Overview of a PDW project](#sessionid-20121)
00:00:00|Michael Frandsen|Gorm|[High Performance Infrastructure for SQL Server 2014](#sessionid-20368)
00:00:00|Miloš Radivojević|Harald|[SQL Server 2014 - New Cardinality Estimator](#sessionid-20736)
00:00:00|Neil Hambly|Knud|[SQL Server 2012 Memory Management](#sessionid-21315)
00:00:00|Rasmus Reinholdt|Knud|[Optimizing BI with SQL2014 In-Memory tables](#sessionid-23512)
00:00:00|Satya Jayanty|Magnus|[Let's cook  'best SQL Server DBA practices'](#sessionid-25019)
00:00:00|Steen Dybboe|Svend|[Window Functions Unleashed](#sessionid-25247)
00:00:00|Uwe Ricken|Gorm|[INSERT / UPDATE / DELETE - deep dive](#sessionid-27240)
00:00:00|Mikael Wedham|Svend|[Practical use of the SSIS Script components](#sessionid-27782)
00:00:00|André Kamman|Harald|[Automate your SSIS development with BIML](#sessionid-34559)
00:00:00|Andreas Wolter|Gorm|[SQL Server 2014 In-Memory OLTP / XTP Management Deep Dive](#sessionid-8815)
00:00:00|Aaron Nelson|Knud|[PowerShell for Data Professionals](#sessionid-8873)
#  
#### SessionID: 10486
# Why proper data quality and modelling matters
#### [Back to calendar](#nr-275)
