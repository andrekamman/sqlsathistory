...
---|---|---|---
08:30:00|Chris Hyde|Analytics and Visualization, BI Delivery|[Python in SQL Server 2017](#sessionid-71611)
08:30:00|John Sterrett|Enterprise Database Administration  Deployment|[DIY: SQL Server Monitoring for your Enterprise](#sessionid-73990)
08:30:00|Mike Byrd|Application  Database Development|[Climbing the SQL Server Index B-Tree (from a user perspective)](#sessionid-74324)
08:30:00|Thomas Norman|Enterprise Database Administration  Deployment|[Database Project Makes Deployment Consistent](#sessionid-75782)
08:30:00|William Assaf|Enterprise Database Administration  Deployment|[What's New In SQL Server 2017](#sessionid-77161)
08:30:00|Juan Soto|Professional Development|[Wish you could live the glamorous consulting life?](#sessionid-77379)
08:30:00|Rick Lowe|Enterprise Database Administration  Deployment|[Why Should I Care About ... Partitioned Views?](#sessionid-77815)
08:30:00|Ryan Adams|Application  Database Development|[History Tracking with Temporal Tables](#sessionid-77936)
08:30:00|Tim Mitchell|BI Platform Architecture, Development  Administration|[Are There Time Bombs in your SSIS Packages?](#sessionid-77986)
09:45:00|Peter Schott|Application  Database Development|[Getting your DB schema under control with SSDT](#sessionid-71620)
09:45:00|Bob Ward|Enterprise Database Administration  Deployment|[Experience SQL Server 2017: The Modern Database Platform](#sessionid-73044)
09:45:00|Dave Bland|Enterprise Database Administration  Deployment|[Extended Events: What are they and How do I use them](#sessionid-74059)
09:45:00|Kenneth Fisher|Enterprise Database Administration  Deployment|[SQL Server Security from the ground up](#sessionid-74260)
09:45:00|Tim Costello|BI Platform Architecture, Development  Administration|[Windowing Functions](#sessionid-74547)
09:45:00|Mark Moore|Other|[Azure SQL and Azure Data Warehouse 101](#sessionid-75850)
09:45:00|Abdullah Mamun|Enterprise Database Administration  Deployment|[Deploying SQL Server on Azure VM (IaaS)](#sessionid-77849)
09:45:00|Russel Loski|Cloud Application Development  Deployment|[Managing Azure Data Lake with PowerShell](#sessionid-78073)
11:00:00|Kevin Hill|Enterprise Database Administration  Deployment|[Disaster recovery is everyone's job!](#sessionid-71613)
11:00:00|Shawn Weisfeld|Cloud Application Development  Deployment|[Get insights from data with Cognitive Services](#sessionid-72061)
11:00:00|Kellyn Pot'Vin-Gorman|Enterprise Database Administration  Deployment|[Essential Linux for the SQL Server DBA](#sessionid-73226)
11:00:00|Garry Bargsley|Enterprise Database Administration  Deployment|[Use PowerShell and dbatools to Manage your SQL Server Environment](#sessionid-74443)
11:00:00|William Assaf|Professional Development|[Think Like a Certification Exam](#sessionid-77160)
11:00:00|Henry Weng|Enterprise Database Administration  Deployment|[Transactional Replication New Features for AlwaysOn AG in SQL 2017](#sessionid-77976)
11:00:00|Tim Mitchell|BI Platform Architecture, Development  Administration|[Introduction to Biml](#sessionid-77985)
11:00:00|Lance Tidwell|Application  Database Development|[New Features in SQL That Will Change the Way You Tune](#sessionid-78044)
11:00:00|Tejpal Thatte|Analytics and Visualization, BI Delivery|[QuickStart on embedding PowerBI reports in your line of business applications](#sessionid-78145)
13:15:00|Steven Tidwell|Application  Database Development|[Dynamic SQL: Tables, Pivots, Parameters  More](#sessionid-71851)
13:15:00|Dainius Sutkevicius|Enterprise Database Administration  Deployment|[How to transition from Profiler to Extended Events and why you should consider.](#sessionid-72972)
13:15:00|Jamey Johnston|Analytics and Visualization, BI Delivery|[Code Like a Snake Charmer - Intro to Python!](#sessionid-73010)
13:15:00|Angela Tidwell|Professional Development|[Becoming the MVP: Soft Skills for the Hard Market](#sessionid-73223)
13:15:00|Brian Guarnieri|Enterprise Database Administration  Deployment|[Security, Hypocrisy, and Standards, "OH MY" or How to hack your data center in three easy steps.](#sessionid-73927)
13:15:00|Eric Blinn|Enterprise Database Administration  Deployment|[Encryption:  Not just for the NSA anymore](#sessionid-74516)
13:15:00|Sean McCown|Enterprise Database Administration  Deployment|[Loading SQL Server Data with Powershell](#sessionid-77117)
13:15:00|Greg Galloway|BI Platform Architecture, Development  Administration|[Automating Azure Analysis Services](#sessionid-77768)
13:15:00|Chris Voss|BI Platform Architecture, Development  Administration|[Should This Be Normalized? When Database Normalization Seems Abnormal](#sessionid-78000)
14:30:00|Stacy Gray|Enterprise Database Administration  Deployment|[Troubleshooting SQL Server Performance](#sessionid-71610)
14:30:00|Tracy Boggiano|Enterprise Database Administration  Deployment|[Intro to Query Store](#sessionid-71673)
14:30:00|Bob Ward|Enterprise Database Administration  Deployment|[Experience SQL Server on Linux and Containers](#sessionid-73045)
14:30:00|Jennifer McCown|Enterprise Database Administration  Deployment|[Beginning Admin: The Care and Feeding of SQL Server](#sessionid-74144)
14:30:00|Je'Anna Lanza-Abbott|Professional Development|[Performance Tuning for Salary Negotiations](#sessionid-77082)
14:30:00|Steve Hughes|BI Platform Architecture, Development  Administration|[Data Security in Power BI](#sessionid-77561)
14:30:00|Jayaprakash Jothiraman|Application  Database Development|[Whats New in SQL Server 2017](#sessionid-77770)
14:30:00|Michael Bourgon|Cloud Application Development  Deployment|[AWS Aurora from a SQL Server DBA's perspective](#sessionid-78047)
14:30:00|David Stein|BI Platform Architecture, Development  Administration|[Azure Data Factory V2 and SSIS Automation With Biml](#sessionid-78089)
15:45:00|Thomas LeBlanc|BI Platform Architecture, Development  Administration|[Getting started with Tabular Analysis Services](#sessionid-71887)
15:45:00|Kevin Trojanowski|Application  Database Development|[SQL Unit Testing with T-SQLt](#sessionid-72016)
15:45:00|Suresh Kandoth|Enterprise Database Administration  Deployment|[SQL Server on Linux : Troubleshooting tips and tricks](#sessionid-72036)
15:45:00|Kris Hokanson|Application  Database Development|[That's bad mkay!](#sessionid-72613)
15:45:00|Reinaldo Kibel|Enterprise Database Administration  Deployment|[AlwaysOn on 2012/2014/2016/2017 Notes from the field and Best Practice](#sessionid-72616)
15:45:00|Mohammad Darab|Professional Development|[3 Lessons Learned in Successful Consulting](#sessionid-73212)
15:45:00|John Wells|Application  Database Development|[Fundamentals That Will Improve Your Query Performance!](#sessionid-75758)
15:45:00|Todd Kleinhans|Enterprise Database Administration  Deployment|[The Life Cycle of a Query in Virtual Reality](#sessionid-78076)
15:45:00|Ryan Casey|BI Platform Architecture, Development  Administration|["Real World" examples on loading a data warehouse using SSIS](#sessionid-80605)
#  
#### SessionID: 71611
# Python in SQL Server 2017
#### [Back to calendar](#SQLSaturday-#734---Dallas-2018)
Event Date: 19-05-2018 - Session time: 15:45:00 - Track: Analytics and Visualization, BI Delivery
## Speaker: Chris Hyde
...
#### [Back to calendar](#SQLSaturday-#734---Dallas-2018)
Event Date: 19-05-2018 - Session time: 15:45:00 - Track: Other
## Speaker: Mark Moore
...
#### [Back to calendar](#SQLSaturday-#734---Dallas-2018)
Event Date: 19-05-2018 - Session time: 15:45:00 - Track: Cloud Application Development  Deployment
