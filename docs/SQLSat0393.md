...
---|---|---|---
08:30:00|Michael Schaeffer|DBA|[Best Practices for Upgrading to SQL Server 2014](#sessionid-21128)
08:30:00|Paul Turley|BI|[Tabular Models: Easier  Faster Than Cubes; Really? ](#sessionid-21869)
08:30:00|Peter Myers|Design|[End-to-End SQL Server Master Data Services](#sessionid-22044)
08:30:00|Argenis Fernandez|Performance|[Stored Procedures vs. Ad-Hoc SQL: Performance Showdown!](#sessionid-9786)
09:45:00|David Eichner|BI|[SRS Report Builder for Business Intelligence](#sessionid-12801)
09:45:00|Sanjay Mishra|DBA|[Business Continuity with SQL Server: Real-Life War Stories](#sessionid-23969)
09:45:00|Vern Rabe|Performance|[Practical Fundamentals of Query Performance Tuning](#sessionid-27387)
09:45:00|Arnie Rowland|TSQL|[RC, SI, and RCSI, Oh My! –We're off to see the Wizard -to understand how it all works.](#sessionid-9868)
11:00:00|Dandy Weyn|BI|[Power BI - getting it right - a full walkthrough](#sessionid-12167)
11:00:00|Denis McDowell|DBA|[DevOps for the DBA - Bridging the Gap Between Infrastructure, Administration, and Development](#sessionid-13078)
11:00:00|Steve Jones|Design|[Get Testing with tSQLt](#sessionid-24544)
11:00:00|Aaron Buma|TSQL|[Organizing and Ranking SQL Result Sets](#sessionid-8828)
13:30:00|Robert Davis|DBA|[Diagnosing Performance with Wait Statistics](#sessionid-11463)
13:30:00|J May|DBA|[Columnstore Indexes in SQL Server 2014: Flipping the DW Fast](#sessionid-16842)
13:30:00|John McAllister|Design|[Enterprise-grade MDM On SQL Server - the Keys to Success ](#sessionid-17157)
13:30:00|Nicholas Cain|DBA|[WHAT HA/DR OPTION(S) ARE RIGHT FOR YOU](#sessionid-21424)
14:45:00|Karen Lopez|DBA|[5+ Database Design Blunders and How To Avoid Them](#sessionid-17914)
14:45:00|Steve Stedman|TSQL|[Exploring SQL Server  Join Types – INNER, OUTER, and much more](#sessionid-25752)
14:45:00|Varun  Singh|DBA|[Case Study: How answers.microsoft.com Overcame the key Challenges of Upgrading to SQL Server 2014 ](#sessionid-25900)
14:45:00|Marko Hotti|TSQL|[SQL Server 2016 Technical Overview on New Features](#sessionid-37061)
#  
#### SessionID: 21128
