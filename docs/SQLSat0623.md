...
---|---|---|---
09:55:00|Guy Glantser|Application  Database Development|[Analyzing Execution Plans Like a Pro](#sessionid-59638)
09:55:00|Amit Rappel|Advanced Analysis Techniques|[Make predictions using Azure Machine Learning Studio](#sessionid-61285)
09:55:00|Itshak David|Enterprise Database Administration  Deployment|[MSSQL on Linux and OPEN source full orchestra from 0 to hero!](#sessionid-62573)
09:55:00|Leonid Ore|BI Platform Architecture, Development  Administration|[Azure SQL DWH, from ingesting the data to providing analysis](#sessionid-63655)
11:10:00|Yossi Elkayam|Analytics and Visualization|[Near/Real Time Analytics with Power BI](#sessionid-59719)
11:10:00|Matan Yungman|Application  Database Development|[Elegant T-SQL Solutions for Real World Problems](#sessionid-62561)
11:10:00|Adi Cohn|Application  Database Development|[TempDB  behind the scenes](#sessionid-62762)
11:10:00|Gilad Mittelman|Application  Database Development|[Azure SQL Database: The Intelligent Cloud Database for App Developers](#sessionid-63207)
13:15:00|Dubi Lebel|Enterprise Database Administration  Deployment|[SQL Server engine under the hood](#sessionid-59883)
13:15:00|Nimrod Keinan|Other|[MSSQL To Run On Linux Systems, Can It Be? Well, Are you ready for the vNext step in evolution?](#sessionid-61450)
13:15:00|Sharon Oliar|Strategy and Architecture|[Hybrid SQL business continuity - Backup , DR and Monitoring](#sessionid-62504)
13:15:00|Ronen Ariely|Strategy and Architecture|[SQL Server Internals - Binary (Stored) format of the data](#sessionid-63290)
14:30:00|Niv Feldman|BI Platform Architecture, Development  Administration|[How to Setup and Manage a Corporate Self-Service Analytics Environment](#sessionid-61732)
14:30:00|yehuda lasri|Enterprise Database Administration  Deployment|[Next generation Saas solution for extreme database performance monitoring](#sessionid-62998)
14:30:00|Danny Ravid|Enterprise Database Administration  Deployment|[Your Database at the speed of Flash](#sessionid-63594)
14:30:00|Erez David|Professional Development|[SQL Server migration with Powershell and dbatools](#sessionid-63679)
15:15:00|Yuval Klein|Enterprise Database Administration  Deployment|[migrating from Sybase ASE data server to Sql Server 2016 VNext on Red Hat Linux](#sessionid-59652)
15:15:00|Satya Jayanty|Cloud Application Development  Deployment|[Big Data with Azure: where to begin? Concepts and best practices](#sessionid-61727)
15:15:00|shay shahak|Cloud Application Development  Deployment|[Secuiring Azure SQL](#sessionid-62463)
16:30:00|Ronen Chenn|BI Platform Architecture, Development  Administration|[Sql Server 2016 Tabular Architecture. Living On the Edge.](#sessionid-59671)
16:30:00|Pini Krisher|Cloud Application Development  Deployment|[Working with the  SQL Azure DB](#sessionid-59797)
16:30:00|Jan Mulkens|Advanced Analysis Techniques|[Enabling Citizen Data Science with Microsoft](#sessionid-61439)
#  
#### SessionID: 59638
