...
---|---|---|---
09:00:00|Alex Yates|DEV|[€20M+ fines and prison: General Data Protection Regulation (GDPR)](#sessionid-67566)
09:00:00|Stijn Wynants|BI/DEV|[Datawarehouse Lightning Performance with Columnstore!](#sessionid-67830)
09:00:00|Karen Lopez|DEV/DBA|[Data Modeling and Design for New Features in SQL Server and Cosmos DB](#sessionid-68283)
09:00:00|Janos Berke|DBA|[SQL Server Installation 101](#sessionid-68700)
09:00:00|Gašper Kamenšek|BI|[Power Query - The Best thing that ever happened in Excel](#sessionid-69700)
10:15:00|Uwe Ricken|DEV|[Advanced insides into System Versioned Temporal Tables](#sessionid-67544)
10:15:00|Regis Baccaro|BI/DEV|[Azure Data Factory vs SSIS, the Ins and Outs.](#sessionid-67603)
10:15:00|Christopher Adkin|DBA|[The All Flash DBA](#sessionid-67885)
10:15:00|Denis Reznik|DEV/DBA|[Hidden gems of SQL Server 2016](#sessionid-68235)
10:15:00|Prathy Kamasani|BI|[On-premises Power BI with Power BI premium and/or Power BI Report Server](#sessionid-68860)
11:30:00|Markus Ehrenmueller-Jensen|DEV|[A Game of Hierarchies: Introduction to Graph Processing with SQL](#sessionid-67608)
11:30:00|Wolfgang Strasser|BI/DEV|[Scale-Out your SSIS Package Executions](#sessionid-67650)
11:30:00|Chrissy LeMaire|DEV/DBA|[Introducing dbatools 1.0](#sessionid-68215)
11:30:00|LEONEL ABREU|DBA|[Security Enhancements in SQL Server 2016](#sessionid-68845)
11:30:00|Jason Horner|BI|[Dimensional Modeling Design Patterns: Beyond the Basics](#sessionid-70860)
13:30:00|Marcin Szeliga|BI|[State-of-the-Art Machine Learning Algorithms in R from Microsoft](#sessionid-67795)
13:30:00|Kamil Nowinski|DEV/DBA|[Understand better Transaction Isolation Levels](#sessionid-68025)
13:30:00|Cathrine Wilhelmsen|BI/DEV|[Tools and Tips for Data Warehouse Developers](#sessionid-68115)
13:30:00|Sergey Olontsev|DEV|[Tricky ways to optimize your T-SQL queries](#sessionid-69561)
13:30:00|Christina Leo|DBA|[Self-Healing Query Execution in SQL 2017](#sessionid-70597)
14:45:00|Paul Andrew|BI/DEV|[Building an End to End IoT Solution Using Raspberry Pi Sensors  Azure](#sessionid-67626)
14:45:00|Mikael Wedham|DEV/DBA|[A Masters view on Locking and blocking](#sessionid-68720)
14:45:00|Marcos Freccia|DBA|[Migrating your local database to Azure SQL DB](#sessionid-69075)
14:45:00|Gabi Münster|BI|[Scoped assignments – Threat or salvation? Some real life experiences…](#sessionid-69235)
14:45:00|Erland Sommarskog|DEV|[Dynamic Search Conditions](#sessionid-69666)
16:00:00|Enrico van de Laar|BI/DEV|[Crazy Data Science](#sessionid-68062)
16:00:00|David Williams|DBA|[SQL Server on Linux - SQL Server 2017 goes cross platform!](#sessionid-68130)
16:00:00|Joseph D'Antoni|DEV/DBA|[Design Seamless Upgrades to SQL Server 2017 with Query Store](#sessionid-68515)
16:00:00|Hugo Kornelis|DEV|[T-SQL User-Defined Functions, or: How to kill performance in one, easy step](#sessionid-69604)
16:00:00|Stephanie Locke|BI|[SQL Server and R for real-time predictions](#sessionid-69694)
#  
#### SessionID: 67566
