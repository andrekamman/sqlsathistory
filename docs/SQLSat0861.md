...
---|---|---|---
08:30:00|John Deardurff|Application  Database Development|[A Beginners Guide to Transactions](#sessionid-89200)
08:30:00|Julie McLain-Harper|Application  Database Development|[Large Transactional Data Migration: A Sr. DBA Case Study From The Trenches](#sessionid-89587)
08:30:00|Dave Mattingly|Cloud Application Development  Deployment|[Alexa, Talk to Me](#sessionid-91003)
08:30:00|Hope Foley|Advanced Analysis Techniques|[Throw a Brick at Your Data: Intro to Azure Databricks](#sessionid-91704)
08:30:00|Eugene Meidinger|Enterprise Database Administration  Deployment|[What's New with SQL Server 2019?](#sessionid-93009)
08:30:00|Slava Trofimov|BI Platform Architecture, Development  Administration|[Better Together: Power BI Dataflows and Azure Data Lake Storage](#sessionid-93015)
08:30:00|Jeff Moden|Enterprise Database Administration  Deployment|[“Black Arts” Index Maintenance #1: How the “Best Practice” Methods are Silently Killing Performance](#sessionid-93017)
09:45:00|Jim Miller|BI Platform Architecture, Development  Administration|[Populating a Data Warehouse with SSIS and Biml Patterns](#sessionid-89311)
09:45:00|Grant Fritchey|Application  Database Development|[Extending DevOps To SQL Server](#sessionid-89348)
09:45:00|Jess Pomfret|Enterprise Database Administration  Deployment|[Install  Configure SQL Server with PowerShell DSC](#sessionid-90633)
09:45:00|Phillip Labry|Cloud Application Development  Deployment|[Analysis Services is in Azure? Seriously!? Let's build a model!](#sessionid-91872)
09:45:00|Jeff Moden|Enterprise Database Administration  Deployment|[“Black Arts” Index Maintenance #2: Better Methods that Can Actually Prevent Fragmentation for Weeks.](#sessionid-93018)
09:45:00|Warren Sifre|BI Platform Architecture, Development  Administration|[Introduction To Data Lakes](#sessionid-93032)
09:45:00|Vanessa Kesten|BI Platform Architecture, Development  Administration|[Help Me SSIS Logging, You're My Only Hope!](#sessionid-93046)
11:00:00|John Deardurff|Application  Database Development|[Inside the Database Engine](#sessionid-89201)
11:00:00|Ben Weissman|Other|[SQL Server Big Data Clusters - A game changer?](#sessionid-89864)
11:00:00|Vladimir Oselsky|Application  Database Development|[Performance Tuning for SQL Developer through Execution Plans](#sessionid-90181)
11:00:00|Sriharsh Adari|BI Platform Architecture, Development  Administration|[Modernize Data Platform -  A Detailed Case Study](#sessionid-92876)
11:00:00|Greg Deckler|Analytics and Visualization|[Building a Machine Learning Regression Model with Zero Code in PowerBI](#sessionid-93023)
11:00:00|Erin Stellato|Enterprise Database Administration  Deployment|[Extending Your Use of Extended Events](#sessionid-93029)
13:00:00|Thomas Grohser|Application  Database Development|[You should use Column Store but Avoid the Mistakes I made. (1/2)](#sessionid-89316)
13:00:00|Thomas Grohser|Application  Database Development|[Implementing Key Value Store in SQL Server](#sessionid-89318)
13:00:00|Cassandra Faris|Professional Development|[Business  Technology: A Communication Guide](#sessionid-89655)
13:00:00|Bert Wagner|Analytics and Visualization|[The Analyst’s Guide To Finding and Fixing Performance Anti-Patterns](#sessionid-91491)
13:00:00|Andy Mallon|Application  Database Development|[Demystifying Data Compression](#sessionid-92265)
13:00:00|Allen White|Enterprise Database Administration  Deployment|[Emergency! Are You Ready for Disaster to Strike?](#sessionid-92958)
13:00:00|Rayis Imayev|Cloud Application Development  Deployment|[Continuous integration and delivery (CI/CD) in Azure Data Factory](#sessionid-93034)
13:00:00|Kerry Tyler|BI Platform Architecture, Development  Administration|[45 Minutes to Your First Tabular Model](#sessionid-93047)
13:00:00|David Maxwell|Professional Development|[Starting your own consulting firm without getting sued.](#sessionid-94870)
14:15:00|Kevin Feasel|Advanced Analysis Techniques|[Classification With Naive Bayes](#sessionid-89402)
14:15:00|Jonathan Stewart|BI Information Delivery|[Now you see it, but did you really?  Correcting visual fallacies...](#sessionid-92881)
14:15:00|Drew Furgiuele|Enterprise Database Administration  Deployment|[SQL Server and PowerShell: Let's Get Serious](#sessionid-93045)
14:15:00|Thomas Grohser|Application  Database Development|[You should use Column Store but Avoid the Mistakes I made. (2/2)](#sessionid-93641)
14:15:00|Joe McTaggart|Enterprise Database Administration  Deployment|[A TCP packet walks into a bar - Connectivity Issues and Bad Jokes](#sessionid-94137)
14:15:00|Tamera Clark|Professional Development|[The Community Speaks: WIT, LGBTQ, diversity and inclusion.](#sessionid-94946)
15:30:00|Sam Nasr|Application  Database Development|[Data Time Travel with SQL Server Temporal Tables](#sessionid-89786)
15:30:00|Ben Weissman|Information Delivery|[Let’s Build SSIS Packages with Biml – Live!](#sessionid-89863)
15:30:00|Lucas Feiock|Cloud Application Development  Deployment|[Lambda architecture design using Azure Databricks for advanced analytics](#sessionid-89984)
15:30:00|Jeff McKenzie|Application  Database Development|[Hey, You Got Your TDD in my SQL DB!](#sessionid-91616)
15:30:00|David Maxwell|Enterprise Database Administration  Deployment|[Watch this space!](#sessionid-93637)
15:30:00|Erin Stellato|Other|[Joker's Wild!](#sessionid-93766)
#  
#### SessionID: 89200
# A Beginners Guide to Transactions
#### [Back to calendar](#SQLSaturday-#861---Columbus-2019)
