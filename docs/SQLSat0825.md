...
---|---|---|---
08:30:00|John Deardurff|Application  Database Development|[A Beginners Guide to Transactions](#sessionid-86426)
08:30:00|Farouq Abukhamireh|BI Platform Architecture, Development  Administration|[Building a Microsoft Business intelligence Solution step-by-step](#sessionid-86490)
08:30:00|Chirag Shah|Enterprise Database Administration  Deployment|[Troubleshooting AlwaysOn Availability Groups - Common Customer Scenarios](#sessionid-86710)
08:30:00|Thomas Norman|Application  Database Development|[Encrypting Data within Sql Server](#sessionid-87196)
08:30:00|Wylie Blanchard|Professional Development|[Become a SQL Pro who’s in High Demand](#sessionid-88004)
08:30:00|H. Ross Reed|Enterprise Database Administration  Deployment|[SQL Server  Auditing](#sessionid-88034)
08:30:00|Phillip Labry|Cloud Application Development  Deployment|[Analysis Services is in Azure? Seriously!? Let's build a model!](#sessionid-88045)
08:30:00|Joseph D'Antoni|Enterprise Database Administration  Deployment|[Containers, Pods, and Databases- The Future of Infrastructure](#sessionid-88261)
08:30:00|Pat Phelan|Enterprise Database Administration  Deployment|[PowerShell for the Reluctant Administrator](#sessionid-88507)
08:30:00|Arthur Daniels III|Enterprise Database Administration  Deployment|[Performance tuning with SQL Server memory grants](#sessionid-89353)
09:50:00|David Maxwell|Enterprise Database Administration  Deployment|[Using Extended Events for Wait Stats Analysis](#sessionid-86449)
09:50:00|Ross LoForte|Enterprise Database Administration  Deployment|[Azure SQL Database Managed Instance for DBAs](#sessionid-86658)
09:50:00|David Giard|Cloud Application Development  Deployment|[How Cloud Computing Empowers a Data Scientist](#sessionid-86948)
09:50:00|Jim Miller|BI Platform Architecture, Development  Administration|[Populating a Data Warehouse with SSIS and Biml Patterns](#sessionid-87371)
09:50:00|Andy Wickman|Professional Development|[Lessons from Consulting:  Third-Party Vendors](#sessionid-87939)
09:50:00|Joseph D'Antoni|Application  Database Development|[Automagic Tuning - SQL Server 2017 and Beyond](#sessionid-88262)
09:50:00|Ravi Kumar|Analytics and Visualization|[Introduction to Azure Machine learning](#sessionid-88323)
09:50:00|Allan Hirt|Enterprise Database Administration  Deployment|[Top Tips for Deploying AGs and FCIs On Premises or In the Cloud](#sessionid-88326)
09:50:00|Chris Hyde|Analytics and Visualization|[Python in SQL Server 2017](#sessionid-88583)
09:50:00|Kevin Kline|Enterprise Database Administration  Deployment|[SentryOne Tools for Productivity and Performance](#sessionid-89334)
11:10:00|Rob Volk|Application  Database Development|[That's So Metadata: Discover Your Database From The Inside](#sessionid-86405)
11:10:00|Jordan Anderson|Analytics and Visualization|[Real-time Analytics with Azure](#sessionid-86508)
11:10:00|Jim Dorame|Cloud Application Development  Deployment|[COSMOS DB Develop Local Deploy Globally](#sessionid-86588)
11:10:00|Sean Forgatch|BI Platform Architecture, Development  Administration|[Azure Data Factory Ingestion Framework](#sessionid-87492)
11:10:00|Deborah Melkin|Application  Database Development|[Back to the Basics: T-SQL 101](#sessionid-88133)
11:10:00|David Klee|Enterprise Database Administration  Deployment|[Modern CPU Architecture and SQL Server Performance](#sessionid-88204)
11:10:00|Lonny Niederstadt|Enterprise Database Administration  Deployment|[Laying down the Law with SQL Server Resource Governor](#sessionid-88595)
11:10:00|Tyler Graham|BI Platform Architecture, Development  Administration|[Master Data Management: BI and Data Science’s Best Friend](#sessionid-90947)
11:10:00|David Bermingham|Enterprise Database Administration  Deployment|[Why Clustering for SQL Server High Availability?](#sessionid-91336)
11:10:00|Janis Griffin|Enterprise Database Administration  Deployment|[Database Performance Monitoring](#sessionid-91379)
12:40:00|Rob Volk|Enterprise Database Administration  Deployment|[Revenge: The SQL!](#sessionid-86404)
12:40:00|Neal Waterstreet|BI Platform Architecture, Development  Administration|[Master Data Management with SQL Server MDS](#sessionid-86968)
12:40:00|Anthony Nocentino|Cloud Application Development  Deployment|[Containers - You Better Get on Board!](#sessionid-88028)
12:40:00|Lynn Ballard|Analytics and Visualization|[Beginner's Guide to Text Mining:  What We Learn from SQL Saturday Presentation Abstracts](#sessionid-88031)
12:40:00|Brian Hansen|Application  Database Development|[The Amazing Utility of ROW_NUMBER()](#sessionid-88408)
12:40:00|John Eisbrener|Professional Development|[Got the Consulting Itch?  The Ins and Outs of being a Contractor for a Living](#sessionid-88482)
12:40:00|Jay Falck|Enterprise Database Administration  Deployment|[Introduction to Linux for SQL Server](#sessionid-88607)
12:40:00|Ola Hallengren|Enterprise Database Administration  Deployment|[Analyzing Performance Problems Using XEvents, DMVs  Query Store](#sessionid-90929)
12:40:00|Deji Akomolafe|Enterprise Database Administration  Deployment|[Virtualizing SQL Server on vSphere - Straight from the Source](#sessionid-91234)
12:40:00|Allan Hirt|Enterprise Database Administration  Deployment|[Modern Infrastructure Fundamentals for Database Professionals](#sessionid-91543)
14:00:00|Jim Donahoe|Enterprise Database Administration  Deployment|[New Instance, Now what?](#sessionid-86416)
14:00:00|Angela Henry|Application  Database Development|[Profiling Your Data](#sessionid-86547)
14:00:00|Michael Johnson|BI Platform Architecture, Development  Administration|[Get started with Power BI Dataflows](#sessionid-87985)
14:00:00|Joe Obbish|Application  Database Development|[Improving Columnstore Load Scalability on Large Servers](#sessionid-88503)
14:00:00|John Sterrett|Cloud Application Development  Deployment|[Successfully Migrating Existing Databases to Azure SQL Database](#sessionid-88604)
14:00:00|Riley Major|Application  Database Development|[Refactoring Monolith Database Stored Procedures](#sessionid-88609)
14:00:00|Kevin Kline|Application  Database Development|[Ten Query Tuning Techniques Every SQL Programmer Should Know](#sessionid-89333)
14:00:00|Bryan Walsh|Enterprise Database Administration  Deployment|[#GetModern with Dell EMC](#sessionid-91360)
14:00:00|Marsha Pierce|Enterprise Database Administration  Deployment|[How To Talk To Your Storage Admin](#sessionid-91855)
14:00:00|Wylie Blanchard|Professional Development|[You’re hired! Creating value before and after the interview to be](#sessionid-91857)
15:15:00|Hasan Savran|Application  Database Development|[Not your Dad's SQL Server; Contemporary twist on a classic standby.](#sessionid-86445)
15:15:00|Lucas Feiock|Cloud Application Development  Deployment|[Lambda architecture design using Azure Databricks for advanced analytics](#sessionid-87135)
15:15:00|Peter Shore|Cloud Application Development  Deployment|[Hello My Friends, Welcome to CosmosDB](#sessionid-87221)
15:15:00|David Bermingham|Enterprise Database Administration  Deployment|[High Availability and Disaster Recovery for SQL Server in Azure IaaS](#sessionid-87509)
15:15:00|Mike Byrd|Application  Database Development|[Climbing the SQL Server Index B-Tree](#sessionid-87713)
15:15:00|Dave Bland|Enterprise Database Administration  Deployment|[Is my SQL Server having Memory Pressure?](#sessionid-87978)
15:15:00|Jake Manske|Application  Database Development|[Diagnosing and fixing deadlocks in SQL Server](#sessionid-88502)
15:15:00|Amy Herold|Enterprise Database Administration  Deployment|[PowerShell for the DBA](#sessionid-88958)
15:15:00|Paul Stanton|Application  Database Development|[Azure SQL DevOps Simplified with Production Data](#sessionid-90927)
15:15:00|David Klee|Professional Development|[My Brain Has Blue Screened - Let's Laugh](#sessionid-91495)
#  
#### SessionID: 86426
# A Beginners Guide to Transactions
#### [Back to calendar](#SQLSaturday-#825-Chicago-2019)
...
#### [Back to calendar](#SQLSaturday-#825-Chicago-2019)
Event Date: 23-03-2019 - Session time: 15:15:00 - Track: BI Platform Architecture, Development  Administration
...
#### [Back to calendar](#SQLSaturday-#825-Chicago-2019)
Event Date: 23-03-2019 - Session time: 15:15:00 - Track: Enterprise Database Administration  Deployment
## Speaker: Chirag Shah
...
#### [Back to calendar](#SQLSaturday-#825-Chicago-2019)
Event Date: 23-03-2019 - Session time: 15:15:00 - Track: Analytics and Visualization
## Speaker: Ravi Kumar
