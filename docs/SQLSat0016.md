...
---|---|---|---
00:00:00|Adam Jorgensen|DBA2|[Performance Optimization Techniques](#sessionid-34921)
00:00:00|Adam Jorgensen|BI|[Dive into Querying Analysis Services with MDX](#sessionid-34922)
00:00:00|Andy Warren|DBA2|[Introduction to SQL Statistics](#sessionid-34933)
00:00:00|Andy Warren|DBA2|[Social and Not so Social Networking for the DBA](#sessionid-34934)
00:00:00|Brian Knight|BI|[Loading a Data Warehouse in SSIS](#sessionid-35002)
00:00:00|Brian Knight|BI|[Introduction to SQL Server Analysis Services(SSAS)](#sessionid-35003)
00:00:00|Chad Miller|DEV|[Powershell and SQL Server Administration](#sessionid-35056)
00:00:00|Chris  Eargle|DBA3|[RESTful Data](#sessionid-35058)
00:00:00|David Lapides|DBA4|[Planning and Deploying Performance Point Server](#sessionid-35082)
00:00:00|David Lapides|BI|[A tour of SQL Server and SharePoint Integration](#sessionid-35083)
00:00:00|Dean Richards|DBA2|[Tuna Helper - Proven Process for Tuning SQL](#sessionid-35094)
00:00:00|Jean-Claude Armand|DBA3|[DW Prescriptive Architecture Fast Track ](#sessionid-35156)
00:00:00|Jeffrey Garbus|DEV|[Choosing Indexes for Performance](#sessionid-35174)
00:00:00|Jeffrey Garbus|DBA|[Indexing for Join Optimization](#sessionid-35175)
00:00:00|Jeffrey Garbus|DBA2|[High Availability options in SQL Server 2008](#sessionid-35176)
00:00:00|Jorge Segarra|DBA|[Policy Based Management 101](#sessionid-35233)
00:00:00|Kendal Van Dyke|DBA3|[Transactional Replication: Beyond The Basics](#sessionid-35262)
00:00:00|Kendal Van Dyke|DEV|[Configuring SQL Access for the Web Developer\Admin](#sessionid-35263)
00:00:00|Kendal Van Dyke|DBA|[Working With XML in SQL Server](#sessionid-35265)
00:00:00|Devin Knight|BI|[Best Practices and Performance Tuning SSIS](#sessionid-35285)
00:00:00|Martin Pichardo|DEV|[SQL Server 2008 Spacial Data Type](#sessionid-35296)
00:00:00|Matt Larson|DBA|[Wait-Time Based SQL Server Performance Management](#sessionid-35297)
00:00:00|Maximo Trinidad|DEV|[PowerShell and SQL Server](#sessionid-35298)
00:00:00|Michael Antonovich|DBA4|[Save Time by Merging It](#sessionid-35322)
00:00:00|Michael Antonovich|DEV|[Identifying and Removing Duplicate Records ](#sessionid-35323)
00:00:00|Michael Mollenhour|DBA4|[SQL Smoking Mirrors](#sessionid-35329)
00:00:00|Michael Mollenhour|BI|[SQL 2008 Data Mining](#sessionid-35330)
00:00:00|Pam Shaw|DBA|[On Demand Report Subscriptions](#sessionid-35372)
00:00:00|Pam Shaw|DBA|[Tips  Tricks for dynamic SSRS Reports](#sessionid-35373)
00:00:00|Shervin Shakibi|DBA4|[Intro to SSIS](#sessionid-35434)
00:00:00|Shervin Shakibi|DBA4|[Advanced SSIS](#sessionid-35436)
00:00:00|Telmo Sampaio|DBA3|[SQL Server Beyond Relational](#sessionid-35462)
00:00:00|Vishal Shukla|DBA3|[ADO .Net Sync Services](#sessionid-35503)
00:00:00|Wes Dumey|DBA2|[ Building a Data Warehouse using SQL Server 2008](#sessionid-35510)
00:00:00|Wes Dumey|DBA4|[Transitions: From Employee to Free-lance](#sessionid-35511)
#  
#### SessionID: 34921
