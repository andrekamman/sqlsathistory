...
---|---|---|---
09:00:00|Troy Gallant|Enterprise Database Administration  Deployment|[Supercharge Your Maintenance Plans!](#sessionid-66455)
09:00:00|Patrick Keisler|Enterprise Database Administration  Deployment|[SQL Audit - Evidence Never Lies](#sessionid-66489)
09:00:00|Thomas LeBlanc|BI Platform Architecture, Development  Administration|[What’s new for SQL Server Analysis Services?](#sessionid-66718)
09:00:00|Shawn Meyers|Enterprise Database Administration  Deployment|[Monitoring and Alerting of Availability Groups](#sessionid-67074)
09:00:00|Rick Heiges|Enterprise Database Administration  Deployment|[Winning with Columnstore - A Customer Story](#sessionid-67449)
09:00:00|Amy Herold|Enterprise Database Administration  Deployment|[Deadlock, Block  Two Smoking Barrels: Breaking Down Blocking and Deadlocks](#sessionid-68198)
09:00:00|Geoff Hiten|Cloud Application Development  Deployment|[ARMed for Azure](#sessionid-68367)
09:00:00|Rob Volk|Application  Database Development|[Logging Messages in SQL Server](#sessionid-68479)
10:30:00|Arvin Meyer|Application  Database Development|[Database Creation Process](#sessionid-66450)
10:30:00|Christopher Sims|BI Platform Architecture, Development  Administration|[Getting graphy with CosmosDB Graph API with Gremlin](#sessionid-66456)
10:30:00|Tracy Boggiano|Enterprise Database Administration  Deployment|[Query Store Primer](#sessionid-66841)
10:30:00|Ronald Dameron|Enterprise Database Administration  Deployment|[Uptight Database Security](#sessionid-67343)
10:30:00|Michael Antonovich|BI Information Delivery|[Creating Reports and Dashboards with Power BI](#sessionid-67597)
10:30:00|Herve Roggero|Strategy and Architecture|[Replicating data from SharePoint Online to SQL Server](#sessionid-68406)
10:30:00|Dmitri Korotkevitch|Enterprise Database Administration  Deployment|[Cautionary Tale of Recompilations, Excessive CPU Load and Plan Caching](#sessionid-68516)
12:00:00|Shawn Meyers|Enterprise Database Administration  Deployment|[vNUMA, pNUMA, save your SQL Servers from certain DoomA](#sessionid-67075)
12:00:00|Diane Schuster|BI Platform Architecture, Development  Administration|[Excel and SSIS: Better Together](#sessionid-67095)
12:00:00|Rick Heiges|Professional Development|[Getting Noticed: Strategies for Your Resume and LinkedIn](#sessionid-67446)
12:00:00|Andy Warren|Enterprise Database Administration  Deployment|[Database Continuous Delivery](#sessionid-69670)
12:00:00|Andy Warren|Advanced Analysis Techniques|[The Path to #GetModern by Dell EMC](#sessionid-69894)
13:15:00|Jeff Taylor|Enterprise Database Administration  Deployment|[How To Tune A Multi-Terabyte Database For Optimum Performance.](#sessionid-66460)
13:15:00|Michael Corey|Cloud Application Development  Deployment|[Monster VM's (Database Virtualization) with vSphere 6.5 Doing IT Right](#sessionid-66470)
13:15:00|Hector Villafuerte|BI Platform Architecture, Development  Administration|[Data Security with Power BI, SSAS, SQL Server and Active Directory](#sessionid-66680)
13:15:00|Thomas LeBlanc|Application  Database Development|[Execution Plan Basics - Beginners](#sessionid-66719)
13:15:00|Neal Waterstreet|BI Platform Architecture, Development  Administration|[Master Data Management with SQL Server 2016 MDS](#sessionid-66807)
13:15:00|Elizabeth Noble|Application  Database Development|[Introduction to unit and integration testing with tSQLt](#sessionid-67599)
13:15:00|Jonathon Moorman|Strategy and Architecture|[Azure Sql PAAS: Lessons from the Real World](#sessionid-69468)
13:15:00|Bradley Ball|Advanced Analysis Techniques|[Baseball Analytics: SQL Server 2016 In-Database R](#sessionid-69847)
14:30:00|Daniel Janik|Advanced Analysis Techniques|[A DBA's guide to whole stack performance troubleshooting](#sessionid-66517)
14:30:00|Kevin Feasel|Analytics and Visualization|[Data Cleansing With SQL And R](#sessionid-66664)
14:30:00|Maximo Trinidad|Application  Database Development|[Working with SQL Server for Linux Cross-Platform](#sessionid-66679)
14:30:00|Sam Mesel|Other|[InMemory Improvements on SQL 2016](#sessionid-66721)
14:30:00|Tracy Boggiano|Enterprise Database Administration  Deployment|[Tips on Managing Lots of SQL Servers](#sessionid-66844)
14:30:00|Tom Hanley|BI Platform Architecture, Development  Administration|[SQL Server Data Partitioning](#sessionid-67052)
14:30:00|Sean Forgatch|BI Platform Architecture, Development  Administration|[Processing Big Data with Azure Data Lake Analytics](#sessionid-67397)
14:30:00|Jeffrey Garbus|Enterprise Database Administration  Deployment|[Indexing for performance](#sessionid-69206)
#  
#### SessionID: 66455
...
# ARMed for Azure
#### [Back to calendar](#nr-678)
Event Date: 07-10-2017 - Session time: 09:00:00 - Track: Cloud Application Development  Deployment
## Speaker: Geoff Hiten
