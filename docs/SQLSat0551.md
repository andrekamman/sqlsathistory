...
---|---|---|---
09:00:00|William Durkin|Enterprise Database Administration  Deployment|[You don't need Enterprise Edition to do that!](#sessionid-49437)
09:00:00|Jan Van humbeek|BI Platform Architecture, Development  Administration|[Bridging the gap - Introducing Mobile Reports](#sessionid-49531)
09:00:00|Koos van Strien|BI Platform Architecture, Development  Administration|[Connect your Shack: Building a Poor Man's IoT](#sessionid-51033)
09:00:00|André Melancia|Analytics and Visualization|[If a machine can learn, why can't YOU learn Azure Machine Learning?](#sessionid-53801)
09:00:00|Ola Hallengren|Enterprise Database Administration  Deployment|[Building a Performance Monitoring System Using XEvents](#sessionid-54467)
10:15:00|Joost van Rossum|BI Platform Architecture, Development  Administration|[Using PowerShell for SSIS](#sessionid-50296)
10:15:00|Joseph D'Antoni|Cloud Application Development  Deployment|[Flying Through the Clouds--Performance Tuning in Azure](#sessionid-50362)
10:15:00|Jan Pieter Posthuma|Analytics and Visualization|[Extending Power BI via the REST API and Power BI Embedded](#sessionid-50990)
10:15:00|Arthur Baan|Enterprise Database Administration  Deployment|[What’s new in SQL Server 2016 Availability Groups](#sessionid-53806)
10:15:00|Klaus Aschenbrenner|Enterprise Database Administration  Deployment|[Latches  Spinlocks](#sessionid-54333)
11:30:00|James Rowland-Jones|Cloud Application Development  Deployment|[A developers guide to Azure SQL Data Warehouse](#sessionid-49468)
11:30:00|Enrico van de Laar|Enterprise Database Administration  Deployment|[Introducing the SQL Server 2016 Query Store](#sessionid-49496)
11:30:00|Lord Richard Douglas|Application  Database Development|[Natural Born Killers, Performance Issues to Avoid](#sessionid-50382)
11:30:00|Remko de Boer|BI Platform Architecture, Development  Administration|[Master Data Services: Onbekend maakt Onbemind](#sessionid-50412)
11:30:00|Jose Manuel Jurado Diaz|Enterprise Database Administration  Deployment|[SQL SERVER - Next station Azure](#sessionid-52566)
13:30:00|Christopher Adkin|Enterprise Database Administration  Deployment|[Super Scaling the LMax Queuing Pattern With SQL Server](#sessionid-49585)
13:30:00|n/a n/a|Analytics and Visualization|[Session Details not available](#sessionid-51015)
13:30:00|Andre Batista|Application  Database Development|[Temporal Data in SQL Server 2016: Why, where and how we should use it ?](#sessionid-52821)
13:30:00|Torsten Strauss|Professional Development|[Query Optimizer (engl)](#sessionid-53021)
13:30:00|John Tunnicliffe|BI Platform Architecture, Development  Administration|[Continuous Integration and the Data Warehouse](#sessionid-53274)
14:45:00|John Martin|Enterprise Database Administration  Deployment|[Securing SQL Server, Patterns and Practices](#sessionid-49443)
14:45:00|Henk van der Valk|BI Platform Architecture, Development  Administration|[SQL Server 2016 Polybase- Benefits  how to get started?](#sessionid-49560)
14:45:00|Uwe Ricken|Application  Database Development|[Mastering DML Operations like a master](#sessionid-49634)
14:45:00|Sebastian van den Putten|Application  Database Development|[NoLock,  What does it exactly do ?](#sessionid-53064)
14:45:00|Rik Opdam|Cloud Application Development  Deployment|[Streaming Fast data with SQL Server  Azure](#sessionid-53879)
16:00:00|Pass NL|Enterprise Database Administration  Deployment|[QA DBA](#sessionid-54049)
16:00:00|Pass NL|Application  Database Development|[QA DB Development](#sessionid-54050)
16:00:00|Pass NL|BI Platform Architecture, Development  Administration|[QA BI](#sessionid-54051)
16:00:00|Pass NL|Cloud Application Development  Deployment|[QA Cloud](#sessionid-54052)
#  
#### SessionID: 49437
# You don't need Enterprise Edition to do that!
#### [Back to calendar](#nr-551)
