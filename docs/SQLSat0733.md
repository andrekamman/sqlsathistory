...
---|---|---|---
08:00:00|John Deardurff|101: Beginner Level Sessions|[The Vocabulary of Performance Tuning](#sessionid-71587)
08:00:00|Andrew Kelly|Enterprise Database Administration  Deployment|[A Day in the Life of the Query Store](#sessionid-71842)
08:00:00|Angela Henry|Application  Database Development|[Data Types Do Matter](#sessionid-72594)
08:00:00|David Bermingham|Enterprise Database Administration  Deployment|[SQL Server in "The Cloud": High Availability and Disaster Recovery in Azure, AWS and Google](#sessionid-73006)
08:00:00|Patrick LeBlanc|BI Platform Architecture, Development  Administration|[Introduction to Azure Analysis Services](#sessionid-73039)
08:00:00|Jeffrey Garbus|Enterprise Database Administration  Deployment|[Indexing for performance](#sessionid-73769)
08:00:00|Alex Grinberg|Application  Database Development|[XML and JSON, does the DBA need it?](#sessionid-74590)
08:00:00|Hilary Wilkie|Professional Development|[Becoming Moused - How you can apply Disney Leadership to your Data Teams](#sessionid-77054)
08:00:00|Neal Waterstreet|BI Platform Architecture, Development  Administration|[Master Data Management with SQL Server 2016 MDS](#sessionid-77776)
08:00:00|Frank Gill|Cloud Application Development  Deployment|[Azure Managed Instance: Reducing Maintenance Costs While Making Migration Simple](#sessionid-77805)
09:15:00|Karlyn LeBlanc|Professional Development|[Creating your Vision](#sessionid-71680)
09:15:00|David Maxwell|Application  Database Development|[Targeting Wait Statistics with Extended Events and DMVs](#sessionid-71984)
09:15:00|Monica Rathbun|Enterprise Database Administration  Deployment|[You're Stuck with Crappy Hardware, Now What?](#sessionid-72409)
09:15:00|Marsha Pierce|Enterprise Database Administration  Deployment|[Mom Rules for Managing Enterprise Database Environments](#sessionid-72877)
09:15:00|Dan Evans|BI Platform Architecture, Development  Administration|[Power BI administration made easy(ier)](#sessionid-73316)
09:15:00|Azhagappan Arunachalam|Enterprise Database Administration  Deployment|[SQL Server and Docker](#sessionid-73645)
09:15:00|Robert Cain|Cloud Application Development  Deployment|[Powering Azure SQL From PowerShell](#sessionid-73647)
09:15:00|Ravi Lobo|Application  Database Development|[A Sense of Automation](#sessionid-74345)
09:15:00|Marco Russo|BI Platform Architecture, Development  Administration|[DAX Optimization Examples](#sessionid-77620)
09:15:00|Michael Fal|101: Beginner Level Sessions|[SQL Server Recovery Fundamentals](#sessionid-77684)
10:30:00|Karen Nelson|Professional Development|[Why am I able to master several technology languages but I struggle in my own business language?](#sessionid-71943)
10:30:00|Bill Anton|BI Platform Architecture, Development  Administration|[What You Need To Know About Processing Tabular Models](#sessionid-72341)
10:30:00|Ed Watson|BI Platform Architecture, Development  Administration|[A Beginner's Guide to Power BI](#sessionid-73342)
10:30:00|Maxwell Myrick|Enterprise Database Administration  Deployment|[The Art and Science of Designing a Mission Critical SQL Server](#sessionid-74235)
10:30:00|Joseph D'Antoni|Cloud Application Development  Deployment|[Containers, Pods, and Databases--Learning About the Future of Infrastructure](#sessionid-77226)
10:30:00|Jonathan Stewart|BI Platform Architecture, Development  Administration|[Performance Tuning for the BI Professional](#sessionid-77415)
10:30:00|Louis Davidson|Application  Database Development|[How to Implement a Hierarchy in SQL Server](#sessionid-77418)
10:30:00|Carl Roepe|101: Beginner Level Sessions|[How to perform a health check](#sessionid-77783)
10:30:00|Kevin Kline|Enterprise Database Administration  Deployment|[Exploring SQL Server's Plan Cache](#sessionid-78761)
10:30:00|Rodney Landrum|Enterprise Database Administration  Deployment|[The DBA Script Thumb (10 year anniversary)](#sessionid-80421)
11:45:00|Rie Irish|Professional Development|[Well, actually...  How to not be THAT guy in IT](#sessionid-71580)
11:45:00|Diane Schuster|BI Platform Architecture, Development  Administration|[Dynamic Data Flows in SSIS without Programming](#sessionid-75802)
11:45:00|Marsha Pierce|Enterprise Database Administration  Deployment|[Virtualizing SQL Server](#sessionid-77711)
11:45:00|Michael Fal|Enterprise Database Administration  Deployment|[Simplifying SQL Data Protection](#sessionid-82093)
11:45:00|SQL Saturday Atlanta|Other|[#GetModern With Dell EMC  Dominick Dequarto](#sessionid-82199)
11:45:00|SQL Saturday Atlanta|Other|[How to Use Encryptionizer to Provide Transparent Encryption to Al](#sessionid-82200)
11:45:00|SQL Saturday Atlanta|Other|[Using RDS SQL Server on Amazon Web Services - Richard Waymire](#sessionid-82498)
11:45:00|David Bermingham|Other|[SANLess clustering for physical, virtual and cloud environments-](#sessionid-82710)
13:00:00|George Walkey|Enterprise Database Administration  Deployment|[Using Powershell to Document SQL Server](#sessionid-71596)
13:00:00|Jeff Reinhard|Enterprise Database Administration  Deployment|[Agile Database Development and Zero Downtime Deployments](#sessionid-71785)
13:00:00|Ryan Wade|BI Analysis, Visualization, and Delivery|[Should You Use M or R for Data Wrangling in Power BI? It Depends.](#sessionid-71989)
13:00:00|Stuart Ainsworth|Professional Development|[All (Data) Things Considered: The Lean Coffee Workshop](#sessionid-72022)
13:00:00|Eric Flamm|Enterprise Database Administration  Deployment|[Intro to SQL Operations Studio](#sessionid-72031)
13:00:00|Samir Behara|Application  Database Development|[DevOps, Continuous Integration  Database Lifecycle Management: Rule them all](#sessionid-77736)
13:00:00|Michael French|BI Platform Architecture, Development  Administration|[Consumption Based Architecture](#sessionid-77761)
13:00:00|Mike Walsh|101: Beginner Level Sessions|[High Availability and Disaster Recovery: Too Many Choices!](#sessionid-77799)
13:00:00|Kerry Tyler|Application  Database Development|[Managing Your Schema with Database Projects in Visual Studio](#sessionid-78850)
13:00:00|Eric Peterson|Enterprise Database Administration  Deployment|[SQL Performance and Tuning in the Amazon Cloud](#sessionid-80102)
14:15:00|Greg Moore|101: Beginner Level Sessions|[Whoa! Backup, what happened?](#sessionid-71650)
14:15:00|Tim Radney|Enterprise Database Administration  Deployment|[Azure SQL Database for the Production DBA](#sessionid-72562)
14:15:00|Jana Sattainathan|Enterprise Database Administration  Deployment|[Monitoring with sp_WhoIsActive, PowerShell and PowerBI](#sessionid-73659)
14:15:00|Kathi Kellenberger|Application  Database Development|[T-SQL Window Function Performance](#sessionid-73742)
14:15:00|Shannon Lowder|BI Platform Architecture, Development  Administration|[Build Your Extract Packages Automatically!](#sessionid-74116)
14:15:00|Teo Lachev|BI Platform Architecture, Development  Administration|[10 Ways to Empower Your BI Strategy with Power BI](#sessionid-74483)
14:15:00|Mike Lawell|Cloud Application Development  Deployment|[Cosmos DB: Planet Earth Scale](#sessionid-77272)
14:15:00|Robert Verell|Enterprise Database Administration  Deployment|[Right-Size Your Data Files](#sessionid-77567)
14:15:00|Elizabeth Noble|Professional Development|[How to win Dev and influence QA](#sessionid-77737)
14:15:00|Kevin Wilkie|Application  Database Development|[Even VIEWs can be sexy](#sessionid-77980)
15:30:00|Pritesh Ostwal|BI Platform Architecture, Development  Administration|[Power BI Analytics On Prem integration within your Apps](#sessionid-71651)
15:30:00|Anthony Nocentino|Enterprise Database Administration  Deployment|[Monitoring Linux Performance for the SQL Server Admin](#sessionid-71960)
15:30:00|Samara Soucy|101: Beginner Level Sessions|[Azure Data Lake for First Time Swimmers](#sessionid-73067)
15:30:00|Aaron Cutshall|Application  Database Development|["There Be Whales Here!" -- Big Data in SQL Server](#sessionid-73373)
15:30:00|Theresa Eller|BI Analysis, Visualization, and Delivery|[Manipulating SharePoint Data in Power BI](#sessionid-73929)
15:30:00|Michael Wharton|Cloud Application Development  Deployment|[Create SQL Server Test Premise Environment in Azure Cloud](#sessionid-74296)
15:30:00|Paul Waters|Application  Database Development|[Getting Git](#sessionid-77762)
15:30:00|Shabnam Watson|BI Platform Architecture, Development  Administration|[SQL Server Analysis Services for the DBA](#sessionid-78922)
15:30:00|Joseph D'Antoni|Enterprise Database Administration  Deployment|[SQL Server 2017 - It Just Gets Faster](#sessionid-82055)
15:30:00|Paco Gonzalez|101: Beginner Level Sessions|[Artificial Intelligence, Cognitive Services, and Power BI](#sessionid-82765)
#  
#### SessionID: 71587
