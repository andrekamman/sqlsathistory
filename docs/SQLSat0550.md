...
---|---|---|---
08:30:00|Joe Hellsten|Enterprise Database Administration  Deployment|[I Created an AG and T log is growing but I have a T Log backup What gives?](#sessionid:-49205)
08:30:00|Chris Shaw|Enterprise Database Administration  Deployment|[Tips for SQL Server Performance and Resiliency](#sessionid:-49668)
08:30:00|Chris Hyde|Analytics and Visualization|[SQL Server R Services in SQL 2016](#sessionid:-49875)
08:30:00|William Wolf|Application  Database Development|[Service Broker - Put Me In Coach](#sessionid:-50664)
08:30:00|Ted Stathakis|BI Platform Architecture, Development  Administration|[Reporting Services 2016: New Features  Smart Migration Strategy](#sessionid:-52290)
08:30:00|Sean McCown|Spotlight|[Be a DBA Army of One](#sessionid:-52333)
09:45:00|Steve Jones|Professional Development|[Branding Yourself for a Dream Job](#sessionid:-50072)
09:45:00|Jim Murphy|Enterprise Database Administration  Deployment|[Mission Possible: Interactive Performance Troubleshooting - Index](#sessionid:-50342)
09:45:00|John Sterrett|Enterprise Database Administration  Deployment|[Why Did My Execution Plan Change? Introduction to Query Store](#sessionid:-50535)
09:45:00|Daniel Janik|Advanced Analysis Techniques|[Translating SANanese to English: How to manipulate your storage admin!](#sessionid:-51109)
09:45:00|Kalen Delaney|Enterprise Database Administration  Deployment|[Recovery Models Made SIMPLE](#sessionid:-52321)
09:45:00|Rudy Rodarte|Application  Database Development|[Log SQL Server Activity on a Budget](#sessionid:-52420)
09:45:00|Ned Otter|Enterprise Database Administration  Deployment|[Real world In-Memory OLTP](#sessionid:-52905)
11:00:00|Mindy Curnutt|Professional Development|[Imposter Syndrome: Are You Faking It  Will they Find Out?](#sessionid:-49202)
11:00:00|Wayne Sheffield|Application  Database Development|[Table Vars and Temp Tables – What you NEED to Know!](#sessionid:-49328)
11:00:00|Stan Geiger|BI Platform Architecture, Development  Administration|[Polybase and Time Travel (Temporal Tables)](#sessionid:-50206)
11:00:00|John Harp|Enterprise Database Administration  Deployment|[Cluster@#$%!  SQL Server Failover Clusters. What Could Go Wrong?](#sessionid:-50723)
11:00:00|Jennifer Smith|Enterprise Database Administration  Deployment|[Designing for Performance – Smokin’ Fast Queries – Query optimiza](#sessionid:-52557)
11:00:00|Rick Lowe|Enterprise Database Administration  Deployment|[Why Should I Care About … The Plan Cache](#sessionid:-52706)
12:00:00|Naomi Williams|Spotlight|[EMC Presents: Maximizing Microsoft SQL Server Storage Investments](#sessionid:-53408)
12:00:00|Naomi Williams|Lunch|[Birds of a Feather -- SQL Server 2016](#sessionid:-53410)
12:00:00|Naomi Williams|Lunch|[Birds of a Feather -- Performance Tuning](#sessionid:-53411)
12:00:00|Naomi Williams|Lunch|[Birds of a Feather -- Data Analytics, Reporting and ETL](#sessionid:-53412)
12:00:00|Naomi Williams|Lunch|[Birds of a Feather -- High Availability](#sessionid:-53413)
12:00:00|Naomi Williams|Lunch|[Birds of a Feather -- Azure](#sessionid:-53414)
13:00:00|Jamey Johnston|Enterprise Database Administration  Deployment|[Enterprise Row Level Security in SQL Server 2016 and Azure SQL DB](#sessionid:-49200)
13:00:00|Lance Tidwell|Enterprise Database Administration  Deployment|[SQL Server Agent: The life preserver for the drowning DBA](#sessionid:-49617)
13:00:00|Mike Byrd|Application  Database Development|[SS2014/2016 In-Memory Tables --Formula One Performance Unleashed???](#sessionid:-50445)
13:00:00|John Sterrett|Cloud Application Development  Deployment|[Azure SQL Database for DBA's](#sessionid:-50533)
13:00:00|Tim Costello|BI Platform Architecture, Development  Administration|[Design a data warehouse dimension the Agile way!](#sessionid:-51096)
13:00:00|Konstantin Melamud|Enterprise Database Administration  Deployment|[Scaling for best performance: Partitioned views.](#sessionid:-52303)
13:00:00|Mark Moore|Enterprise Database Administration  Deployment|[SQL running on Linux](#sessionid:-52994)
14:15:00|Michael Bourgon|Enterprise Database Administration  Deployment|[Overlord - tracking changes real-time, in your environment](#sessionid:-49427)
14:15:00|Tim Mitchell|BI Platform Architecture, Development  Administration|[Introduction to Biml](#sessionid:-49854)
14:15:00|Jennifer McCown|Application  Database Development|[Unraveling Tangled Code:A Spellbinding Tale of Victory Over Chaos](#sessionid:-50034)
14:15:00|Shawn Weisfeld|Azure|[IaaS vs IaaS - Navigating the Decision Tree: Azure SQL DB vs SQL on a VM](#sessionid:-50809)
14:15:00|Lori Edwards|Enterprise Database Administration  Deployment|[SQL Server Statistics – What Are The Chances?](#sessionid:-51214)
14:15:00|Wesley Brown|Enterprise Database Administration  Deployment|[Understanding Storage Systems and SQL Server](#sessionid:-53065)
15:30:00|Ryan Casey|BI Platform Architecture, Development  Administration|[Create a Data Loading Strategy](#sessionid:-49220)
15:30:00|Keith Tate|Enterprise Database Administration  Deployment|[Profiler is Dead! Long Live Extended Events!](#sessionid:-50136)
15:30:00|Amy Herold|Enterprise Database Administration  Deployment|[Beginning Automation with Powershell](#sessionid:-50485)
15:30:00|John Sterrett|Cloud Application Development  Deployment|[Successfully Migrate Existing Databases to Azure SQL Database](#sessionid:-50534)
15:30:00|Matthew Brimer|Enterprise Database Administration  Deployment|[SQL Security Best Practices  Shrinking Your Attack Surface](#sessionid:-51053)
15:30:00|Russel Loski|Application  Database Development|[Meet JSON in SQL Server 2016](#sessionid:-51200)
#  
#### SessionID: 49205
