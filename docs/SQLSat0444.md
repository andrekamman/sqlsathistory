...
---|---|---|---
09:00:00|David Maxwell|Enterprise Database Administration  Deployment|[The Usual SUSPECTs: When Good Databases Go Bad](#sessionid:-37136)
09:00:00|John Deardurff|Application  Database Development|[The PROCESS of Queries](#sessionid:-38173)
09:00:00|Kathi Kellenberger|Application  Database Development|[T-SQL Window Function Performance](#sessionid:-38379)
09:00:00|Ed Leighton-Dick|Enterprise Database Administration  Deployment|[Extending Your Availability Group for Disaster Recovery](#sessionid:-39036)
09:00:00|John Morehouse|Enterprise Database Administration  Deployment|[Database Continuous Delivery  Your Salvation!](#sessionid:-39291)
09:00:00|Steve Wake|BI Platform Architecture, Development  Administration|[Date Dimension: Past  Future in One Script](#sessionid:-39767)
09:00:00|Chris Miller|Application  Database Development|[SQL Server and ElasticSearch Integration](#sessionid:-39841)
10:30:00|Scott Shaw|BI Platform Architecture, Development  Administration|[Navigating the Hadoop Stack](#sessionid:-37482)
10:30:00|Keith Tate|Enterprise Database Administration  Deployment|[Profiler is Dead! Long Live Extended Events!](#sessionid:-38200)
10:30:00|Jason Horner|BI Platform Architecture, Development  Administration|[Dimensional Modeling Design Patterns: Beyond Basics](#sessionid:-38498)
10:30:00|Rob Kraft|Other|[Defense in Depth - Minimizing the Risk of SQL Injection](#sessionid:-39511)
10:30:00|Tristan Wilson|Strategy and Architecture|[Sql Server Architecture for World Domination](#sessionid:-39780)
10:30:00|Andre DuBois|Enterprise Database Administration  Deployment|[Setting up your PowerShell Environment](#sessionid:-39970)
10:30:00|Russ Thomas|BI Platform Architecture, Development  Administration|[In Memory Tables; Not Just For OLTP](#sessionid:-40749)
12:15:00|KC SQLSaturday|Other|[Dell Software Performance Monitoring Solutions for SQL Server](#sessionid:-41151)
12:15:00|KC SQLSaturday|Other|[Data Science at Rockhurst](#sessionid:-41153)
13:00:00|Bill Graziano|Application  Database Development|[Building a Modern Transaction System on SQL Server](#sessionid:-39049)
13:00:00|Zane Brunette|Enterprise Database Administration  Deployment|[Cardinality estimation and how it affects your execution plan](#sessionid:-39199)
13:00:00|Melissa Coates|BI Platform Architecture, Development  Administration|[Power BI: Architecture, Integration Points, Implementation Options](#sessionid:-39369)
13:00:00|Sudhir Gajre|Cloud Application Development  Deployment|[What, Why, and How of Cloud Migrations](#sessionid:-39505)
13:00:00|Wendy Pastrick|Application  Database Development|[Visualizing Your Indexes - Science vs Art](#sessionid:-40023)
13:00:00|Xuan Pham|BI Information Delivery|[SQL in SAS and R](#sessionid:-40212)
13:00:00|Dave Fackler|BI Platform Architecture, Development  Administration|[CSI: DW -- Anatomy of a VLDW!](#sessionid:-40358)
14:30:00|Reeves Smith|BI Platform Architecture, Development  Administration|[Data Integration with Master Data Services ](#sessionid:-39234)
14:30:00|Leslie Weed|BI Platform Architecture, Development  Administration|[Source Control practices for your BI World](#sessionid:-39565)
14:30:00|Michael Bourgon|Enterprise Database Administration  Deployment|[Know what your machines are doing besides SQL Server - WMI, WQL, and PoSH](#sessionid:-39733)
14:30:00|Chase Aucoin|Advanced Analysis Techniques|[Azure Machine Learning - Building New Value From Old Data](#sessionid:-39810)
14:30:00|Brandon Reno|Application  Database Development|[Splitting your tables: Partitioning Basics](#sessionid:-39822)
14:30:00|Dave Walden|Enterprise Database Administration  Deployment|[A Look At SQL Server 2016 Always Encrypted](#sessionid:-39845)
14:30:00|Myles Gartland|Advanced Analysis Techniques|[Trees, Forests and Predictive Models](#sessionid:-40214)
14:30:00|KC SQLSaturday|Other|[Lightning Talks](#sessionid:-41175)
16:00:00|Matt Wigdahl|Application  Database Development|["But It Sounded So Simple!":  Building a Messaging System in Service Broker](#sessionid:-37041)
16:00:00|JD Wade|BI Platform Architecture, Development  Administration|[Connected at the hip for MS BI: SharePoint and SQL](#sessionid:-37351)
16:00:00|Jeff Renz|Application  Database Development|[Introduction to Microsoft Azure DocumentDB](#sessionid:-38576)
16:00:00|Brian Hansen|Enterprise Database Administration  Deployment|[Create a Simple Operational Data Store](#sessionid:-39775)
16:00:00|Christopher Wolff|Application  Database Development|[Continuous Deployments using SSDT](#sessionid:-40084)
16:00:00|Bill Fellows|BI Platform Architecture, Development  Administration|[What is Biml and why are SSIS people talking about it?](#sessionid:-40303)
16:00:00|Melissa Coates|BI Platform Architecture, Development  Administration|[Power BI Open QA](#sessionid:-41147)
#  
#### SessionID: 37136
