...
---|---|---|---
08:30:00|Andrew Loree|Enterprise Database Administration  Deployment|[SQL Server 2017 (Linux and Beyond)](#sessionid-61099)
08:30:00|Brian Carrig|Cloud Application Development  Deployment|[Running SQL Server in AWS](#sessionid-61709)
08:30:00|Brian Beswick|BI Platform Architecture, Development  Administration|[SSAS 2016 Tabular - Diving into the new features](#sessionid-62869)
08:30:00|Kevin Hill|Enterprise Database Administration  Deployment|[SQL Server Security model, in plain English](#sessionid-63360)
08:30:00|Vladimir Oselsky|Application  Database Development|[Crash Course on Better SQL Development](#sessionid-63987)
08:30:00|Rick Lowe|Application  Database Development|[Why should I care about ... the plan cache?](#sessionid-64582)
08:30:00|Paul Southerland|BI Information Delivery|[Self Service BI – ETL and More From A Business Unit User’s Perspective](#sessionid-65051)
09:45:00|Tim Gorman|Enterprise Database Administration  Deployment|[Accelerating DevOps and TDM Using Data Virtualization](#sessionid-59603)
09:45:00|Jim Donahoe|Enterprise Database Administration  Deployment|[New Instance, Now what?](#sessionid-59653)
09:45:00|David Patrick|BI Information Delivery|[Microsoft and Big Data - An Overview of the Power Tools and more!](#sessionid-59690)
09:45:00|Jeff Foushee|Application  Database Development|[Transforming Data using the T-SQL PIVOT / UNPIVOT operators](#sessionid-59771)
09:45:00|Eric Cobb|Enterprise Database Administration  Deployment|[How To Be The DBA When You Don't Have A DBA](#sessionid-61495)
09:45:00|Daniel Glenn|BI Platform Architecture, Development  Administration|[Power BI  SharePoint - A Marriage Made in Redmond](#sessionid-61715)
09:45:00|Mindy Curnutt|Application  Database Development|[The Ins and Outs of SQL Indexes](#sessionid-63842)
09:45:00|Elizabeth Noble|Application  Database Development|[Making Your List and Checking It Twice: Introduction to unit testing with tSQLt](#sessionid-64500)
09:45:00|Shabnam Watson|BI Platform Architecture, Development  Administration|[Performance Monitoring SQL Server Analysis Services](#sessionid-65086)
11:00:00|Samir Behara|Application  Database Development|[Increase Your Coding Speed in SQL Server Management Studio](#sessionid-59796)
11:00:00|Christopher Sims|Application  Database Development|[I like big data for $400  - Exploring quiz show questions using Angular, DocumentDB and Azure Search](#sessionid-62619)
11:00:00|Ed Watson|BI Platform Architecture, Development  Administration|[Introduction to SQL Server Integration Services](#sessionid-63563)
11:00:00|Ryan Wade|Advanced Analysis Techniques|[Leveraging SQL Server R Services to Perform Advanced Analytics](#sessionid-63667)
11:00:00|Kevin Wilkie|Application  Database Development|[The Real Value of Name-Value Pairs: Using PIVOT and UNPIVOT](#sessionid-63905)
11:00:00|Kerry Tyler|BI Platform Architecture, Development  Administration|[45 Minutes to Your First SSAS Tabular Model](#sessionid-64586)
11:00:00|Robert Verell|Enterprise Database Administration  Deployment|[New Features in SQL Server 2017](#sessionid-64593)
13:15:00|Louis Davidson|Application  Database Development|[Database Design Fundamentals](#sessionid-62784)
13:15:00|Teo Lachev|BI Information Delivery|[Understanding Power BI Premium](#sessionid-63796)
13:15:00|Stacia Varga|BI Platform Architecture, Development  Administration|[Reduce, Reuse, Recycle: Automating Your BI Framework](#sessionid-64272)
13:15:00|Russel Loski|Cloud Application Development  Deployment|[Querying Semistructured Data in Azure Data Lake with USQL](#sessionid-64360)
13:15:00|Mike Robbins|Other|[PowerShell Non-Monolithic Script Module Design](#sessionid-64554)
13:15:00|Paco Gonzalez|Advanced Analysis Techniques|[Enterprise Machine Learning with R and SQL Server 2016  2017](#sessionid-64589)
13:15:00|Dan Evans|Advanced Analysis Techniques|[Perceptual Intelligence with Cortana Analytics](#sessionid-64591)
14:30:00|Tracy Boggiano|Enterprise Database Administration  Deployment|[Monitoring Availability Groups](#sessionid-61330)
14:30:00|Neal Waterstreet|BI Platform Architecture, Development  Administration|[Master Data Management with SQL Server 2016 MDS](#sessionid-61528)
14:30:00|Thomas Chan|Enterprise Database Administration  Deployment|[Secure/Encrypt SQL Server Database With TDE](#sessionid-63259)
14:30:00|Naomi Williams|Enterprise Database Administration  Deployment|[SQL Server Internals](#sessionid-63461)
14:30:00|Ryan Wade|Analytics and Visualization|[R-ternatives in Power BI](#sessionid-63668)
14:30:00|Kevin Boles|Other|[SQL Server 2016 SP1 ROCKS!!](#sessionid-63699)
14:30:00|Matt Martin|Enterprise Database Administration  Deployment|[5 Ways to Bypass or Ensure Security](#sessionid-63832)
14:30:00|Tamera Clark|Enterprise Database Administration  Deployment|[Reduce your DBA ( DEV) task list by using Microsoft BI tools](#sessionid-66145)
15:45:00|Tim Warner|Enterprise Database Administration  Deployment|[Install and Configure SQL Server with Windows PowerShell Desired State Configuration](#sessionid-59605)
15:45:00|Kevin Feasel|Analytics and Visualization|[R For the SQL Server Developer](#sessionid-59677)
15:45:00|Kevin Boles|Enterprise Database Administration  Deployment|[On-Demand Creation of Dev/Test Databases with SQL Clone](#sessionid-61809)
15:45:00|Azhagappan Arunachalam|Application  Database Development|[Excel with DAX](#sessionid-63017)
15:45:00|Richard Weiss|Cloud Application Development  Deployment|[A Tour of Cloud Data Platforms as a Service](#sessionid-63388)
15:45:00|William Wolf|Application  Database Development|[Locks, Blocks, and Deadlocks; Tame the Sibling Rivalry](#sessionid-64146)
15:45:00|Simon Kingaby|BI Platform Architecture, Development  Administration|[Using Biml to Automate the Generation of SSIS Packages](#sessionid-65050)
#  
#### SessionID: 61099
