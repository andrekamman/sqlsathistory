...
---|---|---|---
09:00:00|Etienne Lopes|Enterprise Database Administration  Deployment|[Query Store in SQL Server 2016](#sessionid-50583)
09:00:00|Eduardo Piairo|Application  Database Development|[Road to database automation: Database source control](#sessionid-50996)
09:00:00|João Lopes|BI Platform Architecture, Development  Administration|[Integration Services Architecture -  (SSIS) Modern Framework ](#sessionid-52704)
09:00:00|Ricardo Cabral|Application  Database Development|[What is Windows Nano Servers ?](#sessionid-52753)
10:30:00|Johan Bijnens|Enterprise Database Administration  Deployment|[Moving your SQL Server backups to Azure Blob storage](#sessionid-50369)
10:30:00|Murilo Miranda|Cloud Application Development  Deployment|[Azure SQL Database - Migrating from On-Premise to Azure](#sessionid-51189)
10:30:00|Vitor Pombeiro|Strategy and Architecture|[What is SQL Data Warehouse? Is it for me?](#sessionid-52711)
10:30:00|Filipe Coelho|Analytics and Visualization|[Notebooks, notebooks everywhere!](#sessionid-53883)
11:45:00|Gerhard Brueckl|BI Platform Architecture, Development  Administration|[What's New in Analysis Services 2016](#sessionid-50751)
11:45:00|Stijn Wynants|BI Platform Architecture, Development  Administration|[Real-Time Analytics: OLAP  OLTP in the mix!](#sessionid-50933)
11:45:00|Andre Batista|Application  Database Development|[Polybase in SQL Server 2016: Let's query Big Data with T-SQL !](#sessionid-52736)
11:45:00|Remus Rusanu|Enterprise Database Administration  Deployment|[How to monitor efficiently your SQL Server instances](#sessionid-52737)
11:45:00|Scott Klein|Application  Database Development|[Fun with SQL Server 2016 Stretch Database, Temporal, and Always Encrypted](#sessionid-53792)
14:00:00|Mark Broadbent|Enterprise Database Administration  Deployment|[Lockless in Seattle: In-Memory OLTP Transaction Processing](#sessionid-48814)
14:00:00|Ivan Campos|Enterprise Database Administration  Deployment|[Hiding your data with SQL Server 2016](#sessionid-49134)
14:00:00|Niko Neugebauer|Strategy and Architecture|[Hadoop's Architecture it's relation to Microsoft Data Platform](#sessionid-52430)
14:00:00|Pedro Perfeito|BI Information Delivery|[Data Visualization through Microsoft platform](#sessionid-52958)
16:00:00|Christopher Adkin|Enterprise Database Administration  Deployment|[Super Scaling the LMax Queuing Pattern With SQL Server](#sessionid-49000)
16:00:00|Sander van der hoeff|BI Information Delivery|[Unlock the Power of Pivot Tables](#sessionid-49339)
16:00:00|Cláudio Silva|Enterprise Database Administration  Deployment|[Squeezing SQL Server Management Studio](#sessionid-52584)
16:00:00|Pedro Sousa|Enterprise Database Administration  Deployment|[Docker Containers and SQL Server coexistence](#sessionid-52765)
17:10:00|Rui Quintino|Advanced Analysis Techniques|[First steps with  R in the Microsoft Data Platform](#sessionid-49362)
17:10:00|David Barbarin|Enterprise Database Administration  Deployment|[Troubleshooting scenarios with SQL Server availability groups](#sessionid-49869)
17:10:00|Dave Ballantyne|Application  Database Development|[An Introduction to Execution Plans and The Query Optimizer](#sessionid-50662)
#  
#### SessionID: 50583
# Query Store in SQL Server 2016
#### [Back to calendar](#SQLSaturday-#546-Oporto-2016)
