...
---|---|---|---
00:00:00|Brian Flynn|APP DEV / DBA|[Pivoting Performance Data  Pinpointing Problems](#sessionid-10400)
00:00:00|Brad Baker|BIA / BID|[Data Quality Services and SSIS](#sessionid-10617)
00:00:00|Carlos Bossy|BIA|[Enterprise Tabular Models](#sessionid-11334)
00:00:00|Carlos Bossy|BIA|[Predictive Modeling with SQL Server Data Mining](#sessionid-11335)
00:00:00|Chris Shaw|DBA|[Interview Tips](#sessionid-11495)
00:00:00|Chris Shaw|DBA|["What is the Best Disaster Recovery Solution?"](#sessionid-11496)
00:00:00|Colin Smith|APP DEV|[Delphix Agile Data Management](#sessionid-11756)
00:00:00|Colin Smith|APP DEV / DBA|[Intermediate Powershell for the DBA](#sessionid-11757)
00:00:00|David Eichner|APP DEV|[Matching and Survivorship](#sessionid-12724)
00:00:00|Dave Pettengill|Azure Big Data Prof Dev|[A Heart ot Heart with the Business User](#sessionid-13403)
00:00:00|Dave Pettengill|DBA|[Virtualizing Business Critical SQL Servers](#sessionid-13404)
00:00:00|Joseph Verftido|APP DEV|[Global Address Data: Storage and Verification](#sessionid-17481)
00:00:00|Josh Sivey|BID|[SSRS – Implementing a Rendering Extension](#sessionid-17499)
00:00:00|Josh Sivey|APP DEV|[Unit Testing your SQL Server database using tSQLt](#sessionid-17500)
00:00:00|Kathy  Gibbs|DBA|[Best Practices for Monitoring Databases on VMware](#sessionid-17978)
00:00:00|Kathy  Gibbs|BIA / DBA|[Extend your Knowledge with Extended Events](#sessionid-17979)
00:00:00|Kat Long|DBA|[Case studies of Disaster Recovery](#sessionid-17989)
00:00:00|Matt Smith|DBA/BIA|[Designing SSAS for performance and scalability.](#sessionid-19338)
00:00:00|Martin Schoombee|DBA/BIA|[The 10 Commandments of ETL](#sessionid-19749)
00:00:00|Mark Halstead|DBA|[PowerShell for the SQL Server DBA](#sessionid-20139)
00:00:00|Orion Gebremedhin|BIA|[SSAS 2012 Dynamic Security in Tabular Models ](#sessionid-21592)
00:00:00|Orion Gebremedhin|BID|[MDX For Reporting](#sessionid-21593)
00:00:00|Nate Locklin|BID|[Spatial Data in SQL Server Reporting Services](#sessionid-21696)
00:00:00|Paul Turley|BID|[Visualization Choices: What, When, and How?](#sessionid-21845)
00:00:00|Paul Turley|BID|[Use a custom assembly to extend reports  queries](#sessionid-21846)
00:00:00|Randy Knight|BIA / DBA|[Understanding Transaction Isolation Levels](#sessionid-22508)
00:00:00|Randy Knight|APP DEV / DBA|[But it worked great in Dev!  Perfomance for Devs](#sessionid-22509)
00:00:00|Reeves Smith|BIA / DBA|[Get Into Evaluation Context with DAX, the Language of PowerPivot](#sessionid-22769)
00:00:00|Reeves Smith|BIA / BID|[Master Data Services – 101](#sessionid-22770)
00:00:00|Jeff Renz|DBA/BIA|[Tabular Models](#sessionid-22882)
00:00:00|Jeff Renz|BIA|[Data Vault Data Warehouse Architecture](#sessionid-22883)
00:00:00|Robert Miller|APP DEV|[Secret life of windowing functions](#sessionid-23085)
00:00:00|Robert Miller|APP DEV|[You got an OVER clause in my SQL.](#sessionid-23086)
00:00:00|Russ Burns|BIA / BID|[PowerPivot and Power View for the Business Analyst](#sessionid-23564)
00:00:00|Russ Burns|BIA / BID|[Why SSRS/SharePoint Integration Is Worth The Pain](#sessionid-23565)
00:00:00|Ryan McCauley|DBA/BIA|[Introduction to SQL executions plans](#sessionid-23705)
00:00:00|Scott Klein|Azure Big Data Prof Dev|[Kung Fu Migration to Windows Azure SQL Database](#sessionid-24146)
00:00:00|Scott Klein|Azure Big Data Prof Dev|[Cloud Database Scalability with SQL Federation](#sessionid-24148)
00:00:00|Shannon Lowder|Azure Big Data Prof Dev|[OnPremise to Azure](#sessionid-24623)
00:00:00|Stacia Varga|Azure Big Data Prof Dev|[A Big Data Primer](#sessionid-24708)
00:00:00|Stacia Varga|BIA / BID|[Taking BI to the Next Level: Collaboration](#sessionid-24709)
00:00:00|Phil Robinson|BID|[Report Delivery - From Report Manager to the Cloud](#sessionid-24944)
00:00:00|Kevin Boles|BIA|[Indexing Deep Dive ](#sessionid-26237)
00:00:00|Kevin Boles|DBA/BIA|[Common TSQL Mistakes](#sessionid-26238)
00:00:00|Kevin Boles|APP DEV / DBA|[File IO Stalls and Wait Stats - Tune Like Guru!](#sessionid-26241)
00:00:00|Vern Rabe|APP DEV / DBA|[The Significance of Choosing and Using Data Types](#sessionid-27375)
00:00:00|Vern Rabe|BIA / DBA|[Columnstore Indexes in SQL Server 2012](#sessionid-27376)
00:00:00|William E Pearson III|BIA|[Possible Musics:  SSAS Multidimensional vs Tabular](#sessionid-28072)
00:00:00|William E Pearson III|BIA / DBA|[Getting Started with MDX:  The (Very) Basics](#sessionid-28074)
00:00:00|Andrew Duclos|DBA/BIA|[SQL Server Data Tools Tips and Tricks](#sessionid-9483)
#  
#### SessionID: 10400
# Pivoting Performance Data  Pinpointing Problems
#### [Back to calendar](#nr-193)
