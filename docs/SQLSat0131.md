...
---|---|---|---
00:00:00|Brad Baker|SSIS|[What's New in SQL Server 2012 SSIS Development](#sessionid-10132)
00:00:00|Carlos Bossy|BI Architecture|[Real-time Data Warehouse and Reporting](#sessionid-11318)
00:00:00|Carlos Bossy|BI Architecture|[Fast-track to BI Analytics with SQL Server 2012](#sessionid-11321)
00:00:00|Meredith Ryan-Smith|DBA|[Backup Basics - Know your options](#sessionid-11747)
00:00:00|Meredith Ryan-Smith|App Dev / DBA|[Replication Basics](#sessionid-11748)
00:00:00|Colin Smith|DBA|[Powershell for the DBA](#sessionid-11758)
00:00:00|David Ikeda|Microsoft|[Introduction to SQL Server 2012 AlwaysON](#sessionid-12817)
00:00:00|David Ikeda|Professional Development / Azure|[Training  Certifications for SQL Server 2012 ](#sessionid-12818)
00:00:00|Denise McInerney|App Dev / DBA|[“BEGIN…COMMIT” is Not Enough](#sessionid-13092)
00:00:00|Gus Apostol|Microsoft|[SQL Server 2012 Memory Manager Changes](#sessionid-14862)
00:00:00|Gus Apostol|Microsoft|[Troubleshooting SQL Server Performance](#sessionid-14863)
00:00:00|Jacob Wilson|BI Delivery|[SSRS 2012 and SharePoint 2010 Integration](#sessionid-15524)
00:00:00|Jeff Jones|App Dev|[Transact-SQL does Windows](#sessionid-16357)
00:00:00|Josh Sivey|BI Architecture|[SSAS - Usage Based Optimization](#sessionid-17502)
00:00:00|Josh Sivey|BI Architecture|[SSAS/MDX - Performing "point in time" analysis](#sessionid-17503)
00:00:00|Jason Volpe|BI Architecture|[How To Create A BI Semantic Model](#sessionid-17808)
00:00:00|Jason Volpe|Microsoft|[The Ins and Outs of PowerView](#sessionid-17809)
00:00:00|Jason Volpe|Microsoft|[What Does SQL 2012 Mean For SharePoint](#sessionid-17810)
00:00:00|Kathrine Lord|Professional Development / Azure|[Agile modeling and reporting with BISM and Azure](#sessionid-17966)
00:00:00|Kathy  Gibbs|DBA|[Best Practices for Monitoring Databases on VMware](#sessionid-17967)
00:00:00|Lou Carbone|Microsoft|[Migrating Oracle to SQL Server](#sessionid-18980)
00:00:00|Matt Smith|BI Architecture|[What's this columnstore index thing all about?](#sessionid-19339)
00:00:00|Martin Schoombee|BI Architecture|[Temporal Fact Tables: The Road Less Traveled](#sessionid-19744)
00:00:00|Martin Schoombee|BI Architecture|[DW Architecture: More than just Facts  Dimensions](#sessionid-19745)
00:00:00|Randy Knight|App Dev / DBA|[Understanding SQL Server XML Features ](#sessionid-22481)
00:00:00|Randy Knight|App Dev|[But it worked great in Dev!  Perfomance for Devs](#sessionid-22482)
00:00:00|Randy Knight|App Dev / DBA|[Become Bilingual! Oracle for the SQL Server DBA](#sessionid-22483)
00:00:00|Jeff Renz|SSIS|[Advanced SQL Server Integration Services](#sessionid-22903)
00:00:00|Jeff Renz|BI Architecture|[The 2012 Data Warehouse Architecture Debate](#sessionid-22904)
00:00:00|Jeff Renz|BI Delivery|[The Best Dashboard on the Block](#sessionid-22905)
00:00:00|Robert Miller|App Dev|[Using TVPs in .Net applications](#sessionid-23087)
00:00:00|Robert Miller|App Dev|[Using Change Tracking and Change Data Capture](#sessionid-23088)
00:00:00|Rushabh Mehta|SSIS|[SSIS 2012 Mgmt Considerations  Best Practices](#sessionid-23108)
00:00:00|Samuel greene|DBA|[Automation and Monitoring for the DBA](#sessionid-23919)
00:00:00|Doug Brendle|DBA|[What is this cache and how did it get so big?](#sessionid-24031)
00:00:00|Steve Jones|Professional Development / Azure|[Branding Yourself for a Dream Job](#sessionid-24450)
00:00:00|Steve Jones|App Dev|[Encryption in SQL Server](#sessionid-24451)
00:00:00|Stacia Varga|BI Delivery|[(Way Too Much) Fun with Reporting Services ](#sessionid-24719)
00:00:00|Stacia Varga|BI Delivery|[Data Visualization in Reporting Services](#sessionid-24720)
00:00:00|Stacia Varga|BI Delivery|[Power View: A Peek Behind the Curtain](#sessionid-24721)
00:00:00|Mark Bosley|App Dev|[Stupid SQL and the Programmers that Write it](#sessionid-26942)
00:00:00|Tom Marek|BI Delivery|["Ad Hoc Analytics – Can my customer do that?”](#sessionid-26986)
00:00:00|Tom Marek|BI Architecture|[BISM Partitions, Security and Hierarchies](#sessionid-26988)
00:00:00|Tom Kallal|App Dev / DBA|[T-SQL Utilities for Serious DBAs](#sessionid-27039)
00:00:00|William E Pearson III|BI Architecture|[Beyond Plateaux: Optimize SSAS with Best Practices](#sessionid-27884)
00:00:00|William E Pearson III|Professional Development / Azure|[Documenting Your Integrated Microsoft BI Solution](#sessionid-27887)
00:00:00|William E Pearson III|BI Architecture|[Many-to-Many: Multiple Calendars in a Single Cube](#sessionid-27890)
