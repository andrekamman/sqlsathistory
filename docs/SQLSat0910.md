...
---|---|---|---
09:00:00|Miloš Radivojević| DBA|[Demystifying Query Store Plan Forcing](#sessionid-100308)
09:00:00|John Martin|  DEV/DBA|[An Introduction to Terraform, Infrastructure as Code](#sessionid-94303)
09:00:00|Damir Matesic|   DEV|[What's new in MS SQL for developers?](#sessionid-98528)
09:00:00|Prathy Kamasani|      BI|[An Introduction to Data Visualizations and Design Best Practices](#sessionid-98547)
09:00:00|Grega Jerkič|    BI/DEV|[Implementing a new database platform for your modern data warehouse – Snowflake on Azure](#sessionid-98665)
10:15:00|Miloš Radivojević| DBA|[Intelligent Query Processing in SQL Server 2019](#sessionid-100504)
10:15:00|William Durkin|  DEV/DBA|[It's broken, now what? (Approaches to Practical Problem Solving)](#sessionid-94190)
10:15:00|Alexander Klein|    BI/DEV|[Bringing AI to the edge - Azure Cognitive Services in docker containers](#sessionid-94195)
10:15:00|Itzik Ben-Gan|   DEV|[Missing T-SQL querying features for handling NULLs and for data analysis](#sessionid-94286)
10:15:00|Gašper Kamenšek|      BI|[How will we use Excel tomorrow?](#sessionid-96431)
11:30:00|Enrico van de Laar|    BI/DEV|[Advanced analytics in the cloud: AzureML](#sessionid-94353)
11:30:00|Uwe Ricken|  DEV/DBA|[Mastering DML Operations like a master](#sessionid-94547)
11:30:00|Benni De Jagere|      BI|[Troubleshooting Power BI Report Performance](#sessionid-94607)
11:30:00|Andrea Martorana Tusa|   DEV|[T-SQL advanced: Grouping and Windowing](#sessionid-95264)
11:30:00|Joseph D'Antoni| DBA|[Containers, Pods, and Databases- The Future of Infrastructure](#sessionid-96146)
13:30:00|Chris Taylor| DBA|["Kubernetify" your SQL Server Containers](#sessionid-94490)
13:30:00|Kasper de Jonge|    BI/DEV|[Debugging your premium capacity](#sessionid-94887)
13:30:00|Aleksandar Talev|   DEV|[Retail Point-of-sale scenario using Azure Cosmos DB](#sessionid-95173)
13:30:00|Roman Lansky|      BI|[Hitchhiker's Guide to the SSAS Tabular](#sessionid-98314)
13:30:00|Constantin Klein|  DEV/DBA|[IoT Round Table](#sessionid-98703)
14:45:00|Rob Sewell| DBA|[SQL Notebooks in Azure Data Studio for the DBA](#sessionid-94206)
14:45:00|André Kamman|    BI/DEV|[Creating an Enterprise Datalake without an Enterprise budget](#sessionid-94345)
14:45:00|Erland Sommarskog|   DEV|[Don't Bite Off More Than You Can Chew - Take It in Chunks](#sessionid-98471)
14:45:00|Kamil Nowinski|      BI|[Move part of your body to Azure Data Warehouse](#sessionid-98680)
14:45:00|Steve Jones|  DEV/DBA|[Strategies for solving compliance challenges](#sessionid-98728)
16:00:00|Gianluca Sartori| DBA|[Monitoring SQL Server without breaking the bank](#sessionid-98385)
16:00:00|Miroslav Popovic|   DEV|[Docker  ASP.NET Core](#sessionid-98654)
16:00:00|Just Blindbaek|      BI|[End-to-end Business Intelligence solution in Azure](#sessionid-98662)
16:00:00|Simon Whiteley|    BI/DEV|[Python Pipeline Primer: Data Engineering with Azure DataBricks](#sessionid-98726)
16:00:00|Steve Jones|  DEV/DBA|[Adopting a Compliant Database DevOps Process](#sessionid-98729)
#  
#### SessionID: 100308
