...
---|---|---|---
08:30:00|Carlos A. Ulate Hernandez|Data Warehouse Architecture, Development  Administration|[Introducci#243;n a SSIS, lo que necesitas saber para iniciar a trabajar con SSIS](#sessionid-38703)
08:30:00|Jason Horner|Multidimensional Modeling|[Dimensional Modeling Design Patterns: Beyond the Basics](#sessionid-39281)
08:30:00|Javier Loria|Data Warehouse Architecture, Development  Administration|[Como aplicar Scrum a proyectos de BI](#sessionid-41696)
10:00:00|Jose Mayorga|Multidimensional Modeling|[Muldimenional Data Base Design by means of BISM Tabular Models](#sessionid-39026)
10:00:00|Carlos Rojas Vargas|Data Warehouse Architecture, Development  Administration|[Opciones de Mejora de Rendimiento para el Datawarehouse](#sessionid-39031)
10:00:00|Ricardo Estrada|Multidimensional Modeling|[S#250;base al Bus de la Inteligencia de Negocios y h#225;galo #161;#193;gilmente!](#sessionid-40321)
11:00:00|Kenneth Urena|Data Warehouse Architecture, Development  Administration|[Dise#241;ando mi datawarehouse "Disaster recovery ready"](#sessionid-38676)
11:00:00|Eduardo Castro|Data Warehouse Architecture, Development  Administration|[Introducci#243;n a BI con DATAZEN](#sessionid-40048)
11:00:00|Pedro Huguet|Big Data / Internet of Things|[Using big data to drive U.S. healthcare reform](#sessionid-41711)
13:00:00|David Sánchez Aguilar|BI Information Delivery|[Inteligencia de Negocios aplicado para Proyectos de Desarrollo](#sessionid-39418)
13:00:00|Adrian Miranda|Data Warehouse Architecture, Development  Administration|[Lo que debe saber un DBA sobre BI.](#sessionid-40301)
13:00:00|Oscar Marin|Big Data / Internet of Things|[Como implementar una plataforma del Internet of Things con Azure](#sessionid-41188)
14:00:00|Keneth Murillo|Cloud Analytics|[Iniciando con Stream Analytics](#sessionid-39467)
14:00:00|Jason Horner|BI Information Delivery|[Advanced Spatial Analysis: Beyond Bubble Charts](#sessionid-41634)
14:00:00|Maristel Castro Montero|Data Warehouse Architecture, Development  Administration|[Data Profiling (SSIS)-  Herramienta #250;til para el perfilamiento de Datos ](#sessionid-41699)
15:30:00|Miguel Escobar|BI Information Delivery|[Power Query para Power BI: De Cero al [M]#225;ximo](#sessionid-38707)
15:30:00|César Oviedo|Cloud Analytics|[Introduciendo Azure Data Warehouse](#sessionid-38764)
15:30:00|Alejandro Cordero|Data Warehouse Architecture, Development  Administration|[La receta de la abuela para mejores Cargas de Datos!](#sessionid-40922)
#  
#### SessionID: 38703
