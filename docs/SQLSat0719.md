...
---|---|---|---
08:30:00|Anthony Nocentino|Enterprise Database Administration  Deployment|[I Needed to Install 80 SQL Servers…Fast. Here’s How I Did It!](#sessionid-70877)
08:30:00|David Maxwell|Enterprise Database Administration  Deployment|[Targeting Wait Statistics with Extended Events and DMVs](#sessionid-70954)
08:30:00|Ross LoForte|Enterprise Database Administration  Deployment|[Azure SQL Database Administration and Management](#sessionid-71001)
08:30:00|John Sterrett|Enterprise Database Administration  Deployment|[Automate the Pain Away with Query Store and Automatic Tuning](#sessionid-71296)
08:30:00|Karlyn LeBlanc|Professional Development|[Creating your Vision](#sessionid-71576)
08:30:00|Thomas Norman|Enterprise Database Administration  Deployment|[Database Project Makes Deployment Consistent](#sessionid-72173)
08:30:00|Aaron Nelson|BI Platform Architecture, Development  Administration|[PowerShell for BI Professionals: Automating SSIS, SSRS  SSAS](#sessionid-72840)
08:30:00|Chirag Shah|Enterprise Database Administration  Deployment|[SQL Server 2017 Database Engine Enhancements](#sessionid-73712)
08:30:00|Doug Lane|Cloud Application Development  Deployment|[How to Survive Migrating to SQL Server on AWS](#sessionid-73791)
09:50:00|Phil Ekins|Professional Development|[SQL Testing - How to Build a SQL Lab](#sessionid-70875)
09:50:00|William Wolf|Application  Database Development|[Stop Doing That! Common T-SQL Anti-Patterns](#sessionid-71215)
09:50:00|Janis Griffin|Enterprise Database Administration  Deployment|[HiHo! HiHo! SQL Server on Linux, We Go!](#sessionid-71524)
09:50:00|Andy Leonard|BI Platform Architecture, Development  Administration|[Faster SSIS](#sessionid-72049)
09:50:00|Michael Fal|Enterprise Database Administration  Deployment|[Exploring the new SqlServer PowerShell module](#sessionid-72190)
09:50:00|Derik Hammer|Cloud Application Development  Deployment|[Introduction to Azure SQL Data Warehouse](#sessionid-72532)
09:50:00|Brent Ozar|Application  Database Development|[How to Build Fast Multi-Parameter Stored Procedures](#sessionid-73278)
09:50:00|Allan Hirt|Professional Development|[10 Years of Highs and Lows as an Independent Consultant](#sessionid-73578)
09:50:00|John Eisbrener|Application  Database Development|[Columnstore 101: The Five Ws of Columnstore Indexes](#sessionid-73796)
09:50:00|Kerry Tyler|BI Platform Architecture, Development  Administration|[45 Minutes to Your First SSAS Tabular Model](#sessionid-73797)
11:10:00|David Maxwell|Enterprise Database Administration  Deployment|[Understanding and Handling Database Corruption](#sessionid-70956)
11:10:00|Tracy Boggiano|Enterprise Database Administration  Deployment|[Monitoring Availability Groups](#sessionid-71042)
11:10:00|Dave Bland|Enterprise Database Administration  Deployment|[Extended Events: What are they and How do I use them](#sessionid-71058)
11:10:00|Joe Obbish|Application  Database Development|[Decoding the Cardinality Estimator to Speed Up Queries](#sessionid-71358)
11:10:00|Igor Chmil|Cloud Application Development  Deployment|[Migrate multi-terabyte DB from OnPrem to Azure SQL (ASD) with minimal downtime.](#sessionid-72415)
11:10:00|Cathrine Wilhelmsen|BI Platform Architecture, Development  Administration|[Biml for Beginners: Script and Automate SSIS Development](#sessionid-73019)
11:10:00|Arthur Daniels III|Enterprise Database Administration  Deployment|[Plan Cache performance tuning and pruning](#sessionid-73564)
11:10:00|Allan Hirt|Enterprise Database Administration  Deployment|[Infrastructure 101 for SQL Server Deployments](#sessionid-73582)
11:10:00|Seth Bauer|BI Platform Architecture, Development  Administration|[Administering and Deploying Power BI Solutions](#sessionid-73749)
12:40:00|Rick Bielawski|Application  Database Development|[Difficult Queries](#sessionid-72149)
12:40:00|Tracy Boggiano|Enterprise Database Administration  Deployment|[Collecting Performance Metrics](#sessionid-72659)
12:40:00|Rob Volk|Application  Database Development|[Tame Your Unruly Data With Constraints](#sessionid-72746)
12:40:00|Wylie Blanchard|Professional Development|[Become a SQL Pro who’s in High Demand](#sessionid-73434)
12:40:00|David Klee|Enterprise Database Administration  Deployment|[Level Up Your Cloud Infrastructure Skills](#sessionid-73495)
12:40:00|Adam Kerr|Application  Database Development|[Strong Architecture and Entity Framework Code First - It's Possible!](#sessionid-73722)
12:40:00|Tamera Clark|BI Platform Architecture, Development  Administration|[SSRS; Not everything is a dashboard](#sessionid-73766)
12:40:00|Argenis Fernandez|Enterprise Database Administration  Deployment|[SQL Server and Pure Storage: Redefining Database Engineering](#sessionid-77316)
12:40:00|Michael Fal|Enterprise Database Administration  Deployment|[Simplifying SQL Data Protection (with Rubrik)](#sessionid-77478)
14:00:00|William Wolf|Application  Database Development|[Locks, Blocks, and Deadlocks; Tame the Sibling Rivalry](#sessionid-71214)
14:00:00|H. Ross Reed|Enterprise Database Administration  Deployment|[Limiting SQL Server Exposure](#sessionid-71314)
14:00:00|Eric Flamm|Enterprise Database Administration  Deployment|[Intro to SQL Operations Studio](#sessionid-72030)
14:00:00|Marsha Pierce|Enterprise Database Administration  Deployment|[How To Talk To Your Storage Admin](#sessionid-72872)
14:00:00|David Bermingham|Enterprise Database Administration  Deployment|[SQL Server in "The Cloud": High Availability and Disaster Recovery in Azure, AWS and Google](#sessionid-73000)
14:00:00|Henry Treftz|Application  Database Development|[Why Third Party Vendors Do The Things They Do](#sessionid-73171)
14:00:00|Brian Hansen|Enterprise Database Administration  Deployment|[Get Your Optimizer to Give up All Its Secrets](#sessionid-73321)
14:00:00|Lynn Ballard|Professional Development|[Disaster Recovery Planning for Your Career and Your Life...There's No Certification For This](#sessionid-73686)
14:00:00|Diane Schuster|BI Platform Architecture, Development  Administration|[Dynamic Data Flows in SSIS without Programming](#sessionid-77321)
14:00:00|David Klee|Enterprise Database Administration  Deployment|[Advanced SQL Server on VMware Features](#sessionid-77384)
15:15:00|Tim Gorman|Enterprise Database Administration  Deployment|[Reducing The Surface Area Of Risk in Data Security](#sessionid-70965)
15:15:00|Vazi Okhandiar|Analytics and Visualization|[Building a Dashboard in an Hour using PowerPivot  Power BI](#sessionid-71038)
15:15:00|Ben Davis|Enterprise Database Administration  Deployment|[Linked Servers – Purpose, Pitfalls and Performance Implications](#sessionid-73197)
15:15:00|Dan Mallott|Application  Database Development|[ORMs and the DBA: How to Make Both Happy](#sessionid-73330)
15:15:00|Pat Phelan|Application  Database Development|[Relational Data Architecture 101](#sessionid-73525)
15:15:00|Daniel Janik|Enterprise Database Administration  Deployment|[A DBA's guide to whole stack performance troubleshooting](#sessionid-73538)
15:15:00|Eddie Wuerch|Professional Development|[Be the Next Great Speaker: The Complete Speaker Starter Kit](#sessionid-73725)
15:15:00|Ed Leighton-Dick|Enterprise Database Administration  Deployment|[How to Keep Your Databases Secure in Just Minutes a Day](#sessionid-74003)
15:15:00|David Bermingham|Cloud Application Development  Deployment|[Azure Site Recovery and other Disaster Recovery Options for SQL S](#sessionid-77477)
15:15:00|David Klee|Professional Development|[My Brain Has Blue Screened - Let's Laugh](#sessionid-77480)
#  
#### SessionID: 70877
