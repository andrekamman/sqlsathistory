...
---|---|---|---
09:15:00|Johan Bijnens|DBA|[SQL Server High availability on Standard Edition: from Database Mirroring to Always On](#sessionid:-88989)
09:15:00|Gregor Reimling|Cloud|[Azure Governance einfach gemacht mit Azure Blueprints](#sessionid:-89102)
09:15:00|Yana Berkovich|BI|[Governance in PowerBI - Enjoy your Power Responsibly](#sessionid:-90257)
09:15:00|Torsten Strauss|DEV|[Reasons to use in-memory OLTP](#sessionid:-90322)
09:15:00|Alexander Klein|Analytics|[Wie kann die KI helfen die Servicequalität zu bewerten am Beispiel des SQLKellners](#sessionid:-90522)
09:15:00|Sandra Geisler|Mixed|[How Flow Can You Go](#sessionid:-91580)
10:45:00|Ben Weissman|Analytics|[SQL Server Big Data Clusters](#sessionid:-88944)
10:45:00|Markus Winand|DEV|[More Than a Query Language: SQL in the 21st Century](#sessionid:-88947)
10:45:00|Benjamin Kettner|Cloud|[Ist ja kinderleicht: Das Internet der Klötzchen (mit Pia Kettner als Gast)](#sessionid:-90829)
10:45:00|Tillmann Eitelberg|BI|[Modern Data Warehouse - Part 1](#sessionid:-91330)
10:45:00|Bernd Jungbluth|DBA|[Datenschutz mit SQL Server](#sessionid:-91368)
10:45:00|Burak Bagci|Mixed|[Google's Go trifft Microsoft's SQL Server](#sessionid:-91494)
12:00:00|Andrea Martorana Tusa|DEV|[The language of graph databases and SQL Server](#sessionid:-89011)
12:00:00|Sascha Götz|DBA|[Azure SQL Managed Instance - Just another DBaaS?](#sessionid:-90655)
12:00:00|Christoph Seck|Mixed|[Connecting SQL and Blockchain: The Azure Blockchain Workbench [EN]](#sessionid:-90764)
12:00:00|Marcel Franke|Analytics|[Machine Learning in Azure](#sessionid:-91129)
12:00:00|Constantin Klein|Cloud|[On the edge: AI und intelligente Datenverarbeitung mit Azure IoT](#sessionid:-91575)
12:00:00|Tillmann Eitelberg|BI|[Modern Data Warehouse - Part 2](#sessionid:-93085)
14:20:00|Uwe Ricken|DBA|[Use Case for SQL Server Service Broker: Historization of customer data](#sessionid:-88931)
14:20:00|Stefan Grigat|DEV|[Fun with window functions – komplexe Abfragen einfach erstellt](#sessionid:-89445)
14:20:00|Philipp Lenz|BI|[Power BI und Paginated Reports? Die Berichtsplattform in der Cloud im Überblick](#sessionid:-90526)
14:20:00|André Kamman|Analytics|[Creating an Enterprise Datalake without an Enterprise budget](#sessionid:-91582)
14:20:00|Raphael Köllner|Mixed|[The New Machine Age: Sensor Data, Machine Learning, Inferred Data](#sessionid:-93084)
14:20:00|Sascha Dittmann|Cloud|[Verarbeiten von Datenströmen mit Azure](#sessionid:-94590)
15:40:00|Sascha Dittmann|Analytics|[Von 0 auf 100 mit der Kusto Query Language (KQL)](#sessionid:-90541)
15:40:00|Frank Geisler|DBA|[A small step for man a giant step for mankind - Productive SQL Servers in Docker](#sessionid:-90882)
15:40:00|Catalin Gheorghiu|Mixed|[SQL database on IoT devices, could you? should you? would you?](#sessionid:-91447)
15:40:00|Thomas Martens|BI|[Aggregations in Power BI](#sessionid:-93249)
15:40:00|Gerhard Brueckl|Cloud|[Databricks for the SQL Developer](#sessionid:-94408)
17:00:00|Thomas Hütter|DEV|[A refresher on geospatial data in SQL Server](#sessionid:-88831)
17:00:00|Stefan Kirner|Cloud|[Data flows in Azure Data Factory - endlich auch hier Transformationen!](#sessionid:-89024)
17:00:00|Jan Mulkens|BI|[Driving Power BI automation through monitoring](#sessionid:-89027)
17:00:00|Björn Peters|DBA|[Setup and Configure a SQL Server with Powershell DSC](#sessionid:-89596)
17:00:00|Markus Delhofen|Mixed|[SQL Server Projekte mit Azure DevOps](#sessionid:-91343)
17:00:00|Martin Gudel|Analytics|[Predictive Analytics - an Azure Machine Learning-Studio Use-Case](#sessionid:-91449)
#  
#### SessionID: 88989
# SQL Server High availability on Standard Edition: from Database Mirroring to Always On
#### [Back to calendar](#SQLSaturday-#856---Rheinland-2019)
...
#  
#### SessionID: 89596
# Setup and Configure a SQL Server with Powershell DSC
#### [Back to calendar](#SQLSaturday-#856---Rheinland-2019)
Event Date: 25-05-2019 - Session time: 17:00:00 - Track: DBA
