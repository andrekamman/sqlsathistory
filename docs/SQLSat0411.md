...
---|---|---|---
09:00:00|Benjamin Nevarez|DEV (Animals)|[SQL Server Query Tuning  Optimization](#sessionid-39171)
09:00:00|Niko Neugebauer|BI (Wish You Were Here)|[A Day with Columnstore Indexes](#sessionid-39188)
09:00:00|Penelope Coventry|SharePoint (Dark Side of the Moon)|[Automating business processes with SharePoint, Office 365 and Azu](#sessionid-39189)
09:00:00|Mark Broadbent|SharePoint (Dark Side of the Moon)|[Implementing Business Intelligence  SharePoint High Availability](#sessionid-39025)
09:00:00|Rasmus Reinholdt|BI (Wish You Were Here)|[Building tomorrows ETL architecture with BIML and MDS today](#sessionid-39167)
09:00:00|Kennie Pontoppidan|DEV (Animals)|[SQL Anti-Patterns](#sessionid-39170)
09:00:00|Microsoft and Guests|DBA (The Wall)|[Microsoft – Building a Data Driven Strategy](#sessionid-40202)
08:30:00|John Martin|DBA (The Wall)|[Availability Group Maintenance Operations](#sessionid-17292)
08:30:00|Terry McCann|BI (Wish You Were Here)|[SSRS Inception: Reporting on Reporting services.](#sessionid-26106)
08:30:00|Kennie Pontoppidan|Other (A Momentary Lapse of Reason)|[Ask the CEO - Infrastructure for your new business](#sessionid-35732)
08:30:00|André Kamman|Cloud (Piper at the Gates of Dawn)|[How to be a Cloud DBA](#sessionid-37073)
08:30:00|Frank Geisler|DEV (Animals)|[Testing T-SQL Code with tSQLt](#sessionid-37853)
08:30:00|Ryan Yates|SharePoint (Dark Side of the Moon)|[Using SharePoint as a Service Delivery Platform](#sessionid-39974)
08:30:00|Andy Talbot|SharePoint (Dark Side of the Moon)|[SharePoint Enterprise Platforms: Build  Run Lessons Learnt](#sessionid-39976)
10:00:00|Boris Hristov|Cloud (Piper at the Gates of Dawn)|[Securing your SQL Azure Database. How?](#sessionid-10971)
10:00:00|Chris Webb|BI (Wish You Were Here)|[Common Analysis Services Multidimensional Design Mistakes And How To Avoid Them](#sessionid-11482)
10:00:00|Denis Reznik|DEV (Animals)|[SQL Server Performance Tuning. Practical Guide.](#sessionid-13126)
10:00:00|Johan Ludvig Brattås|BI (Wish You Were Here)|[Performance tuning a PowerPivot and Tabular model, notes from the field](#sessionid-17141)
10:00:00|Kenneth Nielsen|Cloud (Piper at the Gates of Dawn)|[Azure Big Data Solution – automation of deployment](#sessionid-18616)
10:00:00|Peter Baddeley|SharePoint (Dark Side of the Moon)|[Understanding SharePoint reporting options for SQL Server](#sessionid-21909)
10:00:00|Uwe Ricken|DBA (The Wall)|[Efficient Index maintenance through DMVs](#sessionid-27294)
10:00:00|Al Eardley|SharePoint (Dark Side of the Moon)|[SharePoint Databases - What you need to know](#sessionid-36688)
11:15:00|Denis Reznik|DBA (The Wall)|[Hidden gems of SQL Server 2014](#sessionid-13127)
11:15:00|Jens Vestergaard|BI (Wish You Were Here)|[Introduction to MDX](#sessionid-17800)
11:15:00|Uwe Ricken|DEV (Animals)|[Building abstract layers for data protection and business logic](#sessionid-27298)
11:15:00|Ruben Pertusa Lopez|BA (The Division Bell)|[AzureML: Welcome to the future of predictive analytics](#sessionid-37013)
11:15:00|John Tunnicliffe|DEV (Animals)|[Continuous Integration and the Data Warehouse](#sessionid-37102)
11:15:00|David Dye|BI (Wish You Were Here)|[Dealing With Errors in SSIS 2012 ](#sessionid-37905)
11:15:00|Sonja Madsen|SharePoint (Dark Side of the Moon)|[Quick Start Guide to JavaScript Frameworks for SharePoint Apps](#sessionid-39971)
12:20:00|James Rowland-Jones|Cloud (Piper at the Gates of Dawn)|[Introducing Azure SQL Data Warehouse](#sessionid-39831)
12:55:00|James Rowland-Jones|BI (Wish You Were Here)|[Scale Out Data Warehouse QA with Big Bang Data Co](#sessionid-39832)
13:30:00|Enrico van de Laar|DBA (The Wall)|[Efficient Indexing Strategies](#sessionid-13817)
13:30:00|Regis Baccaro|SharePoint (Dark Side of the Moon)|[SharePoint as a Business Intelligence platform](#sessionid-22842)
13:30:00|Kennie Pontoppidan|Other (A Momentary Lapse of Reason)|[How to build an IT operations expert](#sessionid-35733)
13:30:00|Mladen Prajdić|DEV (Animals)|[Digging Into the .Net SqlClient](#sessionid-35862)
13:30:00|Frank Geisler|BI (Wish You Were Here)|[Datazen - An overview](#sessionid-37851)
13:30:00|David Dye|BI (Wish You Were Here)|[Creating Dynamic Packages](#sessionid-37907)
13:30:00|Corey Burke|SharePoint (Dark Side of the Moon)|[Re-engineering the SharePoint Migration](#sessionid-39975)
13:30:00|André Kamman|DBA (The Wall)|[No stress with OSTRESS, Lessons Learned from a high traffic Replay attempt](#sessionid-40583)
13:30:00|Allan Mitchell|BA (The Division Bell)|[Azure Data Factory - The New SSIS?](#sessionid-9345)
14:45:00|Niko Neugebauer|DBA (The Wall)|[Understanding  Solving Columnstore Problems](#sessionid-15411)
14:45:00|John Martin|Cloud (Piper at the Gates of Dawn)|[Building your first Microsoft Azure IaaS infrastructure](#sessionid-17288)
14:45:00|Jens Vestergaard|BI (Wish You Were Here)|[Scaling out Analysis Services](#sessionid-17799)
14:45:00|Rasmus Reinholdt|DEV (Animals)|[Taking your application to memory](#sessionid-23536)
14:45:00|Tomaž Kaštrun|BA (The Division Bell)|[Benefits of analytics using Microsoft Azure Machine Learning ](#sessionid-27001)
14:45:00|Penelope Coventry|SharePoint (Dark Side of the Moon)|[Extending SharePoint solutions: Without spending money](#sessionid-36720)
14:45:00|Ruben Pertusa Lopez|BI (Wish You Were Here)|[A journey through the Modern Data Warehouse](#sessionid-37014)
14:45:00|Al Eardley|SharePoint (Dark Side of the Moon)|[Office 365 - The Art of the Possible](#sessionid-39980)
16:00:00|Benjamin Nevarez|DEV (Animals)|[Dive into the Query Optimizer-Undocumented Insight](#sessionid-10370)
16:00:00|Christopher Adkin|DEV (Animals)|[SQL Server Batch Mode and CPU Architectures](#sessionid-11501)
16:00:00|Rasmus Reinholdt|BI (Wish You Were Here)|[Optimizing BI with SQL2014 In-Memory tables](#sessionid-23538)
16:00:00|Thomas Sykes|Cloud (Piper at the Gates of Dawn)|[Blue Sky Thinking: SQL Azure Geospatial Mashup](#sessionid-26998)
16:00:00|Mladen Prajdić|BI (Wish You Were Here)|[Visualizing streaming data in real time](#sessionid-35863)
16:00:00|Anthony Obi|SharePoint (Dark Side of the Moon)|[SharePoint - Migrating Databases and Farm Configuration using PowerShell](#sessionid-37337)
16:00:00|David Parker|SharePoint (Dark Side of the Moon)|[Visualising SharePoint and SQL Data with Visio Professional](#sessionid-39981)
16:00:00|Allan Mitchell|BA (The Division Bell)|[HBase on HDInsight](#sessionid-9341)
#  
#### SessionID: 39171
