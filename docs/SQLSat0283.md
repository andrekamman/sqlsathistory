...
---|---|---|---
00:00:00|Bradley Ball|Track 2|[Inside the Query Optimizer](#sessionid-10150)
00:00:00|Carlos L Chacon|Track 3|[SQL Server - En juego o Fuera de juego?](#sessionid-11188)
00:00:00|David Dye|Track 1|[Location Location Location Preparing and Presenting Geographic Data](#sessionid-13023)
00:00:00|Edwin Blancovitch|Track 4|[MsAccess and SQLServer in the Cloud Integration ](#sessionid-13610)
00:00:00|Guillermo Caicedo Santiago|Track 4|[Introduction to SSIS with BIML](#sessionid-14855)
00:00:00|Javier Guillen|Track 1|[Business Insight through Cloud Based Data Models](#sessionid-16027)
00:00:00|Jose Chinchilla|Track 2|[PowerPivot + Powerview + PowerMap = Self-service BI Revolution](#sessionid-16107)
00:00:00|Jorge Segarra|Track 1|[Azure Virtual Machines: A Walk in the Cloud](#sessionid-17414)
00:00:00|Jose L. Rivera|Track 3|[Tablas Particionadas: De la A a la Z](#sessionid-17467)
00:00:00|Jose Gregorio Redondo Lopez|Track 2|[SQL Server 2014 In Memory Column Store Indexes - Haciendo un Almacén de Datos](#sessionid-17599)
00:00:00|Jorge Sanchez|Track 2|[Creating Reporting Services Reports to be Run in SQL Server Management Studio](#sessionid-17625)
00:00:00|Juan Soto|Track 4|[Wish you could live the glamorous consulting life?](#sessionid-17670)
00:00:00|Maximo Trinidad|Track 3|[Powershell Working with Windows Azure SQL Database Server](#sessionid-19916)
00:00:00|Mike Hillwig|Track 2|[From Mess to Mastery: Managing Large Environments ](#sessionid-20509)
00:00:00|Ramon Ponte|Track 3|[Understanding Power BI by Example](#sessionid-22442)
00:00:00|Rafael Salas|Track 1|[ETL Architecture Checkup: Avoiding Costly Mistakes](#sessionid-22943)
00:00:00|Rogger Rodriguez|Track 4|[Como lograr tu certificación de SQL Server 2012](#sessionid-23421)
00:00:00|Wayne Sheffield|Track 4|[Windowing Functions in SQL Server 2012](#sessionid-27729)
00:00:00|Wayne Sheffield|Track 3|[Table Vars  Temp Tables - What you NEED to Know!](#sessionid-27730)
00:00:00|Alan Koo|Track 1|[PowerPivot, Tabular and Multidimensional Models: Understanding Analysis Services Flavors](#sessionid-9180)
#  
#### SessionID: 10150
