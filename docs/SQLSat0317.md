...
---|---|---|---
00:00:00|Belkis Ozhorasan|Track 4|[Introducing Microsoft Azure HDInsight](#sessionid-10205)
00:00:00|Bob Duffy|Track 2|[Load Testing Analysis Services](#sessionid-10568)
00:00:00|Boris Hristov|Track 4|[The nightmare of locking, blocking and isolation levels!](#sessionid-10953)
00:00:00|Cathrine Wilhelmsen|Track 3|[Generate SSIS packages automatically with Biml and BimlScript](#sessionid-11230)
00:00:00|Erik Flateby|Track 1|[CUBE-functions for fun  profit](#sessionid-13922)
00:00:00|Henk van der Valk|Track 3|[SQL Server PDW (APS)  vs SQL Server, let's see the big differences ](#sessionid-15124)
00:00:00|Niko Neugebauer|Track 4|[Clustered Columnstore Deep Dive](#sessionid-15428)
00:00:00|Joe Chang|Track 2|[Modern Performance](#sessionid-16095)
00:00:00|Johan Ludvig Brattås|Track 4|[Visualization – tales from the field.  How to build a cool Risk Analysis Dashboard on a shoestring](#sessionid-17140)
00:00:00|Kaisa  Lervik |Track 3|[What is Microsoft doing with Predictive Analytics?](#sessionid-17838)
00:00:00|Kalen Delaney|Track 2|[Unblock yourself -- Optimistic concurrency in Hekaton](#sessionid-17852)
00:00:00|Kennie Pontoppidan|Track 1|[SQL anti patterns](#sessionid-18130)
00:00:00|Margarita Naumova|Track 1|[Top 10 DBA mistakes that affect the SQL Server performance](#sessionid-19380)
00:00:00|Marco Russo|Track 4|[DAX from the field: Real World Case Studies](#sessionid-19472)
00:00:00|Neil Hambly|Track 2|[Effective Index Partitioning, Compression Strategy](#sessionid-21388)
00:00:00|Pieter Vanhove|Track 1|[1, 2, 3, … 100. How to manage many SQL Servers the](#sessionid-22148)
00:00:00|Regis Baccaro|Track 1|[Power View and the Cube](#sessionid-22856)
00:00:00|Scott Klein|Track 2|[SQL Server 2014 Top 5 - Hybrid Features](#sessionid-24199)
00:00:00|Sergey Olontsev|Track 3|[Analyzing Query Plans Deep Dive](#sessionid-24374)
00:00:00|Tim Ford|Track 1|[Query Tuning Superstardom for Beginners](#sessionid-26883)
00:00:00|Mikael Wedham|Track 2|[Practical use of the SSIS Script components](#sessionid-27783)
00:00:00|André Kamman|Track 4|[Private Cloud for DBAs](#sessionid-34569)
00:00:00|Aaron Nelson|Track 3|[PowerShell for Data Professionals](#sessionid-8877)
#  
#### SessionID: 10205
# Introducing Microsoft Azure HDInsight
#### [Back to calendar](#nr-317)
