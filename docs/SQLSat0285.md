...
---|---|---|---
00:00:00|Brandon Leach|10 DBA Radar Detectors|[Wrangling performance with Resource Governor](#sessionid-10687)
00:00:00|Jason Brimhall|03 Admin Highway|[SQL 2012 Table Compression](#sessionid-10849)
00:00:00|Julie Smith|01 BI Roadshow|[BIML--Step by Step](#sessionid-11105)
00:00:00|Julie Smith|02 BI HorsePower|[Power Power Query Query With Julie Smith and Rob Volk.](#sessionid-11106)
00:00:00|Carlos L Chacon|07 High Performance|[Judge, Jury,  and Executioner--A First Look At Execution Plans](#sessionid-11194)
00:00:00|Chris Bell|03 Admin Highway|[The Spy Who Loathed Me - An Intro to SQL Security](#sessionid-11261)
00:00:00|Chris Skorlinski|06 Pro Racing|[Best Interview Ever](#sessionid-11571)
00:00:00|David Bermingham|05 Availability Horsepower|[High Availability with Windows Server 2012 R2 and SQL Server 2014](#sessionid-12397)
00:00:00|David Klee|03 Admin Highway|[Squeezing Top Performance from Your Virtualized SQL Server](#sessionid-12502)
00:00:00|David Dye|03 Admin Highway|[Implementing Auditing in SQL Server 2012](#sessionid-13032)
00:00:00|David Dye|03 Admin Highway|[Column Level Encryption](#sessionid-13033)
00:00:00|Dan Holmes|09 Spaghetti Junction|[GIS Data and Solving the Shortest Path](#sessionid-13348)
00:00:00|Louis Davidson|06 Pro Racing|[Database Design Fundamentals](#sessionid-13472)
00:00:00|Ed Watson|07 High Performance|["So you have a performance issue.  What now?"](#sessionid-13689)
00:00:00|Eric Peterson|05 Availability Horsepower|[SQL Server 2012 Always On - The Good, the Bad and the Ugly](#sessionid-13899)
00:00:00|Grant Fritchey|07 High Performance|[Statistics and Query Optimization](#sessionid-14782)
00:00:00|Janis Griffin|07 High Performance|[Geekin’ Out on Extended Events -Deconstructing the system_health session to solve performance issues](#sessionid-15726)
00:00:00|Jason Carter|03 Admin Highway|[Maintenance and Backups:  Intro to Ola Hallengren](#sessionid-15793)
00:00:00|Jason Thomas|02 BI HorsePower|[DataViz You Thought You Couldn't Do with SSRS](#sessionid-15908)
00:00:00|Joe Chang|07 High Performance|[Automating Execution Plan Analysis](#sessionid-16092)
00:00:00|Jeffrey Garbus|04 Code Paths|[Bad, less Bad, not Bad; rewriting bad SQL Code](#sessionid-16334)
00:00:00|Jon Boulineau|04 Code Paths|[T-SQL: Beyond the Basics](#sessionid-17317)
00:00:00|Richie Rump|04 Code Paths|[Entity Framework: Or How I Learned to Stop Worrying and Learned to Love Developers](#sessionid-17424)
00:00:00|Justin Stephens|02 BI HorsePower|[Data Visualization Using Excel](#sessionid-17786)
00:00:00|Kalen Delaney|10 DBA Radar Detectors|[What’s Simple About SIMPLE Recovery?](#sessionid-17849)
00:00:00|Ken Colson|04 Code Paths|[Using recursive Common Table Expressions (CTE)](#sessionid-18037)
00:00:00|Kathi Kellenberger|09 Spaghetti Junction|[T-SQL Window Function Performance](#sessionid-18430)
00:00:00|Lance England|08 BI Traffic Analysis|[Fundamentals of MDX](#sessionid-18941)
00:00:00|Michael French|06 Pro Racing|[Independent Contracting 101](#sessionid-20244)
00:00:00|miguel Cebollero|04 Code Paths|[Database Development Comes out of the Dark Ages](#sessionid-20414)
00:00:00|Denny Cherry|09 Spaghetti Junction|[SQL Server's In Memory Database Objects](#sessionid-21028)
00:00:00|Nelson Davis|08 BI Traffic Analysis|[Merging Excel files from SharePoint for Analysis in Tableau with the BI Stack](#sessionid-21411)
00:00:00|Paul Turley|01 BI Roadshow|[BI Expert Panel - Part 1](#sessionid-21860)
00:00:00|Paul Turley|01 BI Roadshow|[BI Expert Panel - Part 2](#sessionid-21861)
00:00:00|Patrick LeBlanc|02 BI HorsePower|[Introduction to Power BI](#sessionid-22194)
00:00:00|Pam Shaw|01 BI Roadshow|[Tips  Tricks for dynamic SSRS Reports](#sessionid-22360)
00:00:00|Ryan Duclos|09 Spaghetti Junction|[Microsoft Azure SQL Database](#sessionid-22743)
00:00:00|Rafael Salas|11 Express Toll Lane ETL|[ETL Architecture Chekup: Avoiding Costly Mistakes](#sessionid-22941)
00:00:00|Robert Verell|10 DBA Radar Detectors|[READY FOR PROD](#sessionid-23245)
00:00:00|Rob Volk|Ask The Experts!|[Ask The Experts!](#sessionid-23257)
00:00:00|Rob Volk|06 Pro Racing|[Lightning Talks!](#sessionid-23258)
00:00:00|Rob Volk|Ask The Experts!|[Quiz Bowl! - Room 223](#sessionid-23259)
00:00:00|Rodney Landrum|01 BI Roadshow|[Data Analytics and the DBA – Using PowerView to Uncover Interesting Facts About Your SQL Servers](#sessionid-23390)
00:00:00|Ryan Adams|05 Availability Horsepower|[SQL 2012 AlwaysOn Quickstart](#sessionid-23736)
00:00:00|Scott Currie|11 Express Toll Lane ETL|[Create and Load a Staging Environment from Scratch in an Hour with Biml](#sessionid-24050)
00:00:00|Sergey Barskiy|04 Code Paths|[Using SSDT (SQL Server Data Tools) to Manage Database Lifecycle](#sessionid-24328)
00:00:00|Melissa Coates|02 BI HorsePower|[Administering  Managing the Power BI Environment](#sessionid-24937)
00:00:00|Steve Wake|11 Express Toll Lane ETL|[SSIS 2012: More Than Just a Pretty UI](#sessionid-25704)
00:00:00|Stuart Ainsworth|06 Pro Racing|[Managing a Technical Team: Lessons Learned](#sessionid-25840)
00:00:00|Sven Aelterman|05 Availability Horsepower|[Windows Server 2012 R2 High Availability for SQL Server](#sessionid-25917)
00:00:00|Tamera Clark|01 BI Roadshow|[45 min to build your first SSRS report](#sessionid-26006)
00:00:00|Kevin Boles|09 Spaghetti Junction|[SQL Server 2014 New Features](#sessionid-26394)
00:00:00|Tim Mitchell|11 Express Toll Lane ETL|[15 Quick Tips for SSIS Performance](#sessionid-26620)
00:00:00|Tim Radney|10 DBA Radar Detectors|[It is TEMPDB, Why Should You Care?](#sessionid-26674)
00:00:00|Teo Lachev|08 BI Traffic Analysis|[Predictive Analytics for the Data Scientist and BI Pro](#sessionid-26940)
00:00:00|Thomas Stringer|05 Availability Horsepower|[AlwaysOn Availability Groups Troubleshooting and Common Issues](#sessionid-27157)
00:00:00|Kenneth Urena|07 High Performance|[Indexing strategies and good physical designs for performance tuning](#sessionid-27191)
00:00:00|Damu Venkatesan|08 BI Traffic Analysis|[DAX 101](#sessionid-27349)
00:00:00|Wayne Sheffield|10 DBA Radar Detectors|[Crazy Things That Developers Do](#sessionid-27728)
00:00:00|Wendy Pastrick|05 Availability Horsepower|[Navigating the Options for Data Redundancy](#sessionid-27814)
00:00:00|Bill Anton|02 BI HorsePower|[The 20-Minute Tabular Model](#sessionid-28175)
00:00:00|Kerry Tyler|08 BI Traffic Analysis|[Manageable SSAS Deployment Strategies](#sessionid-9082)
00:00:00|Robert Cain|11 Express Toll Lane ETL|[Everything You Ever Knew About SSIS Is Null and Void](#sessionid-9727)
00:00:00|Argenis Fernandez|10 DBA Radar Detectors|[Peace of Mind: Making DBCC CHECKDB Go Faster](#sessionid-9755)
00:00:00|Argenis Fernandez|09 Spaghetti Junction|[Troubleshooting SQL Server with SysInternals Tools](#sessionid-9757)
00:00:00|Allen White|11 Express Toll Lane ETL|[Automate Your ETL Infrastructure with SSIS and PowerShell](#sessionid-9989)
#  
#### SessionID: 10687
