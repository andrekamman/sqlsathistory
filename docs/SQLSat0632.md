...
---|---|---|---
08:30:00|Patrick Flynn|DBA |[Database Corruption - Advanced Recovery Techniques](#sessionid-61287)
08:30:00|Prathy Kamasani|BI|[What's new in Power BI Report Server](#sessionid-63462)
08:30:00|Steve Jones|DEV |[Bringing DevOps to the Database](#sessionid-64576)
10:00:00|Oliver Engels|BI|[Big Data - Big Quality?  A governance round-trip through the possibilities of the MS data platform](#sessionid-61420)
10:00:00|Bob Duffy|Cloud|[SQL Storage Fundamentals for Azure IaaS](#sessionid-62476)
10:00:00|Mikael Wedham|DEV |[A Masters view on Query plans and indexing](#sessionid-62605)
10:00:00|Ivan Campos|DBA |[Hiding data with SQL Server 2016](#sessionid-64283)
10:00:00|Stephanie Locke|BA|[Data Science Fundamentals](#sessionid-67073)
10:00:00|Paul Andrew|BI|[Azure Data Factory  Creating Custom Activities Workshop part I](#sessionid-67218)
11:15:00|Jens Vestergaard|BI|[Pro Techniques for the SSASMD Developer](#sessionid-61197)
11:15:00|Markus Ehrenmueller-Jensen|BA|[Create Stunning Visualizations with The Help of R](#sessionid-61214)
11:15:00|Dmytro Andriychenko|Other|[Kerberos for SQL Server and SharePoint the easy way](#sessionid-61226)
11:15:00|Jose Manuel Jurado Diaz|Cloud|[SQL SERVER - Next station Azure](#sessionid-61237)
11:15:00|Dejan Sarka|DEV |[Temporal Data in SQL Server](#sessionid-61491)
11:15:00|Paul Andrew|BI|[Azure Data Factory  Creating Custom Activities Workshop part II](#sessionid-67219)
12:30:00|Mark Broadbent|Sponsor|[Sponsor lunchtime session Part I](#sessionid-65121)
13:10:00|Mark Broadbent|Sponsor|[Sponsor lunchtime session Part II](#sessionid-65122)
13:45:00|Jens Vestergaard|BI|[DevOps for BI Workshop Part I](#sessionid-61194)
13:45:00|Terry McCann|Cloud|[Azure Machine learning beyond the basics with Juypter notebooks](#sessionid-61207)
13:45:00|Andrew Pruski|DBA |[An introduction to SQL Server  Containers](#sessionid-61336)
13:45:00|Asgeir Gunnarsson|BI|[Analyzing the impact of weather on English Premier League matches in Power BI](#sessionid-61447)
13:45:00|Sam Cogan|Cloud|[Azure Functions and Automation: The SQL Agent in the Cloud](#sessionid-64550)
15:00:00|Oliver Frost|DEV |[Exploring Dark Data with SQL Server 2016 and R](#sessionid-61204)
15:00:00|Andreas Bergstedt|BI|[How to unlock value in your anonymized data](#sessionid-61362)
15:00:00|Niko Neugebauer|BI|[Columnstore killed the OLAP-Star?](#sessionid-61626)
15:00:00|Frank Geisler|DBA |[SQL Server on Linux](#sessionid-62503)
15:00:00|Kennie Pontoppidan|Cloud|[Multi-tenant database architectures – from small scale to hyper-scale](#sessionid-64872)
15:00:00|Jens Vestergaard|BI|[DevOps for BI Workshop Part II](#sessionid-67659)
16:10:00|Thomas Hütter|BA|[So you installed R, now what? A journey through the Tidyverse](#sessionid-61251)
16:10:00|Drew Furgiuele|DBA |[SQL Server and PowerShell: Let's Get Serious](#sessionid-61315)
16:10:00|Bent Pedersen|BI|[Scripting tabular models](#sessionid-61399)
16:10:00|Gavin Campbell|DEV |[Effective Unit Testing for SQL Server](#sessionid-62532)
16:10:00|Simon Whiteley|Cloud|[Real-Time Reporting through the medium of Dance](#sessionid-64306)
#  
#### SessionID: 61287
