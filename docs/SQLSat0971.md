...
---|---|---|---
09:30:00|Jess Pomfret|Enterprise Database Administration  Deployment (Cloud/Hybrid/On-prem)|[Life Hacks: dbatools edition](#sessionid:-103366)
09:30:00|Halvar Trøyel Nerbø|BI Platform Architecture, Development  Administration (Cloud/Hybrid/On-prem)|[From 0 to hero. Azure data factory CI/CD experiences](#sessionid:-103742)
09:30:00|Marco Russo|BI Platform Architecture, Development  Administration (Cloud/Hybrid/On-prem)|[My Power BI Report is Slow: What Should I Do?](#sessionid:-104326)
09:30:00|Ben Weissman|Enterprise Database Administration  Deployment (Cloud/Hybrid/On-prem)|[SQL Server 2019 Big Data Clusters: Make SQL Server your Data Hub for everything](#sessionid:-104329)
10:45:00|Oskari Heikkinen|BI Platform Architecture, Development  Administration (Cloud/Hybrid/On-prem)|[Best Practices for building a Data Lake with Azure Databricks](#sessionid:-101891)
10:45:00|Gianluca Sartori|Enterprise Database Administration  Deployment (Cloud/Hybrid/On-prem)|[Benchmarking in the Cloud](#sessionid:-102584)
10:45:00|Alexander Klein|Analytics and Visualization (Cloud/Hybrid/On-prem)|[Monitoring service quality with Artificial Intelligence](#sessionid:-104435)
10:45:00|Ida Bergum|BI Platform Architecture, Development  Administration (Cloud/Hybrid/On-prem)|[Power Automate your BI](#sessionid:-104453)
12:00:00|Dennes Torres|BI Platform Architecture, Development  Administration (Cloud/Hybrid/On-prem)|[Why Synapse Analytics is beyond Azure SQL Datawarehouse](#sessionid:-101880)
12:00:00|Marius Sandbu|Enterprise Database Administration  Deployment (Cloud/Hybrid/On-prem)|[Azure Arc and Providing Data Platform Services - MSSQL and PostegreSQL](#sessionid:-102507)
12:00:00|Hugo Kornelis|Application  Database Development (Cloud/Hybrid/On-prem)|[From adaptive to intelligent: query processing in SQL 2019](#sessionid:-103607)
12:00:00|Marc Lelijveld|Analytics and Visualization (Cloud/Hybrid/On-prem)|[Use parameters to add extra flexibility to your Power BI content](#sessionid:-104204)
13:15:00|Andreas Hope|Enterprise Database Administration  Deployment (Cloud/Hybrid/On-prem)|[Launch: dbWatch Control Center launch – announcement and live dem](#sessionid:-107580)
13:45:00|Kevin Chant|Enterprise Database Administration  Deployment (Cloud/Hybrid/On-prem)|[Azure DevOps duet (60 minutes version)](#sessionid:-101876)
13:45:00|John Martin|Enterprise Database Administration  Deployment (Cloud/Hybrid/On-prem)|[Four Steps to Securing your Data Platform](#sessionid:-102081)
13:45:00|Magnus Ahlkvist|Application  Database Development (Cloud/Hybrid/On-prem)|[Statistics, an unreliable friend.](#sessionid:-102140)
13:45:00|Marthe Moengen|Enterprise Database Administration  Deployment (Cloud/Hybrid/On-prem)|[Data is all around - so how do you control it? ​](#sessionid:-104402)
15:00:00|Andrew Pruski|Enterprise Database Administration  Deployment (Cloud/Hybrid/On-prem)|[Chaos Engineering for SQL Server](#sessionid:-101974)
15:00:00|Erland Sommarskog|Application  Database Development (Cloud/Hybrid/On-prem)|[SQL Titbits for the Inexperienced](#sessionid:-103428)
15:00:00|Per Christopher Undheim|Enterprise Database Administration  Deployment (Cloud/Hybrid/On-prem)|[Beyond instance tuning: Optimizing and managing a SQL Server Farm](#sessionid:-103975)
16:15:00|Brent Ozar|Application  Database Development (Cloud/Hybrid/On-prem)|[Watch Brent Tune Queries](#sessionid:-101873)
16:15:00|Margarita Naumova|Enterprise Database Administration  Deployment (Cloud/Hybrid/On-prem)|[Consolidation best practices](#sessionid:-104564)
#  
#### SessionID: 103366
# Life Hacks: dbatools edition
#### [Back to calendar](#SQLSaturday-#971---Oslo---Virtual-2020)
