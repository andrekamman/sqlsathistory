...
---|---|---|---
09:00:00|Adrian Miranda|Enterprise Database Administration  Deployment|[10 Cosas que debes de dejar de hacer en una base de datos](#sessionid-37987)
09:00:00|Adrian Miranda|Enterprise Database Administration  Deployment|[T#233;cnicas de afinamiento para SQL Server 2014](#sessionid-37988)
09:00:00|David Sánchez Aguilar|Cloud Application Development  Deployment|[SQL Server como fuente de datos para Office 365](#sessionid-39000)
09:00:00|Alejandro Cordero|Application  Database Development|[SQL Server R#225;pido y Furioso](#sessionid-39062)
09:00:00|Ahias Portillo|Strategy and Architecture|[El ABC de almacenamiento e #237;ndices en Sql Server](#sessionid-39210)
09:00:00|German Ordonez|Enterprise Database Administration  Deployment|[Administre, Diagnostique y Resuelva problemas sobre su SQL Server](#sessionid-39221)
09:00:00|Maristel Castro Montero|BI Platform Architecture, Development  Administration|[Herramientas de perfilamiento de datos para DataWareHouse](#sessionid-39348)
09:00:00|Marlon Ramos|Cloud Application Development  Deployment|[Introducci#243;n a Azure DocumentDB](#sessionid-39355)
09:00:00|Ricardo Estrada|BI Platform Architecture, Development  Administration|[S#250;base al Bus de la Inteligencia de Negocios y h#225;galo #161;#193;gilmente!](#sessionid-39363)
10:00:00|Marco Tulio Gómez Reyes|BI Platform Architecture, Development  Administration|[Primeros pasos en modelos Multidimensionales con Analysis Services](#sessionid-36876)
10:00:00|Eduardo Castro|Enterprise Database Administration  Deployment|[SQL Server Query Processor](#sessionid-38760)
10:00:00|Carlos Lone|Application  Database Development|[Quien se ha llevado mi cambio? Del caos al Control](#sessionid-38992)
10:00:00|Jorge García|BI Platform Architecture, Development  Administration|[Patrones de b#250;squeda en rangos con LookUps](#sessionid-39333)
11:00:00|Walter Montes|Application  Database Development|[Acceso a datos para soluciones altamente escalables usando SQL, noSQL y persistencia pol#237;glota](#sessionid-36874)
11:00:00|Ahias Portillo|BI Platform Architecture, Development  Administration|[SSAS mejores pr#225;cticas.](#sessionid-39207)
11:00:00|Victor Hugo Cardenas|Analytics and Visualization|[Empezando y entendiendo Power Query y el Lenguaje M, Parte de Power BI](#sessionid-39298)
11:00:00|Mario Guzman|BI Platform Architecture, Development  Administration|[Expandiendo las fronteras de SSIS (Cargando datos desde Web Services JSON)](#sessionid-39321)
11:00:00|Jesus Gil|Enterprise Database Administration  Deployment|[Los 10 mandamientos de Jesus](#sessionid-39331)
12:00:00|Walter Montes|Application  Database Development|[Si soy un desarrollador, #191;qu#233; debo conocer de SQL Server?](#sessionid-36873)
12:00:00|Raul Sao|BI Information Delivery|[Conozcamos  Datazen la nueva plataforma m#243;vil para tableros de BI](#sessionid-38818)
12:00:00|David Sánchez Aguilar|Cloud Application Development  Deployment|[Conexi#243;n h#237;birda de Azure con SQL Server On-Premise](#sessionid-38840)
12:00:00|Juan Alvarado|Enterprise Database Administration  Deployment|[SQL 2016: mas alla de su centro de datos](#sessionid-39114)
12:00:00|Javier Loria|Enterprise Database Administration  Deployment|[Todo lo que siempre quiso saber sobre SSMSy MS no tuvo tiempo de ense#241;arte](#sessionid-39361)
14:15:00|Eduardo Castro|Advanced Analysis Techniques|[Herramientas SQL Server y Microsoft Azure para el Cient#237;fico de Datos](#sessionid-37570)
14:15:00|Raul Sao|BI Information Delivery|[Aprende a utilizar Power BI Designer](#sessionid-38817)
14:15:00|David Sánchez Aguilar|Application  Database Development|[Agregando Azure Search a nuestras Web Apps](#sessionid-38838)
14:15:00|Jesus Gil|Enterprise Database Administration  Deployment|[Dr Rudo SQL: Mejores practicas para Administradores de SQL Server y Azure](#sessionid-39335)
14:15:00|Marlon Ramos|Enterprise Database Administration  Deployment|[SQL Saludable](#sessionid-39349)
14:15:00|Ricardo Estrada|BI Platform Architecture, Development  Administration|[Tuning con QUERY STORE la nueva caracter#237;stica de SQL 2016](#sessionid-39354)
14:15:00|Juan Alvarado|BI Information Delivery|[Power BI 2.0: todo lo que ha querido saber sobre BI en la nube](#sessionid-39985)
15:30:00|Marco Tulio Gómez Reyes|BI Platform Architecture, Development  Administration|[QueryLog una fuente de informaci#243;n para optimizaci#243;n de analysis services](#sessionid-36877)
15:30:00|Alejandro Cordero|Application  Database Development|[SQL2014 Transacciones Diferidas - el AS bajo la manga](#sessionid-37340)
15:30:00|Victor Hugo Cardenas|Strategy and Architecture|[Funcionalidades H#237;bridas entre SQL 2014 y Azure](#sessionid-39296)
15:30:00|Javier Loria|Enterprise Database Administration  Deployment|[Inteligencia Geoespacial en SQL ](#sessionid-39360)
15:30:00|Jesus Gil|Enterprise Database Administration  Deployment|[Dr Rudo  Dave Rndn: Mejores practicas para Admin de SQL y Azure](#sessionid-40237)
#  
#### SessionID: 37987
# 10 Cosas que debes de dejar de hacer en una base de datos
#### [Back to calendar](#SQLSaturday-#443---Guatemala-2015)
...
#  
#### SessionID: 36877
# QueryLog una fuente de informaci#243;n para optimizaci#243;n de analysis services
#### [Back to calendar](#SQLSaturday-#443---Guatemala-2015)
Event Date: 22-08-2015 - Session time: 15:30:00 - Track: BI Platform Architecture, Development  Administration
## Speaker: Marco Tulio Gómez Reyes
...
#  
#### SessionID: 37340
# SQL2014 Transacciones Diferidas - el AS bajo la manga
#### [Back to calendar](#SQLSaturday-#443---Guatemala-2015)
Event Date: 22-08-2015 - Session time: 15:30:00 - Track: Application  Database Development
## Speaker: Alejandro Cordero
...
#  
#### SessionID: 39296
# Funcionalidades H#237;bridas entre SQL 2014 y Azure
#### [Back to calendar](#SQLSaturday-#443---Guatemala-2015)
Event Date: 22-08-2015 - Session time: 15:30:00 - Track: Strategy and Architecture
## Speaker: Victor Hugo Cardenas
...
#  
#### SessionID: 40237
# Dr Rudo  Dave Rndn: Mejores practicas para Admin de SQL y Azure
#### [Back to calendar](#SQLSaturday-#443---Guatemala-2015)
Event Date: 22-08-2015 - Session time: 15:30:00 - Track: Enterprise Database Administration  Deployment
## Speaker: Jesus Gil
