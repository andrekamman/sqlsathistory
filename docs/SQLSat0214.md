...
---|---|---|---
00:00:00|Allen White|DBA|[PowerShell 101 for the SQL Server DBA](#sessionid-10024)
00:00:00|Dave Mattingly|Developer|[Master Data Management](#sessionid-12244)
00:00:00|Dave Fackler|BI|[Migrating to SSIS 2012](#sessionid-12333)
00:00:00|Dave Fackler|Developer|[TFS for SQL/BI Developers](#sessionid-12335)
00:00:00|Louis Davidson|DBA|[How to Write a DML Trigger](#sessionid-13459)
00:00:00|Eddie Wuerch|Adv. DBA|[Partitioning for Perf and Mgmt of Large Tables](#sessionid-14095)
00:00:00|Jennifer Alexander|Architecture/Design|[Data Warehouse Architecture (Ralph who?)](#sessionid-15521)
00:00:00|Kevin Kline|Architecture/Design|[SQL Server Internals  Architecture](#sessionid-18209)
00:00:00|Kevin Kline|DBA|[Top 10 Admininistrator Mistakes on SQL Server](#sessionid-18210)
00:00:00|Kyle Neier|Adv. DBA|[Become a SQL Block’stroyer](#sessionid-18909)
00:00:00|Mickey Stuewe|BI|[Tablix - The Rubik Cube of Reporting Services](#sessionid-20383)
00:00:00|Mike Hays|DBA|[Unable to Make Lasting Connections?](#sessionid-20648)
00:00:00|Randy Knight|Developer|[But it worked great in Dev!  Perfomance for Devs](#sessionid-22459)
00:00:00|Randy Knight|Adv. DBA|[Understanding Transaction Isolation Levels](#sessionid-22460)
00:00:00|Russel Loski|Developer|[Introduction to the XML source](#sessionid-23651)
00:00:00|Sanil Mhatre|Developer|[Asynchronous programming with Service Broker](#sessionid-23941)
00:00:00|Shannon Lowder|Architecture/Design|[OnPremise to Azure](#sessionid-24622)
00:00:00|Craig Utley|BI|[Add It Up: Analysis Services Aggregations](#sessionid-24867)
00:00:00|Craig Utley|BI|[Secure SSAS Data Without Tying Yourself in Knots](#sessionid-24868)
00:00:00|Tim Chapman|Adv. DBA|[Index Internals](#sessionid-26747)
00:00:00|Tim Chapman|Adv. DBA|[Transaction Log Internals](#sessionid-26748)
00:00:00|William E Pearson III|BI|[Through Gardens Overgrown: PowerPivot to SSAS 2012Tabular](#sessionid-28090)
00:00:00|Adam Belebczuk|DBA|[Introduction to SQL Server 2012 AlwaysOn Availability Groups](#sessionid-8958)
00:00:00|Andy Thiru|Architecture/Design|[Loading the Windows Azure Cloud ](#sessionid-9942)
00:00:00|Andy Thiru|Architecture/Design|[Moving Enterprise database to cloud](#sessionid-9943)
#  
#### SessionID: 10024
# PowerShell 101 for the SQL Server DBA
#### [Back to calendar](#nr-214)
