...
---|---|---|---
08:45:00|Steve Simon|Application  Database Development|[Efficient and Effective coding of Stored Procedures](#sessionid-45151)
08:45:00|Thomas Norman|Cloud Application Development  Deployment|[Beginning Azure](#sessionid-45830)
08:45:00|Chris Seferlis|BI Platform Architecture, Development  Administration|[Scratching the Surface: Designing your first Power View Report](#sessionid-45965)
08:45:00|Ravi Kumar|BI Platform Architecture, Development  Administration|[What Makes SSIS Tick? A Look at Internals for Performance](#sessionid-46389)
08:45:00|Justin Randall|Enterprise Database Administration  Deployment|[Putting the Squeeze on Large Tables: Improve Performance and Save Space with Data Compression](#sessionid-46909)
10:00:00|George Walters|Enterprise Database Administration  Deployment|[Organizational Security  Compliance with SQL 2012 through 2016](#sessionid-45161)
10:00:00|Edward Pollack|Performance|[Database Design: Solving Problems Before they Start!](#sessionid-45177)
10:00:00|Bryan Cafferky|Analytics and Visualization|[Introduction to R Programming](#sessionid-45200)
10:00:00|Paresh Motiwala|BI Platform Architecture, Development  Administration|[SQL 2016 Upgrade as a Project](#sessionid-46213)
10:00:00|George Walkey|Enterprise Database Administration  Deployment|[Using Powershell to Document SQL Server](#sessionid-46593)
10:00:00|David Klee|Enterprise Database Administration  Deployment|[Virtual SQL Servers. Actual Performance.](#sessionid-51123)
11:15:00|Thomas Grohser|Enterprise Database Administration  Deployment|[Optimizing SQL Server and Databases for large Fact Tables](#sessionid-45139)
11:15:00|David Benoit|Strategy and Architecture|[An Introduction To Big Data For The SQL Server DBA](#sessionid-45315)
11:15:00|Ben Miller|Enterprise Database Administration  Deployment|[PoshDBA: Practical PowerShell for the DBA](#sessionid-45385)
11:15:00|Kevin Feasel|Application  Database Development|[APPLY Yourself](#sessionid-45389)
11:15:00|Josef Richberg|BI Platform Architecture, Development  Administration|[Unseen Minions: Improving Parallel Processing in SSIS](#sessionid-45967)
12:30:00|Sayed Saeed|BI Information Delivery|[The Business Intelligence Side of SQL Server](#sessionid-48126)
12:30:00|Argenis Fernandez|Strategy and Architecture|[SQL Server and Pure Storage: Redefining Database Engineering](#sessionid-48766)
13:45:00|Mike Hillwig|Enterprise Database Administration  Deployment|[Maintenance Plans: Planning to Fail](#sessionid-45157)
13:45:00|Meagan Longoria|BI Platform Architecture, Development  Administration|[Building your ETL Framework with Biml](#sessionid-45303)
13:45:00|Chris Lumnah|Enterprise Database Administration  Deployment|[Taking the pain out of database migrations](#sessionid-45317)
13:45:00|Andy Roberts|Advanced Analysis Techniques|[SQL Server 2016 R Integration - how do I do it and why would I want to??](#sessionid-45324)
13:45:00|Aaron Bertrand|Application  Database Development|[New T-SQL Capabilities in SQL Server 2016 and Azure SQL Database](#sessionid-45660)
15:00:00|Dan Clark|Cloud Application Development  Deployment|[Azure Machine Learning – Bringing Advanced Analytics to the Masses](#sessionid-45182)
15:00:00|Ben Miller|Application  Database Development|[Be Friendly to SQL Server with TSQL Best Practices](#sessionid-45383)
15:00:00|Sunil Kadimdiwan|BI Information Delivery|[SSRS 2016 - End-to-end Mobile BI on any device](#sessionid-45704)
15:00:00|Andrew Kelly|Performance|[The Art of War with Bad Code](#sessionid-47455)
15:00:00|Bob Pusateri|Enterprise Database Administration  Deployment|[Introduction to SQL Server Encryption](#sessionid-47486)
15:00:00|Andrzej Pilacik|Enterprise Database Administration  Deployment|[Refresh a 1TB+ database in under 10 seconds](#sessionid-48138)
#  
#### SessionID: 45151
# Efficient and Effective coding of Stored Procedures
#### [Back to calendar](#SQLSaturday-#518-Maine-2016)
