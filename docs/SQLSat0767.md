...
---|---|---|---
08:30:00|Brian Hansen|Application  Database Development|[Remember Back When?  Temporal Tables in SQL Server 2016 and 2017](#sessionid:-85065)
08:30:00|Monica Rathbun|Enterprise Database Administration  Deployment|[How to Get SQL Server to Run Better on Crappy Hardware.](#sessionid:-85278)
08:30:00|Dave Bland|Enterprise Database Administration  Deployment|[Statistics - Why are they there and what do I do with them](#sessionid:-85377)
08:30:00|John Morehouse|Cloud Application Development  Deployment|[Azure Basics for the DBA](#sessionid:-85408)
08:30:00|Rick Lowe|Enterprise Database Administration  Deployment|[Why should I care about ... the plan cache?](#sessionid:-85532)
08:30:00|Ed Leighton-Dick|Application  Database Development|[Understanding SQL Server Always Encrypted](#sessionid:-85553)
10:00:00|Kevin Feasel|Application  Database Development|[APPLY Yourself](#sessionid:-80810)
10:00:00|Sean McCown|Enterprise Database Administration  Deployment|[Monster Text Manipulation: Regular Expressions for the DBA](#sessionid:-82974)
10:00:00|Brett Powell|BI Information Delivery|[Husker Power BI](#sessionid:-84694)
10:00:00|Jennifer McCown|Enterprise Database Administration  Deployment|[Beginning Admin: The Care and Feeding of SQL Server](#sessionid:-85317)
10:00:00|John Morehouse|Application  Database Development|[Temporal Tables – The New Hotness in Data Auditing](#sessionid:-85410)
10:00:00|B.D. Softley|Professional Development|[SELECT Tidbits FROM My.Experience WHERE  NiceToKnow = 1 and date = DATEADD(D,-1,current_timestamp)](#sessionid:-85420)
12:45:00|Marc Beacom|BI Platform Architecture, Development  Administration|[Implementing a Cloud Analytics Solution: Options, costs and more](#sessionid:-77169)
12:45:00|Chris Lumnah|Enterprise Database Administration  Deployment|[Taking the pain out of database migrations](#sessionid:-82709)
12:45:00|David Klee|Enterprise Database Administration  Deployment|[Zen and the Art of Baselines](#sessionid:-83384)
12:45:00|Bill Fellows|Application  Database Development|[What's new for Developers - SQL Server 2014-2017](#sessionid:-84478)
12:45:00|Ed Leighton-Dick|Enterprise Database Administration  Deployment|[How to Keep Your Databases Secure in Just Minutes a Day](#sessionid:-85551)
12:45:00|Brett Powell|BI Platform Architecture, Development  Administration|[Processing Analysis Services Tabular Models](#sessionid:-86344)
14:15:00|Tim Gorman|Enterprise Database Administration  Deployment|[Reducing The Surface Area Of Risk in Data Security](#sessionid:-77021)
14:15:00|Kevin Feasel|Application  Database Development|[Using Kafka for Real-Time Data Ingestion with .NET](#sessionid:-80811)
14:15:00|Sean McCown|Enterprise Database Administration  Deployment|[Loading SQL Server Data with Powershell](#sessionid:-82973)
14:15:00|Brian Hansen|Enterprise Database Administration  Deployment|[Let's Explore SQL Internals](#sessionid:-85064)
14:15:00|Monica Rathbun|Professional Development|[I'm It - Survival Techniques for the Lone DBA](#sessionid:-85277)
14:15:00|Phillip Labry|Cloud Application Development  Deployment|[Analysis Services is in Azure? Seriously!? Let's build a model!](#sessionid:-86356)
15:45:00|Ryan Casey|BI Platform Architecture, Development  Administration|[Shiny, SSAS Tabular Model Developed from a Star Schema](#sessionid:-80243)
15:45:00|Andy Galbraith|Enterprise Database Administration  Deployment|[Getting Started with Extended Events](#sessionid:-83193)
15:45:00|David Klee|Enterprise Database Administration  Deployment|[Level Up Your Cloud Skills](#sessionid:-83385)
15:45:00|Jennifer McCown|Application  Database Development|[T-SQL's Hidden Support Feature](#sessionid:-85321)
15:45:00|Rick Lowe|Cloud Application Development  Deployment|[SQL Server on Amazon Web Services - Elastic Compute Cloud vs Relational Database Service?](#sessionid:-85533)
15:45:00|Wm Bruce Wray|Security|[Data Breach 101 - Legal and IT Responses](#sessionid:-86379)
#  
#### SessionID: 85065
