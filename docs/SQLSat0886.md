...
---|---|---|---
08:00:00|Drew Furgiuele|Cloud Application Development  Deployment|[Introduction to Azure Databricks](#sessionid-91252)
08:00:00|Julie Smith|Analytics and Visualization|[Leveraging Python in SQL Server](#sessionid-91584)
08:00:00|Jay Robinson|Application  Database Development|[Developer Nights: The Ballad of Bobby Tables](#sessionid-91802)
08:00:00|Chris Bell|Enterprise Database Administration  Deployment|[MSAs, GMSAs,  Groups - Use SQL without traditional user accounts](#sessionid-92926)
08:00:00|Aaron Urfer|Enterprise Database Administration  Deployment|[Identifying Sensitive data with Redgate Data Catalog](#sessionid-93491)
08:00:00|Clark Hahn|Cloud Application Development  Deployment|[What I Learned Stepping onto the Cloud](#sessionid-95192)
08:00:00|Brett VanderPlaats|BI Platform Architecture, Development  Administration|[Cloud Data Warehousing with Snowflake on Azure](#sessionid-95202)
08:00:00|Chris Koester|BI Platform Architecture, Development  Administration|[Azure Data Factory - Beyond the Basics](#sessionid-95357)
08:00:00|Peter Shore|SQLStarter|[SQLStarter - Intro to Database Administration](#sessionid-95493)
09:15:00|Dan Mallott|Cloud Application Development  Deployment|[SSDT, Docker, and (Azure) DevOps: How to Make Your Database Builds a First Class CI/CD Citizen](#sessionid-91315)
09:15:00|Michael Huffer|Cloud Application Development  Deployment|[Brick-by-Brick: Foundational Azure Databricks Concepts](#sessionid-93056)
09:15:00|Lou` Russell|Professional Development|[Stuck In the Middle: Collaborating With Multiple Stakeholders](#sessionid-93404)
09:15:00|Lynn Ballard|Analytics and Visualization|[Beginner's Guide to Text Mining:  What We Learn from SQL Saturday Presentation Abstracts](#sessionid-93777)
09:15:00|Dustin Dorsey|Enterprise Database Administration  Deployment|[Managing the mystery database](#sessionid-95155)
09:15:00|Britton Gray|BI Platform Architecture, Development  Administration|[Cloud Data Warehousing in Azure: Azure DWH and Snowflake](#sessionid-95206)
09:15:00|David Mellinger|BI Platform Architecture, Development  Administration|[Microsoft/Azure Data Integrations: Factories, Pipelines, and Flows Oh My!](#sessionid-95335)
09:15:00|Sumeeth Evans|Strategy and Architecture|[SQL Networking  Security](#sessionid-95394)
09:15:00|Andrew Loree|SQLStarter|[SQLStarter - Intro to Data Science](#sessionid-95494)
09:15:00|Pat Phelan|Enterprise Database Administration  Deployment|[DR  HA 101, what are they and why do I want them?](#sessionid-96735)
10:30:00|Simon Kingaby|Cloud Application Development  Deployment|[Moving Data to the Cloud (with Azure Data Factory)](#sessionid-91084)
10:30:00|Dave Bland|Enterprise Database Administration  Deployment|[Extended Events: What are they and How do I use them](#sessionid-91116)
10:30:00|Andy Wickman|Professional Development|[Lessons from Consulting:  Vendor Applications](#sessionid-91957)
10:30:00|Greg Deckler|Analytics and Visualization|[Building a Machine Learning Regression Model with Zero Code in PowerBI](#sessionid-93025)
10:30:00|Bob Pusateri|Cloud Application Development  Deployment|[Dipping Your Toes In: Azure Data Lake for DBAs](#sessionid-93639)
10:30:00|Sriharsh Adari|BI Platform Architecture, Development  Administration|[Enable Real-time Analytics and Machine Learning with Azure Stream Analytics](#sessionid-95067)
10:30:00|Elizabeth Noble|Strategy and Architecture|[Migrate Your Database(s) with Distributed AGs](#sessionid-95087)
10:30:00|Brandon Lukes|Enterprise Database Administration  Deployment|[Migrating your SQL Server Instance](#sessionid-95386)
10:30:00|Warren Sifre|SQLStarter|[SQLStarter - Intro to Big Data](#sessionid-95495)
10:30:00|Ameena Lalani|Enterprise Database Administration  Deployment|[Learn History from Temporal Tables](#sessionid-96383)
11:45:00|Diane Schuster|BI Platform Architecture, Development  Administration|[CozyRoc: Dynamic Data Flows in SSIS Without Programming](#sessionid-94229)
11:45:00|Tamera Clark|Professional Development|[The Community Speaks: WIT, LGBTQ, diversity and inclusion.](#sessionid-95396)
11:45:00|Eddie Wuerch|Enterprise Database Administration  Deployment|[Agile Ops at Billions of Transactions a Day Without Losing Your M](#sessionid-96823)
