...
---|---|---|---
08:30:00|Steve Allison|Application  Database Development|[Cursors temp tables and pivots oh boy](#sessionid-44657)
08:30:00|Thomas Norman|Cloud Application Development  Deployment|[Beginning Azure](#sessionid-44903)
08:30:00|William Assaf|Application  Database Development|[SQL Server Permissions and Security Principals](#sessionid-45285)
08:30:00|Brent Ozar|Application  Database Development|[Performance Tuning SQL Server with sp_AskBrent#174; and sp_BlitzCache#174;](#sessionid-46198)
08:30:00|Naomi Williams|Enterprise Database Administration  Deployment|[SQL Server Internals](#sessionid-46427)
08:30:00|Theresa Eller|Information Delivery|[Using SQL to Avoid the SharePoint List Threshold](#sessionid-48318)
08:30:00|Faheem Ismat|Enterprise Database Administration  Deployment|[Secure your sensitive data with Always Encrypted](#sessionid-48395)
08:30:00|Chris Hyde|BI Platform Architecture, Development  Administration|[Row-level Security in SSRS and SSAS](#sessionid-48482)
09:45:00|Tim Mitchell|BI Platform Architecture, Development  Administration|[Introduction to Biml](#sessionid-44768)
09:45:00|Jamey Johnston|Analytics and Visualization|[Introduction to R and Data Science Tools in the Microsoft Stack](#sessionid-45693)
09:45:00|Steven Ormrod|Application  Database Development|[SQL Server Window Functions](#sessionid-46986)
09:45:00|Cindy Bean|Enterprise Database Administration  Deployment|[Avoiding the Pitfalls of Database Change Automation](#sessionid-47169)
09:45:00|Vicky Harp|Enterprise Database Administration  Deployment|[Introduction to SQL 2016 Temporal Tables](#sessionid-48217)
09:45:00|Robert Bishop|Enterprise Database Administration  Deployment|[Hostile Takeover](#sessionid-48303)
09:45:00|Amy Herold|Enterprise Database Administration  Deployment|[Hi, my name is Powershell, let's be friends! An Intro to PoSH](#sessionid-48345)
09:45:00|Brian Dudley|Application  Database Development|[SQL Omphaloskepsis: Enlightenment and Productivity Using System Tables](#sessionid-48542)
11:00:00|George Govantes|Strategy and Architecture|[So what does it really take to get to four nines](#sessionid-44666)
11:00:00|Mike Byrd|BI Platform Architecture, Development  Administration|[Change Tracking:  A Near Bullet-Proof ETL Synchronization Control](#sessionid-45205)
11:00:00|Kris Hokanson|Application  Database Development|[Beyond the Where: Full Text Search tips and tricks](#sessionid-45473)
11:00:00|Jamey Johnston|Enterprise Database Administration  Deployment|[Overview of Security Investments in SQL Server 2016 and Azure SQL Database](#sessionid-45694)
11:00:00|Jason Wong|Enterprise Database Administration  Deployment|[  A Choice Performance Tuning](#sessionid-48420)
11:00:00|Sean McCown|Enterprise Database Administration  Deployment|[Monster Text Manipulation: Regular Expressions for the DBA](#sessionid-48479)
11:00:00|Brian Dudley|Application  Database Development|[The Ins and Outs of Partitioned Tables](#sessionid-48566)
11:00:00|John Sterrett|Cloud Application Development  Deployment|[Azure Database for DBA's](#sessionid-49742)
12:30:00|Lori Brown|Enterprise Database Administration  Deployment|[Actively Proactive – Straightforward Ways to Manage and Diagnose SQL](#sessionid-47610)
12:30:00|Robert Moore|Enterprise Database Administration  Deployment|[Cisco UCS, Optimal Platform for SQL Server](#sessionid-48502)
12:30:00|Mark Moore|Information Delivery|[What's new in SQL Server 2016](#sessionid-48681)
12:30:00|Matt White|BI Platform Architecture, Development  Administration|["Transform into a Data-Driven Organization"](#sessionid-49208)
12:30:00|Bryan Walsh|Enterprise Database Administration  Deployment|[Transform Database Agility with XtremIO](#sessionid-49663)
12:30:00|Victor Gentry|Enterprise Database Administration  Deployment|[Tintri  SQL Sentry – Optimizing Your Virtualized Workload](#sessionid-49770)
12:30:00|Amit Parikh|Other|[A new paradigm for workload analytics in SQL Server](#sessionid-49996)
13:30:00|Stacy Gray|Enterprise Database Administration  Deployment|[Troubleshooting SQL Server Performance](#sessionid-44649)
13:30:00|Tim Mitchell|BI Platform Architecture, Development  Administration|[Making the Most of the SSIS Catalog](#sessionid-44771)
13:30:00|Kevin Boles|Enterprise Database Administration  Deployment|[SQL Server Defaults SUCK!!](#sessionid-46148)
13:30:00|Aaron Cutshall|Application  Database Development|[T-SQL Tips  Tricks](#sessionid-46363)
13:30:00|John Harp|Enterprise Database Administration  Deployment|[Cluster@#$%! High Availability Solutions. What Could Go Wrong?](#sessionid-46480)
13:30:00|Anthony {Tex} Moreign|Cloud Application Development  Deployment|[Gen2016™ and the Global “Hybrid” Cloud](#sessionid-47476)
13:30:00|Ken Clement|Application  Database Development|[Codd's Rules, Normal Forms, and SQL Anti-Patterns - Recognition  Repair](#sessionid-48571)
13:30:00|Brent Ozar|Application  Database Development|[Watch Brent Tune Indexes](#sessionid-50251)
14:45:00|Jennifer McCown|Application  Database Development|[Designing Stored Procedure Solutions](#sessionid-44652)
14:45:00|Daniel Janik|Application  Database Development|[Analyze your query plan like a Microsoft Engineer! (SQL 2016 Edit](#sessionid-45001)
14:45:00|Kevin Boles|Application  Database Development|[Indexing Deep Dive](#sessionid-46149)
14:45:00|Bala Shankar|Cloud Application Development  Deployment|[Deploy SQL Server with Microsoft Azure Virtual Machine](#sessionid-46381)
14:45:00|Patrick LeBlanc|BI Information Delivery|[What's New in SSRS 2016](#sessionid-46875)
14:45:00|Keith Tate|Enterprise Database Administration  Deployment|[Profiler is Dead! Long Live Extended Events!](#sessionid-47166)
14:45:00|Lori Edwards|Enterprise Database Administration  Deployment|[SQL Server Statistics – What Are The Chances?](#sessionid-48209)
14:45:00|Amy Herold|Professional Development|[Making the Leap from Developer to DBA](#sessionid-48346)
16:00:00|John Sterrett|Enterprise Database Administration  Deployment|[Why Did My Execution Plan Change? Introduction to Query Store](#sessionid-45718)
16:00:00|Patrick LeBlanc|BI Information Delivery|[Introduction to Microsoft Mobile Reporting](#sessionid-46872)
16:00:00|Dane Schilling|Application  Database Development|[Simple Fun Modeling with SQL Server](#sessionid-47046)
16:00:00|Sean McCown|Enterprise Database Administration  Deployment|[Understanding Backups](#sessionid-48480)
16:00:00|Dave Wiley|Enterprise Database Administration  Deployment|[How answers.microsoft.com Overcame the key Challenges of Upgrading to SQL S](#sessionid-48512)
16:00:00|Todd Kleinhans|Information Delivery|[The Life Cycle of a Query in Virtual Reality](#sessionid-48550)
16:00:00|Richie Rump|Application  Database Development|[Who's Afraid of Entity Framework?](#sessionid-48561)
16:00:00|Shawn Weisfeld|Cloud Application Development  Deployment|[Scale out SQL Server PaaS in Azure Elastically](#sessionid-49756)
#  
#### SessionID: 44657
# Cursors temp tables and pivots oh boy
#### [Back to calendar](#SQLSaturday-#514---Houston-2016)
