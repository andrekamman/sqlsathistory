...
---|---|---|---
00:00:00|Brian Alderman|DBA / Prof Dev|[Optimizing SQL Server for SharePoint ](#sessionid-10772)
00:00:00|Jason Brimhall|APP DEV / DBA|[SQL 2012 Extended Events](#sessionid-10843)
00:00:00|Jason Brimhall|DBA|[Murder They Wrote](#sessionid-10846)
00:00:00|Carlos Bossy|BI|[Getting started with Big Data and BI](#sessionid-11349)
00:00:00|Carlos Bossy|BI|[Enterprise Tabular Models](#sessionid-11350)
00:00:00|Chris Hyde|BI/ APP DEV|[Becoming Certified In Microsoft SQL Server](#sessionid-11511)
00:00:00|David Stein|ETL / SSIS |[Biml – The Next Step in Agile Data Warehousing](#sessionid-12444)
00:00:00|David Stein|BI|[Data Warehouse Mistakes You Can’t Afford to Make](#sessionid-12446)
00:00:00|Eric Oszakiewski|APP DEV|[Make Your DBA Happy: 5 Habits Developers Can Implement Today](#sessionid-13897)
00:00:00|Eric  Stoltze|DBA|[Preparing SQL for SharePoint the balance of resources](#sessionid-13904)
00:00:00|Ginger Grant|BI / Big Data|[Power BI –  Cloud Self-Service BI](#sessionid-14663)
00:00:00|Ginger Grant|BI / Big Data|[The Sqoop on Big Data from it’s humble beginnings to rise to notoriety](#sessionid-14664)
00:00:00|Gene Stout|DBA|[SQL 2012 AlwaysOn](#sessionid-14841)
00:00:00|Jason Kassay|BI/ APP DEV|[Getting Started with Execution Plans](#sessionid-16878)
00:00:00|John McAllister|BI / Big Data|[Enterprise-grade MDM On SQL Server - the Keys to Success](#sessionid-17155)
00:00:00|John Sterrett|DBA / Prof Dev|[Powershell for SQL Server DBA's](#sessionid-17179)
00:00:00|Josh Sivey|BI/ APP DEV|[Introduction to Microsoft Power Query](#sessionid-17506)
00:00:00|Joe Salvatore|BI/ APP DEV|[Fundamentals of Data Warehouse Architecture and Design](#sessionid-17623)
00:00:00|John Yang|BI / Big Data|[An End-to-End Big Data Architecture to Improve Marketing ROI](#sessionid-17825)
00:00:00|Kevin Cox|DBA|[SQL Server HA and DR in a Windows Azure Virtual Machine – Deep Dive](#sessionid-18247)
00:00:00|Kevin Cox|BI/ APP DEV|[Keynote - Breakthrough Data Platform Performance with SQL 2014](#sessionid-18248)
00:00:00|Kathi Kellenberger|APP DEV|[Writing Better T-SQL Queries with Window Functions](#sessionid-18432)
00:00:00|Kathi Kellenberger|DBA|[Women in Tech Panel](#sessionid-18434)
00:00:00|Keith Tate|APP DEV / DBA|[The Curious Case of Isolation Levels](#sessionid-18853)
00:00:00|Lori Edwards|DBA|[SQL Server Statistics – What Are The Chances?](#sessionid-19235)
00:00:00|Matt Smith|BI|[Unlock the Power in Power BI](#sessionid-19340)
00:00:00|Marc Jellinek|BI|[SQL Server 2012 Master Data Services / Data Quality Services](#sessionid-19422)
00:00:00|Mark Paszli|ETL / SSIS |[Probing into the Microsoft SSIS Model: Reconfiguring SSIS Packages Using an Automated Approach](#sessionid-19566)
00:00:00|Martin Schoombee|BI|[Designing and Loading Slowly Changing Dimensions](#sessionid-19752)
00:00:00|Andre DuBois|APP DEV|[What secrets does your table schema hold?](#sessionid-21163)
00:00:00|Orion Gebremedhin|BI / Big Data|[Introduction to the Hive Query Language for BI Developers](#sessionid-21590)
00:00:00|Randy Knight|DBA / Prof Dev|[Understanding the SQL Server Transaction Log](#sessionid-22522)
00:00:00|Randy Knight|APP DEV / DBA|[Locks, Blocks, and Deadlocks Oh My!](#sessionid-22523)
00:00:00|Reeves Smith|ETL / SSIS |[Increase your SSIS productivity with Biml](#sessionid-22758)
00:00:00|Jeff Renz|BI/ APP DEV|[Battle of the Finch Bots](#sessionid-22912)
00:00:00|Jeff Renz|BI / Big Data|[Dashboards - More than One Way to Visualize Data](#sessionid-22915)
00:00:00|Robert Miller|DBA|[Event Notification in SQL Server 2012](#sessionid-23089)
00:00:00|Ryan McCauley|DBA|[SQL Clustering - what it is, what it isn't, and how to get both](#sessionid-23704)
00:00:00|Shawn Meyers|DBA|[Translate SQL server performance issues into business costs](#sessionid-24631)
00:00:00|Kevin Boles|DBA|[SQL Server 2014 New Features](#sessionid-26401)
00:00:00|Kevin Boles|DBA|[SQL Injection](#sessionid-26402)
00:00:00|Tim Mitchell|ETL / SSIS |[15 Quick Tips for SSIS Performance](#sessionid-26622)
00:00:00|Tim Mitchell|ETL / SSIS |[Handling Errors and Data Anomalies in SSIS](#sessionid-26623)
00:00:00|TJay Belt|DBA|[Database Release Management: Tips to help organize it](#sessionid-26897)
00:00:00|TJay Belt|DBA|[Documentation – you know you love it](#sessionid-26898)
00:00:00|Vern Rabe|DBA|[Basics of Query Performance Tuning](#sessionid-27372)
00:00:00|Warren Sifre|APP DEV|[Introduction to FileTables in SQL 2012](#sessionid-27554)
00:00:00|William E Pearson III|BI|[Beyond Plateaux: Optimize SSAS via Best Practices](#sessionid-28123)
00:00:00|William E Pearson III|BI|[Getting Started with MDX](#sessionid-28124)
00:00:00|John McAllister|BI|[Master Data Services - 4 Key Features in 60 Minutes](#sessionid-34672)
00:00:00|Ami Levin|APP DEV / DBA|[Where did I put my (primary) keys?](#sessionid-9391)
00:00:00|Ami Levin|APP DEV|[Physical Join Operators](#sessionid-9392)
#  
#### SessionID: 10772
