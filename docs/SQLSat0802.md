...
---|---|---|---
09:15:00|Denny Cherry|Enterprise Database Administration  Deployment|[How to Maintain the Same Level of Utilities in Cloud Deployments - Securability, Reliability and Sca](#sessionid-83477)
09:15:00|Armando Lacerda|Cloud Application Development  Deployment|[Azure for SQL Server Professionals - Get your head in the Cloud](#sessionid-83533)
09:15:00|Mindy Curnutt|Professional Development|[Impostor Syndrome: Are You Faking It  Will they Find Out?](#sessionid-83550)
09:15:00|Andrew Karcher|Strategy and Architecture|[Foundations of a Data Driven Organization](#sessionid-83888)
09:15:00|Sepand Gojgini|BI Platform Architecture, Development  Administration|[Columnstore Index Primer](#sessionid-84419)
09:15:00|Maxwell Myrick|Enterprise Database Administration  Deployment|[The Art and Science of Designing a Mission Critical SQL Server](#sessionid-84477)
09:15:00|Ike Ellis|BI Information Delivery|[Introduction to DAX](#sessionid-85198)
09:15:00|Simon Cho|Application  Database Development|[[StepbyStep] SQL server Index operation for beginner to expert.](#sessionid-85389)
10:30:00|Jeff Prom|Strategy and Architecture|[Save Time and Resources - Performance Tuning Strategies](#sessionid-83492)
10:30:00|Jay Falck|Enterprise Database Administration  Deployment|[Introduction to Linux for SQL Server](#sessionid-83622)
10:30:00|Kevin Feasel|Strategy and Architecture|[Much Ado About Hadoop](#sessionid-84103)
10:30:00|Suresh Datla|BI Information Delivery|[Power BI Dashboard - Creating End to End Solutions](#sessionid-84479)
10:30:00|Ted Stathakis|BI Information Delivery|[Introduction to SQL Server Reporting Services](#sessionid-85126)
10:30:00|Peter Kral|BI Platform Architecture, Development  Administration|[SSIS Deployment Smackdown! Package vs. Project!](#sessionid-85209)
10:30:00|Ben Aminnia|Professional Development|[Choosing a Career Path in Database Technologies](#sessionid-85331)
10:30:00|Dustin Vannoy|Data Science, Analytics and Visualization|[A Week in the Life of a Data Scientist](#sessionid-85502)
12:15:00|Diane Schuster|BI Platform Architecture, Development  Administration|[CozyRoc: Dynamic Data Flows in SSIS Without Programming](#sessionid-85419)
12:15:00|Arneh Eskandari|Enterprise Database Administration  Deployment|[The role of the DBA in Compliant Database DevOps](#sessionid-85805)
12:15:00|Susan Wong|Cloud Application Development  Deployment|[Database Migration to Cloud with Zero Downtime](#sessionid-85956)
13:30:00|Denny Cherry|Application  Database Development|[SQL Server Database Administration for the non-DBA](#sessionid-83473)
13:30:00|Armando Lacerda|Professional Development|[DBA vNext](#sessionid-83534)
13:30:00|Mindy Curnutt|Application  Database Development|[The Ins and Outs of SQL Indexes](#sessionid-83549)
13:30:00|Zia Khan|Data Science, Analytics and Visualization|[Hands on Data Science Tutorial](#sessionid-84056)
13:30:00|Maxwell Myrick|Enterprise Database Administration  Deployment|[SQL Server Then and Now: Changing the State of Long-held Beliefs](#sessionid-84476)
13:30:00|Brodie Brickey|Application  Database Development|[SSIS Basics](#sessionid-85199)
13:30:00|Benjamin Nevarez|Application  Database Development|[Dive into the Query Optimizer - Undocumented Insight](#sessionid-85620)
13:30:00|Mike Burek|Application  Database Development|[Use SQL Server 2017 Features in Your Older SQL Server Versions](#sessionid-85722)
14:45:00|Randy Knight|Enterprise Database Administration  Deployment|[Locks, Blocks, and Deadlocks, Oh My!](#sessionid-83816)
14:45:00|Kevin Feasel|Data Science, Analytics and Visualization|[R For the SQL Server Developer](#sessionid-84104)
14:45:00|Adam Anderson|BI Platform Architecture, Development  Administration|[Delivering Business Value Faster](#sessionid-84501)
14:45:00|Jeff Mlakar|Enterprise Database Administration  Deployment|[Database Corruption! Preventing Disaster to your Database.](#sessionid-84680)
14:45:00|Brodie Brickey|BI Information Delivery|[Data Driven Subscription Reports with SSRS Standard Edition](#sessionid-85200)
14:45:00|Steve Rezhener|BI Information Delivery|[SQL Server Integration Services (SSIS) - hate to love it or love to hate it?](#sessionid-85248)
14:45:00|Patrick Partin|Information Delivery|[What just happened? Creating your own real-time dashboard with Grafana, Influx, and Telegraf.](#sessionid-85608)
14:45:00|Benjamin Nevarez|Application  Database Development|[Understanding Parameter Sniffing](#sessionid-85622)
16:00:00|Randy Knight|Application  Database Development|[But it worked great in Dev!  Perfomance for Devs](#sessionid-83815)
16:00:00|Amie Mason|Data Science, Analytics and Visualization|[Azure Intelligent Services](#sessionid-84481)
16:00:00|Jeff Mlakar|Enterprise Database Administration  Deployment|[Environmental SQL Server Troubleshooting](#sessionid-84679)
16:00:00|Ted Stathakis|BI Platform Architecture, Development  Administration|[Reporting Services 2016: New Features  Smart Migration Strategy](#sessionid-85127)
16:00:00|Peter Kral|Enterprise Database Administration  Deployment|[SSIS Project Deployment: The T-SQL Way](#sessionid-85208)
16:00:00|Eddie Maloney|Application  Database Development|[The Secrets of Partitioning](#sessionid-85585)
16:00:00|Mike Burek|Application  Database Development|[Basic Windowing Functions](#sessionid-85719)
16:00:00|Thomas Hull|Enterprise Database Administration  Deployment|[SQL Security, Encryption,  Compliance](#sessionid-85725)
#  
#### SessionID: 83477
# How to Maintain the Same Level of Utilities in Cloud Deployments - Securability, Reliability and Sca
#### [Back to calendar](#nr-802)
