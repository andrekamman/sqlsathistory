...
---|---|---|---
08:30:00|Justin Dearing|Application  Database Development|[Version control with GIT for the DBA Precon](#sessionid-62498)
08:30:00|Kevin Feasel|Strategy and Architecture|[Big Data, Small Data, and Everything In Between](#sessionid-57900)
08:30:00|Grant Fritchey|Enterprise Database Administration  Deployment|[Azure SQL Database for the DBA](#sessionid-59392)
08:30:00|Jonathan Stewart|BI Information Delivery|[From problem to Power BI:  A journey in data visualization](#sessionid-61558)
08:30:00|Chris Sommer|Enterprise Database Administration  Deployment|[Painting with PowerShell: SQL Server Administration](#sessionid-61639)
09:45:00|James Serra|Enterprise Database Administration  Deployment|[Big data architectures and the data lake](#sessionid-57885)
09:45:00|Taiob Ali|Enterprise Database Administration  Deployment|[How to migrate a SQL database to Microsoft Azure SQL V12](#sessionid-61389)
09:45:00|Justin Dearing|Application  Database Development|[Version control with GIT for the DBA](#sessionid-62495)
09:45:00|Amy Herold|Enterprise Database Administration  Deployment|[Making the Leap from Developer to DBA](#sessionid-63836)
11:00:00|Kevin Feasel|Analytics and Visualization|[R For the SQL Server Developer](#sessionid-57902)
11:00:00|Andrew Loree|Enterprise Database Administration  Deployment|[Stretch Database and Managed Backups: Cloud Services for your SQL Servers](#sessionid-61276)
11:00:00|Jonathan Stewart|BI Platform Architecture, Development  Administration|[An introduction to the magical world of BIML!](#sessionid-61556)
11:00:00|Paul Popovich Jr|Enterprise Database Administration  Deployment|[Distributed Replay, using  it to plan for the future.](#sessionid-62407)
11:00:00|Thomas Grohser|Application  Database Development|[# vs @ - it's not about Social Media it's about temporary tables and data](#sessionid-62799)
12:15:00|Allen White|Other|[Tuning Query Performance with SentryOne Plan Explorer](#sessionid-64624)
13:30:00|Edward Pollack|Application  Database Development|[Finding Islands, Gaps, and Clusters in Complex Data](#sessionid-57878)
13:30:00|Derik Hammer|Enterprise Database Administration  Deployment|[Architecting Availability Groups](#sessionid-57895)
13:30:00|Chris Hyde|Analytics and Visualization|[SQL Server R Services in SQL 2016](#sessionid-59588)
13:30:00|Andrew Loree|Enterprise Database Administration  Deployment|[SQL Server vNext (Linux and Beyond)](#sessionid-61277)
13:30:00|Amy Herold|Professional Development|[WIT: Start 'em Young - Growing Women in IT](#sessionid-63727)
14:45:00|Edward Pollack|Enterprise Database Administration  Deployment|[Building Effective Backups](#sessionid-57880)
14:45:00|Grant Fritchey|Application  Database Development|[The Query Store and Query Tuning in SQL Server](#sessionid-59393)
14:45:00|James Serra|Professional Development|[Learning to present and becoming good at it](#sessionid-59579)
14:45:00|Thomas Grohser|Application  Database Development|[Developing and deploying reusable TSQL code with Visual Studio and SQL Server Data Tools](#sessionid-62800)
14:45:00|Allen White|Application  Database Development|[Scalable Application Design with Service Broker](#sessionid-63451)
16:00:00|Derik Hammer|Application  Database Development|[Query Tuning without Production Data](#sessionid-57897)
16:00:00|Taiob Ali|Enterprise Database Administration  Deployment|[Think like the Cardinality Estimator](#sessionid-61658)
16:00:00|Allen White|Enterprise Database Administration  Deployment|[Emergency! Are You Ready for Disaster to Strike?](#sessionid-63449)
#  
#### SessionID: 62498
