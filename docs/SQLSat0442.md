...
---|---|---|---
09:00:00|George Walkey|Enterprise Database Administration  Deployment|[Scripting out SQL Server for Documentation and Disaster Recovery](#sessionid-37110)
09:00:00|miguel Cebollero|Application  Database Development|[SQL Server 2014 In-Memory Programming](#sessionid-38633)
09:00:00|Josh Luedeman|Cloud Application Development  Deployment|[Data Factory: Data Integration in the Cloud](#sessionid-38653)
09:00:00|Steve Jones|Application  Database Development|[The Encryption Primer](#sessionid-38744)
09:00:00|Mark Tabladillo|Analytics and Visualization|[Microsoft Technologies for Data Science](#sessionid-38750)
09:00:00|Mitchell Pearson|BI Platform Architecture, Development  Administration|[SSIS Performance Tuning Techniques](#sessionid-38809)
09:00:00|James McAuliffe|Enterprise Database Administration  Deployment|[Changing Data Is Easy, Managing Data Change is Hard!](#sessionid-38858)
09:00:00|Allan Hirt|Enterprise Database Administration  Deployment|[What's New for High Availability in SQL Server 2016 and Windows Server 2016](#sessionid-38870)
09:00:00|Kendal Van Dyke|Enterprise Database Administration  Deployment|[Transactional Replication: Architecture, Setup, and Monitoring](#sessionid-38914)
09:00:00|Susan Rickman|Application  Database Development|[DataTypes - What's the Big Deal?](#sessionid-40380)
09:00:00|Mark Scott|Analytics and Visualization|[Looking for the Power BI on-prem alternative?](#sessionid-40806)
10:35:00|Janis Griffin|Enterprise Database Administration  Deployment|[Top 10 Wait Types Everyone Should Know](#sessionid-36837)
10:35:00|Daniel Janik|Advanced Analysis Techniques|[Analyze your query plan like a Microsoft Engineer!](#sessionid-37012)
10:35:00|Jason Carter|Enterprise Database Administration  Deployment|[Encryption 101: A look at SQL Encryption Options](#sessionid-37734)
10:35:00|Charles Hyman|BI Platform Architecture, Development  Administration|[SQL 2016 Changes and Enhancements for BI and Beyond](#sessionid-37989)
10:35:00|Mike Davis|Professional Development|[Interview Puzzles and how to handle them](#sessionid-38176)
10:35:00|Dustin Ryan|BI Platform Architecture, Development  Administration|[Designing a Data Warehouse from the Ground Up](#sessionid-38395)
10:35:00|Eric Wisdahl|Application  Database Development|[An Introductory Look at Execution Plans](#sessionid-38773)
10:35:00|Gareth Swanepoel|Cloud Application Development  Deployment|[A practical guide to Windows Azure SQL Database for the DBA](#sessionid-38824)
10:35:00|Damu Venkatesan|BI Information Delivery|[Self-Service ETL with Microsoft Power Query](#sessionid-38836)
10:35:00|Richie Rump|Application  Database Development|[Entity Framework: Or How I Learned to Stop Worrying and Learned to Love Developers](#sessionid-38855)
12:30:00|Allan Hirt|Enterprise Database Administration  Deployment|[Building a Better Mousetrap: Using Cisco UCS for SQL Server Deplo](#sessionid-40685)
12:30:00|Jeff Abbott|Application  Database Development|[Be the SQL Server Dev/Ops Hero, brought to you by Actifio](#sessionid-41241)
12:30:00|Todd Phillippe|Advanced Analysis Techniques|[Object Level Recovery Made Easy brought to you by Dell Software](#sessionid-41245)
12:30:00|Janis Griffin|Application  Database Development|[Advanced Performance Tuning Tips with Database Performance Analyz](#sessionid-41257)
12:30:00|Patrick Pinchera|Enterprise Database Administration  Deployment|[Flash Storage Drill Down: Know Your Storage Infrastructure](#sessionid-41305)
12:30:00|Kendal Van Dyke|Enterprise Database Administration  Deployment|[Implementing a SANLess Cluster in Under an Hour, brought to you b](#sessionid-41477)
13:30:00|Dave Mattingly|Professional Development|[Achievement Unlocked: How to Get Promoted](#sessionid-36813)
13:30:00|Prakash Heda|Enterprise Database Administration  Deployment|[Detect Worst Performing SQL Queries During Peak Hour](#sessionid-37169)
13:30:00|Jeff Reinhard|Enterprise Database Administration  Deployment|[AlwaysOn Availability Groups Kickoff](#sessionid-38094)
13:30:00|Jorge Besada|Application  Database Development|[PowerShell and Python - The Clash - Part Deux](#sessionid-38113)
13:30:00|Lindsay Clark|Enterprise Database Administration  Deployment|[Beginners SQL Server Security the Low Hanging Fruit](#sessionid-38496)
13:30:00|Jorge Novo|Application  Database Development|[Loading Complex Data Structures using SSIS Programming](#sessionid-38640)
13:30:00|Andy Warren|Professional Development|[How To Become a SQL Server DBA](#sessionid-38847)
13:30:00|Louis Davidson|Strategy and Architecture|[How In-Memory Database Objects Affect Database Design](#sessionid-38850)
13:30:00|Sebastian Meine|Application  Database Development|[SQL Server 2016 Always Encrypted](#sessionid-38857)
13:30:00|Pankaj Satyaketu|Cloud Application Development  Deployment|[An intro to Azure SQL Data Warehouse](#sessionid-38874)
13:30:00|Pam Shaw|BI Information Delivery|[Taking the Scary out of Monster Reports](#sessionid-38876)
13:30:00|Bradley Ball|Application  Database Development|[What's New in SQL Server 2016](#sessionid-40871)
13:30:00|Buck Woody|Advanced Analysis Techniques|[Cortana Analytics Demystified](#sessionid-41262)
15:15:00|Wayne Sheffield|Application  Database Development|[Table Vars and Temp Tables – What you NEED to Know!](#sessionid-36793)
15:15:00|Ronald Dameron|Enterprise Database Administration  Deployment|[Real World SQL Server Administration with just a bit of sysadmin](#sessionid-36856)
15:15:00|Jeffrey Garbus|Information Delivery|[Indexing for Join Optimization](#sessionid-36863)
15:15:00|Wes Springob|Analytics and Visualization|[How to build your first Power BI Dashboard in 60 Min.](#sessionid-37540)
15:15:00|Stuart Ainsworth|Strategy and Architecture|[Eating The Elephant; A DBA's Guide to Hadoop  Big Data](#sessionid-38178)
15:15:00|Maximo Trinidad|Application  Database Development|[PowerShell with Visual Studio SQL Data Tools](#sessionid-38346)
15:15:00|Dmitri Korotkevitch|Application  Database Development|[Thinking Outside of the In-Memory Box](#sessionid-38446)
15:15:00|Karlyn LeBlanc|Professional Development|[Balancing Work and Home to Create a Better You](#sessionid-38730)
15:15:00|Patrick LeBlanc|BI Information Delivery|[Introduction to DataZen](#sessionid-38732)
15:15:00|Ian Lanham|Enterprise Database Administration  Deployment|[Management Data Warehouse and Data Collector](#sessionid-38816)
15:15:00|David Pless|Enterprise Database Administration  Deployment|[SQL SERVER 2016 PERFORMANCE FEATURES](#sessionid-38830)
16:30:00|Andrey Korshikov|Professional Development|[SQL Injection – are you ready for defense?](#sessionid-36811)
16:30:00|Rob Volk|Application  Database Development|[Tame Your Unruly Data...With Constraints!](#sessionid-37687)
16:30:00|Jack Corbett|Application  Database Development|[Don't Be Trigger Happy: Safe Use of Triggers](#sessionid-37870)
16:30:00|Troy Gallant|Enterprise Database Administration  Deployment|[Indexing your Data Warehouse](#sessionid-38137)
16:30:00|Jen Underwood|BI Information Delivery|[Roadmap: What's Coming Next for SQL Server BI and Power BI ](#sessionid-38410)
16:30:00|Robert Biddle|Analytics and Visualization|[Introduction To R](#sessionid-38510)
16:30:00|Mike Lawell|Application  Database Development|[Execution Plans for Mere Mortals](#sessionid-38658)
16:30:00|Colleen Morrow|Enterprise Database Administration  Deployment|[Enterprise Auditing with SQL Server Audit](#sessionid-38734)
16:30:00|Leigh Freijo|Professional Development|[Why I won't hire you and what you can do about it!](#sessionid-38859)
16:30:00|Brian Davis|BI Platform Architecture, Development  Administration|[DQ What? DQ Who? DQ How?](#sessionid-38911)
#  
#### SessionID: 37110
# Scripting out SQL Server for Documentation and Disaster Recovery
#### [Back to calendar](#SQLSaturday-#442-Orlando-2015)
...
#### [Back to calendar](#SQLSaturday-#442-Orlando-2015)
Event Date: 10-10-2015 - Session time: 16:30:00 - Track: Cloud Application Development  Deployment
...
#### [Back to calendar](#SQLSaturday-#442-Orlando-2015)
Event Date: 10-10-2015 - Session time: 16:30:00 - Track: Advanced Analysis Techniques
...
#### [Back to calendar](#SQLSaturday-#442-Orlando-2015)
Event Date: 10-10-2015 - Session time: 16:30:00 - Track: Strategy and Architecture
...
#### [Back to calendar](#SQLSaturday-#442-Orlando-2015)
Event Date: 10-10-2015 - Session time: 16:30:00 - Track: Information Delivery
