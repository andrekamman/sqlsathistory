...
---|---|---|---
00:00:00|Belkis Ozhorasan|Adara|[Easy Way of Data Consumption  Visualization with SSRS, PowerPivot and Power View](#sessionid-10206)
00:00:00|Benjamin Nevarez|Jupiter 2|[Query Processing in In-Memory OLTP (Hekaton)](#sessionid-10386)
00:00:00|Boris Hristov|Adara|[The nightmare of locking, blocking and isolation levels!](#sessionid-10945)
00:00:00|Burak Tufanoglu|Adara|[See the POWER of PowerBI](#sessionid-11133)
00:00:00|Batuhan Yildiz|Jupiter 2|[Monitoring and Assessing SQL Server with extended events](#sessionid-11138)
00:00:00|Denis Reznik|Jupiter 1|[Effective T-SQL. To be effective or not to be.](#sessionid-13148)
00:00:00|Faruk Celik|Mira|[How to tune your applications before moving your database to Microsoft Azure SQL Database (PaaS)](#sessionid-14184)
00:00:00|Işıl Efe|Adara|[SQL 2014 Column Store Index Enhancements](#sessionid-15436)
00:00:00|Ismail Adar|Jupiter 1|[Write Quick, Readable and High Performance Queries Using Window Functions with SQL Server 2014](#sessionid-15443)
00:00:00|Alexander Karl|Vega|[DQS step-by-step  with Domain Management, Knowledge Discovery and Matching Policies](#sessionid-17935)
00:00:00|Koray Kocabas|Vega|[Predictive Modelling with SQL Server and Azure ML](#sessionid-18808)
00:00:00|Levent Oktar|Jupiter 2|[SQL Server 2014: High Availability and Disaster Recovery Solutions](#sessionid-19145)
00:00:00|Mihail Mateev|Mira|[Scaling Out Microsoft Azure SQL Databases](#sessionid-20338)
00:00:00|Mine Tokus|Mira|[Relational Data Management on Microsoft Azure](#sessionid-20797)
00:00:00|Mustafa Acungil|Adara|[One Small Step for Power BI, Four Giant Tools for Power Users](#sessionid-21227)
00:00:00|Gokan Ozcifci|Vega|[Deep dive to SQL Server configuration for SharePoint Server](#sessionid-21602)
00:00:00|Serdar Altug|Vega|[Why "Big Data" Is a Big Deal? Converting Big Data into Value](#sessionid-23814)
00:00:00|Saverio  Lorenzini|Jupiter 1|[How to improve SQL query performances by analyzing the cached code in buffer pool](#sessionid-24004)
00:00:00|Chandra Mohan Situmalli|Mira|[Backups for Azure SQL Databases and SQL Server instances running on Azure Virtual Machines](#sessionid-24039)
00:00:00|Satya Jayanty|Jupiter 2|[Let's cook  'best SQL Server DBA practices'](#sessionid-25031)
00:00:00|Kevin Boles|Jupiter 1|[Common TSQL Mistakes](#sessionid-26438)
00:00:00|Tomaž Kaštrun|Vega|[Making customer segmentation using SQL Server SSAS](#sessionid-27011)
00:00:00|Turgay Sahtiyan|Jupiter 1|[How Latch Contention Affects the Performance? Common Scenarios and Workarounds from the Field](#sessionid-27169)
00:00:00|Umit Sunar|Mira|[Introduction to Document DB and Azure Search](#sessionid-27179)
00:00:00|Yigit Aktan|Jupiter 2|[Troubleshooting: How to understand if the storage is a problem on the database server?](#sessionid-28288)
#  
#### SessionID: 10206
