...
---|---|---|---
10:00:00|Paul Turley|BI Information Delivery|[Reporting Services 2016 Solutions: The New Awesome](#sessionid:-41898)
10:00:00|Rob Mandeville|Enterprise Database Administration  Deployment|[Know your bottlenecks: Wait time analysis](#sessionid:-42222)
10:00:00|Chris Hyde|Advanced Analysis Techniques|[SQL Server R Services in SQL 2016](#sessionid:-42277)
10:00:00|Vern Rabe|Enterprise Database Administration  Deployment|[It’s Time for a Change : Temporal Table Support in SQL Server 2016](#sessionid:-42489)
10:00:00|Ryan McCauley|Strategy and Architecture|[How to troubleshoot beyond what you understand](#sessionid:-42562)
10:00:00|Delora Bradish|BI Platform Architecture, Development  Administration|[Build Your BI House with a Blueprint: Modeling for MS BI](#sessionid:-42938)
10:00:00|William E Pearson III|Analytics and Visualization|[Introducing Forensic Analytics with Power BI](#sessionid:-43035)
10:00:00|Andy Tabisz|Application  Database Development|[Creating Access Web Apps with SQL Azure and SharePoint](#sessionid:-44879)
10:00:00|Thomas Grohser|Enterprise Database Administration  Deployment|[SQL Server Storage Engine under the hood ](#sessionid:-45602)
10:00:00|Rushabh Mehta|BI Information Delivery|[Mastering and Enhancing Company Data](#sessionid:-46091)
10:00:00|Mindy Curnutt|Enterprise Database Administration  Deployment|[SQL Server Bingo – Install, Migration  Config](#sessionid:-46418)
10:00:00|Joseph D'Antoni|Strategy and Architecture|[The Tricky Part of Doing Tricky Things in your Data Model](#sessionid:-46529)
10:00:00|Carlos Bossy|Advanced Analysis Techniques|[Predictive Analytics Fundamentals](#sessionid:-46777)
10:00:00|Orion Gebremedhin|Advanced Analysis Techniques|[Microsoft Azure : Elastic Cloud Compute and Storage for Big Data Processing](#sessionid:-46927)
11:15:00|Eric Peterson|Application  Database Development|[JSON and SQL 2016](#sessionid:-42930)
11:15:00|Delora Bradish|BI Platform Architecture, Development  Administration|[Performance Matters: Optimizing SSAS Multidimensional Cubes](#sessionid:-42939)
11:15:00|William E Pearson III|Strategy and Architecture|[Possible Musics: Choosing between SSAS Multidimensional and Tabular](#sessionid:-43033)
11:15:00|Sean Werick|Application  Database Development|[Tired of looking for query performance optimizations?  Try the Query Store!](#sessionid:-45518)
11:15:00|Kevin Wilkie|Application  Database Development|[Even VIEWs can be sexy](#sessionid:-45683)
11:15:00|Stan Geiger|BI Platform Architecture, Development  Administration|[Performance Monitoring for Analysis Services](#sessionid:-46038)
11:15:00|Ned Otter|Enterprise Database Administration  Deployment|[SQL SERVER 2016, HEKATON REVEALED](#sessionid:-46350)
11:15:00|Chris Shaw|Enterprise Database Administration  Deployment|[Tips for SQL Server Performance and Resiliency](#sessionid:-46422)
11:15:00|Geoff Valera|Analytics and Visualization|[DataZen and More](#sessionid:-46457)
11:15:00|Joseph D'Antoni|BI Platform Architecture, Development  Administration|[Essential Architecture for Bi in a Virtual Environment](#sessionid:-46530)
11:15:00|Reeves Smith|BI Platform Architecture, Development  Administration|[SQL Server Integration Services for Data Science](#sessionid:-46673)
11:15:00|Carlos Bossy|BI Platform Architecture, Development  Administration|[Real-time Data Warehousing for rapid BI Analysis](#sessionid:-46794)
11:15:00|Steve Jones|Application  Database Development|[End to End Protection with Always Encrypted in SQL Server 2016](#sessionid:-46856)
12:30:00|Orion Gebremedhin|Advanced Analysis Techniques|[Microsoft Cortana Analytics: The Unified Platform for Advanced Analytics](#sessionid:-46928)
12:30:00|Josh Sivey|Strategy and Architecture|[Don’t forget the licensing!](#sessionid:-48665)
12:30:00|Matt White|Professional Development|[Learn about Pyramid Analytics’ BI Office Version 6 Platform Release](#sessionid:-49313)
12:30:00|Matthew Smith|Strategy and Architecture|[Microsoft Presents: Don’t forget the licensing!](#sessionid:-49366)
12:30:00|Ed Cho|Strategy and Architecture|[Cisco and Nimble Storage: Partnering to Create the Next Generation SQL Serv](#sessionid:-49367)
12:30:00|Kathi Kellenberger|Professional Development|[WIT Session: The Year of Yes](#sessionid:-49540)
13:45:00|Michael Perillo|Analytics and Visualization|[Introduction to Tableau](#sessionid:-41770)
13:45:00|Mike Byrd|Application  Database Development|[SS2014 In-Memory Tables:  Formula 1 Performance Unleashed?](#sessionid:-41798)
13:45:00|Mark Broadbent|Enterprise Database Administration  Deployment|[Ye Olde Cluster Curiosity Shoppe - A miscellany of SQL Clustering top tips](#sessionid:-42086)
13:45:00|Mark Broadbent|Enterprise Database Administration  Deployment|[The NOLOCK Chronicles](#sessionid:-42087)
13:45:00|Drew Furgiuele|Enterprise Database Administration  Deployment|[SQL Server and PowerShell: Let's Get Serious](#sessionid:-42240)
13:45:00|TJay Belt|Cloud Application Development  Deployment|[Hadoop, Hive, JSON, and Data! Oh, my!](#sessionid:-42484)
13:45:00|Phil Ekins|Enterprise Database Administration  Deployment|[Availability Groups:  Monitoring and Alerting](#sessionid:-43013)
13:45:00|Sean Brown|Application  Database Development|[Managing Databases in Visual Studio and TFS](#sessionid:-45206)
13:45:00|Steve Hughes|Application  Database Development|[A Window into Your Data: Using SQL Window Functions](#sessionid:-45465)
13:45:00|Stan Geiger|BI Platform Architecture, Development  Administration|["Polybase and Time Travel (Temporal Tables)"](#sessionid:-46041)
13:45:00|Josh Sivey|Cloud Application Development  Deployment|[Azure SQL Data Warehouse – Elastic Data Analytics in the cloud](#sessionid:-46413)
13:45:00|Mindy Curnutt|Application  Database Development|[The Ins and Outs of SQL Indexes](#sessionid:-46417)
13:45:00|Martin Schoombee|BI Information Delivery|[MDX: Troubleshooting Tips  Tricks](#sessionid:-46742)
13:45:00|Rowland Gosling|BI Platform Architecture, Development  Administration|[Accelerating Batch Processing with Apache Spark](#sessionid:-48112)
15:00:00|Mike Byrd|Application  Database Development|[SQL Server Foreign Keys – De-mystifying the Rest of the Story](#sessionid:-41797)
15:00:00|Jeff Schmidt|Enterprise Database Administration  Deployment|[SQL 2014 , been there done that!](#sessionid:-42204)
15:00:00|Dean Richards|Enterprise Database Administration  Deployment|[Introduction to Wait Types and Response Time Analysis](#sessionid:-45448)
15:00:00|Kathi Kellenberger|Enterprise Database Administration  Deployment|[Kerberos Delegation for SSRS Made Simple](#sessionid:-45625)
15:00:00|Naomi Williams|Professional Development|[SQL Server Internals](#sessionid:-46428)
15:00:00|Konstantin Melamud|BI Platform Architecture, Development  Administration|[Optimizing your data warehouse for OLAP Processing](#sessionid:-46452)
15:00:00|Paul Graham|BI Platform Architecture, Development  Administration|[How do you validate your ETL?](#sessionid:-46527)
15:00:00|Ginger Grant|Advanced Analysis Techniques|[Data Driven Decision Making with Azure ML](#sessionid:-46750)
15:00:00|Alan Faulkner|Cloud Application Development  Deployment|[Introduction to Azure Data Factory Service](#sessionid:-46756)
15:00:00|Jeff Prom|BI Platform Architecture, Development  Administration|[Mastering Master Data Services](#sessionid:-46765)
15:00:00|Amy Herold|Enterprise Database Administration  Deployment|[Deadlock, Block  Two Smoking Barrels: Breaking Down Blocking and Deadlocks](#sessionid:-46786)
15:00:00|Steve Jones|Application  Database Development|[Get Testing with tSQLt](#sessionid:-46855)
15:00:00|Jason Brimhall|Enterprise Database Administration  Deployment|[Bare Naked Skinny on SQL Server](#sessionid:-48623)
16:00:00|Thomas Grohser|Enterprise Database Administration  Deployment|[Optimizing the SQL Server and Databases for large Fact Tables](#sessionid:-45601)
16:15:00|Rachael Martino|BI Platform Architecture, Development  Administration|[Power BI Performance Tips](#sessionid:-44820)
16:15:00|Reeves Smith|BI Platform Architecture, Development  Administration|[Increase your SSIS productivity with Biml](#sessionid:-45295)
16:15:00|Kathi Kellenberger|Enterprise Database Administration  Deployment|[Top 5 SQL Server Mistakes](#sessionid:-45626)
16:15:00|Arnie Rowland|Strategy and Architecture|[Table Partitioning -Beyond the Basics](#sessionid:-46052)
16:15:00|Konstantin Melamud|Enterprise Database Administration  Deployment|[Turbo Boost Performance: In Memory Tables index optimizations](#sessionid:-46455)
16:15:00|Rick Lowe|Application  Database Development|[Weird stuff I saw while supporting a Java team](#sessionid:-46596)
16:15:00|Ben Thul|Application  Database Development|[Phone Book Phun - Learning database concepts with the White Pages](#sessionid:-46665)
16:15:00|Robert Miller|Analytics and Visualization|[Welcome to Azure Stream Analytics](#sessionid:-46780)
16:15:00|Amy Herold|Enterprise Database Administration  Deployment|[Hi, my name is Powershell, let's be friends! An Intro to PoSH](#sessionid:-46787)
16:15:00|Sayed Saeed|BI Information Delivery|[The Business Intelligence Side of SQL Server](#sessionid:-48128)
16:15:00|Jason Brimhall|Enterprise Database Administration  Deployment|[Working with Object Compression in SQL Server](#sessionid:-48622)
16:15:00|Phil Robinson|BI Information Delivery|[Power BI Desktop – A BI developer’s view](#sessionid:-49686)
#  
#### SessionID: 41898
# Reporting Services 2016 Solutions: The New Awesome
#### [Back to calendar](#SQLSaturday-#492---Phoenix-2016)
