...
---|---|---|---
00:00:00|Bill Fellows|2 -SQL Dev|[2012 TSQL Sweets](#sessionid:-10438)
00:00:00|Bob Pusateri|1 -Indexes|[The Skinny on Data Compression](#sessionid:-10593)
00:00:00|Brent Ozar|5 -On/Off Prem |[Building Faster SQL Servers](#sessionid:-10728)
00:00:00|Buck Woody||[The Cloud is Coming for Your Career - Buwahahahaha](#sessionid:-11099)
00:00:00|Carl Rabeler||[Authorization  Access Rights w/ SharePoint  SQL](#sessionid:-11173)
00:00:00|Robert Davis|6 -Performance |[Recovering from Corruption](#sessionid:-11444)
00:00:00|David Eichner|3 -BI Treats |[Overview of PowerPivot](#sessionid:-12730)
00:00:00|Douglas Barrett|2 -SQL Dev|[Agile Data Warehousing with WhereScape](#sessionid:-13397)
00:00:00|Ed Snajder|4 -Powershell|[Powershell Smoke for SQL Server Mirrors](#sessionid:-13965)
00:00:00|Eddie Wuerch|6 -Performance |[TempDB Performance Troubleshooting and Optimizing](#sessionid:-14082)
00:00:00|Hugo Kornelis|1 -Indexes|[Understanding Indexes](#sessionid:-15052)
00:00:00|Hugo Kornelis|1 -Indexes|[Advanced Indexing](#sessionid:-15053)
00:00:00|Janis Griffin|7 -Getting it Right |[Extend Your Knowledge with Extended Events!](#sessionid:-15669)
00:00:00|Jason Horner|3 -BI Treats |[ Isn't that Spatial! (BI Edition)](#sessionid:-15837)
00:00:00|Jeremiah Peschka|6 -Performance |[Killer Techniques for Database Performance](#sessionid:-16584)
00:00:00|Josh Fennessy|8 -ETL  Analysis|[Looking to the future - Tabular Mode SSAS](#sessionid:-16722)
00:00:00|Jason Kassay|2 -SQL Dev|[The Accidental Programmer](#sessionid:-16885)
00:00:00|Julie Koesmarno|3 -BI Treats |[Power View for Geographical Analysis ](#sessionid:-16906)
00:00:00|Joe Salvatore|8 -ETL  Analysis|[SSIS Patterns and Practices: Loading Fact Tables](#sessionid:-17106)
00:00:00|Laerte Junior|4 -Powershell|[Troubleshooting SQL Server with PowerShell](#sessionid:-18919)
00:00:00|Kendra Little|1 -Indexes|[Index Psychiatry: The Top 5 Disorders](#sessionid:-19169)
00:00:00|Mark Broadbent|6 -Performance |[READPAST  Furious-Transactions,LockingIsolation](#sessionid:-19546)
00:00:00|Mark Simms|5 -On/Off Prem |[SQLCAT - Building scalable  cloud applications](#sessionid:-19792)
00:00:00|Matt Masson|5 -On/Off Prem |[Efficient On-Premise to Cloud Data Transfer](#sessionid:-19833)
00:00:00|Michael Swinarski|7 -Getting it Right |[The Most Ignored Best Practices](#sessionid:-20365)
00:00:00|Michael Wells|4 -Powershell|[Rapidly Deploying SQL Server with PowerShell](#sessionid:-20377)
00:00:00|Michael Wells|5 -On/Off Prem |[Running SQL Server 2012 on Server Core: Why  How](#sessionid:-20378)
00:00:00|Pat Sinthusan|7 -Getting it Right |[New Data Management Capabilities with SQL Server 2](#sessionid:-21737)
00:00:00|Paul Turley|3 -BI Treats |[Power View and PowerPivot: High-Octane Self-svc BI](#sessionid:-21834)
00:00:00|Peter Myers|3 -BI Treats |[What's New for Self-Service BI in Excel 2013](#sessionid:-21978)
00:00:00|Peter Myers|8 -ETL  Analysis|[Introduction to SQL Server 2012 MDS and DQS](#sessionid:-21979)
00:00:00|Rick  Morelan|2 -SQL Dev|[Introducing SQL Server Data Tools. (Project Juneau](#sessionid:-23001)
00:00:00|Rob Garrison|7 -Getting it Right |[Schema Design: Advanced Data Validation Techniques](#sessionid:-23235)
00:00:00|Russel Loski|8 -ETL  Analysis|[SSRS data driven subscription using SSIS](#sessionid:-23627)
00:00:00|Hossam Alfraih|1 -Indexes|[A Tour in The Indexing World!](#sessionid:-23998)
00:00:00|Scott Klein|5 -On/Off Prem |[SQL Azure - What is it and why do you need it?](#sessionid:-24133)
00:00:00|Steve Stedman|2 -SQL Dev|[Unleashing Common Table Expressions in SQL Server](#sessionid:-25737)
00:00:00|Tim Mitchell|8 -ETL  Analysis|[SSIS Incremental Load Design Patterns](#sessionid:-26612)
00:00:00|Tim Ford|6 -Performance |[Performance Enhancing Laziness](#sessionid:-26845)
00:00:00|Vern Rabe|7 -Getting it Right |[The Significance of Choosing and Using Data Types](#sessionid:-27374)
00:00:00|Victor Isakov|2 -SQL Dev|[What DBAs Should Know About Windows Server 2012](#sessionid:-27442)
00:00:00|Aaron Nelson|4 -Powershell|[PowerShell for Data Professionals](#sessionid:-8852)
#  
#### SessionID: 10438
# 2012 TSQL Sweets
