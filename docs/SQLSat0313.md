...
---|---|---|---
00:00:00|Boris Hristov|DEV|[The nightmare of locking, blocking and isolation levels!](#sessionid-10954)
00:00:00|Christoph Muthmann|DEV|[Performancesteigerung durch Window Functions](#sessionid-11148)
00:00:00|Christoph Seck|BI|[From XML to Nested Sets: Handling Hierarchies with SQL Server](#sessionid-11683)
00:00:00|Constantin Klein|DEV|[Unit Testing and Continuous Deployment for DB-Development?](#sessionid-11805)
00:00:00|n/a n/a|DBA|[Session Details not available](#sessionid-12090)
00:00:00|David Postlethwaite|Open|[Beware of the Dark Side - A Guided Tour of Oracle for the SQL Server DBA](#sessionid-12463)
00:00:00|Dejan Sarka|Mixed |[Analyzing Text with SQL Server 2014](#sessionid-13563)
00:00:00|Florian Eiden|BI|[Agile Datawarehousing: tips and tricks to deliver your BI solution using Agile methodolgy like SCRUM](#sessionid-14290)
00:00:00|Frank Geisler|DBA|[Always ON 2014](#sessionid-14325)
00:00:00|Dr. Holger Schwichtenberg|DEV|[Datenzugriff mit Entity Framework – brauchbar oder einfach nur langsam?](#sessionid-14920)
00:00:00|Harm Knolle|Open|[Yahoo Cloud Serving Benchmark - MS SQL Server vs. MongoDB](#sessionid-14941)
00:00:00|Niko Neugebauer|Mixed |[Clustered Columnstore Deep Dive](#sessionid-15424)
00:00:00|Jean-Pierre Riehl|BI|[Power Query vs. SSIS, which one is the most powerful?](#sessionid-16260)
00:00:00|Alexander Karl|BI|[Anwenden u. Erweitern des SSIS CatalogDB für ein Logging Framework](#sessionid-17948)
00:00:00|Sascha Lorenz|DBA|[PowerShell 101 für SQL Administratoren](#sessionid-19228)
00:00:00|Marcel Franke|Open|[SAP HANA, Power Pivot, SQL Server - In-Memory-Technologien im Vergleich](#sessionid-19437)
00:00:00|Martin Kopp|Mixed |[Column Store Index 2012 vs. 2014](#sessionid-19739)
00:00:00|Mihail Mateev|Open|[Node.js for Microsoft SQLServer Nerds](#sessionid-20346)
00:00:00|Miloš Radivojević|DBA|[SQL Server 2014 - New Cardinality Estimator](#sessionid-20752)
00:00:00|Oliver Engels|Mixed |[Siena calling! Project Siena a RBID App?](#sessionid-21554)
00:00:00|Oliver Engels|Open|[SSIS und HDInsight - Zwei Welten treffen aufeinander?](#sessionid-21555)
00:00:00|Stephan Köppen|Mixed |[ROLAP mit der PDW - Endlich der nötige Performanceboost](#sessionid-23790)
00:00:00|Sascha Dittmann|DEV|[MapReduce in der Praxis](#sessionid-23986)
00:00:00|Scott Klein|DEV|[SQL Server 2014 Top 5 - Hybrid Features](#sessionid-24182)
00:00:00|Scott Klein|Open|[MongoDB on Windows Azure](#sessionid-24200)
00:00:00|Sergey Olontsev|DBA|[Data Corruption: how to detect, resolve and prevent](#sessionid-24368)
00:00:00|William Durkin|DBA|[Database Replication - What, How and Why](#sessionid-28210)
00:00:00|Andreas Wolter|Mixed |[Columnstore, In-Memory, Page oder Row-Compressed, OLTP vs OLAP – SQL Server 2014 Speichertypen](#sessionid-8820)
#  
#### SessionID: 10954
