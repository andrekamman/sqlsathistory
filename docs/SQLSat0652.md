...
---|---|---|---
08:00:00|Teo Lachev|BI Platform Architecture, Dev, Delivery  Admin|[What's New for BI in SQL Server 2017](#sessionid-63677)
08:00:00|Brian Carrig|Cloud Application Development  Deployment|[Running SQL Server in AWS](#sessionid-63705)
08:00:00|Tim Mitchell|BI Platform Architecture, Dev, Delivery  Admin|[Deep Dive into the SSIS Catalog](#sessionid-63937)
08:00:00|Ed Watson|BI Platform Architecture, Dev, Delivery  Admin|[Introduction to SQL Server Integration Services](#sessionid-64363)
08:00:00|Doug McClurg|Application  Database Development|[Continuous Deployment with SSDT](#sessionid-64672)
08:00:00|Mike Robbins|Other|[PowerShell 101: The No-Nonsense Beginner’s Guide to PowerShell](#sessionid-64725)
08:00:00|Kiran Math|Analytics  Visualization|[Extract, Transform And Load  - Using R](#sessionid-64901)
08:00:00|Tracy Boggiano|Optimization  Performance|[Collecting Baseline Metrics](#sessionid-65363)
08:00:00|Lindsay Clark|Enterprise Database Administration  Deployment|[Is SQL Server 2016 My Perfect Match?](#sessionid-65442)
08:00:00|Patrick LeBlanc|Power BI|[Power BI:  Customers Stories from the Frontline](#sessionid-67753)
09:15:00|Patrick Keisler|Enterprise Database Administration  Deployment|[SQL Audit - Evidence Never Lies](#sessionid-63660)
09:15:00|Andy Leonard|BI Platform Architecture, Dev, Delivery  Admin|[Designing an SSIS Framework](#sessionid-63735)
09:15:00|Eric Peterson|Cloud Application Development  Deployment|[High Availability in the Cloud](#sessionid-64132)
09:15:00|Kate Grass|BI Platform Architecture, Dev, Delivery  Admin|[Let’s Get Meta: an Overview of ETL Frameworks using Biml](#sessionid-64502)
09:15:00|Jim Christopher|Analytics  Visualization|[Replacing Institutional Knowledge with Artificial Intelligence so I can Take a Damned Vacation](#sessionid-64655)
09:15:00|Eric Flamm|Enterprise Database Administration  Deployment|[Use Visual Studio Code to Access SQL Server from Windows (or Mac, or Linux, or ...)](#sessionid-64685)
09:15:00|Shabnam Watson|BI Platform Architecture, Dev, Delivery  Admin|[Performance Monitoring SQL Server Analysis Services (SSAS)](#sessionid-64979)
09:15:00|Bhakthi Liyanage|Analytics  Visualization|[Azure Machine Learning I : Machine Learning and Predictive Analytics with AML Studio](#sessionid-64984)
09:15:00|Robert Verell|Enterprise Database Administration  Deployment|[New Features in SQL Server 2017](#sessionid-65406)
09:15:00|Chris Hyde|Analytics  Visualization|[Python in SQL Server 2017](#sessionid-65543)
10:30:00|Naomi Williams|Enterprise Database Administration  Deployment|[SQL Server Internals](#sessionid-63657)
10:30:00|John Deardurff|Professional Development|[How to get Microsoft Certified](#sessionid-63694)
10:30:00|Lance Tidwell|Optimization  Performance|[Introduction to Execution Plans](#sessionid-63892)
10:30:00|Louis Davidson|Application  Database Development|[Database Design Fundamentals](#sessionid-63948)
10:30:00|Luis Figueroa|Cloud Application Development  Deployment|[Enabling EDW and BI workloads on Hadoop with Hive / LLAP](#sessionid-64177)
10:30:00|Daniel Glenn|BI Platform Architecture, Dev, Delivery  Admin|[Power BI  SharePoint - A Marriage Made in Redmond](#sessionid-64307)
10:30:00|Julie Smith|BI Platform Architecture, Dev, Delivery  Admin|[Heckin Sweet Reports with Power BI](#sessionid-64579)
10:30:00|Andrew Kelly|Optimization  Performance|[Query Store – What is it all about?](#sessionid-64645)
10:30:00|Stuart Ainsworth|Professional Development|[The Future of the DBA: DevOps, the Cloud Paradigm, and the Microsoft Data Platform](#sessionid-64680)
10:30:00|Damu Venkatesan|BI Platform Architecture, Dev, Delivery  Admin|[Self-Service ETL with Microsoft Power Query](#sessionid-65394)
11:45:00|Rie Irish|Professional Development|[Let Her Finish: Supporting Women's Voices from meetings to the board room](#sessionid-64390)
11:45:00|Cassius Rhue|Cloud Application Development  Deployment|[Secrets to Fast, Easy High Availability for SQL Server in AWS](#sessionid-67247)
11:45:00|Marsha Pierce|Enterprise Database Administration  Deployment|[How To Talk To Your Storage Admin](#sessionid-67248)
11:45:00|Steve Abraham|Cloud Application Development  Deployment|[Using SQL Server on Amazon Web Services - High Availability and R](#sessionid-67295)
11:45:00|Diane Schuster|BI Platform Architecture, Dev, Delivery  Admin|[Excel and SSIS: Better Together](#sessionid-67450)
11:45:00|Nathan Wood|Optimization  Performance|[Architecting for Performance](#sessionid-67634)
13:00:00|Amy Herold|Other|[Making the Leap from Developer to DBA](#sessionid-63646)
13:00:00|Aaron Cutshall|Application  Database Development|[Introduction to Relational Database Design Patterns](#sessionid-63746)
13:00:00|Kevin Feasel|Analytics  Visualization|[Data Cleansing With SQL And R](#sessionid-63773)
13:00:00|Angela Henry|Power BI|[What is Power BI?](#sessionid-64175)
13:00:00|Jonathan Stewart|BI Platform Architecture, Dev, Delivery  Admin|[Performance Tuning for the BI Professional](#sessionid-64254)
13:00:00|Elizabeth Noble|Application  Database Development|[Making Your List and Checking It Twice: Introduction to unit testing with tSQLt](#sessionid-64501)
13:00:00|Dan Mallott|Application  Database Development|[ORMs and the DBA: How to Make Both Happy](#sessionid-64574)
13:00:00|Kevin Wilkie|Professional Development|[IT and the Evil Empire (Business) : Friends or Enemies?](#sessionid-64932)
13:00:00|Patrick LeBlanc|Cloud Application Development  Deployment|[Introduction to Azure Analysis Services](#sessionid-65376)
13:00:00|Jennifer McCown|Analytics  Visualization|[T-SQL's Hidden Support Feature](#sessionid-67037)
14:15:00|Kellyn Pot'Vin-Gorman|Enterprise Database Administration  Deployment|[Introducing the Limitless DBA-  Copy Data Management, DBA Style](#sessionid-63648)
14:15:00|Matt Gordon|Enterprise Database Administration  Deployment|[New Features and New Speed in SQL Server 2016 (and 2017!) Always On Availability Groups](#sessionid-63650)
14:15:00|Christopher Sims|Application  Database Development|[I like big data for $400  - Exploring quiz show questions using Angular, DocumentDB and Azure Search](#sessionid-63653)
14:15:00|Ulysses B Brown Jr|Analytics  Visualization|[So you have installed Microsoft R Services (In-database)  ... Now what "R" you going to do?](#sessionid-63658)
14:15:00|Thomas Norman|Application  Database Development|[Database Project Makes Deployment Consistent](#sessionid-63670)
14:15:00|William Wolf|Application  Database Development|[Blue Collar SQL Tricks - Make Standard Edition Work for you.](#sessionid-64220)
14:15:00|Karlyn LeBlanc|Professional Development|[Taking Time for You](#sessionid-64318)
14:15:00|Robert Cain|Cloud Application Development  Deployment|[Powering Azure from PowerShell](#sessionid-64459)
14:15:00|Katherine Fraser|BI Platform Architecture, Dev, Delivery  Admin|[Plots and Data Points: Pulling R Charts together in a Power BI Da](#sessionid-64844)
14:15:00|Adam Saxton|Power BI|[What's New with Power BI](#sessionid-65541)
15:30:00|Chris Hyde|Analytics  Visualization|[SQL Server R Services in SQL 2016](#sessionid-63642)
15:30:00|Ryan Wade|Analytics  Visualization|[Leveraging SQL Server R Services to Perform Advanced Analytics](#sessionid-63662)
15:30:00|Jim Wooley|Application  Database Development|[Getting started with Entity Framework Core](#sessionid-63706)
15:30:00|Samir Behara|Application  Database Development|[Making developers lives easier with SQL Server 2016](#sessionid-63794)
15:30:00|Matt Martin|Optimization  Performance|[Optimization, Optimization – Make Your Queries Faster](#sessionid-63830)
15:30:00|Sven Aelterman|Cloud Application Development  Deployment|[Azure SQL Database: 12 Things To Know](#sessionid-63854)
15:30:00|David Klee|Enterprise Database Administration  Deployment|[Linux for the SQL Server Administrator](#sessionid-63858)
15:30:00|Simon Kingaby|BI Platform Architecture, Dev, Delivery  Admin|[How to Move a Ton of Data from the Mainframe to the Cloud (with B](#sessionid-64948)
15:30:00|Todd Kleinhans|Enterprise Database Administration  Deployment|[VLDB Tips and Migration Tactics](#sessionid-64983)
15:30:00|Mike Lawell|Enterprise Database Administration  Deployment|[Execution Plans for Mere Mortals](#sessionid-65437)
15:30:00|Glen Gordon|Professional Development|[Agile isn't the A in DBA, but you still should know it](#sessionid-65441)
#  
#### SessionID: 63677
