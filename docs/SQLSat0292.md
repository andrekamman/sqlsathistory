...
---|---|---|---
00:00:00|Christopher Campbell|BI|[Big Data Trends with the Microsoft Parallel Data Warehouse](#sessionid-11720)
00:00:00|Colleen Morrow|DBA|[SQL Audit - auditing doesn't have to be boring](#sessionid-11777)
00:00:00|Craig Purnell|Wildcard 2|[Achieving Compliance with SQL Server](#sessionid-11997)
00:00:00|David Klee|Wildcard 1|[How to Argue with Your Infrastructure Admins – and Win](#sessionid-12522)
00:00:00|Frank Murphy|Wildcard 2|[DIY Geocoding](#sessionid-14297)
00:00:00|Gill Rowley|Wildcard 1|[You're the DBA.  Now What?](#sessionid-14647)
00:00:00|Gill Rowley|Dev|[Dynamic Connections in SSIS](#sessionid-14648)
00:00:00|Ginger Grant|BI|[The Sqoop on Big Data from it’s humble beginnings to rise to notoriety](#sessionid-14658)
00:00:00|Ginger Grant|Wildcard 2|[Power BI –  Cloud Self-Service BI](#sessionid-14659)
00:00:00|Grant Fritchey|Dev|[Building a Database Deployment Pipeline](#sessionid-14770)
00:00:00|Grant Fritchey|Dev|[Getting Started Reading Execution Plans](#sessionid-14771)
00:00:00|Jeff Moden|DBA|[Partitioning System for "WORM" Tables](#sessionid-16057)
00:00:00|John  Gayer|Wildcard 1|[SQL Server 2014 Managed Backup to Windows Azure](#sessionid-16758)
00:00:00|Mike Hays|Wildcard 1|[Troubleshooting Your Network Connections](#sessionid-20657)
00:00:00|Michael Schulte|BI|[Extending SQL Server with Advanced Analytics and R](#sessionid-21131)
00:00:00|Dustin Prescott|Dev|[Hacking SQL Server - A Peek into the Dark Side](#sessionid-22296)
00:00:00|Brian Davis|BI|[SSIS Templates Can Make Your Life Easier](#sessionid-22637)
00:00:00|Brian Davis|Wildcard 2|[Getting Started with Hekaton (In-Memory OLTP)](#sessionid-22638)
00:00:00|Rick Brewis|DBA|[SQL Server 2014 - In-Memory OLTP](#sessionid-22684)
00:00:00|George Squillace|BI|[All About the SSIS Catalog (SSISDB)](#sessionid-25089)
00:00:00|Tim Ford|Wildcard 1|[The Most Important Dynamic Management Objects for New DBAs](#sessionid-26872)
00:00:00|Tom Groszko|Dev|[T-SQL For Beginning Developers](#sessionid-26985)
00:00:00|Allen White|DBA|[Automate Your ETL Infrastructure with SSIS and PowerShell](#sessionid-9983)
#  
#### SessionID: 11720
